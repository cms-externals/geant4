...
inline bool write_out_one_page_two_regions(std::ostream& a_out, bool a_verbose,
...
inline bool write_out_two_pages(std::ostream& a_out, bool a_verbose, const std::string& a_file)
{
  ...
  //////////////////////////////////////////////////////////
  viewer.open_file(a_file,
                   true);  // true = anonymous = no creator, creation date, title in the file.
...
bool test_viewplot(std::ostream& a_out, bool a_verbose)
{
  ...
  if (!tools::test_with_file(a_out, a_verbose, "utest_1_", ".ps", _remove, utest_viewplot_1_ps,
                             write_out_one_page_two_regions)
      && stop_if_failed)
    return false;
  if (!tools::test_with_file(a_out, a_verbose, "utest_2_", ".ps", _remove, utest_viewplot_2_ps,
                             write_out_two_pages)
      && stop_if_failed)
    return false;
