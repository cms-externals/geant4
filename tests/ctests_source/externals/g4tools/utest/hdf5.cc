...
static bool write_hdf5(std::ostream& a_out, bool a_verbose, to_compare_hdf5& a_cmp,
                       const std::string& a_file)
{
  ...
  TOOLS_TEST_FUNC(
    toolx::hdf5::write_struct<S_B>(histos, "my_struct", S_B_file_type, S_B_mem_type, my_struct))
...
static bool read_hdf5(std::ostream& a_out, bool a_verbose, const to_compare_hdf5& a_cmp,
                      const std::string& a_file)
{
  ...
  //// Use the data ////////////////////////
  //////////////////////////////////////////
  if (!tools::equal<unsigned int>(a_out, __FILE__, __LINE__, n, (unsigned int)1000000))
    return false;
  ...
  if (!tools::equal<unsigned int>(a_out, __FILE__, __LINE__, s.e.a, (unsigned int)314))
    return false;
  if (!tools::equal<int>(a_out, __FILE__, __LINE__, s.e.b, -315)) return false;
  if (!tools::equal<float>(a_out, __FILE__, __LINE__, s.e.c, 3.14F, 0.0001F, tools::ffabs))
    return false;
  if (!tools::equal<double>(a_out, __FILE__, __LINE__, s.e.ds[5], 3.16, 0.0001, tools::dfabs))
    return false;
  if (!tools::equal<int>(a_out, __FILE__, __LINE__, ::strcmp(s.e.s, "hello"), 0)) return false;
  if (!tools::equal<unsigned int>(a_out, __FILE__, __LINE__, my_object.ui, (unsigned int)314))
    return false;
  if (!tools::equal(a_out, __FILE__, __LINE__, my_object.f, 315.0F, 0.0001F, tools::ffabs))
    return false;
  {
