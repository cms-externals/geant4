...
inline bool test_with_file(std::ostream& a_out, bool a_verbose, const std::string& a_prefix,
                           const std::string& a_suffix, bool a_remove, inc_func a_inc_func,
                           test_func a_test_func, filter_func a_filter_func = 0)
{
  std::string file;
...
inline bool test_with_file(std::ostream& a_out, bool a_verbose, const std::string& a_prefix,
                           const std::string& a_suffix, bool a_remove, inc_func a_inc_func,
                           test_plot_func a_test_func, unsigned int a_cols, unsigned int a_rows,
                           float a_plotter_scale, const std::string& a_style,
