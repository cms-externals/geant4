...
{
  H1* slice = new H1(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
                     a_from.axis_x().upper_edge());
  if (!fill_slice_x(a_from, aJbeg, aJend, *slice))
  {
    delete slice;
    return 0;
  }
...
{
  H1* slice = new H1(a_title, a_from.axis_y().bins(), a_from.axis_y().lower_edge(),
                     a_from.axis_y().upper_edge());
  if (!fill_slice_y(a_from, aIbeg, aIend, *slice))
  {
    delete slice;
    return 0;
  }
...
{
  H2* slice = new H2(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
...
{
  H2* slice = new H2(a_title, a_from.axis_y().bins(), a_from.axis_y().lower_edge(),
