...
{
  h1d* slice_x = new h1d(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
                         a_from.axis_x().upper_edge());
  if (!fill_slice_x(a_from, aJbeg, aJend, *slice_x)) {
    delete slice_x;
    return 0;
  }
  return slice_x;
...
{
  h1d* slice_y = new h1d(a_title, a_from.axis_y().bins(), a_from.axis_y().lower_edge(),
                         a_from.axis_y().upper_edge());
  if (!fill_slice_y(a_from, aIbeg, aIend, *slice_y)) {
    delete slice_y;
    return 0;
  }
  return slice_y;
...
{
  p1d* slice_x = new p1d(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
                         a_from.axis_x().upper_edge());
  if (!fill_profile_x(a_from, aJbeg, aJend, *slice_x)) {
    delete slice_x;
    return 0;
  }
  return slice_x;
...
{
  p1d* slice_y = new p1d(a_title, a_from.axis_y().bins(), a_from.axis_y().lower_edge(),
                         a_from.axis_y().upper_edge());
  if (!fill_profile_y(a_from, aIbeg, aIend, *slice_y)) {
    delete slice_y;
    return 0;
  }
  return slice_y;
...
{
  h2d* slice = new h2d(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
                       a_from.axis_x().upper_edge(), a_from.axis_y().bins(),
                       a_from.axis_y().lower_edge(), a_from.axis_y().upper_edge());
  if (!fill_slice_xy(a_from, aKbeg, aKend, *slice)) {
    delete slice;
    return 0;
  }
  return slice;
...
{
  h2d* slice = new h2d(a_title, a_from.axis_y().bins(), a_from.axis_y().lower_edge(),
                       a_from.axis_y().upper_edge(), a_from.axis_z().bins(),
                       a_from.axis_z().lower_edge(), a_from.axis_z().upper_edge());
  if (!fill_slice_yz(a_from, aIbeg, aIend, *slice)) {
    delete slice;
    return 0;
  }
  return slice;
...
{
  h2d* slice = new h2d(a_title, a_from.axis_x().bins(), a_from.axis_x().lower_edge(),
                       a_from.axis_x().upper_edge(), a_from.axis_z().bins(),
                       a_from.axis_z().lower_edge(), a_from.axis_z().upper_edge());
  if (!fill_slice_xz(a_from, aJbeg, aJend, *slice)) {
    delete slice;
    return 0;
  }
  return slice;
