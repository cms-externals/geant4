...
int main()
{
  ...
  G4ConsumeParameters(Al);

  density = 1.390 * g / cm3;
  a = 39.95 * g / mole;
  G4Material* lAr = new G4Material(name = "liquidArgon", z = 18., a, density);
  G4ConsumeParameters(lAr);

  density = 8.960 * g / cm3;
  a = 63.55 * g / mole;
  G4Material* Cu = new G4Material(name = "Copper", z = 29., a, density);
  G4ConsumeParameters(Cu);

  density = 11.35 * g / cm3;
  a = 207.19 * g / mole;
  G4Material* Pb = new G4Material(name = "Lead ", z = 82., a, density);
  G4ConsumeParameters(Pb);
  ...
  G4Material* steam = new G4Material(name = "Water steam ", density, ncomponents = 1, kStateGas,
                                     temperature, pressure);
  ...
  new G4Material(name = "Galactic", z = 1., a = 1.01 * g / mole, density, kStateGas, temperature,
                 pressure);
  ...
  G4Material* beam =
    new G4Material(name = "Beam ", density, ncomponents = 1, kStateGas, temperature, pressure);
  ...
  G4Material* XeCH4C3H8 = new G4Material(name = "XeCH4C3H8", density, ncomponents = 3);
  ...
  G4Material* Ar20CO2 = new G4Material(name = "Ar20CO2", density, ncomponents = 2);
  ...
  G4Material* He20CO2 = new G4Material(name = "He20CO2", density, ncomponents = 2);
  ...
  for (iMat = 0; iMat < numberOfMat; iMat++) {
    ...
    for (iSan = 0; iSan < nbOfElements; iSan++) {
      thisMaterialZ[iSan] = (G4int)(*theMaterialTable)[iMat]->GetElement(iSan)->GetZ();
    }
    ...
    //
    G4SandiaTable* sanMatrix = G4Material::GetMaterial(matName)->GetSandiaTable();
    ...
    for (row = 0; row < sanIndex; row++) {
      ...
      for (iSan = 1; iSan < 5; iSan++) {
        unit *= keV;
        G4cout << "\t" << (sanMatrix->GetSandiaCofForMaterial(row, iSan)) / (density * unit);
      }
      G4cout << G4endl;
    }
    G4cout << G4endl;
