...
int main()
{
  ...
  G4cout << "\n---> " << matName << ": mass of molecule " << mass << " = " << mass / g
         << " g = " << mass / CLHEP::amu << " amu" << G4endl;
  ...
  for (it = matComponents.begin(); it != matComponents.end(); it++) {
    ...
    G4String local_name = mat->GetName();
    G4double fraction = it->second;
    G4cout << "  " << std::setw(13) << local_name << ": " << std::setw(7) << fraction << G4endl;
  }
