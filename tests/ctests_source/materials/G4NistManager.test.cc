...
int main()
{
  ...
  G4Material* CH4 =
    new G4Material("Methane", density, ncomponents = 2, kStateGas, temperature, pressure);
  ...
  G4Material* Air =
    new G4Material("dry_Air", density, ncomponents = 2, kStateGas, temperature, pressure);
  ...
  temperature = 273.15 * kelvin;
  G4Material* CO2 =
    new G4Material("Carbonic gas", density, ncomponents = 2, kStateGas, temperature, pressure);
