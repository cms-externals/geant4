...
int main()
{
  ...
  G4double PPCKOV[NUMENTRIES] = {
    ...
    3.360E-9, 3.453E-9, 3.552E-9, 3.656E-9, 3.767E-9, 3.884E-9,
  };

  G4double ABSCO[NUMENTRIES] = {
    1750.0, 1450.0,  // see (**)
    344.8,  408.2,  632.9,  917.4,  1234.6, 1388.9, 1515.2, 1724.1, 1886.8, 2000.0,
    2631.6, 3571.4, 4545.5, 4761.9, 5263.2, 5263.2, 5555.6, 5263.2, 5263.2, 4761.9,
    4545.5, 4166.7, 3703.7, 3333.3, 3000.0, 2850.0, 2700.0, 2450.0, 2200.0, 1950.0,
  };
  ...
  G4cout << "The absorption coefficient is:  " << anAbsorptionCoefficient << G4endl;
  LoopUntilPressEnter();
  ...
  while (++absco) {
    G4cout << absco.GetPhotonMomentum() / MeV << "MeV \t" << absco.GetProperty() << G4endl;
  }
  G4cout << "\n\n <END OF TEST>" << G4endl;
