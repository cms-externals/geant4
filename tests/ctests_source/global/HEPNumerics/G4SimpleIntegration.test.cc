...
int main()
{
  ...
  {
    n = (int)std::pow(2, i);
    G4cout << n << "\t" << myIntegrand.Trapezoidal(a, b, n) << "\t" << myIntegrand.MidPoint(a, b, n)
           << "\t" << myIntegrand.Gauss(a, b, n) << "\t" << myIntegrand.Simpson(a, b, n) << G4endl;
  }
  G4cout << G4endl;
  for (i = 0; i < 10; i++)
  {
    ...
    G4cout << i << ". " << adaptIntegrand.AdaptGaussIntegration(a, b) << G4endl;
  }
  return 0;
}
