...
int main()
{
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "true = " << truth
           << "  and n-point Gauss-Chebyshev =  " << myChebyshev.Integral(a, b) << G4endl;
  }
  for (i = 1; i < 20; i++) {
    n = 1 * i;
    G4GaussJacobiQ myJacobi(CosFunction, 0.5, 0.5, n);
    G4cout << "n = " << n << "\t" << "true = " << truth
           << "  and n-point Gauss-Jacobi =  " << myJacobi.Integral() << G4endl;
  }
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "true = " << truth
           << "  and n-point GaussHermite =  " << myHermite.Integral() << G4endl;
  }
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "true = 0.5 "
           << "  and n-point GaussLaguerre =  " << myLaguerre.Integral() << G4endl;
  }
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << myLegendre.GetNumber() << "true is 0.5 " << "  and n-point GaussLegendre is  "
