...
G4double GlobalFunction(G4double x)
{
  return std::exp(-x) * std::cos(x);
}

G4double GlobalCos(G4double x)
{
  return std::cos(x);
}

G4double GlobalHermite(G4double x)
{
...
void B::Integrand()
{
  ...
  for (i = 1; i <= 20; i++) {
    ...
    G4cout << n << "\t" << simpson1 << "\t" << simpson2 << "\t" << legendre1 << "\t" << legendre2
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "exact = 0.5 "
           << "  and n-point GaussLaguerre =  " << laguerre1 << "\t" << laguerre2 << G4endl;
  }
  for (i = 1; i < 20; i++) {
    n = 1 * i;
    ...
    G4cout << "n = " << n << "\t" << "exact = " << exactH
           << "  and n-point GaussHermite =  " << hermite1 << "\t" << hermite2 << G4endl;
  }
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "exact = " << exactJ
           << "  and n-point Gauss-Jacobi =  " << jacobi1 << "\t" << jacobi2 << G4endl;
  }
}
...
int main()
{
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "exact = 0.5 "
           << "  and n-point Laguerre =  " << laguerre << G4endl;
  }
  for (i = 1; i < 20; i++) {
    n = 1 * i;
    G4double exactH = 2 * 0.125 * std::sqrt(pi) * std::exp(-0.25);
    G4double hermite = iii.Hermite(GlobalHermite, n);
    G4cout << "n = " << n << "\t" << "exact = " << exactH << "  and n-point Hermite =  " << hermite
           << G4endl;
  }
  G4double exactJ = pi * 0.4400505857;
  ...
  for (i = 1; i < 20; i++) {
    ...
    G4cout << "n = " << n << "\t" << "exact = " << exactJ << "  and n-point Jacobi =  " << jacobi
           << G4endl;
  }
