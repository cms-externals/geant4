  ...
  if (!pdefaultEngine) {
    switch (engineSwitch) {
      ...
      case 8:
        ...
        break;
      default:
        std::cerr << "Non valid selection for RandomEngine, valid values from 0 (default) to 4"
                  << std::endl;
        abort();
        break;
    }
...
int main(int argc, char** argv)
{
  ...
  int ps[] = {G4UNIFORMRANDPOOL_DEFAULT_POOLSIZE, G4UNIFORMRANDPOOL_TINY_POOLSIZE,
