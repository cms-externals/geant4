...
echo starting for g4-win10-vs26
...
set COMNTOOLS=C:\Program Files\Microsoft Visual Studio\18\Community\Common7\Tools\
rem ---Compiler------------------------------------------------------
...
set xerc_dirs=D:\sw\lcg\external\XercesC\3.3.0\%Platform%-windows-vc26
set xerc_dirs=D:\sw\lcg\external\XercesC\3.2.5\%Platform%-windows-vc22,%xerc_dirs%
