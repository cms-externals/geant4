...
Int_t nmod =7;
TString nam[nmod]  = {"BIC","BERT","PRECO","FTFP","QGSP","LIEGE","QGSB"};
TString nam1[nmod]  = {"BIC/Data","BERT/Data","PRECO","FTFP","QGSP","LIEGE","QGSB"};
TString fl[nmod]   = {"bic","bert","prec","ftfp","qgsp","incl","qgsb"}; 
Int_t coll[nmod]   = {4, 2, 6, 7, 4, 3, 1};
Int_t active[nmod] = {1, 1, 1, 1, 1, 1, 1};
