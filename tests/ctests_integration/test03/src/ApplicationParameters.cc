...
namespace ApplicationParameters
{
  ...
  G4bool TestPlot = false;
  G4bool TestAscii = false;
  G4bool TestDirectory = true;
  G4int  NofNtupleFiles = 0;
  G4bool NtupleRowWise = false;
  G4bool NtupleRowMode = true;
  G4bool MergeNtuple = false;
  G4String FileName = "testAnalysis";
  G4String HistoDirName = "histograms";
  G4String NtupleDirName = "ntuples";
  G4int  VerboseLevel = 2;
  G4int  ReadVerboseLevel = 1;
