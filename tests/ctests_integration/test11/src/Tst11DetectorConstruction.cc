...
#include "Tst11TargetParameterisation.hh"
...
void Tst11DetectorConstruction::SelectMaterialPointer()
{
  ...
  if (simpleBoxLog)
  {
    ...
    ((Tst11TargetParameterisation*)pVPVParameterisation)->SetMaterial(selectedMaterial);
  }
}
...
G4VPhysicalVolume* Tst11DetectorConstruction::Construct()
{
  ...
  pVPVParameterisation = new Tst11TargetParameterisation(1, selectedMaterial);
...
void Tst11DetectorConstruction::defineTKMaterials()
{
  ...
  G4Material* Hydrogen1 = new G4Material("Hydrogen1", density = 1.0 * g / cm3, ncomponents = 1,
                                         kStateSolid, 0. * kelvin, 1 * atmosphere);
  ...
  G4Element* elTSH =
    new G4Element("TS_H_of_Polyethylene", "H_POLYETHYLENE", 1.0, 1.0079 * g / mole);
  ...
  G4Element* elTSOBeO = new G4Element("TS_O_of_Beryllium_Oxide", "O_BeO", 8, 15.9994 * g / mole);
  ...
  G4Element* elTSBe = new G4Element("TS_Beryllium_Metal", "Be", 4, 9.012182 * g / mole);

  G4Element* elTSAl = new G4Element("TS_Aluminium_Metal", "Al", 13, 26.9815386 * g / mole);

  G4Element* elTSFe = new G4Element("TS_Iron_Metal", "Fe", 26, 55.845 * g / mole);
  ...
  G4Material* matCH2_TS =
    new G4Material("Polyethylene_TS", density = 0.94 * g / cm3, ncomponents = 2);
  ...
  G4Material* matD2O_TS =
    new G4Material("Heavy_Water_TS", density = 1.107 * g / cm3, ncomponents = 2);
  ...
  G4Material* matBeO_TS =
    new G4Material("Beryllium_Oxide_TS", density = 3.02 * g / cm3, ncomponents = 2);
  ...
  // ncomponents= 2 ); matUO2_TS -> AddElement(elTSOUO2,natoms=1); matUO2_TS -> AddElement(elTSUUO2,
  // natoms = 1);
...
void Tst11DetectorConstruction::createIsotopeMaterial(G4int iZ, G4int iA, G4String name,
