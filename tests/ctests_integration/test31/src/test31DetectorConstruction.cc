...
G4VPhysicalVolume* test31DetectorConstruction::Construct()
{
  ...
  physWorld = new G4PVPlacement(0, G4ThreeVector(), "World", logicWorld, 0, false, 0);
  //
  // Absorber container
  //
  ...
  G4VPhysicalVolume* pv =
    new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, dz), "Container", logicGap, physWorld, false, 0);
  //
  // Absorber
  //
  ...
  {
    physAbs = new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, z), "Absorber", logicAbs, pv, false, j);
...
void test31DetectorConstruction::PrintGeomParameters()
{
  ...
  G4cout << ". The transverse size (XY) of the world is " << SizeXY / mm << " mm" << G4endl;
  G4cout << "The ABSORBER is made of " << NumberOfAbsorbers << " items of "
         << AbsorberThickness / mm << " mm of " << AbsorberMaterial->GetName();
  G4cout << ". The transverse size (XY) is " << SizeXY / mm << " mm" << G4endl;
  G4cout << "The meanExc(eV)= " << AbsorberMaterial->GetIonisation()->GetMeanExcitationEnergy() / eV
         << G4endl;
}
