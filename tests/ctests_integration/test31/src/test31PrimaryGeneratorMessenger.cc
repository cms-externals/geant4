...
test31PrimaryGeneratorMessenger::test31PrimaryGeneratorMessenger(test31PrimaryGeneratorAction* gen)
  : theGen(gen)
{
...
void test31PrimaryGeneratorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  if (1 < theGen->GetVerbose())
  {
    G4cout << "test31PrimaryGeneratorMessenger: Next command value = " << newValue << G4endl;
  }
