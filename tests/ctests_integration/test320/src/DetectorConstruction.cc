...
G4VPhysicalVolume* DetectorConstruction::DefineVolumes()
{
  ...
  // Layer Z
  //
  G4VSolid* zlayerS = new G4Box("ZLayer",  // its name
                                calorXYSize / 2, calorXYSize / 2, LayerZSize / 2);  // its size

  G4LogicalVolume* zlayerLV = new G4LogicalVolume(zlayerS,  // its solid
                                                  absorberMaterial,  // its material
                                                  "ZLayer");  // its name

  new G4PVReplica("ZLayer",  // its name
  ...
  // Layer YZ
  //
  G4VSolid* yzLayerS = new G4Box("YZLayer",  // its name
                                 calorXYSize / 2, LayerXYSize / 2, LayerZSize / 2);  // its size

  G4LogicalVolume* yzLayerLV = new G4LogicalVolume(yzLayerS,  // its solid
                                                   absorberMaterial,  // its material
                                                   "YZLayer");  // its name

  new G4PVReplica("YZLayer",  // its name
  ...
  // Layer XYZ
  //
  G4VSolid* xyzLayerS = new G4Box("XYZLayer",  // its name
                                  LayerXYSize / 2, LayerXYSize / 2, LayerZSize / 2);  // its size

  G4LogicalVolume* xyzLayerLV = new G4LogicalVolume(xyzLayerS,  // its solid
                                                    absorberMaterial,  // its material
                                                    "XYZLayer");  // its name

  new G4PVReplica("XYZLayer",  // its name
  ...
  //
  G4cout << "\n------------------------------------------------------------"
         << "\n---> The calorimeter is " << NofZLayers << " layers of: [ " << LayerZSize / mm
