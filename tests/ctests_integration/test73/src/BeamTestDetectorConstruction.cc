...
G4VPhysicalVolume* BeamTestDetectorConstruction::Construct()
{
  ...
  chamberParam = new BeamTestCellParameterisation(NbOfChambers,  // NoChambers
                                                  firstPosition,  // Z of center of first
                                                  ChamberSpacing,  // Z spacing of centers
                                                  ChamberWidth);  // Width Chamber
  physiChamber = new G4PVParameterised("Chamber",  // their name
  ...
  G4cout << "There are " << NbOfChambers << " chambers in the tracker region. "
         << "The chambers are " << ChamberWidth / mm << " mm of " << ChamberMater->GetName()
         << "\n The distance between chamber is " << ChamberSpacing / um << " um" << G4endl;
