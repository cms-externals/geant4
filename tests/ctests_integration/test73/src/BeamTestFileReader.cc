...
FileReader::FileReader(const char* filename) : file(filename), line(), failed(false) {}

FileReader::FileReader(const std::string& filename) : file(filename.c_str()), line(), failed(false)
{}
