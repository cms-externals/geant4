...
BeamTestRunActionMessenger::BeamTestRunActionMessenger(BeamTestRunAction* runAction)
  : theRunAction(runAction)
{
  ...
  theMergedFileCmd->SetGuidance(
    "File name for the merged file name (see /analysis/filename/merge command).");
