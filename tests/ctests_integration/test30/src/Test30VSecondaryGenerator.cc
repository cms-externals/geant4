...
Test30VSecondaryGenerator::Test30VSecondaryGenerator(G4HadronicInteraction* hadi,
  ...
  : hInteraction(hadi), material(mat), targetA(0)
{
  ...
  G4cout << "New generator for material " << material->GetName()
         ...
         << " Nmat= " << material->GetNumberOfMaterials() << " Target element: " << elm->GetName()
         << G4endl;
  generatorName = "";
}
...
void Test30VSecondaryGenerator::SetA(G4int A)
{
  ...
  G4cout << "Test30VSecondaryGenerator::SetA: Nucleus with A= " << targetA << "  Z= " << targetZ
         << " " << elm->GetName() << G4endl;
}
