...
// ********************************************************************
//
/// \file electromagnetic/TestEmXX/src/PhysListEmStandard.cc
...
void PhysListEmStandard::ConstructProcess()
{
  ...
  while ((*particleIterator)())
  {
    ...
    if (particleName == "gamma")
    {
      ...
      G4JAEAElasticScattering* es = new G4JAEAElasticScattering;
      auto esModel = new G4JAEAPolarizedElasticScatteringModel();
      // esModel->SetPolarizationSensitvity(1,0,0);
      es->SetEmModel(esModel);
      pmanager->AddDiscreteProcess(es);
