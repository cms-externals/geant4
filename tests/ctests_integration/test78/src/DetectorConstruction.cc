...
// ********************************************************************
//
/// \file electromagnetic/TestEmXX/src/DetectorConstruction.cc
...
void DetectorConstruction::DefineMaterials()
{
  ...
  new G4Material("Tin"    , z=50., a=118.71*g/mole, density= 7.31*g/cm3);
...
//	    	     0.45*cm,0.5*cm,0.5*cm,0,CLHEP::twopi);  //its dimensions
