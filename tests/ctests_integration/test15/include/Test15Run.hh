...
public:
  ...
  void analyseNeutronFlux(G4double energy, G4double time, G4double startEnergy, G4int TrackID, G4int ParentID, G4double zMomentum, G4double startTime, G4double radius, G4double zPos, G4double parentEnergy, G4String parentParticle, G4double cos_angle, G4int number_generations, G4String Particle, G4bool reduced_tally);

  void analyseNeutronShellFluence(G4double energy, G4double time, G4double startEnergy, G4int TrackID, G4int ParentID, G4double zMomentum, G4double startTime, G4double radius, G4double zPos, G4double parentEnergy, G4String parentParticle, G4double steplength, G4bool enter_sph, G4bool enter_cyl, G4bool exit_sph, G4bool exit_cyl, G4String Volume, G4bool enter_sph_front, G4bool exit_sph_front, G4int preParentReplica, G4int postParentReplica, G4int preReplica, G4int postReplica);
...
public:
  ...
  G4int gamma_flux, neutron_flux, neutron_check, electron_flux, piminus_flux, piplus_flux, pizero_flux, positron_flux, proton_flux, muon_flux, other_flux, exiting_flux, exitinggrichine_flux, exiting_check_flux, neutron_fluence, neutron_fluence_46cm, neutron_fluence_cyl;
