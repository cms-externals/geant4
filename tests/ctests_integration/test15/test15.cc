...
int main(int argc,char** argv)
{
  ...
  Test15ShellDetectorConstruction *pdet =
    new Test15ShellDetectorConstruction(parallelName);
  ...
  if(physics == "FTFP_BERT") physlist = new FTFP_BERT;
  else if(physics == "FTFP_BERT_HP") physlist = new FTFP_BERT_HP;
  else if(physics == "QGSP_BERT") physlist = new QGSP_BERT;
  else if(physics == "QGSP_BIC_HP") physlist = new QGSP_BIC_HP;
  else if(physics == "QGSP_BIC_AllHP") physlist = new QGSP_BIC_AllHP;
  else if(physics == "QGSP_BIC") physlist = new QGSP_BIC;
  else if(physics == "QGS_BIC") physlist = new QGS_BIC;
  else if(physics == "QGSP_INCLXX") physlist = new QGSP_INCLXX;
  else if(physics == "QGSP_INCLXX_HP") physlist = new QGSP_INCLXX_HP;
  else if(physics == "QBBC") physlist = new QBBC;
  else if(physics == "LBE") physlist = new LBE;
  else if(physics == "Shielding") physlist = new Shielding;
  else {
    G4cout << G4endl << G4endl << " Physics list: " << physics << " not recognised!!! Mis-typed??? " << G4endl << G4endl << G4endl;
    PrintUsage();
    return 1;
  }
