...
void Test15DetectorConstruction::DefineMaterials()
{
  ...
  // making vacuum
  G4Material* vacuum =
    new G4Material(name = "Vacuum", z = 1., a = 1. * g / mole, density = 1.e-20 * g / cm3,
  ...
  G4Material* Air =
    new G4Material("AIR", 1.2929 * kg / m3, 2, kStateGas, 300.00 * kelvin, 1.0 * atmosphere);
  ...
  G4Material* metalCu =
    new G4Material(name = "MetalCopper", density = 8.960 * g / cm3, ncomponents = 1);
  metalCu->AddElement(Cu, 1);

  // lead
  G4Element* Pb = new G4Element(name = "Lead", symbol = "Pb", z = 82., a = 207.2 * g / mole);
  G4Material* metalPb =
    new G4Material(name = "MetalLead", density = 11.340 * g / cm3, ncomponents = 1);
  ...
  G4Element* Pb204 = new G4Element(name = "Pb204", symbol = "Pb204", ncomponents = 1);
  Pb204->AddIsotope(Lead204, abundance = 1);
  G4Element* Pb206 = new G4Element(name = "Pb206", symbol = "Pb206", ncomponents = 1);
  Pb206->AddIsotope(Lead206, abundance = 1);
  G4Element* Pb207 = new G4Element(name = "Pb207", symbol = "Pb207", ncomponents = 1);
  Pb207->AddIsotope(Lead207, abundance = 1);
  G4Element* Pb208 = new G4Element(name = "Pb208", symbol = "Pb208", ncomponents = 1);
  Pb208->AddIsotope(Lead208, abundance = 1);
  G4Element* PbNat = new G4Element(name = "PbNat", symbol = "PbNat", ncomponents = 4);
  ...
  G4Material* metalPb204 =
    new G4Material(name = "MetalLead204", density = 11.340 * g / cm3, ncomponents = 1);
  metalPb204->AddElement(Pb204, 1);
  G4Material* metalPb206 =
    new G4Material(name = "MetalLead206", density = 11.340 * g / cm3, ncomponents = 1);
  metalPb206->AddElement(Pb206, 1);
  G4Material* metalPb207 =
    new G4Material(name = "MetalLead207", density = 11.340 * g / cm3, ncomponents = 1);
  metalPb207->AddElement(Pb207, 1);
  G4Material* metalPb208 =
    new G4Material(name = "MetalLead208", density = 11.340 * g / cm3, ncomponents = 1);
  metalPb208->AddElement(Pb208, 1);
  G4Material* metalPbNat =
    new G4Material(name = "MetalLeadNat", density = 11.340 * g / cm3, ncomponents = 1);
  metalPbNat->AddElement(PbNat, 1);

  G4Isotope* He3 = new G4Isotope(name = "Helium3", iz = 2, in = 3, a = 3.0 * g / mole);
  G4Element* He = new G4Element(name = "Helium", "He", ncomponents = 1);
  He->AddIsotope(He3, abundance = 1);
  G4Material* helium3 =
    new G4Material(name = "helium3", density = 0.1785 * kg / m3, ncomponents = 1);
  helium3->AddElement(He, 1);

  G4Element* Si = new G4Element(name = "Silicon", symbol = "Si", z = 14., a = 28.09 * g / mole);
  G4Material* silicon =
    new G4Material(name = "silicon", density = 3.000 * g / cm3, ncomponents = 1);
...
G4VPhysicalVolume* Test15DetectorConstruction::Construct()
{
  ...
  world_phys =
    new G4PVPlacement(0, G4ThreeVector(0., 0., 0.), "world_phys", world_log, NULL, false, 0);
  ...
  lab_phys = new G4PVPlacement(0, G4ThreeVector(0., 0., 0.), "lab_phys", lab_log, world_phys, false,
                               0, olap_test);
  ...
  G4Box* lead_box = new G4Box("lead_box", 0.5 * leadWidth, 0.5 * leadHeight, 0.5 * leadLength);
  lead_log = new G4LogicalVolume(lead_box, lab_mat, "lead_log");
  lead_phys = new G4PVPlacement(0, G4ThreeVector(0., 0., 0.), "lead_phys", lead_log, lab_phys,
                                false, 0, olap_test);
  ...
  G4Box* blockA_box = new G4Box("blockA_box", 0.5 * blockWidthA - 1.0 * nanometer,
                                0.5 * blockHeightA, 0.5 * blockLengthA);
  ...
  // tubs is from 0 to 360 degrees to remove problem of exact interface between block and cylinder
  // hole
  G4Tubs* blockB_hole = new G4Tubs("blockB_hole", 0. * cm, blockB_holeRadius,
                                   0.5 * blockLengthA + 1.0 * mm, 0. * deg, 360. * deg);
  G4Tubs* blockB_beamhole = new G4Tubs("blockB_beamhole", 0. * cm, 0.5 * blockB_beamholeDiameter,
                                       0.5 * blockLengthA + 1.0 * mm, 0. * deg, 360. * deg);
  //  G4SubtractionSolid* blockB_box = new
  //  G4SubtractionSolid("blockB_box",blockA_box,blockB_hole,G4Transform3D(rotblockBhole,
  //  G4ThreeVector(0., 0.5*blockWidthA, 0.)));
  G4SubtractionSolid* blockB_box = new G4SubtractionSolid(
    "blockB_box", blockA_box, blockB_hole,
    G4Transform3D(G4RotationMatrix(), G4ThreeVector(-0.5 * blockWidthA, 0., 0.)));
  G4SubtractionSolid* blockB_beambox =
    new G4SubtractionSolid("blockB_beambox", blockB_box, blockB_beamhole,
                           G4Transform3D(G4RotationMatrix(), G4ThreeVector(0.0, 0., 0.)));
  ...
  G4Box* blockC_box =
    new G4Box("blockC_box", 0.5 * blockWidthC, 0.5 * blockHeightC, 0.5 * blockLengthC);
  ...
  G4Tubs* sampleTube = new G4Tubs("sampleTube", 0. * cm, sampleTubeRadius, 0.5 * sampleTubeLength,
                                  0. * deg, 360. * deg);
  sampleTube_log = new G4LogicalVolume(sampleTube, sampleTube_mat, "sampleTube_log");

  G4Sphere* sampleSphere = new G4Sphere("sampleSphere", 0. * cm, sampleSphereRadius, 0. * deg,
  ...
  sample_phys =
    new G4PVPlacement(0, G4ThreeVector(sampleSphereXpos, sampleSphereYpos, sampleSphereZpos),
                      "sample_phys", sampleSphere_log, lead_phys, false, 0, olap_test);

  //   sample_phys2 = new G4PVPlacement(0, G4ThreeVector(sampleSphereXpos2, sampleSphereYpos2,
  //   sampleSphereZpos2), "sample_phys2", sampleSphere_log2, blockB_phys, false,0);
  // have to use logical mother as it's sitting inside multiple placements...........!
  sample_phys2 =
    new G4PVPlacement(0, G4ThreeVector(sampleSphereXpos2, sampleSphereYpos2, sampleSphereZpos2),
                      sampleSphere_log2, "sample_phys2", blockB_log, false, 0, olap_test);

  sampleTube_phys =
    new G4PVPlacement(0, G4ThreeVector(sampleTubeXpos, sampleTubeYpos, sampleTubeZpos),
                      "sampleTube_phys", sampleTube_log, lead_phys, false, 0, olap_test);
  ...
  G4Box* sample_box =
    new G4Box("sample_box", 0.5 * sampleWidth, 0.5 * sampleLength, 0.5 * sampleHeight);
...
void Test15DetectorConstruction::CreateLayer1()
{
  ...
  for (G4int j = 0; j < 2; j++)
  {
    ...
    {
      blockB_phys =
        new G4PVPlacement(G4Transform3D(rotblockB, G4ThreeVector(blockB_x, blockB_y, blockB_z)),
                          "blockB_phys", blockB_log, lead_phys, false, replica_idx_B, olap_test);
      replica_idx_B++;
      if (j == 1)
      {
        replica_sample = 4;
        // xxx  	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys4", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
...
void Test15DetectorConstruction::CreateLayer2()
{
  ...
  for (G4int j = 0; j < 2; j++)
  {
    ...
    {
      blockA_phys =
        new G4PVPlacement(G4Transform3D(rotblockA, G4ThreeVector(blockA_x, blockA_y, blockA_z)),
                          "blockA_phys", blockA_log, lead_phys, false, replica_idx_A, olap_test);
      replica_idx_A++;
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 5;
        // xxx  	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys5", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
...
void Test15DetectorConstruction::CreateLayer6()
{
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 1;
        // xxx  sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys1", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 12;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x-0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys12", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 10;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x-0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys10", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  beamblockB_phys =
    new G4PVPlacement(G4Transform3D(rotblockB, G4ThreeVector(blockB_x, blockB_y, blockB_z)),
                      "beamblockB_phys", beamblockB_log, lead_phys, false, 0, olap_test);
  blockB_z += blockLengthB;
  beamblockB_phys =
    new G4PVPlacement(G4Transform3D(rotblockB, G4ThreeVector(blockB_x, blockB_y, blockB_z)),
                      "beamblockB_phys", beamblockB_log, lead_phys, false, 1, olap_test);
  replica_sample = 3;
  // xxx  sampleTube_phys = new G4PVPlacement(0,
  // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys3", xxx
  // sampleTube_log, lead_phys, false, replica_sample, olap_test);
  //   replica_sample++;
  blockB_z += blockLengthB;
  for (G4int i = 2; i < 5; i++)
  {
    ...
    G4cout << " BLOCKB: " << i << " x: " << blockB_x << " y: " << blockB_y << " z: " << blockB_z
           << " replica: " << replica_idx_B << G4endl;
  }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 2;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys2", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 11;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x-0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys11", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 6;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys6", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 7;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phys7", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 8;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phy8", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
...
void Test15DetectorConstruction::CreateLayer11()
{
  ...
  for (G4int j = 0; j < 2; j++)
  {
    for (G4int i = 0; i < 5; i++)
    {
      ...
      if (j == 1)
      {
        replica_sample = 9;
        // xxx   	    sampleTube_phys = new G4PVPlacement(0,
        // G4ThreeVector((blockB_x+0.5*blockWidthB),blockB_y,blockB_z), "sampleTube_phy9", xxx
        // sampleTube_log, lead_phys, false, replica_sample, olap_test); 	    replica_sample++;
      }
      blockB_z += blockLengthB;
    }
  ...
  G4cout << G4endl << G4endl << G4endl << " Got to end of lead block construction " << G4endl
         << G4endl << G4endl << G4endl << G4endl << " and number of blocks is: " << G4endl
         << " Block Type A: " << replica_idx_A << G4endl << " Block Type B: " << replica_idx_B
         << G4endl << " Block Type C: " << replica_idx_C << G4endl << G4endl << G4endl << G4endl
         << G4endl;
}
