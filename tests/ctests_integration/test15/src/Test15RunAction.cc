...
Test15RunAction::Test15RunAction(): G4UserRunAction(),
...
void Test15RunAction::EndOfRunAction(const G4Run* aRun)
{
  ...
  if (isMaster)
	...
	<< G4endl << G4endl 
	<< " Integral Neutron Flux @ 46cm: " << tarcRun->GetIntegralFlux_46cm() 
	<< G4endl
  ...
  G4cout
    << " Exiting Grichine Flux : " << ExitGrichineFlux << G4endl  
    << " Exiting Flux : " << ExitFlux << G4endl  
    << " Total Exiting Energy : " << ExitEnergy << G4endl  
    << " Exiting Check Flux : " << ExitCheckFlux << G4endl  
    << "------------------------------------------------------------" << G4endl 
    << G4endl;

  G4cout << " Gamma Edep : mean = "
	 << analysisManager->GetH1(1)->mean()
	 << " rms = "
	 << analysisManager->GetH1(1)->rms() << G4endl;

  G4cout << " Neutron Lethargy : mean = "
...
{
  G4double radial_mean_energy[10] = {0.1, 1.5, 5.0, 10.0, 18.0, 100.0, 480.0, 1000.0, 10000.0, 50000.0};

  G4double radial_distance_1[76] = {-187.5,
				    -164.5,
				    -154.6,
				    -132.7,
				    -124.8,
  ...
  G4double radial_fluence_1[76] = {178127,
				   208387,
				   252267,
				   652345,
				   721648,
  ...
  G4double radial_error_1[76] = {20916,
				 15236,	
				 19480,	
				 26868,	
				 31621,	
  ...
  for(G4int i=0;i<76; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[0] << " radius: " << radial_distance_1[i] << " Data: " << radial_fluence_1[i] << G4endl;

  }

  G4double radial_distance_2[102] = {-187.5,
				     -164.5,
				     -154.6,
				     -150.2,
				     -132.7,
  ...
  G4double radial_fluence_2[102] = {52037,
				    60333,
				    73270,
				    75772,
				    172600,
  ...
  G4double radial_error_2[102] = {7250,
				  2796,	
				  4200,	
				  4035,	
				  7786,	
  ...
  for(G4int i=0;i<102; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[1] << " radius: " << radial_distance_2[i] << " Data: " << radial_fluence_2[i] << G4endl;

  }

  G4double radial_distance_3[102] = {-187.5,
				     -164.5,
				     -154.6,
				     -150.2,
				     -132.7,
  ...
  G4double radial_fluence_3[102] = {19654,
				    23255,
				    28522,
				    29988,
				    66240,
  ...
  G4double radial_error_3[102] = {3775,	
				  1093,	
				  1666,	
				  1721,	
				  3049,	
  ...
  for(G4int i=0;i<102; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[2] << " radius: " << radial_distance_3[i] << " Data: " << radial_fluence_3[i] << G4endl;

  }

  G4double radial_distance_4[102] = {-187.5,
				     -164.5,
				     -154.6,
				     -150.2,
				     -132.7,
  ...
  G4double radial_fluence_4[102] = {10787,
				    12973,
				    16029,
				    16823,
				    37060,
  ...
  G4double radial_error_4[102] = {2087,	
				  682,	
				  1040,	
				  1044,	
				  1781,	
  ...
  for(G4int i=0;i<102; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[3] << " radius: " << radial_distance_4[i] << " Data: " << radial_fluence_4[i] << G4endl;

  }

  G4double radial_distance_5[102] = {-187.5,
				     -164.5,
				     -154.6,
				     -150.2,
				     -132.7,
  ...
  G4double radial_fluence_5[102] = {6356,
				    7770,
				    9671,
				    10087,
				    22305,
  ...
  G4double radial_error_5[102] = {961,
				  395,
				  648,
				  658,   
				  1000,  
  ...
  for(G4int i=0;i<102; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[4] << " radius: " << radial_distance_5[i] << " Data: " << radial_fluence_5[i] << G4endl;

  }

  G4double radial_distance_6[99] = {-187.5,
				    -164.5,
				    -154.6,
				    -150.2,
				    -132.7,
  ...
  G4double radial_fluence_6[99] = {1257,
				   1637,
				   2095,
				   2100,
				   4818,
  ...
  G4double radial_error_6[99] = {232,	
				 101,	
				 181,	
				 180,
				 261,	
  ...
  for(G4int i=0;i<99; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[5] << " radius: " << radial_distance_6[i] << " Data: " << radial_fluence_6[i] << G4endl;

  }

  G4double radial_distance_7[92] = {-187.5,
				    -164.5,
				    -154.6,
				    -150.2,
				    -132.7,
  ...
  G4double radial_fluence_7[92] = {262,
				   372,
				   493,
				   464,
				   1136,
  ...
  for(G4int i=0;i<92; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[6] << " radius: " << radial_distance_7[i] << " Data: " << radial_fluence_7[i] << G4endl;

  }

  G4double radial_distance_8[80] = {-187.5,
				    -164.5,
				    -154.6,
				    -150.2,
				    -132.7,
  ...
  G4double radial_fluence_8[80] = {122,
				   182,
				   247,
				   223,
				   571,
  ...
  for(G4int i=0;i<80; ++i){    
    ...
    fLowRadialFile << " Energy: " << radial_mean_energy[7] << " radius: " << radial_distance_8[i] << " Data: " << radial_fluence_8[i] << G4endl;

  }

  G4double he3_radial_distance_2[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_2[10] = {665235,
				       593298,
				       602514,
				       387449,
				       420921,
  ...
  G4double he3_radial_error_2[10] = {9979,
				     9474,
				     9483,
				     7658,
				     7966,
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[1] << " radius: " << he3_radial_distance_2[i] << " Data: " << he3_radial_fluence_2[i] << G4endl;

  }

  G4double he3_radial_distance_3[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_3[10] = {284113,
				       245043,
				       266956,
				       168293,
				       180439,
  ...
  G4double he3_radial_error_3[10] = {4660,	
				     4334,	
				     4501,	
				     3576,	
				     3725,	
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[2] << " radius: " << he3_radial_distance_3[i] << " Data: " << he3_radial_fluence_3[i] << G4endl;

  }


  G4double he3_radial_distance_4[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_4[10] = {167763,
				       143894,
				       157657,
				       96559,
				       107418,
  ...
  G4double he3_radial_error_4[10] = {3135,
				     2910,
				     3064,
				     2392,
				     2504,
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[3] << " radius: " << he3_radial_distance_4[i] << " Data: " << he3_radial_fluence_4[i] << G4endl;

  }


  G4double he3_radial_distance_5[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_5[10] = {105971,
				       90614,
				       100489,
				       59547,
				       66724,
  ...
  G4double he3_radial_error_5[10] = {2071,
				     1921,
				     2019,
				     1556,
				     1647,
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[4] << " radius: " << he3_radial_distance_5[i] << " Data: " << he3_radial_fluence_5[i] << G4endl;

  }


  G4double he3_radial_distance_6[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_6[10] = {26393,
				       21271,
				       24639,
				       14014,
				       15459,
  ...
  G4double he3_radial_error_6[10] = {656,
				     588,
				     634,
				     478,
				     502,
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[5] << " radius: " << he3_radial_distance_6[i] << " Data: " << he3_radial_fluence_6[i] << G4endl;

  }


  G4double he3_radial_distance_7[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_7[10] = {6932,
				       5332,
				       6363,
				       3500,
				       3989,
  ...
  G4double he3_radial_error_7[10] = {247,
				     217,	
				     240,	
				     180,	
				     188,	
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[6] << " radius: " << he3_radial_distance_7[i] << " Data: " << he3_radial_fluence_7[i] << G4endl;

  }


  G4double he3_radial_distance_8[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_8[10] = {3746,
				       2736,
				       3440,
				       1835,
				       2070,
  ...
  G4double he3_radial_error_8[10] = {144,	
				     124,	
				     139,	
				     102,   
				     108,	
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[7] << " radius: " << he3_radial_distance_8[i] << " Data: " << he3_radial_fluence_8[i] << G4endl;

  }


  G4double he3_radial_distance_9[10] = {16.8,
					40.4,
					45.6,
					69.1,
					81.1,
  ...
  G4double he3_radial_fluence_9[10] = {496,
				       399,
				       603,
				       313,
				       316,
  ...
  G4double he3_radial_error_9[10] = {32,
				     28,
				     36,
				     25,
				     26,
  ...
  for(G4int i=0;i<10; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[8] << " radius: " << he3_radial_distance_9[i] << " Data: " << he3_radial_fluence_9[i] << G4endl;

  }

  G4double he3_radial_distance_10[6] = {81.1,
					98.6,
					105.3,
					113.5,
					124.8,
  ...
  G4double he3_radial_fluence_10[6] = {81,
				       61,
				       27,
				       30,
				       16,
  ...
  G4double he3_radial_error_10[6] = {10,	
				     8,	
				     4,	
				     6,	
				     5,	
  ...
  for(G4int i=0;i<6; ++i){    
    ...
    fDataRadialFile << " Energy: " << radial_mean_energy[9] << " radius: " << he3_radial_distance_10[i] << " Data: " << he3_radial_fluence_10[i] << G4endl;
...
void Test15RunAction::createNeutronFluxHisto(G4int events, const Test15Run* tarcRun)
{
  ...
  G4double absolute_totalflux = (tarcRun->total_flux*(1000000000.0/(G4double)events))/26130.008; // dividing by surface area of the shell: 4*pi*r^2
  ...
  G4double shell_volume = (4.0/3.0)*3.14159265*std::pow(shell_outer_radius,3.0) - (4.0/3.0)*3.14159265*std::pow(shell_inner_radius,3.0);
  ...
  fHighEnergyFile << std::setw(12) << "Energy" << std::setw(12) << "Geant4" << std::setw(12) << "error" << std::setw(12) << "Data" << std::setw(12) << "stat" << std::setw(12) << "syst" << std::setw(12) << "bin_min" << std::setw(12) << "bin_max" << G4endl;
  fLowEnergyFile << std::setw(12) << "Energy" << std::setw(12) << "Geant4" << std::setw(12) << "error" << std::setw(12) << "Data" << std::setw(12) << "stat" << std::setw(12) << "syst" << std::setw(12) << "bin_min" << std::setw(12) << "bin_max" << G4endl;
  fLithiumEnergyFile << std::setw(12) << "Energy" << std::setw(12) << "Geant4" << std::setw(12) << "error" << std::setw(12) << "Data" << std::setw(12) << "stat" << std::setw(12) << "syst" << std::setw(12) << "bin_min" << std::setw(12) << "bin_max" << G4endl;
  ...
  for(G4int i = 0; i<32; ++i) {
    ...
    //xbug    G4double absolute_flux_perp = (cos_flux[i]*(1000000000.0/(G4double)events))/26130.008;
    G4double temp_bin_width = tarcRun->flux_energy[i+1] - tarcRun->flux_energy[i];
    G4double absolute_flux_perp = mean_energy*(((tarcRun->cos_flux[i]*(1000000000.0/(G4double)events))/26130.008)/temp_bin_width);

    G4double absolute_fluence = mean_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->fluence_step[i])/sphere_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_fluence_front = mean_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->fluence_front_step[i])/sphere_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
    //xbug    G4double absolute_fluence_cyl = 100.0*(1000000000.0/(G4double)events)*((fluence_step_cyl[i])/cylinder_volume); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_fluence_cyl = mean_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->fluence_step_cyl[i])/cylinder_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_fluence_shell = mean_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->fluence_step_shell[i])/shell_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_fluence_shell_error = 0.0;
    if(tarcRun->fluence_step_shell[i] > 0.0) {
      absolute_fluence_shell_error = (std::sqrt(tarcRun->fluence_step_shell[i])/tarcRun->fluence_step_shell[i])*absolute_fluence_shell;
    }
    ...
    G4cout << " fluence_step[i]: " << tarcRun->fluence_step[i] << " fluence_step_cyl[i]: " << tarcRun->fluence_step_cyl[i] << G4endl;
    G4double absolute_eflux = (tarcRun->eflux[i]*(1000000000.0/(G4double)events))/26130.008;
    G4double absolute_error = 0.0;
    if(tarcRun->flux[i] > 0.0) absolute_error = (std::sqrt(tarcRun->flux[i])/tarcRun->flux[i])*absolute_flux;
    ...
    G4cout << " Got here i:" << i << " mean_energy: " << mean_energy << " absolute_flux: " << absolute_flux << G4endl;
    G4cout << G4endl << G4endl << G4endl;
    G4cout << " Got here i:" << i << " mean_energy: " << mean_energy << " absolute_fluence: " << absolute_fluence << G4endl;
    G4cout << " Got here i:" << i << " mean_energy: " << mean_energy << " absolute_fluence cylinder: " << absolute_fluence_cyl << G4endl;
    G4cout << " and flux: " << tarcRun->flux[i] << " events: " << events << " and flux data: " << tarcRun->flux_data[i] << " and cos flux:" << tarcRun->cos_flux[i] << G4endl;
    G4cout << G4endl << G4endl << G4endl;
    local_energy_integral[2] += absolute_flux*mean_energy;
    local_energy_integral[3] += tarcRun->flux_data[i]*mean_energy;

    fHighEnergyFile << std::setw(12) << mean_energy << std::setw(12) << absolute_fluence_shell << std::setw(12) << absolute_fluence_shell_error 
		    << std::setw(12) << tarcRun->flux_data[i] << std::setw(12) << tarcRun->flux_stat_error[i] << std::setw(12) << tarcRun->flux_syst_error[i] 
		    << std::setw(12) << tarcRun->flux_energy[i] << std::setw(12) << tarcRun->flux_energy[i+1] 
		    << G4endl;
  ...
  for(G4int i = 0; i<100; ++i) {
    ...
    G4double absolute_low_flux = (tarcRun->low_flux[i]*(1000000000.0/(G4double)events))/26130.008;
    //xbug    G4double absolute_low_flux_perp = (cos_low_flux[i]*(1000000000.0/(G4double)events))/26130.008;
    G4double temp_bin_width_low = tarcRun->low_energy[i+1] - tarcRun->low_energy[i];
    G4double absolute_low_flux_perp = mean_low_energy*(((tarcRun->cos_low_flux[i]*(1000000000.0/(G4double)events))/26130.008)/temp_bin_width_low);
    G4double absolute_low_fluence = 100.0*(1000000000.0/(G4double)events)*((tarcRun->low_fluence_step[i])/sphere_volume); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_low_fluence_front = 100.0*(1000000000.0/(G4double)events)*((tarcRun->low_fluence_front_step[i])/sphere_volume); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_low_fluence_cyl = mean_low_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->low_fluence_step_cyl[i])/cylinder_volume)/temp_bin_width_low); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_low_fluence_shell = mean_low_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->low_fluence_step_shell[i])/shell_volume)/temp_bin_width_low); // factor of 100 to account for /cm2 from /mm2

    G4double absolute_low_fluence_shell_error = 0.0;
    if(tarcRun->low_fluence_step_shell[i] > 0) {
      absolute_low_fluence_shell_error = (std::sqrt(tarcRun->low_fluence_step_shell[i])/tarcRun->low_fluence_step_shell[i])*absolute_low_fluence_shell;
    }

    G4double absolute_low_error = 0;
    if(tarcRun->low_flux[i] > 0.0) {
      absolute_low_error = (std::sqrt(tarcRun->low_flux[i])/tarcRun->low_flux[i])*absolute_low_flux;
    }
    //
    ...
    G4cout << " Got here i:" << i << " mean_energy: " << mean_low_energy << "lowE1: " << tarcRun->low_energy[i] << " lowE2: " << tarcRun->low_energy[i+1] << " absolute_flux: " << absolute_low_flux << G4endl;
    G4cout << " and flux: " << tarcRun->low_flux[i] << " events: " << events << " and flux data: " << tarcRun->low_flux_data[i] << G4endl;
    G4cout << " and fluence: " << tarcRun->low_fluence[i] << " events: " << events << " and flux data: " << tarcRun->low_flux_data[i] << G4endl;

    fLowEnergyFile << std::setw(12) << mean_low_energy << std::setw(12) << absolute_low_fluence_shell << std::setw(12) << absolute_low_fluence_shell_error 
		   << std::setw(12) << tarcRun->low_flux_data[i] << std::setw(12) << tarcRun->low_stat[i] << std::setw(12) << tarcRun->low_syst[i] 
		   << std::setw(12) << tarcRun->low_energy[i] << std::setw(12) << tarcRun->low_energy[i+1] 
		   << G4endl;
  ...
  for(G4int i = 0; i<100; ++i) {
    G4double mean_lithium_energy = std::sqrt((tarcRun->lithium_energy[i+1])*(tarcRun->lithium_energy[i]));
    G4double absolute_lithium_flux = (tarcRun->lithium_flux[i]*(1000000000.0/(G4double)events))/26130.008;
    //xbug    G4double absolute_lithium_flux_perp = (cos_lithium_flux[i]*(1000000000.0/(G4double)events))/26130.008;
    G4double temp_bin_width_lithium = tarcRun->low_energy[i+1] - tarcRun->low_energy[i];
    G4double absolute_lithium_flux_perp = mean_lithium_energy*(((tarcRun->cos_lithium_flux[i]*(1000000000.0/(G4double)events))/26130.008)/temp_bin_width_lithium);
//     G4double absolute_lithium_fluence = (lithium_fluence[i]*(1000000000.0/(G4double)events))*((lithium_fluence_step[i]/cm)/sphere_volume/cm3);
    G4double absolute_lithium_fluence = 100.0*(1000000000.0/(G4double)events)*((tarcRun->lithium_fluence_step[i])/sphere_volume); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_lithium_fluence_front = 100.0*(1000000000.0/(G4double)events)*((tarcRun->lithium_fluence_front_step[i])/sphere_volume); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_lithium_fluence_cyl = mean_lithium_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->lithium_fluence_step_cyl[i])/cylinder_volume)/temp_bin_width_lithium); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_lithium_fluence_shell = mean_lithium_energy*(100.0*(1000000000.0/(G4double)events)*((tarcRun->lithium_fluence_step_shell[i])/shell_volume)/temp_bin_width_lithium); // factor of 100 to account for /cm2 from /mm2
    G4double absolute_lithium_fluence_shell_error = 0.0;
    if(tarcRun->lithium_fluence_step_shell[i] > 0) {
      absolute_lithium_fluence_shell_error = (std::sqrt(tarcRun->lithium_fluence_step_shell[i])/tarcRun->lithium_fluence_step_shell[i])*absolute_lithium_fluence_shell;
    }

    G4cout << G4endl << G4endl << G4endl << " lithium_fluence_step_shell = " << tarcRun->lithium_fluence_step_shell[i] << " for i: " << i << " mean energy: " << mean_lithium_energy << G4endl << G4endl << G4endl;

    G4double absolute_lithium_Zflux = (tarcRun->lithium_Zflux[i]*(1000000000.0/(G4double)events))/859.539;
    G4double absolute_lithium_flux_5cm = (tarcRun->lithium_flux_5cm[i]*(1000000000.0/(G4double)events))/12.57;
    G4double absolute_lithium_error = 0.0;
    if(tarcRun->lithium_flux[i] > 0.0) {
      absolute_lithium_error = (std::sqrt(tarcRun->lithium_flux[i])/tarcRun->lithium_flux[i])*absolute_lithium_flux;
    }
    G4double absolute_lithium_error_5cm = 0.0;
    if(tarcRun->lithium_flux_5cm[i] > 0.0 ) {
      absolute_lithium_error_5cm = (std::sqrt(tarcRun->lithium_flux_5cm[i])/tarcRun->lithium_flux_5cm[i])*absolute_lithium_flux_5cm;
    }
    //
    ...
    G4cout << " LITHIUM Got here i:" << i << " lithium mean_energy: " << mean_lithium_energy << "lowE1: " << tarcRun->lithium_energy[i] << " lowE2: " << tarcRun->lithium_energy[i+1] << " absolute_flux: " << absolute_lithium_flux << G4endl;
    G4cout << " and flux: " << tarcRun->lithium_flux[i] << " events: " << events << " and flux data: " << tarcRun->lithium_flux_data[i] << G4endl;
    G4cout << " and fluence: " << tarcRun->lithium_fluence[i] << " events: " << events << " and flux data: " << tarcRun->lithium_flux_data[i] << G4endl;

    fLithiumEnergyFile << std::setw(12) << mean_lithium_energy << std::setw(12) << absolute_lithium_fluence_shell << std::setw(12) << absolute_lithium_fluence_shell_error 
		       << std::setw(12) << tarcRun->lithium_flux_data[i] << std::setw(12) << tarcRun->lithium_stat[i] << std::setw(12) << tarcRun->lithium_syst[i] 
		       << std::setw(12) << tarcRun->lithium_energy[i] << std::setw(12) << tarcRun->lithium_energy[i+1] 
		       << G4endl;
  ...
  G4cout << G4endl
	 << G4endl
	 << G4endl
	 << " total_flux: " << tarcRun->total_flux << G4endl
	 << " absolute total_flux: " << absolute_totalflux << G4endl
	 << G4endl
	 << G4endl
	 << G4endl;
  ...
  G4double absolute_integral_scintillation = (tarcRun->integral_scintillation*(1.e9/(G4double)events))/(integral_surface_area/cm2);
  G4double absolute_integral_scintillation_E = (tarcRun->integral_scintillation_E*(1.e9/(G4double)events))/(integral_surface_area/cm2);

  G4double absolute_integral_lithium = (tarcRun->integral_lithium*(1000000000.0/(G4double)events))/26130.008;
  G4double absolute_integral_lithium_E = (tarcRun->integral_lithium_E*(1000000000.0/(G4double)events))/26130.008;
  G4double absolute_integral_helium = (tarcRun->integral_helium*(1000000000.0/(G4double)events))/26130.008;
  G4double absolute_integral_helium_E = (tarcRun->integral_helium_E*(1000000000.0/(G4double)events))/26130.008;
  ...
  if(absolute_integral_scintillation != 0)
    G4cout << G4endl
	   ...
	   << G4endl
	   << G4endl
	   << " Low Flux, Geant4: " << absolute_integral_scintillation << " data: " << tarc_integral << " ratio: " << tarc_integral/absolute_integral_scintillation << " surface area: " << G4BestUnit(integral_surface_area,"Surface") << G4endl
	   << " Lithium Flux, Geant4: " << absolute_integral_lithium << " data: " << tarc_lithium << G4endl
	   << " Helium Flux, Geant4: " << absolute_integral_helium << " data: " << tarc_helium << G4endl
	   << G4endl
	   << G4endl
	   << G4endl
	   << " ENERGY Low Flux, Geant4: " << absolute_integral_scintillation_E << " data: " << tarc_integral_E << G4endl
	   << " ENERGY Lithium Flux, Geant4: " << absolute_integral_lithium_E << " data: " << tarc_lithium_E << G4endl
	   << " ENERGY Helium Flux, Geant4: " << absolute_integral_helium_E << " data: " << tarc_helium_E << G4endl
	   << G4endl
	   << G4endl
	   << G4endl;
  ...
  for (G4int i=0; i<10; ++i) {
    for (G4int j=0; j<10; ++j) {
      ...
      G4cout << " temp_radius: " << G4BestUnit(temp_radius,"Length") << " surface_area: " << G4BestUnit(surface_area,"Surface") << G4endl;
      G4double temp_denominator = tarcRun->fractional_bin_width*tarcRun->radii_energies[j]/eV;
      G4cout << " flux_radius[i][j]: " << tarcRun->flux_radius[i][j] << " events: " << events << " bin width in eV: " << temp_denominator << G4endl;
...
{
  //--------------------------------------------------
  // nRadialShellFluence = tpf->create("4999", "Radial Shell Fluence","float radius, energy, fluence, true_e, true_f");
  ...
  for(G4int i=0; i<26; ++i) {
    G4double shell_volume = (4.0/3.0)*3.14159265*std::pow(outer_radius[i],3.0) - (4.0/3.0)*3.14159265*std::pow(inner_radius[i],3.0);
    G4double radius = 0.5*(outer_radius[i] + inner_radius[i]);
    // loop over energies
    for(G4int j=0; j<10; ++j) {
      G4double temp_bin_width = tarcRun->lithium_radial_energy_upper[j] - tarcRun->lithium_radial_energy_lower[j];
      if(tarcRun->radial_fluence_step[i][j] != 0) {
	G4double absolute_radial_fluence = tarcRun->lithium_radial_mean[j]*(100.0*(1000000000.0/(G4double)events)*((tarcRun->radial_fluence_step[i][j])/shell_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
	G4double absolute_radial_fluence_true = tarcRun->lithium_radial_true_mean[j]*(100.0*(1000000000.0/(G4double)events)*((tarcRun->radial_fluence_step[i][j])/shell_volume)/temp_bin_width); // factor of 100 to account for /cm2 from /mm2
	
	G4cout << " radial_fluence_step = " << tarcRun->radial_fluence_step[i][j] << " for i: " << i << " and j: " << j << " mean energy: " << tarcRun->lithium_radial_mean[j] << " outer radius: " << outer_radius[i] << G4endl;
	...
	analysisManager->FillNtupleDColumn(8,3, tarcRun->lithium_radial_true_mean[j]); // true_e lithium_radial_true_mean[j]
	analysisManager->FillNtupleDColumn(8,4, absolute_radial_fluence_true); // true_f
	analysisManager->AddNtupleRow(8);

	fGeant4RadialFile << " Energy: " << tarcRun->lithium_radial_mean[j] << " radius: " << radius/10. << " Geant4: " << absolute_radial_fluence/tarcRun->lithium_radial_mean[j] << G4endl;
