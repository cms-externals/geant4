...
void drawKMinus( std::string, std::string );
void drawKMinusRegre( std::string, std::string, std::string );
...
TGraphErrors* getPi0EnergyAsGraph()
{
      ...
      TGraphErrors* gr = new TGraphErrors( NPointsKMinus_Pi0Energy, 
                                           Pi0Energy, 
			                   Pi0EnergyStat,
					   0, 0 );     
...
double calcChi2Pi0Energy( std::string target, std::string model, int& NDF )
{
...
double calcChi2Topology( std::string target, std::string model, int& NDF )
{
