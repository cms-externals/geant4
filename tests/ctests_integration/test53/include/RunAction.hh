...
public:
  ...
  RunAction(DetectorConstruction*, PrimaryGeneratorAction* genAct, HistoManager* histoMgr=0);
  virtual ~RunAction();
  ...
  void SetEdepAndRMS(G4int i, G4double edep, G4double rms, G4double lim);
...
private:
  ...
  std::vector<G4double>   fEdepTrue;
  std::vector<G4double>   fRmsTrue;
  std::vector<G4double>   fLimitTrue;                
  G4bool                  fApplyLimit;
