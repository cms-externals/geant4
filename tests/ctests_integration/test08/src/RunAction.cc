...
void RunAction::EndOfRunAction(const G4Run* run)
{
  ...
  G4cout << G4endl << " The run consists of " << nofEvents << " " << runCondition << G4endl
         ...
         << " Average number of e-  per event : " << nsecPerEvent << G4endl
         << " Max edep : " << G4BestUnit(fMaxEdep.GetValue(), "Energy") << G4endl
         << " Min edep : " << G4BestUnit(fMinEdep.GetValue(), "Energy") << G4endl
         << " Passed primary : " << std::boolalpha << fPassed.GetValue() << G4endl
         << " Event counter: " << fEventCounter.GetValue() << G4endl
         << " Event counter2: " << fEventCounter2.GetValue() << G4endl;
