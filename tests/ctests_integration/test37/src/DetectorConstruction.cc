...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  LayerThichness1 = Absorber1Thickness / NbOfLayersOfMedium1;
  solidLayerMedium1 =
    new G4Box("LayerMedium 1", LayerThichness1 / 2, (10.0 / 2) * cm, (10. / 2) * cm);
  ...
  {
    physiLayerMedium1 = new G4PVPlacement(
      0,
      G4ThreeVector(((LayerThichness1 - Absorber1Thickness) / 2 + iAbs * LayerThichness1), 0., 0.),
      logicLayerMedium1, "LayerMedium 1", logicMedium1, false, iAbs + 1);
  }
  //--------------------------------------------------------------------------------
  //                                 Medium2
  ...
  physiMedium2 =
    new G4PVPlacement(0, G4ThreeVector(Absorber1Thickness + 0.5 * Absorber2Thickness, 0., 0.),
                      logicMedium2, "Medium 2", logicWorld, false, 0);

  // Layers of Medium2
  LayerThichness2 = Absorber2Thickness / NbOfLayersOfMedium2;
  solidLayerMedium2 =
    new G4Box("LayerMedium 2", LayerThichness2 / 2, (10.0 / 2) * cm, (10. / 2) * cm);
  ...
  {
    physiLayerMedium2 = new G4PVPlacement(
      0,
      G4ThreeVector(((LayerThichness2 - Absorber2Thickness) / 2 + iAb * LayerThichness2), 0., 0.),
      logicLayerMedium2, "LayerMedium 2", logicMedium2, false, iAb + 1);
  }
  //--------------------------------------------------------------------------------
  //                                 Medium3
  ...
  physiMedium3 = new G4PVPlacement(
    0, G4ThreeVector(Absorber1Thickness + Absorber2Thickness + 0.5 * Absorber3Thickness, 0., 0.),
    logicMedium3, "Medium 3", logicWorld, false, 0);

  // Layers of Medium2
  LayerThichness3 = Absorber3Thickness / NbOfLayersOfMedium3;
  solidLayerMedium3 =
    new G4Box("LayerMedium 3", LayerThichness3 / 2, (1.0 / 2) * cm, (10. / 2) * cm);
  ...
  {
    physiLayerMedium3 = new G4PVPlacement(
      0,
      G4ThreeVector(((LayerThichness3 - Absorber3Thickness) / 2 + iAb * LayerThichness3), 0., 0.),
      logicLayerMedium3, "LayerMedium 3", logicMedium3, false, iAb + 1);
  }
