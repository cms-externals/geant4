...
class AddOnTargetLayer : public TargetComponent
{
  public:
    ...
    AddOnTargetLayer(TargetComponent* component, TargetGeometryManager* geomManager,
                     G4String layerName, G4String material = "Beryllium",
    ...
    G4VPhysicalVolume* GetWorldVolPhys() { return targetComponent->GetWorldVolPhys(); }
