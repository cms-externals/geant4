...
class DetectorConstruction : public G4VUserDetectorConstruction {
 ...
 public:
   ...
   void CreateFrontLayer(const G4String& layerName);
   void SetLayerRadius(G4double radi);
   void SetLayerThickness(G4double thickn);
   void SetLayerMaterial(const G4String& mat);
   void SetLayerMaxStepSize(G4double maxsize);
