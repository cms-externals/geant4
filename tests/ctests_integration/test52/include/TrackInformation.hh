...
class TrackInformation : public G4VUserTrackInformation
{
  ...
  public:
    ...
    inline void SetHitTarget() { hitTarget = true; }
    inline G4bool HitTarget() const { return hitTarget; }
    inline void SetEscapeEnergy(G4double en) { escapeEnergy = en; }
    inline G4double EscapeEnergy() { return escapeEnergy; }
};
