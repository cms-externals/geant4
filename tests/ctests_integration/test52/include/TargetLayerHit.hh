...
class TargetLayerHit : public G4VHit
{
  ...
  public:
    ...
    inline void SetVolumeName(G4String name) { volName = name; }
    inline void StoreEnergyDeposit(G4double energy) { energyDeposit = energy; }
    inline void StorePositionPre(G4ThreeVector pos) { positionPre = pos; }
    inline void StorePositionPost(G4ThreeVector pos) { positionPost = pos; }
    inline void StoreParticleType(G4String par) { particle = par; }
    inline void StoreTrackID(G4int id) { trackID = id; }
    ...
    inline G4ThreeVector GetPosition() { return positionPre; }
    inline G4double GetXCoordPre() { return positionPre.x(); }
    inline G4double GetYCoordPre() { return positionPre.y(); }
    inline G4double GetZCoordPre() { return positionPre.z(); }
    inline G4double GetXCoordPost() { return positionPost.x(); }
    inline G4double GetYCoordPost() { return positionPost.y(); }
    inline G4double GetZCoordPost() { return positionPost.z(); }
    inline G4String GetParticleType() { return particle; }
    inline G4int GetTrackID() { return trackID; }
    inline Secondaries& GetSecParticles() { return secParticles; }
};
