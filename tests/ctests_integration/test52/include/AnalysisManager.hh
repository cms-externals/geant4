...
class AnalysisManager : public DataManager {
 ...
 public:
   static AnalysisManager* Instance(G4double zLow = 0.0, 
                                    G4double zUp = 10.0);
   static void Destroy(); 
 
   void CreateCalorimeter(G4double pos, 
                          G4double thickn, 
                          G4double rad);
   void ScoreEnergyDeposit(G4double en, 
                           ...
                           G4double z,
                           const G4String& type="");
   void ScoreParticleEnergy(G4double en, 
                            G4double x, 
                            G4double y, 
                            G4double z,
                            const G4String& type);
   void ScoreEnteringParticles(G4double en, 
                               G4double x, 
                               G4double y, 
                               G4double z,
                               const G4String& type);
   void ScoreExitingParticles(G4double en, 
                              G4double x, 
                              G4double y, 
                              G4double z,
                              const G4String& type, 
