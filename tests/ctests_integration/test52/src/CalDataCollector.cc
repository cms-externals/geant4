...
void CalDataCollector::ScoreEnergyDeposit(G4double en, G4double x, G4double y, G4double z,
...
{
  G4cout << "--------------------------------------------------------" << G4endl;
  G4cout << "CALORIMETER: " << GetLowerBound() << " to " << GetUpperBound() << G4endl;
  G4cout << "--------------------------------------------------------" << G4endl;
  ...
  G4cout << "Center and Thickness:  " << center << " " << thickness
         << "   Total Energy Deposit: " << totEnergyDeposit
         << "   Rel. Error: " << totEnergyDepositRelErr << G4endl
         << "  Electron Energy Deposit: " << elecEnergyDeposit << G4endl
         << "  Photon Energy Deposit:   " << photEnergyDeposit << G4endl;
