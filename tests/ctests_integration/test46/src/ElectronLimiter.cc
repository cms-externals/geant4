...
ElectronLimiter::ElectronLimiter(const G4ParticleDefinition *part)
    : G4VEmProcess("eLimiter", fGeneral),
      particle(part),regionEcal(nullptr),regionHcal(nullptr),
      limitEcal(DBL_MAX),factEcal(1.0),rmsEcal(0.0),
      limitHcal(DBL_MAX),factHcal(1.0),rmsHcal(0.0),
      insideEcal(false) 
{
...
G4VParticleChange*
ElectronLimiter::PostStepDoIt(const G4Track& track, const G4Step&) 
{
