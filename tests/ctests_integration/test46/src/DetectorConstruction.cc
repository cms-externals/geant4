...
DetectorConstruction::DetectorConstruction(LimiterPhysics* lim):
  logicWorld(nullptr),physiWorld(nullptr),logicPS(nullptr),
  logicECal(nullptr),logicCrystal(nullptr)
{
  ...
  const G4double absThick[17]={12.977, 7.815, 4.932, 4.932, 4.932, 4.932, 4.932, 4.932, 4.932, 4.932, 5.371, 5.516, 5.516, 5.516, 5.516, 5.516, 9.734};
  const G4double scThick[17]={9, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 3.7, 9}; 
...
{
  if(physiWorld) { return physiWorld; }
