...
int main(int argc, char** argv)
{
  ...
  LimiterPhysics* limiter = new LimiterPhysics();
  DetectorConstruction* det = new DetectorConstruction(limiter);
  ...
  if ("QGSP_FTFP_BERT_EML" == physName)
  {
    phys = new QGSPCMS_FTFP_BERT_EML();
  }
  ...
  else if ("FTFP_BERT_EMM" == physName)
  {
    phys = new FTFPCMS_BERT_EMM();
  }
  else if ("" == physName)
  {
    physName = "FTFP_BERT";
