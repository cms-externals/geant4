...
class HistoManager
{
  ...
  public:
    ...
    void AddHcalHit(const G4ParticleDefinition*, G4int, G4double, G4double, const G4ThreeVector&);
    ...
    void SetHcalStart(G4double);
    void SetHcalCell(G4double);

    void SetBeamEnergy(G4double);
    void SetFirstInteraction(G4double, G4int, G4int);
