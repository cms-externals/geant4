...
class Histo
{
  public:
    ...
    void SetHisto1D(G4int, G4int, G4double, G4double);

    // Histogram activation/deactivation
    void Activate(G4int, G4bool);

    // Histogramms are filled
    void Fill(G4int i, G4double x, G4double w = 1.0);
    ...
    inline G4bool IsNtupleActive() const { return fNtupleActive; };

  private:

    G4AnalysisManager* fManager;
