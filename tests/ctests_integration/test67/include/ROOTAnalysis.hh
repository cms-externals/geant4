...
class ROOTAnalysis
{
  public:
    ...
    void AddGammaSecondary(G4String processName);
    int CheckPhysicalResults();
    void CloseFile();
    void EndOfRun(G4int runID, G4double energy, G4int nEventsTotal, G4int nEventsPeak,
                  G4int nEventsFull);
    void OneMoreSecondary();
    void CountSteps(G4int nst);
  ...
  private:
    ...
    Double_t fSecondaries;
    Double_t fTotalSteps;
};
