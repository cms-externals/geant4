...
static void OutputCases(G4int N,  // Number of events per case.
                        const std::vector<G4String>& particleNameList,
                        const std::vector<G4double>& energyList,
                        const std::vector<G4String>& materialNameList)
{
  for (size_t iMaterial = 0; iMaterial < materialNameList.size(); iMaterial++)
  {
    for (size_t iEnergy = 0; iEnergy < energyList.size(); iEnergy++)
    {
      for (size_t iParticle = 0; iParticle < particleNameList.size(); iParticle++)
      {
        G4cout << "\n#\n# " << particleNameList[iParticle] << " at "
               << G4BestUnit(energyList[iEnergy], "Energy") << " in " << materialNameList[iMaterial]
               << "\n#";

        G4cout << "\n/gun/particle " << particleNameList[iParticle] << "\n/gun/energy "
               << G4BestUnit(energyList[iEnergy], "Energy") << "\n/mydet/SelectMaterial "
               << materialNameList[iMaterial] << "\n/run/beamOn " << N;
      }
    }
  }
}
...
int main(int argc, char** argv)
{
  ...
  */
  ...
  std::vector<G4String> gamma_particleNameList;
  gamma_particleNameList.push_back("gamma");
  std::vector<G4double> gamma_energyList;
  gamma_energyList.push_back(16 * MeV);
  gamma_energyList.push_back(8 * MeV);
  gamma_energyList.push_back(4 * MeV);
  gamma_energyList.push_back(2 * MeV);
  gamma_energyList.push_back(1 * MeV);
  gamma_energyList.push_back(500 * keV);
  gamma_energyList.push_back(250 * keV);
  gamma_energyList.push_back(125 * keV);
  gamma_energyList.push_back(62.5 * keV);

  std::vector<G4String> gamma_materialNameList;
  gamma_materialNameList.push_back("G4_Be");
  gamma_materialNameList.push_back("G4_C");
  gamma_materialNameList.push_back("G4_N");
  gamma_materialNameList.push_back("G4_O");
  gamma_materialNameList.push_back("G4_Al");
  gamma_materialNameList.push_back("G4_Fe");
  gamma_materialNameList.push_back("G4_Ge");
  gamma_materialNameList.push_back("G4_Cu");
  gamma_materialNameList.push_back("G4_Au");
  gamma_materialNameList.push_back("G4_Pb");
  gamma_materialNameList.push_back("G4_U");
  OutputCases(N, gamma_particleNameList, gamma_energyList, gamma_materialNameList);
