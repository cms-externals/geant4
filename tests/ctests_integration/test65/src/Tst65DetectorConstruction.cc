...
#include "Tst65TargetParameterisation.hh"
...
void Tst65DetectorConstruction::SelectMaterialPointer()
{
  ...
  if (simpleBoxLog)
  {
    ...
    ((Tst65TargetParameterisation*)pVPVParameterisation)->SetMaterial(selectedMaterial);
  }
}
...
G4VPhysicalVolume* Tst65DetectorConstruction::Construct()
{
  ...
  pVPVParameterisation = new Tst65TargetParameterisation(1, selectedMaterial);
