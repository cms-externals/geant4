...
void Tst65PhysicsList::ConstructHad()
{
  ...
  while ((*myParticleIterator)())
  {
    ...
    if (particleName == "gamma")
    {
      ...
      /*
            G4HadronicProcess* thePhotoFissionProcess = new G4HadronicProcess( "photoFission",
         fFission ); G4LENDFissionCrossSection* endlFissionXS = new G4LENDFissionCrossSection(
         particle ); G4LENDFission* endlFissionFS = new G4LENDFission( particle );
            ...
            G4HadronicProcess* thePhotoCaptureProcess = new G4HadronicProcess( "photoCapture",
         fCapture ); G4LENDCaptureCrossSection* endlCaptureXS = new G4LENDCaptureCrossSection(
         particle ); G4LENDCapture* endlCaptureFS = new G4LENDCapture( particle );
    ...
    else if (particleName == "neutron")
    {
      ...
      G4LENDElasticCrossSection* theNeutronData =
        new G4LENDElasticCrossSection(G4Neutron::Neutron());
      ...
      G4LENDInelasticCrossSection* theNeutronData1 =
        new G4LENDInelasticCrossSection(G4Neutron::Neutron());
      ...
      G4LENDFissionCrossSection* theNeutronData2 =
        new G4LENDFissionCrossSection(G4Neutron::Neutron());
      ...
      G4LENDCaptureCrossSection* theNeutronData3 =
        new G4LENDCaptureCrossSection(G4Neutron::Neutron());
