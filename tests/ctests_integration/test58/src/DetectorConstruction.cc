...
void DetectorConstruction::DefineMaterials()
{
  ...
  // examples of gas
  //
  new G4Material("H2Gas", z = 1, a = 1.01 * g / mole, density = 0.27 * mg / cm3);
...
void DetectorConstruction::ComputeCalorParameters()
{
  ...
  if (defaultWorld)
  {
    WorldSizeX = 1.5 * AbsorberThickness;
...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  //
  solidAbsorber =
    new G4Box("Absorber", AbsorberThickness / 2, AbsorberSizeYZ / 2, AbsorberSizeYZ / 2);
...
void DetectorConstruction::PrintCalorParameters()
{
  ...
  G4cout << "\n The  WORLD   is made of " << G4BestUnit(WorldSizeX, "Length") << " of "
         << WorldMaterial->GetName();
  G4cout << ". The transverse size (YZ) of the world is " << G4BestUnit(WorldSizeYZ, "Length")
         << G4endl;
  G4cout << " The ABSORBER is made of " << G4BestUnit(AbsorberThickness, "Length") << " of "
         << AbsorberMaterial->GetName();
  G4cout << ". The transverse size (YZ) is " << G4BestUnit(AbsorberSizeYZ, "Length") << G4endl;
