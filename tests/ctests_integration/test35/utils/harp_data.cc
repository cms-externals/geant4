...
void Print(std::ofstream* fout, std::string s, std::string s1, std::string s2, int n, double* x)
{
  (*fout) << "**  " << s << std::endl;
...
void Print1(std::ofstream* fout, std::string s, std::string s1, std::string s2, int n, double* x)
{
  (*fout) << "**  " << s << std::endl;
...
int main(int argc, char** argv)
{
  ...
  for (i = 0; i < nang; i++)
  {
    (*fout) << "#####.. Theta= " << ang[i] << " - " << ang[i + 1] << std::endl;
