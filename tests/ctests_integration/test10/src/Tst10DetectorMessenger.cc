...
Tst10DetectorMessenger::Tst10DetectorMessenger(Tst10DetectorConstruction* myDC) : myDetector(myDC)
{
  G4String defParam;
  ...
  selDetCmd->SetCandidates(
    "Sphere Orb Box Cone Tube CutTube Hype Torus Para Paraboloid Trd Trap GenericTrap Polyhedra "
    "Polycone TwistedBox TwistedTrd TwistedTrap TwistedTrap2  TwistedTubs Ellipsoid EllipticalTube "
    "EllipticalCone Tet TessellatedSolid ExtrudedSolid UnionSolid IntersectionSolid "
    "SubtractionSolid");
