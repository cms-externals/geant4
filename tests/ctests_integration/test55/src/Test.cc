...
Test::Test(const G4String& physQuantity, const G4String& category, G4double refValue,
...
std::ostream& Test::Print(std::ostream& os) const
{
  ...
  if (fMaterialName.length() > 13) material = fMaterialName.substr(0, 10) + "...";

  os << std::setw(10) << std::right << fParticleName << std::setw(15) << std::right << material
     << std::setw(12) << std::right << fPrimaryEnergy / MeV << std::setw(14) << std::right
     << ossRef.str() << std::setw(5) << std::right << fReferenceRelError * 100.0 << std::setw(13)
     << std::right
     << ossSim.str()
  ...
  if (fPassed)
    os << std::setw(4) << std::right << "P";
  else
    os << std::setw(4) << std::right << "F";
