...
static const G4int kMaxTally = 20;
...
public:
  ...
  inline G4VPhysicalVolume* GetAbsorPhysVol() const { return pAbsor; }
  inline G4VPhysicalVolume* GetWorldPhysVol() const { return pWorld; }

  inline void SetBeamParticle(const G4ParticleDefinition* p) { fParticle = p; }
  inline const G4ParticleDefinition* GetBeamParticle() const { return fParticle; }

  inline void SetBeamEnergy(G4double ener) { fEnergy = ener; }
  inline G4double GetBeamEnergy() const    { return fEnergy; }
