...

{
  ...
  G4cout << " --- Tst68StackingAction constructor --- " << G4endl
         << " \t gammaEnergyThreshold1    = " << gammaEnergyThreshold1 / MeV << " MeV " << G4endl
         << " \t electronEnergyThreshold1 = " << electronEnergyThreshold1 / MeV << " MeV " << G4endl
         << " \t positronEnergyThreshold1 = " << positronEnergyThreshold1 / MeV << " MeV " << G4endl
         ...
         << " \t positronBiasingFactor1   = " << positronBiasingFactor1 << G4endl << G4endl
         << " \t gammaEnergyThreshold2    = " << gammaEnergyThreshold2 / MeV << " MeV " << G4endl
         << " \t electronEnergyThreshold2 = " << electronEnergyThreshold2 / MeV << " MeV " << G4endl
         << " \t positronEnergyThreshold2 = " << positronEnergyThreshold2 / MeV << " MeV " << G4endl
         ...
         << " \t positronBiasingFactor2   = " << positronBiasingFactor2 << G4endl << G4endl
         << " \t neutronKillingEnergyThreshold = " << neutronKillingEnergyThreshold / MeV << " MeV "
         << G4endl << " \t neutronEnergyThreshold        = " << neutronEnergyThreshold / MeV
         << " MeV " << G4endl << " \t neutronWeightThreshold        = " << neutronWeightThreshold
         << G4endl << " \t neutronBiasingFactor          = " << neutronBiasingFactor << G4endl
         << " ----------------------------------------------- " << G4endl;
...
Tst68StackingAction::~Tst68StackingAction()
{
  ...
  for (int i = 0; i < Nmax; i++)
  {
    ...
    std::cout << "\t exponent=" << i
              << "\t weight=" << std::pow(static_cast<double>(electronBiasingFactor2), i)
  ...
  for (int i = 0; i < Nmax; i++)
  {
    ...
    std::cout << "\t exponent=" << i
              << "\t weight=" << std::pow(static_cast<double>(positronBiasingFactor2), i)
...
G4ClassificationOfNewTrack Tst68StackingAction::ClassifyNewTrack(const G4Track* aTrack)
{
