...
inline G4Material* Tst68DetectorConstruction::GetAbsorberMaterial() const
{
  return theAbsorberMaterial;
}

inline G4Material* Tst68DetectorConstruction::GetActiveMaterial() const
{
  return theActiveMaterial;
}

inline void Tst68DetectorConstruction::SetIsCalHomogeneous(const G4bool choice)
{
  theIsCalHomogeneous = choice;
}

inline void Tst68DetectorConstruction::SetIsUnitInLambda(const G4bool choice)
{
  theIsUnitInLambda = choice;
}

inline void Tst68DetectorConstruction::SetAbsorberTotalLength(const G4double value)
{
  theAbsorberTotalLength = value;
}

inline void Tst68DetectorConstruction::SetCalorimeterRadius(const G4double value)
{
  theCalorimeterRadius = value;
}

inline void Tst68DetectorConstruction::SetActiveLayerNumber(const G4int value)
{
...
inline void Tst68DetectorConstruction::SetActiveLayerSize(const G4double value)
{
  theActiveLayerSize = value;
}

inline void Tst68DetectorConstruction::SetReadoutLayerNumber(const G4int value)
{
  theReadoutLayerNumber = value;
  if (theActiveLayerNumber % theReadoutLayerNumber != 0)
  {
    G4cout << "***WARNING*** Tst68DetectorConstruction::SetReadoutLayerNumber" << G4endl
           << "\t theReadoutLayerNumber = " << theReadoutLayerNumber
           << " is NOT compatible with theActiveLayerNumber = " << theActiveLayerNumber << G4endl
           << "\t Forced theReadoutLayerNumber = theActiveLayerNumber" << G4endl;
    theReadoutLayerNumber = theActiveLayerNumber;
  }
}

inline void Tst68DetectorConstruction::SetIsRadiusUnitInLambda(const G4bool choice)
{
  theIsRadiusUnitInLambda = choice;
}

inline void Tst68DetectorConstruction::SetRadiusBinSize(const G4double value)
{
  theRadiusBinSize = value;
}

inline void Tst68DetectorConstruction::SetRadiusBinNumber(const G4int value)
{
