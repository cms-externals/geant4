...
{
  G4Material* h2gas = new G4Material("hydrogen", 1.0, 1.01 * g / mole, 71.0 * mg / cm3);

  // experimental hall (world volume)
  G4VSolid* worldSolid = new G4Box("worldBox", 10.0 * m, 3.0 * m, 10.0 * m);
  G4LogicalVolume* worldLogical = new G4LogicalVolume(worldSolid, h2gas, "worldLogical", 0, 0, 0);
