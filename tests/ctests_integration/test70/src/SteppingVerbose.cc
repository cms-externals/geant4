...
void SteppingVerbose::StepInfo()
{
  ...
  if (verboseLevel >= 1)
  {
    if (!(GetMolecule(fTrack)))
    {
      ...
      {
        G4cout << G4endl;
        G4cout << std::setw(5) << "#Step#" << " " << std::setw(8) << "X" << "    " << std::setw(6)
               << "Y" << "    " << std::setw(6) << "Z" << "    " << std::setw(9) << "KineE" << " "
               << std::setw(9) << "dEStep" << " " << std::setw(10) << "StepLeng" << std::setw(10)
               << "TrakLeng" << std::setw(10) << "NextVolu" << std::setw(10) << "Process" << G4endl;
      }
...
void SteppingVerbose::TrackingStarted()
{
  ...
  if (verboseLevel > 0 && !GetMolecule(fTrack))
  {
    G4cout << std::setw(5) << "Step#" << " " << std::setw(6) << "X" << "    " << std::setw(6) << "Y"
           ...
           << std::setw(15) << "Nb of secondaries" << G4endl;
