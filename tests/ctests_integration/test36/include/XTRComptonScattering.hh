...

{
  public:  // with description
    ...
    G4bool StorePhysicsTable(const G4ParticleDefinition*, const G4String& directory, G4bool);
    ...
    G4double GetCrossSectionPerAtom(G4DynamicParticle* aDynamicGamma, G4Element* anElement);
    ...
    virtual G4double ComputeCrossSectionPerAtom(G4double GammaEnergy, G4double AtomicNumber);
