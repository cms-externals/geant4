...
inline G4double Em10StepCut::PostStepGetPhysicalInteractionLength(const G4Track& aTrack, G4double,
                                                                  G4ForceCondition* condition)
{
  ...
  *condition = NotForced;
  ...
  if ((MaxChargedStep > 0.) && (aTrack.GetVolume() != NULL)
...
inline G4VParticleChange* Em10StepCut::PostStepDoIt(const G4Track& aTrack, const G4Step&)
{
  // do nothing
...
inline G4double Em10StepCut::GetMeanFreePath(const G4Track&, G4double, G4ForceCondition*)
{
  return 0.;
}
