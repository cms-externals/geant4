...
Tst14CalorimeterSD::Tst14CalorimeterSD(G4String name, Tst14DetectorConstruction* det)
...
{
  CalCollection = new Tst14CalorHitsCollection(SensitiveDetectorName, collectionName[0]);
  static G4int HCID = -1;
  if (HCID < 0)
  {
