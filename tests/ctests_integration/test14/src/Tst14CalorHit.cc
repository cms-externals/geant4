...
Tst14CalorHit::Tst14CalorHit() : G4VHit()
{
  EdepAbs = 0.;
  TrackLengthAbs = 0.;
  EdepGap = 0.;
...
Tst14CalorHit::Tst14CalorHit(const Tst14CalorHit& right) : G4VHit()
{
  EdepAbs = right.EdepAbs;
  TrackLengthAbs = right.TrackLengthAbs;
  EdepGap = right.EdepGap;
  TrackLengthGap = right.TrackLengthGap;
}
