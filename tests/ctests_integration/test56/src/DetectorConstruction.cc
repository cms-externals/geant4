...
DetectorConstruction::DetectorConstruction() : fPvolBox(0), fLvolBox(0), fMaterial(0)
{
  fBoxSize = 1 * cm;
  DefineMaterials();
  // SetMaterial("Water");
...
void DetectorConstruction::DefineMaterials()
{
  ...
  G4Element* H  = new G4Element("Hydrogen" ,"H" , z= 1., a=   1.01*g/mole);/  G4Element* N  = new
  G4Element("Nitrogen" ,"N" , z= 7., a=  14.01*g/mole); G4Element* O  = new G4Element("Oxygen" ,"O"
  , z= 8., a=  16.00*g/mole);
...
G4VPhysicalVolume* DetectorConstruction::ConstructVolumes()
{
  ...
  fLvolBox = new G4LogicalVolume(sBox,  // its shape
                                 fMaterial,  // its material
                                 fMaterial->GetName());  // its name

  fPvolBox = new G4PVPlacement(0,  // no rotation
                               G4ThreeVector(),  // at (0,0,0)
                               fLvolBox,  // its logical volume
                               fMaterial->GetName(),  // its name
                               0,  // its mother  volume
