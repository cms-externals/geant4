...
inline G4double Tst18StepCut::PostStepGetPhysicalInteractionLength(const G4Track& aTrack,
...
inline G4VParticleChange* Tst18StepCut::PostStepDoIt(const G4Track& aTrack, const G4Step&)
{
  // do nothing
...
inline G4double Tst18StepCut::GetMeanFreePath(const G4Track&, G4double, G4ForceCondition*)
{
  return 0.;
}
