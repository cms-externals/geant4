...
class UIcmdWithNucleusAndUnit : public G4UIcommand
{
  public:  // with description
    ...
    UIcmdWithNucleusAndUnit(const char* theCommandPath, G4UImessenger* theMessenger);
    ...
    void SetParameterName(const char* theNameA, const char* theNameZ, const char* theNameE,
