...
Tst18RunAction::Tst18RunAction() : fileName("rdmex2.log")
{
...
void Tst18RunAction::EndOfRunAction(const G4Run*)
{
  ...
  {
    G4cout << std::setiosflags(std::ios::fixed) << std::setprecision(3)
           << std::setiosflags(std::ios::right) << std::setw(12) << Energies[i]
           << std::resetiosflags(std::ios::fixed) << std::setiosflags(std::ios::scientific)
           << std::setprecision(4) << std::setw(12) << Weights[i] << std::setprecision(4)
           << std::setw(12) << Times[i] << "     " << std::resetiosflags(std::ios::scientific)
           << Particles[i] << G4endl;
  }
  G4cout << G4endl;
}
