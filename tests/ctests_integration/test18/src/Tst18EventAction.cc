...
Tst18EventAction::Tst18EventAction() : eventMessenger(0), numberOfSecondariesPerEvent(0)
{
...
void Tst18EventAction::EndOfEventAction(const G4Event*)
{
  ...
  {
    G4Exception("Tst18EventAction::EndOfEventAction", "Tst18_00", JustWarning,
                "No Decay Products Found");
  }
}
