...
G4VPhysicalVolume* Tst18GeometryConstruction::Construct()
{
  ...
  density = 2.65 * g / cm3;
  G4Material* SiliconDioxide = new G4Material(name = "silicon oxide", density, nel = 2);
  ...
  G4Box* universe_box = new G4Box("universe_b", universe_x, universe_y, universe_z);
  G4LogicalVolume* universe_log = new G4LogicalVolume(universe_box, Vacuum, "universe_L", 0, 0, 0);
  G4VPhysicalVolume* universe_phys =
    new G4PVPlacement(0, G4ThreeVector(), universe_log, "universe_P", 0, false, 0);
  ...
  new G4PVPlacement(0, G4ThreeVector(), aSphere_log1, "aSphere_P1", universe_log, false, 0);
  ...
  new G4PVPlacement(0, G4ThreeVector(), aSphere_log2, "aSphere_P2", aSphere_log1, false, 0);
