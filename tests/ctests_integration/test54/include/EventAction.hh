...
class EventAction : public G4UserEventAction
{
  ...
  public:
    ...
    void AddTrakLenCharg(G4double length) { fTrackLenCharged += length; }
    void AddTrakLenNeutr(G4double length) { fTrackLenNeutral += length; }
  ...
  private:
    ...
    G4double fTrackLenCharged, fTrackLenNeutral;
