...
public:
  ...
  bool HistoExist(G4int id) const        { return fExist[id]; }
  G4double GetHistoBinWidth(G4int id) const;  
  G4double GetHistoUnit(G4int id) const  { return fUnit[id]; }
  void SetMaster(G4bool master)          { fMaster = master; }
