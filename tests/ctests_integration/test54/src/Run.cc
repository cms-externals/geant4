...
void Run::EndOfRun()
{
  ...
  fTrackLenCharged /= TotNbofEvents; fTrackLenCharged2 /= TotNbofEvents;
  G4double rmsTLCh = fTrackLenCharged2 - fTrackLenCharged*fTrackLenCharged;
  if (rmsTLCh>0.) rmsTLCh = std::sqrt(rmsTLCh/TotNbofEvents);
  else            rmsTLCh = 0.;

  fTrackLenNeutral /= TotNbofEvents; fTrackLenNeutral2 /= TotNbofEvents;
