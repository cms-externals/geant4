...
Test30HadronProduction::Test30HadronProduction(const G4String& aName)
  : G4VDiscreteProcess(aName), theGenerator(0)
{
  InitializeMe();
}
...
G4double Test30HadronProduction::PostStepGetPhysicalInteractionLength(const G4Track&, G4double,
...
G4VParticleChange* Test30HadronProduction::PostStepDoIt(const G4Track& track, const G4Step&)
{
