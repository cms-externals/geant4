...
//-------------------------- Global histograms  -------------------------
std::ofstream PimP8y("PimP8y.dat",std::ios::out);
std::ofstream PimP8x("PimP8x.dat",std::ios::out);
std::ofstream PimP8pt2("PimP8pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    G4cout<< "******** Rapidity ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
     ...
     PimP8y<<G4Version<<G4endl;
     PimP8y<<"  Y         P         Neut       Pip        Pim       Kp"
         <<"      Km       Pbar "<< G4endl;
    ...
    for(G4int ii=0; ii <100; ii++)
    {
     Yu+=0.1;
     PimP8y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP8y<<YUzhi[ii][jj]<<" ";}
     PimP8y<<G4endl;
    }
//
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PimP8x<<G4Version<<G4endl;
    PimP8x<<"  Xf       P      Neut       Pip      Pim      Kp"
        <<"      Km       Pbar"<< G4endl;
    ...
    for(G4int ii=0; ii <100; ii++)
    {
     ...
     {
      PimP8x<<Xu<<" ";
      for(G4int jj=0;jj < 7; jj++){PimP8x << XfUzhi[ii][jj]/3.14159<<" ";}
      PimP8x<<G4endl;
     }
    }
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PimP8pt2<<G4Version<<G4endl;
    PimP8pt2<<"  Pt2      P      Neut       Pip      Pim      Kp"
           <<"     Km     Pbar"<< G4endl;
    ...
    for(G4int ii=0; ii <99; ii++)  // 100
    {
     Pt2u+=0.015;
     PimP8pt2<<Pt2u<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP8pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PimP8pt2<<G4endl;
    }
