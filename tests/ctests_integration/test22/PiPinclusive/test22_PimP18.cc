...
//-------------------------- Global histograms  -------------------------
std::ofstream PimP18y("PimP18y.dat",std::ios::out);
std::ofstream PimP18x("PimP18x.dat",std::ios::out);
std::ofstream PimP18pt2("PimP18pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    G4cout<< "******** Rapidity ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
     ...
     PimP18y<<G4Version<<G4endl;
     PimP18y<<"  Y         P         Neut       Pip        Pim       Kp"
         <<"      Km       Pbar "<< G4endl;
    ...
    for(G4int ii=0; ii <100; ii++)
    {
     Yu+=0.1;
     PimP18y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP18y<<YUzhi[ii][jj]<<" ";}
     PimP18y<<G4endl;
    }
//
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PimP18x<<G4Version<<G4endl;
    PimP18x<<"  Xf       P      Neut       Pip      Pim      Kp"
        <<"      Km       Pbar"<< G4endl;
    ...
    for(G4int ii=0; ii <100; ii++)
    {
     ...
     {
      PimP18x<<Xu<<" ";
      for(G4int jj=0;jj < 7; jj++){PimP18x << XfUzhi[ii][jj]/3.14159<<" ";}
      PimP18x<<G4endl;
     }
    }
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PimP18pt2<<G4Version<<G4endl;
    PimP18pt2<<"  Pt2      P      Neut       Pip      Pim      Kp"
           <<"     Km     Pbar"<< G4endl;
    ...
    for(G4int ii=0; ii <99; ii++)  // 100
    {
     Pt2u+=0.015;
     PimP18pt2<<Pt2u<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP18pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PimP18pt2<<G4endl;
    }
