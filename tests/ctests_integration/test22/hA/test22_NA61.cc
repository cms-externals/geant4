...
for(G4int ii=0; ii < 10; ii++)
{
 ...
 {                                          
  Pro1[jj][ii]=sigIn*Pro1[jj][ii]/Ninelast/0.1; Pro<<Pro1[jj][ii]<<" ";
 }
 Pro<<G4endl;
}
...
for(G4int ii=0; ii <21; ii++)
{
 ...
 for(G4int jj=0;jj <10; jj++)
 {                                          
  Pro2[jj][ii]=sigIn*Pro2[jj][ii]/Ninelast/0.2; Pro<<Pro2[jj][ii]<<" ";
 }
 Pro<<G4endl;
}                                                                           
...
for(G4int ii=0; ii <12; ii++)
{
 ...
 for(G4int jj=0;jj <10; jj++)
 {                                          
  Pro3[jj][ii]=sigIn*Pro3[jj][ii]/Ninelast/0.4; Pro<<Pro3[jj][ii]<<" ";
 }
 Pro<<G4endl;
}    
...
for(G4int ii=0; ii <19; ii++)
{
 ...
 for(G4int jj=0;jj <10; jj++)
 {                                          
  Pro4[jj][ii]=sigIn*Pro4[jj][ii]/Ninelast/0.8; Pro<<Pro4[jj][ii]<<" ";
 }
 Pro<<G4endl;
}    
