...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        for (G4int i = 0; i < n; ++i)  // Loop over produced particles
        {
          ...
          G4int IthetaKp(-1);
          if ((0.02 < theta) && (theta <= 0.14))
          {
            IthetaKp = 0;
          }
          if ((0.14 < theta) && (theta <= 0.24))
          {
            IthetaKp = 1;
          }
      ...
      Pro << "P S0_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pro1[jj][ii] = sigIn * Pro1[jj][ii] / Ninelast / 0.1;
          Pro << Pro1[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pro2[jj][ii] = sigIn * Pro2[jj][ii] / Ninelast / 0.2;
          Pro << Pro2[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pro3[jj][ii] = sigIn * Pro3[jj][ii] / Ninelast / 0.4;
          Pro << Pro3[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 19; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pro4[jj][ii] = sigIn * Pro4[jj][ii] / Ninelast / 0.8;
          Pro << Pro4[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      Pip << "P S0_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pip1[jj][ii] = sigIn * Pip1[jj][ii] / Ninelast / 0.1;
          Pip << Pip1[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pip2[jj][ii] = sigIn * Pip2[jj][ii] / Ninelast / 0.2;
          Pip << Pip2[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pip3[jj][ii] = sigIn * Pip3[jj][ii] / Ninelast / 0.4;
          Pip << Pip3[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pip4[jj][ii] = sigIn * Pip4[jj][ii] / Ninelast / 0.8;
          Pip << Pip4[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      Pim << "P S0_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pim1[jj][ii] = sigIn * Pim1[jj][ii] / Ninelast / 0.1;
          Pim << Pim1[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pim2[jj][ii] = sigIn * Pim2[jj][ii] / Ninelast / 0.2;
          Pim << Pim2[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pim3[jj][ii] = sigIn * Pim3[jj][ii] / Ninelast / 0.4;
          Pim << Pim3[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 10; jj++)
        {
          Pim4[jj][ii] = sigIn * Pim4[jj][ii] / Ninelast / 0.8;
          Pim << Pim4[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 2; jj++)
        {
          Kp1[jj][ii] = sigIn * Kp1[jj][ii] / Ninelast / 0.1;
          Kp << Kp1[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 2; jj++)
        {
          Kp2[jj][ii] = sigIn * Kp2[jj][ii] / Ninelast / 0.2;
          Kp << Kp2[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 2; jj++)
        {
          Kp3[jj][ii] = sigIn * Kp3[jj][ii] / Ninelast / 0.4;
          Kp << Kp3[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 2; jj++)
        {
          Kp4[jj][ii] = sigIn * Kp4[jj][ii] / Ninelast / 0.8;
          Kp << Kp4[jj][ii] << " ";
        }
        Kp << G4endl;
      }
