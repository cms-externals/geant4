...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        for (G4int i = 0; i < n; ++i)  // Loop over produced particles
        {
          ...
          if ((0. < theta) && (theta <= 0.01))
          {
            Itheta = 0;
          }
          if ((0.01 < theta) && (theta <= 0.02))
          {
            Itheta = 1;
          }
          if ((0.02 < theta) && (theta <= 0.04))
          {
            Itheta = 2;
          }
          if ((0.04 < theta) && (theta <= 0.06))
          {
            Itheta = 3;
          }
          if ((0.06 < theta) && (theta <= 0.10))
          {
            Itheta = 4;
          }
          if ((0.10 < theta) && (theta <= 0.14))
          {
            Itheta = 5;
          }
          if ((0.14 < theta) && (theta <= 0.18))
          {
            Itheta = 6;
          }
          if ((0.18 < theta) && (theta <= 0.24))
          {
            Itheta = 7;
          }
          if ((0.24 < theta) && (theta <= 0.30))
          {
            Itheta = 8;
          }
          if ((0.30 < theta) && (theta <= 0.36))
          {
            Itheta = 9;
          }
          if ((0.36 < theta) && (theta <= 0.42))
          {
            Itheta = 10;
          }

          G4int IthetaLam(-1);  // For Lambda
          if ((0.0 < theta) && (theta <= 0.04))
          {
            IthetaLam = 0;
          }
          if ((0.04 < theta) && (theta <= 0.06))
          ...
          if ((0.30 < theta) && (theta <= 0.42))
          {
            IthetaLam = 7;
          }

          G4int IthetaKp(-1);  // For K+ K-
          if ((0.0 < theta) && (theta <= 0.02))
          {
            IthetaKp = 0;
          }
          if ((0.02 < theta) && (theta <= 0.04))
          ...
          if (Itheta >= 0)  // for Pi+ Pi- Protons
          {
            if ((pname == "proton") && !QEtriger)
            {
              if ((p < 1.))
              {
                G4int Ip = G4int((p - 0.) / 0.1);
                Pro1[Itheta][Ip]++;
              }
              else if ((1. < p) && (p < 5.2))
              {
                G4int Ip = G4int((p - 1.) / 0.2);
                Pro2[Itheta][Ip]++;
              }
              else if ((5.2 < p) && (p < 10.))
              {
                G4int Ip = G4int((p - 5.2) / 0.4);
                Pro3[Itheta][Ip]++;
              }
              else if ((10. < p) && (p < 25.10))
              {
                G4int Ip = G4int((p - 10.) / 0.8);
                Pro4[Itheta][Ip]++;
              };
            };
      ...
      Pro << "P S0_10 S10_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 "
             "S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pro1[jj][ii] = sigIn * Pro1[jj][ii] / Ninelast / 0.1 / DpiP[jj];
          Pro << Pro1[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pro2[jj][ii] = sigIn * Pro2[jj][ii] / Ninelast / 0.2 / DpiP[jj];
          Pro << Pro2[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pro3[jj][ii] = sigIn * Pro3[jj][ii] / Ninelast / 0.4 / DpiP[jj];
          Pro << Pro3[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 19; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pro4[jj][ii] = sigIn * Pro4[jj][ii] / Ninelast / 0.8 / DpiP[jj];
          Pro << Pro4[jj][ii] << " ";
        }
        Pro << G4endl;
      }
      ...
      Pip << "P S0_10 S10_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 "
             "S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pip1[jj][ii] = sigIn * Pip1[jj][ii] / Ninelast / 0.1 / DpiP[jj];
          Pip << Pip1[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pip2[jj][ii] = sigIn * Pip2[jj][ii] / Ninelast / 0.2 / DpiP[jj];
          Pip << Pip2[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pip3[jj][ii] = sigIn * Pip3[jj][ii] / Ninelast / 0.4 / DpiP[jj];
          Pip << Pip3[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pip4[jj][ii] = sigIn * Pip4[jj][ii] / Ninelast / 0.8 / DpiP[jj];
          Pip << Pip4[jj][ii] << " ";
        }
        Pip << G4endl;
      }
      ...
      Pim << "P S0_10 S0_20 S20_40 S40_60 S60_100 S100_140 S140_180 S180_240 S240_300 S300_360 "
             "S360_400"
          << G4endl;
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pim1[jj][ii] = sigIn * Pim1[jj][ii] / Ninelast / 0.1 / DpiP[jj];
          Pim << Pim1[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pim2[jj][ii] = sigIn * Pim2[jj][ii] / Ninelast / 0.2 / DpiP[jj];
          Pim << Pim2[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pim3[jj][ii] = sigIn * Pim3[jj][ii] / Ninelast / 0.4 / DpiP[jj];
          Pim << Pim3[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 11; jj++)
        {
          Pim4[jj][ii] = sigIn * Pim4[jj][ii] / Ninelast / 0.8 / DpiP[jj];
          Pim << Pim4[jj][ii] << " ";
        }
        Pim << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Kp1[jj][ii] = sigIn * Kp1[jj][ii] / Ninelast / 0.1 / Dkpkm[jj];
          Kp << Kp1[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Kp2[jj][ii] = sigIn * Kp2[jj][ii] / Ninelast / 0.2 / Dkpkm[jj];
          Kp << Kp2[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Kp3[jj][ii] = sigIn * Kp3[jj][ii] / Ninelast / 0.4 / Dkpkm[jj];
          Kp << Kp3[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Kp4[jj][ii] = sigIn * Kp4[jj][ii] / Ninelast / 0.8 / Dkpkm[jj];
          Kp << Kp4[jj][ii] << " ";
        }
        Kp << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Km1[jj][ii] = sigIn * Km1[jj][ii] / Ninelast / 0.1 / Dkpkm[jj];
          Km << Km1[jj][ii] << " ";
        }
        Km << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Km2[jj][ii] = sigIn * Km2[jj][ii] / Ninelast / 0.2 / Dkpkm[jj];
          Km << Km2[jj][ii] << " ";
        }
        Km << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Km3[jj][ii] = sigIn * Km3[jj][ii] / Ninelast / 0.4 / Dkpkm[jj];
          Km << Km3[jj][ii] << " ";
        }
        Km << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Km4[jj][ii] = sigIn * Km4[jj][ii] / Ninelast / 0.8 / Dkpkm[jj];
          Km << Km4[jj][ii] << " ";
        }
        Km << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 7; jj++)
        {
          K01[jj][ii] = sigIn * K01[jj][ii] / Ninelast / 0.1 / Dk0L[jj];
          K0 << K01[jj][ii] << " ";
        }
        K0 << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 7; jj++)
        {
          K02[jj][ii] = sigIn * K02[jj][ii] / Ninelast / 0.2 / Dk0L[jj];
          K0 << K02[jj][ii] << " ";
        }
        K0 << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 7; jj++)
        {
          K03[jj][ii] = sigIn * K03[jj][ii] / Ninelast / 0.4 / Dk0L[jj];
          K0 << K03[jj][ii] << " ";
        }
        K0 << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 7; jj++)
        {
          K04[jj][ii] = sigIn * K04[jj][ii] / Ninelast / 0.8 / Dk0L[jj];
          K0 << K04[jj][ii] << " ";
        }
        K0 << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 10; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Lam1[jj][ii] = sigIn * Lam1[jj][ii] / Ninelast / 0.1 / Dk0L[jj];
          Lam << Lam1[jj][ii] << " ";
        }
        Lam << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 21; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Lam2[jj][ii] = sigIn * Lam2[jj][ii] / Ninelast / 0.2 / Dk0L[jj];
          Lam << Lam2[jj][ii] << " ";
        }
        Lam << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Lam3[jj][ii] = sigIn * Lam3[jj][ii] / Ninelast / 0.4 / Dk0L[jj];
          Lam << Lam3[jj][ii] << " ";
        }
        Lam << G4endl;
      }
      ...
      for (G4int ii = 0; ii < 12; ii++)
      {
        ...
        for (G4int jj = 0; jj < 8; jj++)
        {
          Lam4[jj][ii] = sigIn * Lam4[jj][ii] / Ninelast / 0.8 / Dk0L[jj];
          Lam << Lam4[jj][ii] << " ";
        }
        Lam << G4endl;
      }
