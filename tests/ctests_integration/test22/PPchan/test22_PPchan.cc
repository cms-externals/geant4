...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        */
        ...
        G4int Nother = NprotonBar + Nneutron + NneutronBar + Npim + Npip + NKm + NKp + NK0s + NK0l
                       + NLambda + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        ...
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 2) && (Npi0 == 1))
        {
          ...
          if (verbose > 0)
          {
            G4cout << "pp pi0 " << G4endl;
            G4int Uzh;
            G4cin >> Uzh;
          }
        }

        Nother = NprotonBar + NneutronBar + Npim + Npi0 + NKm + NKp + NK0s + NK0l + NLambda
                 + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        ...
        if ((Ncharged == 4) && (Nother == 0) && (Nproton == 2) && (Npip == 1) && (Npim == 1))
        {
          ...
          if (verbose > 0)
          {
            G4cout << " 2p pi+ pi- " << G4endl;
            G4int Uzh;
            G4cin >> Uzh;
          }
        }

        Nother = NprotonBar + NneutronBar + Npi0 + NKm + NKp + NK0s + NK0l + NLambda + NLambdaBar
                 + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;

        if ((Ncharged == 4) && (Nother == 0) && (Nproton == 1) && (Nneutron == 1) && (Npip == 2)
            && (Npim == 1))
        {
          Xs[Uzhi_run][7]++;
          if (verbose > 0)
          {
            G4cout << " pn 2pi+ pi- " << G4endl;
            G4int Uzh;
            G4cin >> Uzh;
          }
        }

        Nother = NprotonBar + Nneutron + NneutronBar + NKm + NKp + NK0s + NK0l + NLambda
                 + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
            ...
            && (Npi0 == 1))
        {
          ...
          if (verbose > 0)
          {
            G4cout << " pp pi+ pi- pi0 " << G4endl;
            G4int Uzhi;
            G4cin >> Uzhi;
          }
        }
        Nother = NprotonBar + Nneutron + NneutronBar + Npip + Npim + Npi0 + NKm + NKp + NK0s + NK0l
                 + NLambda + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;

        Nother = Nneutron + NprotonBar + NneutronBar + Npim + Npip + Npi0 + NKm + NK0s + NK0l
                 + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime;
  ...
  PPchan << " Plab   Xtot    Xel     Xin    PPPi0    PNpip   PPpippim  PN2pippim   PPpippimpi0  "
            "LPKp   PP"
         << G4endl;
