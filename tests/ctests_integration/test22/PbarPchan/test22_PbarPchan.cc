...
//+++++++++++++++++ Store after each event ++++++++++++++++++++++++++++++
      ...
      if(JUzhi == 2) {                             // Uzhi Apr. 2016
        G4int FSbaryon=Nproton    + Nneutron    +
...
*/
//if((n == 2) && (NSigma_m == 1)) {G4cout<<" NSigma_mBar "<<NSigma_mBar<<" NSigma_pBar "<<NSigma_pBar<<G4endl; G4int Uzhi; G4cin>>Uzhi;}
//--------4   Elastic Pbar P
G4int Nother=                  Nneutron    +
                  ...
                  Ngamma                    ;
if((NprotonBar == 1) && (Nproton == 1) && (Nother == 0))
{Xs[Uzhi_run][4]++;  } // G4cout<<" 4 "<<G4endl;} // TopoUzhi[Uzhi_run][JUzhi]--;
...
{Xs[Uzhi_run][6]++;}// G4cout<<" 6 L Lbar"<<G4endl; G4int Uzhi; G4cin>>Uzhi;}			//Vova
...
{Xs[Uzhi_run][17]++;}// G4cout<<" 17 3Pi+ 3Pi-"<<G4endl;  G4int Uzhi; G4cin>>Uzhi;}
...
{Xs[Uzhi_run][18]++;}// G4cout<<" 18 3Pi+ 3Pi- Pi0"<<G4endl;  G4int Uzhi; G4cin>>Uzhi;}
...
{Xs[Uzhi_run][21]++;} // G4cout<<" 21 "<<G4endl;}
...
{Xs[Uzhi_run][22]++;G4cout<<" 22 "<<G4endl; G4int Uzhi; G4cin>>Uzhi;} //} // G4cout<<" 22 "<<G4endl;}
...
{Xs[Uzhi_run][23]++;}// G4cout<<" 23  Sigma0 Lbar "<<G4endl; G4int Uzhi; G4cin>>Uzhi;}			//Vova
...
{Xs[Uzhi_run][23]++;} // G4cout<<" 23 "<<G4endl;}
...
{Xs[Uzhi_run][24]++;} // G4cout<<" 24 "<<G4endl;}
...
{Xs[Uzhi_run][24]++;G4cout<<" 24 "<<G4endl; G4int Uzhi; G4cin>>Uzhi;} // G4cout<<" 24 "<<G4endl;}
...
{Xs[Uzhi_run][25]++;} // G4cout<<" 25 "<<G4endl;}
...
{Xs[Uzhi_run][25]++;G4cout<<" 25 "<<G4endl; G4int Uzhi; G4cin>>Uzhi;} // G4cout<<" 25 "<<G4endl;}
...
{Xs[Uzhi_run][26]++;} // G4cout<<" 26 "<<G4endl;}
...
{Xs[Uzhi_run][27]++;} // G4cout<<" 27 "<<G4endl;}
...
{Xs[Uzhi_run][28]++;} // G4cout<<" 28 "<<G4endl;}
...
{Xs[Uzhi_run][29]++;} // G4cout<<" 29 "<<G4endl;}
...
{Xs[Uzhi_run][30]++;} // G4cout<<" 30 "<<G4endl;}
...
{Xs[Uzhi_run][31]++;} // G4cout<<" 31 "<<G4endl;}
...
if((Npip == 1) && (Npim == 1) && (Npi0 == 1) && (NK0l == 1) && (NK0s == 1) && (Nother == 0))
{Xs[Uzhi_run][32]++;} // G4cout<<" 32 "<<G4endl;}
...
{Xs[Uzhi_run][33]++;} // G4cout<<" 33 "<<G4endl;}
...
if(Ntotal != 0)
{
     ...
     for(G4int ii=4;ii<34; ii++) {Xs[Uzhi_run][ii]*=sigTot/Ntotal;}
}
...
PbarPchan3<<" Plab      LamLamBar     S+S-Bar  S-S+Bar S0LamBar+cc LamPi0LamBar S+Pi-LamBar+cc LamK0Nbar+cc "<< G4endl;
//             0           6           21        22      23           19          24             25
for(G4int ii=0;ii<Uzhi_run;ii++) //--------------------------------- Uzhi
  {
   PbarPchan3<<" "<<Xs[ii][0]<<" "<<Xs[ii][6];
   for(G4int jj=21;jj<24;jj++) {PbarPchan3<<" "<<Xs[ii][jj];};
...
PbarPchan4<<" Plab   Pi+Pi-K+K-  Pi0Pi-K+K0s  Pi+Pi-K0lK0s  Pi+Pi-2K0s  Pi+PI-Pi0K+K-  Pi+2Pi-K+K0s  Pi+Pi-PI0KlKs  Pi+Pi-Pi02K0s    "<< G4endl;
//                      26           27           28            29          30             31             32             33
for(G4int ii=0;ii<Uzhi_run;ii++) //--------------------------------- Uzhi
  {
   PbarPchan4<<" "<<Xs[ii][0];
   for(G4int jj=26;jj<34;jj++) {PbarPchan4<<" "<<Xs[ii][jj];};
