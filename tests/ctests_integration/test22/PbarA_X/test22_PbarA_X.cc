...
int main()
{
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarH << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
           << cross_secel / millibarn << " " << cross_inel / millibarn << " " << chipsTot << " "
           << chipsEl << " " << chipsIn << G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarH2 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
            << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarHe << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
            << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarLi6 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
             << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarBe9 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
             << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarC12 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
             << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarAl27 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
              << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarCu64 << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
              << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarSn << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
            << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarPb << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
            << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
  ...
  for (G4int i = 1; i < 335; i++)
  {
    ...
    XpbarU << " " << Plab / GeV << " " << energy / GeV << " " << cross_sec / millibarn << " "
           << cross_secel / millibarn << " " << cross_inel / millibarn << G4endl;
    //         <<" "<<chipsTot           <<" "<<chipsEl              <<" "<<chipsIn<<G4endl;
  }
