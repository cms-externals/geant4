...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        */
        ...
        G4int Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                       + Nproton + Nneutron + NSigma0 + NSigmaP + NSigmaM + Npim + Npip + NKm + NKp
                       + NK0s + NK0l + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 0) && (Nother == 0) && (NLambda == 1) && (Npi0 == 1))
        {
          Xs[Uzhi_run][4]++;
          if (verbose > 0) G4cout << "L Pi0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NSigma0 + NSigmaP + NSigmaM + Npi0 + NKm + NKp + NK0s + NK0l
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (NLambda == 1) && (Npip == 1) && (Npim == 1))
        {
          Xs[Uzhi_run][5]++;
          if (verbose > 0) G4cout << "L Pi+ Pi- " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NSigma0 + NSigmaP + NSigmaM + NKm + NKp + NK0s + NK0l
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (NLambda == 1) && (Npip == 1) && (Npim == 1)
            && (Npi0 == 1))
        {
          Xs[Uzhi_run][6]++;
          if (verbose > 0) G4cout << "L Pi+ Pi- Pi0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npi0 + NKp + NK0s + NK0l
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (Nneutron == 1) && (NKm == 1) && (Npip == 1))
        {
          Xs[Uzhi_run][7]++;
          if (verbose > 0) G4cout << "N K- Pi+ " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NSigmaP + NSigmaM + Npim + Npip + NKm + NKp + NK0s + NK0l
                 + Neta + Neta_prime;
        // if((Ncharged == 0) && (Nother == 0) && (NLambda == 1) && (Ngamma == 1) && (Npi0 ==1))
        if ((Ncharged == 0) && (Nother == 0) && (NSigma0 == 1) && (Npi0 == 1))
        {
          Xs[Uzhi_run][8]++;
          if (verbose > 0) G4cout << "Sigma0 Pi0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NLambda + NSigma0 + NSigmaM + Npip + Npi0 + NKm + NKp + NK0s
                 + NK0l + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (NSigmaP == 1) && (Npim == 1))
        {
          Xs[Uzhi_run][9]++;
          if (verbose > 0) G4cout << "Sigma+ Pi- " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NLambda + NSigma0 + NSigmaM + Npip + NKm + NKp + NK0s + NK0l
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (NSigmaP == 1) && (Npim == 1) && (Npi0 == 1))
        {
          Xs[Uzhi_run][10]++;
          if (verbose > 0) G4cout << "Sigma+ Pi- Pi0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npip + Npi0 + NKm + NKp
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (NK0s + NK0l == 1))
        {
          Xs[Uzhi_run][11]++;
          if (verbose > 0) G4cout << "N K0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npip + Npi0 + NKm + NKp
                 + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (NK0s + NK0l == 1) && (Npim == 1))
        {
          Xs[Uzhi_run][12]++;
          if (verbose > 0) G4cout << "P K0 Pi- " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + Nneutron + NLambda + NSigma0 + NSigmaP + Npim + Npi0 + NKm + NKp + NK0s
                 + NK0l + Ngamma + Neta + Neta_prime;
        ...
        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npip + Npi0 + NKp
                 + NK0s + NK0l + Ngamma + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (NKm == 1))
        {
          Xs[Uzhi_run][14]++;
          TopoUzhi[Uzhi_run][2]--;
          if (verbose > 0) G4cout << "Elastic " << G4endl;
        }  //  Ntotal--;
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      if (nevt - Nfault != 0)
        Xs[Uzhi_run][14] *= sigTot / (nevt - Nfault);  // Elastic cross section
  ...
  KmPchan << " Plab Xtot Xel Xin L_Pi0 L_PipPim L_PipPimPi0 N_KmPip S0_Pi0 Sp_Pim Sp_PimPi0 N_K0 "
             "P_K0Pim Sm_Pip Km_Pel"
          << G4endl;
