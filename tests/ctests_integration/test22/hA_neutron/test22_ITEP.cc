 ...
 { for(G4int j=0;j<24;j++)
  {
   ...
   FileName2="Itp.dat";
   if(nameGen=="ftfp"){ FileName1="Itn.dat";}
   if(nameGen=="bertini"){ FileName1="ItnBe.dat"; }
...
// 19 Sept. 2015    sigIn/=1000.;
    ...
    for(G4int ii=0; ii <22; ii++)
    {
      ...
      for(G4int jj= 0; jj <  6; jj++) {hAp<<" "<<XUzhiP[ii][jj]; hAn<<" "<<XUzhiN[ii][jj];}

      for(G4int jj= 6; jj < 12; jj++) {hAp<<" "<<XUzhiP[ii][jj]; hAn<<" "<<XUzhiN[ii][jj];}

      for(G4int jj=12; jj < 18; jj++) {hAp<<" "<<XUzhiP[ii][jj]; hAn<<" "<<XUzhiN[ii][jj];}

      for(G4int jj=18; jj < 24; jj++) {hAp<<" "<<XUzhiP[ii][jj]; hAn<<" "<<XUzhiN[ii][jj];}
      hAp<<G4endl;
      hAn<<G4endl;
    }
