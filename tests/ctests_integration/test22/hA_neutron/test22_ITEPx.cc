...
#include "FTFtest2.icc"  // Initialization
  ...
  // G4double Tkin [22]
  // ={ 7.5, 8.5, 9.5, 11.0, 13.0, 15.0, 17.0, 19.0, 22.5, 27.5, 35.0, 45.0, 55.0, 70.0, 90.0,
...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      if (nameGen == "ftfp")
        hAF << Plab / GeV << " " << XUzhiN[1][19] << " " << XUzhiN[3][19] << " " << XUzhiN[5][19]
            << " " << sigIn << G4endl;
      if (nameGen == "bertini")
        hAB << Plab / GeV << " " << XUzhiN[1][19] << " " << XUzhiN[3][19] << " " << XUzhiN[5][19]
            << " " << sigIn << G4endl;
      //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi
