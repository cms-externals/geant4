...
G4double Anles [24] = {10. , 15. , 20. , 25. , 29. , 35. , 40. , 44. , 49. , 54. , 59. , 64. , 69. , 74. , 79. , 84. , 89. , 99.0,  109. , 119. , 129. , 139. , 149. , 160.};
G4double AnLow [24] = { 7.5, 12.5, 17.5, 22.5, 27.5, 32.0, 38.0, 42.0, 46.5, 51.5, 56.5, 61.5, 66.5, 71.5, 76.5, 81.5, 86.5, 94.0,  104.0, 114.0, 124.0, 134.0, 144.0, 154.0};
G4double AnHig [24] = {12.5, 17.5, 22.5, 27.5, 30.5, 38.0, 42.0, 46.0, 51.5, 56.5, 61.5, 66.5, 71.5, 76.5, 81.5, 86.5, 91.5, 104.0, 114.0, 124.0, 134.0, 144.0, 154.0, 166.0};
...
// G4double Tkin [22] ={ 7.5, 8.5, 9.5, 11.0, 13.0, 15.0, 17.0, 19.0, 22.5, 27.5, 35.0, 45.0, 55.0, 70.0, 90.0, 110.0, 130.0, 150.0, 170.0, 190.0, 210.0, 230.0};
G4double TkinL[22] ={ 7.0, 8.0, 9.0, 10.0, 12.0, 14.0, 16.0, 18.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 80.0, 100.0, 120.0, 140.0, 160.0, 180.0, 200.0, 220.0};
G4double TkinH[22] ={ 8.0, 9.0, 10.0, 12.0, 14.0, 16.0, 18.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 80.0, 100.0, 120.0, 140.0, 160.0, 180.0, 200.0, 220.0, 240.0};
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  std::ofstream hAF("hAnX.dat",std::ios::out);
  std::ofstream hAB("hAnXBe.dat",std::ios::out);

 hAF<<G4Version<<G4endl;
 hAF<<"Plab T8p7 T11 T15 Sigma"<<G4endl;

 hAB<<G4Version<<G4endl;
 hAB<<"Plab T8p7 T11 T15 Sigma"<<G4endl;
...
//
          for(G4int iT=0; iT <22; iT++)
          {
           if((TkinL[iT] <= T) && (T < TkinH[iT]))
           {
            ...
            {
             if((AnLow[iTh] <= theta) && (theta < AnHig[iTh])) {XUzhiP[iT][iTh]+=1./Pmod;}
            }
           }
          }
//
...
//
          for(G4int iT=0; iT <22; iT++)
          {
           if((TkinL[iT] <= T) && (T < TkinH[iT]))
           {
            for(G4int iTh=0; iTh < 24; iTh++)
            {
             if((AnLow[iTh] <= theta) && (theta < AnHig[iTh])) {XUzhiN[iT][iTh]+=1./Pmod;}
            }
           }
          }
//
...
// ----------------------------- Tkin distributions----------------------
    ...
    if(nameGen=="ftfp") hAF<<Plab/GeV<<" "<<XUzhiN[1][19]<<" "<<XUzhiN[3][19]<<" "<<XUzhiN[5][19]<<" "<<sigIn<<G4endl;
    if(nameGen=="bertini") hAB<<Plab/GeV<<" "<<XUzhiN[1][19]<<" "<<XUzhiN[3][19]<<" "<<XUzhiN[5][19]<<" "<<sigIn<<G4endl;
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi
