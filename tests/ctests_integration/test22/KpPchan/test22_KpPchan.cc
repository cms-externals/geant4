...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        */
        ...
        G4int Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                       + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npi0 + NKm + NKp
                       + Neta + Neta_prime;
        ...
        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npi0 + NKm + NK0s + NK0l
                 + Neta + Neta_prime;
        ...
        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npip + NKm + NK0s
                 + NK0l + Neta + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (NKp == 1) && (Npi0 == 1))
        {
          Xs[Uzhi_run][6]++;
          if (verbose > 0) G4cout << "P K+ Pi0 " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + NKm + NKp + Neta
                 + Neta_prime;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (NK0s + NK0l == 1) && (Npip == 1)
            && (Npi0 == 1))
        {
          Xs[Uzhi_run][7]++;
          if (verbose > 0) G4cout << "P K0 Pi+ Pi0" << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npi0 + NKm + NK0s + NK0l
                 + Neta + Neta_prime;
        if ((Ncharged == 4) && (Nother == 0) && (Nproton == 1) && (NKp == 1) && (Npip == 1)
            && (Npim == 1))
        {
          Xs[Uzhi_run][8]++;
          if (verbose > 0) G4cout << "P K+ Pi+ Pi- " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nproton + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npi0 + NKm + NKp + Neta
                 + Neta_prime;

        if ((Ncharged == 2) && (Nother == 0) && (Nneutron == 1) && (NK0s + NK0l == 1)
            && (Npip == 2))
        {
          Xs[Uzhi_run][9]++;
          if (verbose > 0) G4cout << "n K0 Pi+ Pi+ " << G4endl;
        }

        Nother = NprotonBar + NneutronBar + NLambdaBar + NSigma0Bar + NSigmaPBar + NSigmaMBar
                 + Nneutron + NLambda + NSigma0 + NSigmaP + NSigmaM + Npim + Npip + Npi0 + NKm
                 + NK0s + NK0l + Neta + Neta_prime;
  ...
  KpPchan << " Plab   Xtot    Xel       Xin    pK0_Pip    nKpPip    pKpPi0  pK0PipPi0  pKpPipPim  "
             "nK0PipPip  KpP"
          << G4endl;
