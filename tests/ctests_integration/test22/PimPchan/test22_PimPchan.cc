...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        */
        ...
        G4int Nother = Nproton + NprotonBar + NneutronBar + Npim + Npip + NKm + NKp + NK0s + NK0l
                       + NLambda + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        if ((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (Npi0 == 1))
        {
          Xs[Uzhi_run][4]++;
          if (verbose > 0) G4cout << " n Pi0 " << G4endl;
        }

        Nother = Nproton + NprotonBar + NneutronBar + Npim + Npip + NKm + NKp + NK0s + NK0l
                 + NLambda + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        if ((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (Npi0 == 2))
        {
          Xs[Uzhi_run][5]++;
          if (verbose > 0) G4cout << " n 2Pi0 " << G4endl;
        }

        Nother = Nproton + NprotonBar + NneutronBar + Npi0 + NKm + NKp + NK0s + NK0l + NLambda
        ...
        Nother = NprotonBar + Nneutron + NneutronBar + Npip + NKm + NKp + NK0s + NK0l + NLambda
                 + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (Npi0 == 1) && (Npim == 1))
        {
          Xs[Uzhi_run][7]++;
          if (verbose > 0) G4cout << " p Pip Pim " << G4endl;
        }
        ...
        {
          Xs[Uzhi_run][8]++;
          if (verbose > 0) G4cout << " n 3Pi0 " << G4endl;
        }
        ...
        {
          Xs[Uzhi_run][9]++;
          if (verbose > 0) G4cout << " p Pip 2Pim " << G4endl;
        }

        Nother = NprotonBar + Nneutron + NneutronBar + Npip + Npi0 + NKm + NKp + NK0s + NK0l
                 + NLambda + NLambdaBar + NSigma0 + NSigma0Bar + Neta + Neta_prime + Ngamma;
        if ((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (Npim == 1))
        {
          Xs[Uzhi_run][10]++;
          TopoUzhi[Uzhi_run][2]--;
          if (verbose > 0) G4cout << " Pim P " << G4endl;
        }  //  Ntotal--;
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  PimPchan << " Plab      Xtot     Xel    Xin     NPi0    N2pi0     Npippim  Ppi0pim    N3pi0     "
              "Ppip2pim     PimP"
           << G4endl;
