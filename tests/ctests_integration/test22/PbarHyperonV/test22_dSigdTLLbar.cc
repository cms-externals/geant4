...
#include "FTFtest4.icc"  // -------- Start run processing
        ...
        if ((n == 2) && (AntiLam == 1) && (Lam == 1))  // Lambda - AntiLambda
        {
          for (G4int i = 0; i < n; ++i)  // Loop over produced particles
          {
            ...
            if (id == -3122)
            {
              ...
              G4int Nbin = G4int(T / 0.04);
              if ((Nbin >= 0) && (Nbin <= 49)) DistrT[0][Nbin]++;
            }
          }  //     end of the loop on particles
        ...
        if ((n == 2) && (AntiLam == 1) && (Sigma0 == 1))  // AntiLambda Sigma0
        {
          for (G4int i = 0; i < n; ++i)  // Loop over produced particles
          {
            ...
            if (id == -3122)
            {
              ...
              G4int Nbin = G4int(T / 0.04);
              if ((Nbin >= 0) && (Nbin <= 49)) DistrT[1][Nbin]++;
            }
          }  //     end of the loop on particles
      ...
      for (G4int i = 0; i < 50; i++)
      {
        ...
        SumLLbar += DistrT[0][i];
        SumLbarS += DistrT[1][i];
        DistrT[0][i] *= X_b / 0.04 / Ntotal;
        DistrT[1][i] *= X_b / 0.04 / Ntotal;
