...
#include "FTFtest4.icc"  // -------- Start run processing
      ...
      for (G4int iter = 0; iter < nevt; ++iter)
      {
        ...
        for (G4int i = 0; i < n; ++i)  // Loop over produced particles
        {
          ...
          G4int Pt2Bin = pt2 / dP;
          if (Pt2Bin < 0) Pt2Bin = 0;
          if (Pt2Bin > 49) Pt2Bin = 49;
          ...
          G4int RapBin =
            (rapidity - Ylow) / dY;  // if(RapBin < 0.) RapBin=0; if(RapBin > 49) RapBin=49;
          ...
          if (id == 3122)  // Lambda
          {
            ...
            G4int XfBin = (Xf + 1.0) / dX;
            if (XfBin < 0) XfBin = 0;
            if (XfBin > 49) XfBin = 49;
