...
Tst33AppStarterMessenger::Tst33AppStarterMessenger(Tst33AppStarter& appstarter)
...
void Tst33AppStarterMessenger::SetNewValue(G4UIcommand* pCmd, G4String szValue)
{
  ...
  if (pCmd == fWWCmd)
  {
    ...
    else
    {
      ...
      G4Exception("Tst33AppStarterMessenger::SetNewValue()", "TST33-02", FatalException, desc);
    }
