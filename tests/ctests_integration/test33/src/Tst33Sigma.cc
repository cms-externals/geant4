...
G4double Tst33Sigma::GetXsum() const
{
  return fXsum;
}
G4double Tst33Sigma::GetXXsum() const
{
  return fXXsum;
}
G4double Tst33Sigma::GetSumOfWeights() const
{
  return fWsum;
}
G4double Tst33Sigma::GetWeightedXsum() const
{
  return fWXsum;
}
G4double Tst33Sigma::GetWeightedXXsum() const
{
  return fWXXsum;
}
