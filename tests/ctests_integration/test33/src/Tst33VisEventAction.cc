...
Tst33VisEventAction::Tst33VisEventAction()
  : drawFlag("all"), printModulo(1), eventMessenger(nullptr)
{
...
void Tst33VisEventAction::EndOfEventAction(const G4Event*) {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void Tst33VisEventAction::DrawTrajectory(G4Trajectory&) const {}
