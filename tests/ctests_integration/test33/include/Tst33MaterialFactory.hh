...
#  define Tst33MaterialFactory_hh 1
...
using Tst33MapSymbolElement = std::map<G4String, G4Element*>;
using Tst33MapElementFraction = std::map<G4Element*, G4double>;
...
class Tst33MaterialFactory
{
  ...
  private:
    ...
    void FillElementMap(const G4String& name, const G4String& symbol, G4int Z, G4double A);
