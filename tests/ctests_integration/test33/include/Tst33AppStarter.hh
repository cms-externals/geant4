...
class Tst33AppStarter
{
  public:
    ...
    void CreateScorer();
    void CreateIStore();
    void CreateWeightWindowStore(G4PlaceOfAction poa, G4bool zeroWindow);
    void CreateWeightRoulette(G4int mode);
    void ClearSampling();
    void Run(G4int nevents);
    void AddWeightChanger();

    inline void ForcingCoupled(G4bool vl = true) { forceCoupled = vl; }
