...
#  endif
  ...
  public:
    ...
    inline G4int GetCrystalNum() { return crystalnumber; }
    inline void SetCrystalNum(G4int num) { crystalnumber = num; }
    inline G4ThreeVector GetPos() { return pos; }
    inline void SetStart(G4ThreeVector xyz) { start = xyz; }
    inline G4ThreeVector GetStart() { return start; }
