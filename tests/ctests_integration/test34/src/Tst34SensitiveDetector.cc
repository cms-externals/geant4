...
void Tst34SensitiveDetector::Initialize(G4HCofThisEvent*)
{
  ...
  caloHitsCollection = new Tst34HitsCollection(SensitiveDetectorName, collectionName[0]);
}
...
G4bool Tst34SensitiveDetector::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
...
G4bool Tst34SensitiveDetector::ProcessHits(G4GFlashSpot* aSpot, G4TouchableHistory*)
{
