...
{
  if (!mpointer) mpointer = new Tst34MaterialManager;
  return mpointer;
}

void Tst34MaterialManager::storeElement(G4String name, G4String symbol, G4double z, G4double a)
{
...
void Tst34MaterialManager::storeMaterial(G4String name, G4double z, G4double a, G4double d)
{
...
void Tst34MaterialManager::storeMaterial(G4String name, G4double d, G4int ncomponent)
{
  if (mlist.find(name) != mlist.end())
  {
    G4cout << "attempt of redefining an existing material " << G4endl;
