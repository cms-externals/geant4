...
Tst34EventAction::Tst34EventAction() : nevent(0), dtime(0.0), calorimeterCollectionId(-1) {}
...
void Tst34EventAction::EndOfEventAction(const G4Event* evt)
{
  ...
  G4cout << " ------ Tst34EventAction::End of event nr. " << nevent << "  -----" << G4endl;
  ...
  if (THC)
  {
    ...
    G4cout << "  " << n_hit << " hits are stored in Tst34HitsCollection " << G4endl;
  ...
  G4cout << " #### Tst34EventAction::Test:"
         << " Total energy deposited in the calorimeter: " << totE << " (GeV)" << G4endl;
}
