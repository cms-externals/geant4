...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    crystalLogic = new G4LogicalVolume(crystalSolid,
                                       crystalMaterial,
                                       "Crystal");
    ...
    //print crystal info
    G4cout << "Crystal size: " << CrystalSize.x()/mm << "x" << CrystalSize.y()/mm
           << "x" << CrystalSize.z()/mm << " mm3" << G4endl;
    ...
    G4LogicalVolume* fLogicDetector = new G4LogicalVolume(Detector, 
                                                          Silicon,
                                                          "Detector");
    new G4PVPlacement(0, 
                      posDetector, 
