...
T07DetectorMessenger::T07DetectorMessenger(T07DetectorConstruction* T07Det) : T07Detector(T07Det)
{
  ...
  GapMaterCmd->SetCandidates(
    "Air Aluminium liquidArgon Scintillator quartz Aerogel CarbonicGas WaterSteam Galactic Beam");
