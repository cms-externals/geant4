...
int main(int argc, char** argv)
{
  ...
  // Detector setup (deleted by run-manager)
  Tst01DetectorConstruction* det = new Tst01DetectorConstruction;
  ...
  runManager->SetUserAction(new Tst01PrimaryGeneratorAction(det));
