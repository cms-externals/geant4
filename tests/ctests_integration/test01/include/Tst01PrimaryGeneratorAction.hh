...
class Tst01PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
  public:
    ...
    Tst01PrimaryGeneratorAction(Tst01DetectorConstruction* detector);
...
inline void Tst01PrimaryGeneratorAction::SetGunPosition(G4ThreeVector pGun)
{
  fGunPosition = pGun;
  fPosition = std::sqrt(fGunPosition.x() * fGunPosition.x() + fGunPosition.y() * fGunPosition.y()
