...
void HARPDataJSONMaster( std::string tgt, int tgtlnk )
{
   ...
   std::string fjsonname = "HARP-spectra-piplus-";
   fjsonname += tgt;
   fjsonname += ".json";
...
void HARPDataJSONCompose( std::ofstream& jsonfile, std::string tgt, int tgtlnk, std::string secondary )
{
   ...
   ReadHARPData( "piplus", tgt, "3.0", secondary, "FW" ); 
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      //
      // NOTE: beamlnk=42 is 3 GeV/c pi+ 
      //
      // NOTE: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":42,\"targetlnk\":"<< tgtlnk <<",\"observablelnk\":8,\"secondarylnk\":" 
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus",tgt, "3.0", secondary, "LA" );
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      //
      // NOTE-2: beamlnk=42 is 3 GeV/c pi+ 
      //
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus", tgt, "5.0", secondary, "FW" ); 
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE: observablelnk=8 means diff. xsec dsigma / dtheta dp
      //
      // NOTE: beamlnk=43 is 5 GeV/c pi+ 
      //
      // NOTE: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":43,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
               << seclink << ",\"reactionlnk\":1," << std::endl;
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus",tgt, "5.0", secondary, "LA" );
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE-1: observablelnk=8 means diff. xsec dsigma / dtheta dp
      //
      // NOTE-2: beamlnk=43 is 5 GeV/c pi+
      //
      // NOTE-3: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":43,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus", tgt, "8.0", secondary, "FW" ); 
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE: observablelnk=8 means diff. xsec dsigma / dtheta dp
      //
      // NOTE: beamlnk=44 is 8 GeV/c pi+ 
      //
      // NOTE: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":44,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
               << seclink << ",\"reactionlnk\":1," << std::endl;
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus",tgt, "8.0", secondary, "LA" );
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE-1: observablelnk=8 means diff xsec dsigma / dtheta dp
      //
      // NOTE-2: beamlnk=44 is 8 GeV/c pi+ 
      //
      // NOTE-3: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":44,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus", tgt, "12.0", secondary, "FW" ); 
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE: observablelnk=8 means diff. xsec dsigma / dtheta dp
      //
      // NOTE: beamlnk=45 is 12 GeV/c pi+ 
      //
      // NOTE: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":45,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
               << seclink << ",\"reactionlnk\":1," << std::endl;
...
// -->      jsonfile << "\"imageblobslnk\":NULL,\"scoreslnk\":2,\"accesslnk\":1,\"parvalue\":{}" << std::endl;
   ...
   ReadHARPData( "piplus",tgt, "12.0", secondary, "LA" );
   ...
   for ( int i=0; i<NSetsHARP; ++i )
   {
	 ...
	 return;
      ...
      // NOTE-1: observablelnk=8 means diff. xsec dsigma / dtheta dp
      //
      // NOTE-2: beamlnk=45 is 12 GeV/c pi+ 
      //
      // NOTE-3: reactionlnk=1 means "particle production"
      //
      jsonfile << "\"beamlnk\":45,\"targetlnk\":" << tgtlnk << ",\"observablelnk\":8,\"secondarylnk\":" 
