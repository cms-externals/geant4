...
class TstTarget : public G4VUserDetectorConstruction
{
  public:
    ...
    void SetDimentions(G4double x1, G4double x2, G4double x3)
    {
      fX1 = x1;
      fX2 = x2, fX3 = x3;
      return;
    }
    void SetX(G4double val)
    {
      fX1 = val;
      return;
    }
    void SetY(G4double val)
    {
      fX2 = val;
      return;
    }
    ...
    void SetRMin(G4double val)
    {
      fX1 = val;
      return;
    }
    void SetRMax(G4double val)
    {
      fX2 = val;
      return;
    }
    void SetShape(G4String val)
    {
      fShape = val;
      return;
    }
    ...
    G4double GetAMass() const { return fAMass; }
    G4double GetRMax() const;
    G4double GetZLength() const { return fX3; }
  ...
  private:
    ...
    G4double fAMass;  // cache it for possible future use !
