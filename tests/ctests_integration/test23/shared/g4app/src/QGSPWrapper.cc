...
QGSPWrapper::QGSPWrapper(const G4String& name, G4ProcessType type) : ProcessWrapper(name, type) {}
...
void QGSPWrapper::Compose()
{
  ...
  gen->SetMaxEnergy(100.0 * TeV /* G4HadronicParameters::Instance()->GetMaxEnergy() */);
