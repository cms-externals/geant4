...
printf "<value>FTFP_BERT, NuBeam</value>\n" >> ${script}
printf "</tag>\n" >> ${script}
printf "<tag>\n" >> ${script}
...
printf "<value>passed</value>\n" >> ${script}
printf "</score>\n" >> ${script}
printf "<imageblob>proton-Ta-8.0GeV-${secondary[$j]}-${region[$k]}-models.gif</imageblob>\n" >> ${script}
printf "<taglist>\n" >> ${script}
printf "<tag>\n" >> ${script}
printf "<name>Model</name>\n" >> ${script}
printf "<value>FTFP_BERT, QGSP_BERT, Shielding, ShieldingM</value>\n" >> ${script}
printf "</tag>\n" >> ${script}
printf "</taglist>\n" >> ${script}
...
printf "<value>passed</value>\n" >> ${script}
printf "</score>\n" >> ${script}
printf "<imageblob>proton-Ta-8.0GeV-${secondary[$j]}-theta-spectra-models.gif</imageblob>\n" >> ${script}
printf "<taglist>\n" >> ${script}
printf "<tag>\n" >> ${script}
printf "<name>Model</name>\n" >> ${script}
printf "<value>FTFP_BERT, QGSP_BERT, Shielding, ShieldingM</value>\n" >> ${script}
