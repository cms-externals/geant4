...
Tst75HistoSet::Tst75HistoSet(G4String htitle, G4float maxke) : TstHistoSet(htitle), fMaxKE(maxke)
{
  float bins_proton[] = {0.,     4.,     8.,     12.,    16.,    20.,    24.,    28.,    32.,
                         36.,    40.,    44.,    49.35,  54.30,  59.70,  65.60,  72.10,  79.20,
                         86.95,  95.45,  104.75, 114.90, 126.00, 138.10, 151.25, 165.55, 181.15,
                         198.10, 215.70, 226.00, 246.00, 266.00, 286.00};
...
void Tst75HistoSet::FillEvt(G4VParticleChange* aChange, const G4LorentzVector&,
