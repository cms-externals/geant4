...
#ifndef Tst04DetectorConstruction_h
#define Tst04DetectorConstruction_h 1
...
class G4Element;
class G4Material;
class Tst04DetectorMessenger;

#include "G4VUserDetectorConstruction.hh"
#include "globals.hh"

class Tst04DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    Tst04DetectorConstruction();
    ~Tst04DetectorConstruction();
  ...
  private:
     ...
     Tst04DetectorMessenger* detectorMessenger;

     G4VPVParameterisation* pVPVParameterisation;
};
