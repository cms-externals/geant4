...
G4VPhysicalVolume* Tst04DetectorConstruction::Construct()
{
  ...
  G4LogicalVolume* parameterisedSimpleBoxLV = new G4LogicalVolume ( mySimpleBox,
                                                        selectedMaterial ,
                                                        "ParameterisedSimpleBoxLV" );

  new G4PVParameterised ( "ParameterisedSimpleBox" ,
                          parameterisedSimpleBoxLV ,
                          simpleBoxLog ,
                          kUndefined ,
                          1 ,
                          pVPVParameterisation );
...
void Tst04DetectorConstruction::createIsotopeMaterial( G4int iZ , G4int iA ,
