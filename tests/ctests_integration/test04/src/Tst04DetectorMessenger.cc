...
Tst04DetectorMessenger::Tst04DetectorMessenger(Tst04DetectorConstruction* myDC) : myDetector(myDC)
{
  G4String defParam;
...
Tst04DetectorMessenger::~Tst04DetectorMessenger()
{
  delete selMatCmd;
  delete mydetDir;
}

void Tst04DetectorMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
