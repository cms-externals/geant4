...
void Tst04PhysicsList::ConstructHad()
{
  ...
  while ((*myParticleIterator)())
  {
    ...
    else if (particleName == "proton")
    {
      ...
      G4ParticleHPInelastic* hpInelasticFS =
    ...
    else if (particleName == "neutron")
    {
      ...
      G4ParticleHPInelastic* theLENeutronInelasticModel =
        new G4ParticleHPInelastic(G4Neutron::Neutron(), "ParticleHPInelastic");
      G4ParticleHPInelasticData* theNeutronData1 =
        new G4ParticleHPInelasticData(G4Neutron::Neutron());
    ...
    else if (particleName == "deuteron")
    {
      ...
      G4ParticleHPInelasticData* hpInelasticXS =
