...
int main(int argc, char** argv)
{
  ...
  TK_particleNameList.push_back("proton");
  TK_particleNameList.push_back("deuteron");
  TK_particleNameList.push_back("triton");
  TK_particleNameList.push_back("He3");
  TK_particleNameList.push_back("alpha");
  std::vector<G4double> TK_energyList;
  TK_energyList.push_back(20 * MeV);
  TK_energyList.push_back(16 * MeV);
  TK_energyList.push_back(12 * MeV);
  TK_energyList.push_back(8 * MeV);
  TK_energyList.push_back(4 * MeV);
  TK_energyList.push_back(2 * MeV);
