...
Tst50DetectorMessenger::Tst50DetectorMessenger(Tst50DetectorConstruction* tst50Det)
  : detector(tst50Det)
{
  ...
  targetThicknessCmd->AvailableForStates(G4State_PreInit);
  ...
  targetXDimensionCmd->AvailableForStates(G4State_PreInit);
  ...
  targetYDimensionCmd->AvailableForStates(G4State_PreInit);
  ...
  setStepMaxCmd->AvailableForStates(G4State_PreInit, G4State_Idle);
...
void Tst50DetectorMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  if (command == targetXDimensionCmd)
  {
