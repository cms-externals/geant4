...
{
  theTree = treeFact->create(name + "output" + ".xml", "xml", false, true, "");
  ...
  gammaAttenuationCoefficientDataPoint =
    dataPointFactory->create("Gamma attenuation coefficient test", 2);

  histogramFactory = aFact->createHistogramFactory(*theTree);
  histogramEnergyDeposit =
    histogramFactory->createHistogram1D("10", " Energy Deposit per event", 120, 0., 1.2);
}
...
void Tst50AnalysisManager::StoppingPower(G4int PointNumber, G4double primaryParticleEnergy,
                                         G4double SP)
{
...
void Tst50AnalysisManager::CSDARange(G4int PointNumber, G4double primaryParticleEnergy,
                                     G4double range)
{
...
void Tst50AnalysisManager::ParticleTransmission(G4int PointNumber, G4double primaryParticleEnergy,
                                                G4double TransFraction, G4double BackFraction,
                                                G4double TransError, G4double BackError)
{
...
void Tst50AnalysisManager::TransmittedEnergy(G4int PointNumber, G4double primaryParticleEnergy,
                                             G4double energy)
{
