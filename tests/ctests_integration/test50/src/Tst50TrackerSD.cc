...
Tst50TrackerSD::Tst50TrackerSD(G4String name) : G4VSensitiveDetector(name)
{
  G4String HCname;
...
{
  tst50Collection = new Tst50TrackerHitsCollection(SensitiveDetectorName, collectionName[0]);
}
