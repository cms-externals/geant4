...
foreach(_shell IN LISTS shells_list)
  ...
  if(NOT ${_shell} STREQUAL cmd)
    ...
    foreach(_ds ${GEANT4_EXPORTED_DATASETS})
      _g4tc_setenv_ifnotset_command(_dssetenvcmd ${_shell} ${${_ds}_ENVVAR} "$GEANT4_DATA_DIR/${${_ds}_PATH}")
      set(GEANT4_ENV_DATASETS "${GEANT4_ENV_DATASETS}${_dssetenvcmd}\n")
    endforeach()
   ...
   # - Set data paths
    ...
    foreach(_ds ${GEANT4_EXPORTED_DATASETS})
     ...
     _g4tc_setenv_ifnotset_command(_dssetenvcmd ${_shell} ${${_ds}_ENVVAR} "%GEANT4_DATA_DIR%\\${_native_path}")
     set(GEANT4_ENV_DATASETS "${GEANT4_ENV_DATASETS}${_dssetenvcmd}\n")
   endforeach()
