...
#
if(MSVC)
  # Require MSVC that supports standard flags
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.11.25505)
    message(FATAL_ERROR "Geant4 requires MSVC 19.11.25505 (Visual Studio 2017 update 3) or newer")
  else()
