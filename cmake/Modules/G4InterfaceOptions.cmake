...
if(GEANT4_USE_QT)
  ...
  if(Qt5Core_VERSION GREATER_EQUAL QT3D_MINIMUM_VERSION)
    ...
    find_package(Qt53DCore ${QT3D_MINIMUM_VERSION} REQUIRED)
    find_package(Qt53DExtras ${QT3D_MINIMUM_VERSION} REQUIRED)
    find_package(Qt53DRender ${QT3D_MINIMUM_VERSION} REQUIRED)
