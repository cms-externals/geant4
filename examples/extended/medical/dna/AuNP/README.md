...
file plot_physics.C. The plot_physics.C is for for study of physics only. 
...
- under your ROOT session, type in: .X plot_physics.C to execute the macro file
- alternatively you can type directly under your session: root plot_physics.C
