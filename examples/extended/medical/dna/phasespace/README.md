...
For each particle entering the sphere, it records :
- the PDG encoding of the particle
- the 3 PostStepPoint coordinates (in microns)
- the 3 PostStepPoint momentum cosine (no unit)
- the kinetic energy at PostStepPoint (in keV)
