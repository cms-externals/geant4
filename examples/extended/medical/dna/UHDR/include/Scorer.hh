...
struct Dose : public G4UImessenger
{
    ...
    G4double fDoseCutOffPerPulse = 0; //L.T.Anh: cutoff value for 1 pulse.
...
private:
  ...
  const G4MolecularConfiguration* fH3Op = G4MoleculeTable::Instance()->GetConfiguration("H3Op(B)");
  const G4MolecularConfiguration* fOHm = G4MoleculeTable::Instance()->GetConfiguration("OHm(B)");
  const G4MolecularConfiguration* fH2O = G4MoleculeTable::Instance()->GetConfiguration("H2O");
  const G4MolecularConfiguration* fO2 =   G4MoleculeTable::Instance()->GetConfiguration("O2");
