...
G4MoleculeReactionCounterScorer::G4MoleculeReactionCounterScorer(G4String name, G4String counterName, G4int depth)
  : G4VPrimitiveMoleculeScorer<G4MoleculeReactionCounter, G4MoleculeReactionCounterIndex, G4String>(
      name, counterName, depth)
{}

std::tuple<G4String>
G4MoleculeReactionCounterScorer::ConvertCounterIndexToKey(const G4MoleculeReactionCounterIndex& idx) const
{
  return std::make_tuple(idx.GetInfo());
}

void G4MoleculeReactionCounterScorer::WriteWithAnalysisManager() const
{
