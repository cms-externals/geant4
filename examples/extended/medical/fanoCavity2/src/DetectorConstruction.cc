...
{ 
  ...
  G4Material* vapor = nist->BuildMaterialWithNewDensity(
                      "Water_vapor","G4_WATER", 1.0*mg/cm3);

  nist->FindOrBuildMaterial("G4_AIR");
  nist->FindOrBuildMaterial("G4_Al");
  
  nist->BuildMaterialWithNewDensity("Graphite", "G4_GRAPHITE", 
                                    2.265*g/cm3);
  nist->BuildMaterialWithNewDensity("Graphite_gas", "G4_GRAPHITE", 
                                    2.265*mg/cm3);

  nist->BuildMaterialWithNewDensity("Aluminium_gas", "G4_Al", 2.7*mg/cm3);
  
  fWallMaterial = H2O;
  fCavityMaterial = vapor;
