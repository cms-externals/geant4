...
/// \brief Implementation of the volumeTreeVisitor::DetectorConstruction class
...
// To test / demonstrate Volume Tree Walker
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4cout << " DetectorConstruction::Construct() called. \n"
         << " Calling G4VolumeTreeReporter " << G4endl;
