...
G4ThreadLocal GFlashShowerModel* ExGflashDetectorConstruction::fFastShowerModel = nullptr;
G4ThreadLocal GFlashHomoShowerParameterisation* ExGflashDetectorConstruction::fParameterisation =
  nullptr;
G4ThreadLocal GFlashParticleBounds* ExGflashDetectorConstruction::fParticleBounds = nullptr;
