...
```
 ...
 the VAE model of this example. More details can be found in README in
 training_vae (\ref refPar04training_vae).

 For CaloDiT-2 training and adaptation to new detectors, refer README.md in
 training_calodit (\ref refPar04training_calodit).
