...
{   
  ...
  G4double Slit3x = fSlit3SampleDistance*sin(fthetaSetup);
  G4double Slit3z = fPhantomZ + fSlit3SampleDistance*cos(fthetaSetup);
  G4ThreeVector Slit3PositionVector = G4ThreeVector(Slit3x, 0., Slit3z); 
    
  G4double Slit4x = fSlit4SampleDistance*sin(fthetaSetup);
  G4double Slit4z = fPhantomZ + fSlit4SampleDistance*cos(fthetaSetup);
  ...
  G4double Detx = fDetectorSampleDistance*sin(fthetaSetup);
  G4double Detz = fPhantomZ + fDetectorSampleDistance*cos(fthetaSetup);
  ...
  G4double Shieldx = ShieldingSampleDistance*sin(fthetaSetup);
  G4double Shieldz = fPhantomZ +
    ShieldingSampleDistance*cos(fthetaSetup);
  ...
  G4double ShieldBackx = ShieldingBackSampleDistance*sin(fthetaSetup);
  G4double ShieldBackz = fPhantomZ +
    ShieldingBackSampleDistance*cos(fthetaSetup);
