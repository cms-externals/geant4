...
class Run : public G4Run
{
  public:
    ...
    void AddEnergyTransmitted(G4double etrans)
    {
      fEnergyTransmitted += etrans;
      fEnergyTransmitted2 += etrans * etrans;
    };

    void AddEnergyReflected(G4double erefl)
    {
      fEnergyReflected += erefl;
      fEnergyReflected2 += erefl * erefl;
    };
  ...
  private:
    ...
    G4double fEnergyTransmitted = 0., fEnergyTransmitted2 = 0.;
    G4double fEnergyReflected = 0., fEnergyReflected2 = 0.;
