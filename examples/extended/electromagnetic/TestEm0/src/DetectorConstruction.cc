...
void DetectorConstruction::DefineMaterials()
{
  ...
  G4Material* matXe0 =
  new G4Material("XenonGas0",density0, ncomponents=1,
                 kStateGas,temperature0, pressure0);
  ...
  G4Material* matXe1 =
  new G4Material("XenonGas1",density1, ncomponents=1,
                 kStateGas,temperature1, pressure1);
