...
class IRTDamageReactionModel : public G4VDNAHitModel
{
  public:
    ...
    IRTDamageReactionModel& operator=(const IRTDamageReactionModel& right) = delete;
    ...
    G4bool DoReaction(const G4Track& track, const G4double&, const DNANode&) override;

  private:
    G4double GetTimeToEncounter(const G4MolecularConfiguration* molA,
                                const G4MolecularConfiguration* molB, const G4double& distance);
