...
//                                  ACTUAL CONTRIBUTORS
//                                  ====================
//                G.A.P. Cirrone(a), L. Pandola(a), G. Petringa(a), F.Romano (a,g)
//
//
//                      ==========>   PAST CONTRIBUTORS  <==========
//
...
// Initialise the Visualisation
    ...
    { //interactive mode: define de UI session
#ifdef G4UI_USE
...
#endif
        // start the session here: make the Geant4 prompt  Idle> available here
