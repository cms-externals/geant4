...
void GRInitialization::SetWindowText(G4UIExecutive* ui)
{
  ...
  qt->SetStartPage(std::string("<table width='100%'><tr><td width='50%'></td><td><div ")+
       ...
       "<div style='background:#EEEEEE;'><b>Tooltips :</b><ul>"+
         "<li><b>Start a new run :</b><br />"+
         "/control/execute <i>macro_file</i><br />"+
         "/run/beamOn <i>number_of_events</i></li></ul></div>"+
       "<div style='background:#EEEEEE;'><b>Documentation :</b><ul>"+
         "<li><b>GORAD manual :</b><br />"+
         "<i><a href='http://www.worldscientific.com/doi/abs/10.1142/S1793962313400011'>URL to be added</a></i></li>"+
         "</ul></div>"+
       "<div style='background:#EEEEEE;'><b>Additional sample GDML file :</b><ul>"+
         "<li><b>Orion spacecraft shield :</b><br />"+
         "<i><a href='http://www.worldscientific.com/doi/abs/10.1142/S1793962313400011'>URL to be added</a></i></li>"+
         "</ul></div>"
       );
#endif
