...
G4PSPassageCellFluxForCylinder3D::G4PSPassageCellFluxForCylinder3D(const G4String& name, G4int ni,
...
G4PSPassageCellFluxForCylinder3D::G4PSPassageCellFluxForCylinder3D(const G4String& name,
...
void G4PSPassageCellFluxForCylinder3D::SetCylinderSize(G4ThreeVector cylSize, G4double StartAng,
                                                       G4double AngSpan)
{
