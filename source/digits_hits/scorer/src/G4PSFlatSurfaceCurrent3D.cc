...
G4PSFlatSurfaceCurrent3D::G4PSFlatSurfaceCurrent3D(const G4String& name, G4int direction, G4int ni,
                                                   G4int nj, G4int nk, G4int di, G4int dj, G4int dk)
  : G4PSFlatSurfaceCurrent(name, direction), fDepthi(di), fDepthj(dj), fDepthk(dk)
{
  SetNijk(ni, nj, nk);
}

G4PSFlatSurfaceCurrent3D::G4PSFlatSurfaceCurrent3D(const G4String& name, G4int direction,
