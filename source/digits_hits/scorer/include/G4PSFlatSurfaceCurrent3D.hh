...
#ifndef G4PSFLATSURFACECURRENT3D_HH
#define G4PSFLATSURFACECURRENT3D_HH
...
class G4PSFlatSurfaceCurrent3D : public G4PSFlatSurfaceCurrent
{
  public:
    ...
    G4PSFlatSurfaceCurrent3D(const G4String& name, G4int direction, G4int ni = 1, G4int nj = 1,
