...
G4GeneralParticleSourceMessenger::GetInstance(G4GeneralParticleSource* psc)
{
  ...
  if (theInstance == nullptr) theInstance = new G4GeneralParticleSourceMessenger(psc);
  return theInstance;
}
  ...
  : fGPS(fPtclGun)
{
  ...
  applyEnergyWeightCmd1->SetGuidance(
...
#define CHECKPG()                                                                              \
  {                                                                                            \
    ...
    {                                                                                          \
      ...
      G4Exception("G4GeneralParticleSourceMessenger::SetNewValue", "G4GPS003", FatalException, \
                  msg);                                                                        \
      return;                                                                                  \
    }                                                                                          \
  }
...
void G4GeneralParticleSourceMessenger::SetNewValue(G4UIcommand* command, G4String newValues)
{
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetPosDist()->SetPosRot1(posrot1Cmd->GetNew3VectorValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetPosDist()->SetPosRot2(posrot2Cmd->GetNew3VectorValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetPosDist()->SetRadius0(radius0Cmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetPosDist()->SetParAlpha(paralpCmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetPosDist()->SetParTheta(partheCmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetAngDist()->SetMinTheta(minthetaCmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetAngDist()->SetMaxTheta(maxthetaCmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //    {
  //      CHECKPG();
  //      fParticleGun->GetEneDist()->SetGradient(gradientCmd->GetNewDoubleValue(newValues)); G4cout
  //      << " G4GeneralParticleSourceMessenger - Warning:" << G4endl
  //             << " The command is obsolete and will be removed soon." << G4endl
  //             << " Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  //      G4cout << " G4GeneralParticleSourceMessenger - Warning: The command is obsolete and will
  //      be removed soon. Please try to use the new structured commands!" << G4endl;
  //    }
  ...
  if (command == directionCmd)
  {
    ...
    fParticleGun->GetAngDist()->SetParticleMomentumDirection(
  ...
  else if (command == applyEnergyWeightCmd1)
  {
    ...
    if (eDisType != "Lin")
    {
      ...
      ed << "Energy distribution is defined as " << eDisType
         << ". /gps/ene/applyEneWeight is available only for Linear distribution.";
      command->CommandFailed(ed);
      return;
    }
    fParticleGun->GetEneDist()->ApplyEnergyWeight(
      applyEnergyWeightCmd1->GetNewBoolValue(newValues));
  }
...
void G4GeneralParticleSourceMessenger::IonCommand(const G4String& newValues)
{
  if (fShootIon)
  {
    ...
    G4ParticleDefinition* ion =
      G4IonTable::GetIonTable()->GetIon(fAtomicNumber, fAtomicMass, fIonExciteEnergy);
    if (ion == nullptr)
    {
      G4ExceptionDescription ed;
...
void G4GeneralParticleSourceMessenger::IonLvlCommand(const G4String& newValues)
{
  if (fShootIon)
  {
    ...
    G4ParticleDefinition* ion =
      G4IonTable::GetIonTable()->GetIon(fAtomicNumberL, fAtomicMassL, fIonEnergyLevel);
    if (ion == nullptr)
    {
      G4ExceptionDescription ed;
