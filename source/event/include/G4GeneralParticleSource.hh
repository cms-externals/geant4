...
#define G4GENERALPARTICLESOURCE_HH
...
class G4GeneralParticleSource : public G4VPrimaryGenerator
{
  public:
    ...
    inline G4SingleParticleSource* GetCurrentSource() const { return GPSData->GetCurrentSource(); }
    // Return the pointer to current particle gun
    inline G4int GetCurrentSourceIndex() const { return GPSData->GetCurrentSourceIdx(); }
