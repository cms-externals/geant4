...
class G4StackManager
{
  public:
    ...
    void SetDefaultClassification(const G4ParticleDefinition*, G4ClassificationOfNewTrack,
                                  G4ExceptionSeverity es = G4ExceptionSeverity::IgnoreTheIssue);
    ...
    inline G4ClassificationOfNewTrack GetDefaultClassification() { return fDefaultClassification; }

  public:

    void ReleaseSubEvent(G4int ty);
    inline std::size_t GetNSubEventTypes() { return subEvtTypes.size(); }
    inline G4int GetSubEventType(std::size_t i) { return subEvtTypes[i]; }
  ...
  private:
    ...
    std::map<G4TrackStatus, std::pair<G4ClassificationOfNewTrack, G4ExceptionSeverity>>
      defClassTrackStatus;
