...
class G4Event
{
  public:
    ...
    inline void SetEventID(G4int i) { eventID = i; }
    inline void SetHCofThisEvent(G4HCofThisEvent* value) { HC = value; }
    inline void SetDCofThisEvent(G4DCofThisEvent* value) { DC = value; }
    inline void SetTrajectoryContainer(G4TrajectoryContainer* value)
    {
      trajectoryContainer = value;
    }
    inline void SetEventAborted() { eventAborted = true; }
    ...
    inline void KeepTheEvent(G4bool vl = true) const { keepTheEvent = vl; }
    inline G4bool KeepTheEventFlag() const { return keepTheEvent; }
    ...
    inline void KeepForPostProcessing() const { ++grips; }
    ...
    inline G4int GetNumberOfGrips() const { return grips; }
    ...
    inline G4HCofThisEvent* GetHCofThisEvent() const { return HC; }
    inline G4DCofThisEvent* GetDCofThisEvent() const { return DC; }
    inline G4TrajectoryContainer* GetTrajectoryContainer() const { return trajectoryContainer; }
    ...
    inline const G4String& GetRandomNumberStatus() const
    {
      ...
      {
        G4Exception("G4Event::GetRandomNumberStatus", "Event0701", JustWarning,
    ...
    inline const G4String& GetRandomNumberStatusForProcessing() const
    {
      ...
      {
        G4Exception("G4Event::GetRandomNumberStatusForProcessing", "Event0702", JustWarning,
                    "Random number status is not available for this event.");
      }
  ...
  public:
    ...
    inline G4int GetNumberOfCompletedSubEvent() const { return (G4int)fSubEventGarbageBin.size(); }
  ...
  private:
    ...
    //   - TODO (PHASE-II): we may need to consider better way to delete sub-events stored in this
    //   garbase bin
  ...
  public:
    ...
    inline G4Event* GetMotherEvent() const { return motherEvent; }
    inline G4int GetSubEventType() const { return subEventType; }
    inline const G4SubEvent* GetSubEvent() const { return fSubEvent; }
