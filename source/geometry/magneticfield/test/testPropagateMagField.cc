...
G4RotationMatrix       rotM( 0.1, 0.2, 0.05 );  // RotationMatrix( double phi, double theta, double psi );
...
G4FieldManager* SetupFieldManager(G4int stepperType)
{
    ...
    switch ( stepperType ) 
    {
      ...
      case 100:         
      case 101:  pDriver = new G4BFieldIntegrationDriver<G4RK547FEq1>(
                                stepMinimum, new G4RK547FEq1(fEquation));
         break;
      case 102:  pDriver = new G4BFieldIntegrationDriver<G4RK547FEq2>(
                                  stepMinimum, new G4RK547FEq2(fEquation)); break;
      case 103:  pDriver = new G4BFieldIntegrationDriver<G4RK547FEq3>(
                                  stepMinimum, new G4RK547FEq3(fEquation)); break;
      case 105:  pDriver = new G4BFieldIntegrationDriver<G4DormandPrince745>(
                                  stepMinimum, new G4DormandPrince745(fEquation)); break;
      case 106:  pDriver = new G4BFieldIntegrationDriver<G4DormandPrinceRK56>(
                                  stepMinimum, new G4DormandPrinceRK56(fEquation)); break;         
