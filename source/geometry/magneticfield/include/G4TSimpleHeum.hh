...
class G4TSimpleHeum : public G4TMagErrorStepper<G4TSimpleHeum<T_Equation, N>, T_Equation, N>
{
  public:
...
template<class T_Equation, unsigned int N>
G4TSimpleHeum<T_Equation, N>::G4TSimpleHeum(T_Equation* EqRhs, unsigned int numberOfVariables)
  : G4TMagErrorStepper<G4TSimpleHeum<T_Equation, N>, T_Equation, N>(EqRhs, numberOfVariables),
    ...
    fEquation_Rhs(EqRhs)
{
  ...
  {
    G4Exception("G4TSimpleHeum: constructor", "GeomField0001", FatalException,
                "Equation is not an G4EquationOfMotion.");
  }
}

template<class T_Equation, unsigned int N>
inline void G4TSimpleHeum<T_Equation, N>::DumbStepper(const G4double yIn[], const G4double dydx[],
