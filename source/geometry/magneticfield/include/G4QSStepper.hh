...
class G4QSStepper : public G4MagIntegratorStepper
{
  public:
    ...
    G4QSStepper( G4EquationOfMotion* equation,
                 ...
                 G4int qssOrder= -1 ); 
    // qssOrder:  2 or 3 expected ;  if <= 0 , use value from Messenger
    ...
    G4StepperType StepperType() const override { return kQSStepper; }
    ...
    inline void setRestMass(G4double restMass); 
      // Sets the restMass -- checking / ensuring that it is positive
