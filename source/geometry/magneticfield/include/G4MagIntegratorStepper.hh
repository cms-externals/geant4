...
class G4MagIntegratorStepper
{
  public:
     ...
     *             type driver.
     */
    G4MagIntegratorStepper(G4EquationOfMotion* Equation, G4int numIntegrationVariables,
                           G4int numStateVariables = 12, G4bool isFSAL = false);
     ...
     */
    inline void RightHandSide(const G4double y[], G4double dydx[], G4double field[]) const;
