...
//
//
// $Id: G4FSALIntegrationDriver.hh 111078 2018-07-11 08:09:14Z gcosmo $
//
//
...
private:
     ...
     G4double fSafety;
     G4double fPowShrink;   //  exponent for shrinking
     G4double fPowGrow;    //  exponent for growth

     // muximum error values for shrinking / growing (optimisation).
     G4double fErrorConstraintShrink;
     G4double fErrorConstraintGrow;
