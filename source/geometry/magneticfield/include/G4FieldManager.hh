...
class G4FieldManager
{
  ...
  private:
    ...
    //
    G4double fDelta_One_Step_Value = G4FieldDefaults::kDeltaOneStep; //  for one tracking/physics step
    G4double fDelta_Intersection_Val  = G4FieldDefaults::kDeltaIntersection; //  for boundary intersection
