...
// ---------------------------------------------------------------------------
G4HelixMixedStepper::G4HelixMixedStepper(G4Mag_EqRhs* EqRhs, G4int stepperNumber,
...
// ---------------------------------------------------------------------------
void G4HelixMixedStepper::DumbStepper(const G4double yIn[], G4ThreeVector Bfld, G4double h,
                                      G4double yOut[])
{
...
G4MagIntegratorStepper* G4HelixMixedStepper::SetupStepper(G4Mag_EqRhs* pE, G4int StepperNumber)
{
  ...
  switch (StepperNumber)
  {
    ...
    default:
      ...
      if (fVerbose > 0)
      {
        G4cout << "G4DormandPrince745 (Default)";
      }
      break;
  }
  ...
  if (fVerbose > 0)
  {
    G4cout << " chosen as stepper for small steps in G4HelixMixedStepper." << G4endl;
  }
