...
// Constructor
//
G4DoLoMcPriRK34::G4DoLoMcPriRK34(G4EquationOfMotion* EqRhs, G4int noIntegrationVariables,
                                 G4bool primary)
...
//
void G4DoLoMcPriRK34::Stepper(const G4double yInput[], const G4double DyDx[], G4double Step,
                              G4double yOut[], G4double yErr[])
{
  ...
  //
  const G4double b21 = 7.0 / 27.0, b31 = 7.0 / 72.0, b32 = 7.0 / 24.0,

                 b41 = 3043.0 / 3528.0, b42 = -3757.0 / 1176.0, b43 = 1445.0 / 441.0,

                 b51 = 17617.0 / 11662.0, b52 = -4023.0 / 686.0, b53 = 9372.0 / 1715.0,
                 b54 = -66.0 / 595.0,

                 b61 = 29.0 / 238.0, b62 = 0.0, b63 = 216.0 / 385.0, b64 = 54.0 / 85.0,
                 b65 = -7.0 / 22.0,

                 dc1 = 363.0 / 2975.0 - b61, dc2 = 0.0 - b62, dc3 = 981.0 / 1750.0 - b63,
                 dc4 = 2709.0 / 4250.0 - b64, dc5 = -3.0 / 10.0 - b65,
  ...
  for (i = 0; i < numberOfVariables; ++i)
  {
    yErr[i] =
      Step
      * (dc1 * DyDx[i] + dc2 * ak2[i] + dc3 * ak3[i] + dc4 * ak4[i] + dc5 * ak5[i] + dc6 * ak6[i]);
...
void G4DoLoMcPriRK34::Interpolate(G4double tau, G4double yOut[])
{
...
//
void G4DoLoMcPriRK34::Interpolate(const G4double yInput[], const G4double dydx[],
