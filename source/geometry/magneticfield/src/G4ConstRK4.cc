  ...
  : G4MagErrorStepper(EqRhs, 6, numStateVariables)
{
  ...
  if (numStateVariables < 8)
  {
    ...
    G4Exception("G4ConstRK4::G4ConstRK4()", "GeomField0002", FatalException, message,
                "Use another Stepper!");
  }
...
// NRC p. 712-713 .
//
void G4ConstRK4::DumbStepper(const G4double yIn[], const G4double dydx[], G4double h,
                             G4double yOut[])
{
...
void G4ConstRK4::Stepper(const G4double yInput[], const G4double dydx[], G4double hstep,
