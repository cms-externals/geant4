...
// Constructor
//
G4DormandPrinceRK56::G4DormandPrinceRK56(G4EquationOfMotion* EqRhs, G4int noIntegrationVariables,
                                         G4bool primary)
...
//
void G4DormandPrinceRK56::Stepper(const G4double yInput[], const G4double dydx[], G4double Step,
...
//   endpoint DyDx ( for future FSAL version )
{
  ...
  //
  const G4double b21 = 1.0 / 10.0, b31 = -2.0 / 81.0, b32 = 20.0 / 81.0,

                 b41 = 615.0 / 1372.0, b42 = -270.0 / 343.0, b43 = 1053.0 / 1372.0,

                 b51 = 3243.0 / 5500.0, b52 = -54.0 / 55.0, b53 = 50949.0 / 71500.0,
                 b54 = 4998.0 / 17875.0,

                 b61 = -26492.0 / 37125.0, b62 = 72.0 / 55.0, b63 = 2808.0 / 23375.0,
                 b64 = -24206.0 / 37125.0, b65 = 338.0 / 459.0,

                 b71 = 5561.0 / 2376.0, b72 = -35.0 / 11.0, b73 = -24117.0 / 31603.0,
                 b74 = 899983.0 / 200772.0, b75 = -5225.0 / 1836.0, b76 = 3925.0 / 4056.0,

                 b81 = 465467.0 / 266112.0, b82 = -2945.0 / 1232.0, b83 = -5610201.0 / 14158144.0,
                 b84 = 10513573.0 / 3212352.0, b85 = -424325.0 / 205632.0,
                 b86 = 376225.0 / 454272.0, b87 = 0.0,

                 c1 = 61.0 / 864.0, c2 = 0.0, c3 = 98415.0 / 321776.0, c4 = 16807.0 / 146016.0,
                 c5 = 1375.0 / 7344.0, c6 = 1375.0 / 5408.0, c7 = -37.0 / 1120.0, c8 = 1.0 / 10.0,

                 b91 = 61.0 / 864.0, b92 = 0.0, b93 = 98415.0 / 321776.0, b94 = 16807.0 / 146016.0,
                 b95 = 1375.0 / 7344.0, b96 = 1375.0 / 5408.0, b97 = -37.0 / 1120.0,
                 b98 = 1.0 / 10.0,

                 dc1 = c1 - 821.0 / 10800.0, dc2 = c2 - 0.0, dc3 = c3 - 19683.0 / 71825,
                 dc4 = c4 - 175273.0 / 912600.0, dc5 = c5 - 395.0 / 3672.0,
                 dc6 = c6 - 785.0 / 2704.0, dc7 = c7 - 3.0 / 50.0, dc8 = c8 - 0.0, dc9 = 0.0;
  ...
  for (i = 0; i < numberOfVariables; ++i)
  {
    yOut[i] = yIn[i]
              + Step
                  * (b91 * dydx[i] + b92 * ak2[i] + b93 * ak3[i] + b94 * ak4[i] + b95 * ak5[i]
  ...
  for (i = 0; i < numberOfVariables; ++i)
  {
    ...
    yErr[i] = Step
              * (dc1 * dydx[i] + dc2 * ak2[i] + dc3 * ak3[i] + dc4 * ak4[i] + dc5 * ak5[i]
                 + dc6 * ak6[i] + dc7 * ak7[i] + dc8 * ak8[i] + dc9 * ak9[i]);
...
//
void G4DormandPrinceRK56::SetupInterpolate_low(const G4double yInput[], const G4double dydx[],
                                               const G4double Step)
{
  const G4int numberOfVariables = this->GetNumberOfVariables();

  G4double b_101 = 33797.0 / 460800.0, b_102 = 0., b_103 = 0., b_104 = 27757.0 / 70785.0,
           b_105 = 7923501.0 / 26329600.0, b_106 = -927.0 / 3760.0,
           b_107 = -3314760575.0 / 23165835264.0, b_108 = 2479.0 / 23040.0, b_109 = 1.0 / 64.0;
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] =
      yIn[i]
      + Step
          * (b_101 * dydx[i] + b_102 * ak2[i] + b_103 * ak3[i] + b_104 * ak4[i] + b_105 * ak5[i]
             + b_106 * ak6[i] + b_107 * ak7[i] + b_108 * ak8[i] + b_109 * ak9[i]);
  }
  RightHandSide(yTemp, ak10_low);  // 10th Stage
}

void G4DormandPrinceRK56::Interpolate_low(const G4double yInput[], const G4double dydx[],
                                          const G4double Step, G4double yOut[], G4double tau)
{
  ...
  // bf2 = bf3 = 0.0
  bf1 =
    (66480.0 * tau_4 - 206243.0 * tau_3 + 237786.0 * tau_2 - 124793.0 * tau + 28800.0) / 28800.0;
  ...
  bf7 =
    -5764801.0 * tau * (16464.0 * tau_3 - 32797.0 * tau_2 + 17574.0 * tau - 1927.0) / 7239323520.0;
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yOut[i] = yIn[i]
              + Step * tau
                  * (bf1 * dydx[i] + bf4 * ak4[i] + bf5 * ak5[i] + bf6 * ak6[i] + bf7 * ak7[i]
                     + bf8 * ak8[i] + bf9 * ak9[i] + bf10 * ak10_low[i]);
  }
}
...
//
void G4DormandPrinceRK56::SetupInterpolate_high(const G4double yInput[], const G4double dydx[],
                                                const G4double Step)
{
  // Coefficients for the additional stages
  //
  G4double b101 = 33797.0 / 460800.0, b102 = 0.0, b103 = 0.0, b104 = 27757.0 / 70785.0,
           b105 = 7923501.0 / 26329600.0, b106 = -927.0 / 3760.0,
           b107 = -3314760575.0 / 23165835264.0, b108 = 2479.0 / 23040.0, b109 = 1.0 / 64.0,

           b111 = 5843.0 / 76800.0, b112 = 0.0, b113 = 0.0, b114 = 464.0 / 2673.0,
           b115 = 353997.0 / 1196800.0, b116 = -15068.0 / 57105.0,
           b117 = -282475249.0 / 3644974080.0, b118 = 8678831.0 / 156245760.0,
           b119 = 116113.0 / 11718432.0, b1110 = -25.0 / 243.0,

           b121 = 15088049.0 / 199065600.0, b122 = 0.0, b123 = 0.0, b124 = 2.0 / 5.0,
           b125 = 92222037.0 / 268083200.0, b126 = -433420501.0 / 1528586640.0,
           b127 = -11549242677007.0 / 83630285291520.0, b128 = 2725085557.0 / 26167173120.0,
           b129 = 235429367.0 / 16354483200.0, b1210 = -90924917.0 / 1040739840.0,
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] = yIn[i]
               + Step
                   * (b101 * dydx[i] + b102 * ak2[i] + b103 * ak3[i] + b104 * ak4[i] + b105 * ak5[i]
                      + b106 * ak6[i] + b107 * ak7[i] + b108 * ak8[i] + b109 * ak9[i]);
  }
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] =
      yIn[i]
      + Step
          * (b111 * dydx[i] + b112 * ak2[i] + b113 * ak3[i] + b114 * ak4[i] + b115 * ak5[i]
             + b116 * ak6[i] + b117 * ak7[i] + b118 * ak8[i] + b119 * ak9[i] + b1110 * ak10[i]);
  }
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] = yIn[i]
               + Step
                   * (b121 * dydx[i] + b122 * ak2[i] + b123 * ak3[i] + b124 * ak4[i] + b125 * ak5[i]
                      + b126 * ak6[i] + b127 * ak7[i] + b128 * ak8[i] + b129 * ak9[i]
...
//
void G4DormandPrinceRK56::Interpolate_high(const G4double yInput[], const G4double dydx[],
                                           const G4double Step, G4double yOut[], G4double tau)
{
  ...
  bi[1][0] = 1.0, bi[1][1] = -18487.0 / 2880.0, bi[1][2] = 139189.0 / 7200.0,
  bi[1][3] = -53923.0 / 1800.0, bi[1][4] = 13811.0 / 600, bi[1][5] = -2071.0 / 300,
  //  --------------------------------------------------------
  //
  ...
  //  COEFFICIENTS OF  bi[4]
    bi[4][0] = 0.0, bi[4][1] = -30208.0 / 14157.0, bi[4][2] = 1147904.0 / 70785.0,
  bi[4][3] = -241664.0 / 5445.0, bi[4][4] = 241664.0 / 4719.0, bi[4][5] = -483328.0 / 23595.0,
  //  --------------------------------------------------------
  //
  //  COEFFICIENTS OF  bi[5]
    bi[5][0] = 0.0, bi[5][1] = -177147.0 / 32912.0, bi[5][2] = 3365793.0 / 82280.0,
  bi[5][3] = -2302911.0 / 20570.0, bi[5][4] = 531441.0 / 4114.0, bi[5][5] = -531441.0 / 10285.0,
  //  --------------------------------------------------------
  //
  //  COEFFICIENTS OF  bi[6]
    bi[6][0] = 0.0, bi[6][1] = 536.0 / 141.0, bi[6][2] = -20368.0 / 705.0,
  bi[6][3] = 55744.0 / 705.0, bi[6][4] = -4288.0 / 47.0, bi[6][5] = 8576.0 / 235,
  //  --------------------------------------------------------
  //
  //  COEFFICIENTS OF  bi[7]
    bi[7][0] = 0.0, bi[7][1] = -1977326743.0 / 723932352.0, bi[7][2] = 37569208117.0 / 1809830880.0,
  bi[7][3] = -1977326743.0 / 34804440.0, bi[7][4] = 1977326743.0 / 30163848.0,
  ...
  //  COEFFICIENTS OF  bi[12]
    bi[12][0] = 0.0, bi[12][1] = -576.0 / 35.0, bi[12][2] = 19584.0 / 175.0,
  bi[12][3] = -6336.0 / 25.0, bi[12][4] = 41472.0 / 175.0, bi[12][5] = -13824.0 / 175.0;
  //  --------------------------------------------------------
