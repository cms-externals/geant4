                                     ...
                                     G4double B[]) const  // [3]
{
  ...
  G4double Br;
  G4double P[8], Q[8];
  static G4ThreadLocal G4double c[8] = {-9.26e-5, -3.51e-5, 2.94e-6,   -1.10e-6,
  ...
  P[4] = 10 * rz
         * (r8 - 40.0 * r6 * z2 / 3.0 + 32 * r4 * z4 - 128.0 * r2 * z6 / 7.0 + 128.0 * z8 / 63.0);
  P[5] = 0;
  P[6] = 0;
  P[7] = 0;
  ...
  Q[4] = r10 - 50 * r8 * z2 + 800.0 * r6 * z4 / 3.0 - 320 * r4 * z6 + 640.0 * r2 * z8 / 7.0
         - 256.0 * z10 / 63.0;
  Q[5] = 0;
  Q[6] = 0;
  Q[7] = 0;
