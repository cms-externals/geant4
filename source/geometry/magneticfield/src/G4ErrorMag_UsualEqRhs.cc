...
G4ErrorMag_UsualEqRhs::G4ErrorMag_UsualEqRhs(G4MagneticField* MagField) : G4Mag_UsualEqRhs(MagField)
{}

//---------------------------------------------------------------------

void G4ErrorMag_UsualEqRhs::EvaluateRhsGivenB(const G4double y[], const G4double B[3],
                                              G4double dydx[]) const
{
