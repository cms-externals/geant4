...
void G4EqEMFieldWithEDM::SetChargeMomentumMass(G4ChargeState particleCharge, G4double MomentumXc,
...
void G4EqEMFieldWithEDM::EvaluateRhsGivenB(const G4double y[], const G4double Field[],
                                           G4double dydx[]) const
{
  // Components of y:
  //    0-2 dr/ds,
