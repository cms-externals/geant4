...
void G4MagHelicalStepper::AdvanceHelix(const G4double yIn[], const G4ThreeVector& Bfld, G4double h,
...
//
void G4MagHelicalStepper::Stepper(const G4double yInput[], const G4double*, G4double hstep,
