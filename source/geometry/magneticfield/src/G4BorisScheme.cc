  ...
  : fEquation(equation), fnvar(nvar)
{
  if (nvar <= 0)
  {
    G4Exception("G4BorisScheme::G4BorisScheme()", "GeomField0002", FatalException,
...
void G4BorisScheme::UpdatePosition(const G4double restMass, const G4double /*crg*/,
...
void G4BorisScheme::UpdateVelocity(const G4double restMass, const G4double charge,
                                   const G4double yIn[], G4double yOut[], G4double hstep) const
{
  // Particle information
...
// ----------------------------------------------------------------------------------
void G4BorisScheme::StepWithErrorEstimate(const G4double yIn[], G4double restMass, G4double charge,
...
void G4BorisScheme::StepWithMidAndErrorEstimate(const G4double yIn[], G4double restMass,
