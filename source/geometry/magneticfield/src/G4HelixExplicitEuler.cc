...
G4HelixExplicitEuler::G4HelixExplicitEuler(G4Mag_EqRhs* EqRhs) : G4MagHelicalStepper(EqRhs) {}

void G4HelixExplicitEuler::Stepper(const G4double yInput[],  // [7]
                                   const G4double*, G4double Step,
                                   G4double yOut[],  // [7]
                                   G4double yErr[])
{
...
void G4HelixExplicitEuler::DumbStepper(const G4double yIn[], G4ThreeVector Bfld, G4double h,
                                       G4double yOut[])
{
