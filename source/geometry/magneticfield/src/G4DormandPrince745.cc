...
G4DormandPrince745::G4DormandPrince745(G4EquationOfMotion* equation, G4int noIntegrationVariables)
  : G4MagIntegratorStepper(equation, noIntegrationVariables)
{}

void G4DormandPrince745::Stepper(const G4double yInput[], const G4double dydx[], G4double hstep,
                                 ...
                                 G4double yOut[], G4double yErr[])
{
  ...
  //
  const G4double b21 = 0.2, b31 = 3.0 / 40.0, b32 = 9.0 / 40.0, b41 = 44.0 / 45.0,
...
//
void G4DormandPrince745::Interpolate5thOrder(G4double yOut[], G4double tau) const
{
