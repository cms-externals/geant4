...
//   1  |    587/8064         0      4440339/15491840   24353/124800     387/44800    2152/5985
//   7267/94080
//-------------------------------------------------------------------------------------------------------------------
//           587/8064         0      4440339/15491840   24353/124800     387/44800    2152/5985
//           7267/94080       0
//          2479/34992        0          123/416       612941/3411720    43/1440      2272/6561
...
// Constructor
//
G4BogackiShampine45::G4BogackiShampine45(G4EquationOfMotion* EqRhs, G4int noIntegrationVariables,
                                         G4bool primary)
  : G4MagIntegratorStepper(EqRhs, noIntegrationVariables)
{
  ...
  const G4int numStateVars = std::max(noIntegrationVariables, GetNumberOfStateVariables());
...
//
void G4BogackiShampine45::Stepper(const G4double yInput[], const G4double DyDx[], G4double Step,
                                  G4double yOut[], G4double yErr[])
{
  ...
  //
  const G4double b21 = 1.0 / 6.0, b31 = 2.0 / 27.0, b32 = 4.0 / 27.0,

                 b41 = 183.0 / 1372.0, b42 = -162.0 / 343.0, b43 = 1053.0 / 1372.0,

                 b51 = 68.0 / 297.0, b52 = -4.0 / 11.0, b53 = 42.0 / 143.0, b54 = 1960.0 / 3861.0,

                 b61 = 597.0 / 22528.0, b62 = 81.0 / 352.0, b63 = 63099.0 / 585728.0,
                 b64 = 58653.0 / 366080.0, b65 = 4617.0 / 20480.0,

                 b71 = 174197.0 / 959244.0, b72 = -30942.0 / 79937.0, b73 = 8152137.0 / 19744439.0,
                 b74 = 666106.0 / 1039181.0, b75 = -29421.0 / 29068.0, b76 = 482048.0 / 414219.0,

                 b81 = 587.0 / 8064.0, b82 = 0.0, b83 = 4440339.0 / 15491840.0,
                 b84 = 24353.0 / 124800.0, b85 = 387.0 / 44800.0, b86 = 2152.0 / 5985.0,
                 b87 = 7267.0 / 94080.0;
  ...
  // difference)
  //
  const G4double dc1 = b81 - 2479.0 / 34992.0, dc2 = 0.0, dc3 = b83 - 123.0 / 416.0,
                 dc4 = b84 - 612941.0 / 3411720.0, dc5 = b85 - 43.0 / 1440.0,
                 dc6 = b86 - 2272.0 / 6561.0, dc7 = b87 - 79937.0 / 1113912.0,
                 dc8 = -3293.0 / 556956.0;
  ...
  for (i = 0; i < numberOfVariables; ++i)
  {
    yOut[i] = yIn[i]
              + Step
                  * (b81 * DyDx[i] + b82 * ak2[i] + b83 * ak3[i] + b84 * ak4[i] + b85 * ak5[i]
                     + b86 * ak6[i] + b87 * ak7[i]);
  }
...
void G4BogackiShampine45::SetupInterpolationHigh()
{
  ...
  //
  const G4double a91 = 455.0 / 6144.0, a92 = 0.0, a93 = 10256301.0 / 35409920.0,
                 a94 = 2307361.0 / 17971200.0, a95 = -387.0 / 102400.0, a96 = 73.0 / 5130.0,
                 a97 = -7267.0 / 215040.0, a98 = 1.0 / 32.0,

                 a101 = -837888343715.0 / 13176988637184.0, a102 = 30409415.0 / 52955362.0,
                 a103 = -48321525963.0 / 759168069632.0, a104 = 8530738453321.0 / 197654829557760.0,
                 a105 = 1361640523001.0 / 1626788720640.0, a106 = -13143060689.0 / 38604458898.0,
                 a107 = 18700221969.0 / 379584034816.0, a108 = -5831595.0 / 847285792.0,
                 a109 = -5183640.0 / 26477681.0,

                 a111 = 98719073263.0 / 1551965184000.0, a112 = 1307.0 / 123552.0,
                 a113 = 4632066559387.0 / 70181753241600.0,
                 a114 = 7828594302389.0 / 382182512025600.0, a115 = 40763687.0 / 11070259200.0,
                 a116 = 34872732407.0 / 224610586200.0, a117 = -2561897.0 / 30105600.0,
                 a118 = 1.0 / 10.0, a119 = -1.0 / 10.0, a1110 = -1403317093.0 / 11371610250.0;
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] = yIn[i]
               + Step
                   * (a91 * dydx[i] + a92 * ak2[i] + a93 * ak3[i] + a94 * ak4[i] + a95 * ak5[i]
                      + a96 * ak6[i] + a97 * ak7[i] + a98 * ak8[i]);
  }
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] = yIn[i]
               + Step
                   * (a101 * dydx[i] + a102 * ak2[i] + a103 * ak3[i] + a104 * ak4[i] + a105 * ak5[i]
                      + a106 * ak6[i] + a107 * ak7[i] + a108 * ak8[i] + a109 * ak9[i]);
  }
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yTemp[i] =
      yIn[i]
      + Step
          * (a111 * dydx[i] + a112 * ak2[i] + a113 * ak3[i] + a114 * ak4[i] + a115 * ak5[i]
             + a116 * ak6[i] + a117 * ak7[i] + a118 * ak8[i] + a119 * ak9[i] + a1110 * ak10[i]);
  }
  ...
  for (G4int l = 0; l < nwant; ++l)
  {
    ...
    p[5][l] =
      bi[5][6] * ak5[l]
      + ((bi[10][6] * ak10[l] + bi[8][6] * ak8[l]) + (bi[7][6] * ak7[l] + bi[6][6] * ak6[l]))
      + ((bi[4][6] * ak4[l] + bi[9][6] * ak9[l]) + (bi[3][6] * ak3[l] + bi[11][6] * ak11[l])
         + bi[1][6] * dydx[l]);
    //  Coefficient of tau^5
    p[4][l] = (bi[10][5] * ak10[l] + bi[9][5] * ak9[l])
              + ((bi[7][5] * ak7[l] + bi[6][5] * ak6[l]) + bi[5][5] * ak5[l])
              + ((bi[4][5] * ak4[l] + bi[8][5] * ak8[l]) + (bi[3][5] * ak3[l] + bi[11][5] * ak11[l])
                 + bi[1][5] * dydx[l]);
    //  Coefficient of tau^4
    p[3][l] = ((bi[4][4] * ak4[l] + bi[8][4] * ak8[l]) + (bi[7][4] * ak7[l] + bi[6][4] * ak6[l])
               + bi[5][4] * ak5[l])
              + ((bi[10][4] * ak10[l] + bi[9][4] * ak9[l])
                 + (bi[3][4] * ak3[l] + bi[11][4] * ak11[l]) + bi[1][4] * dydx[l]);
    //  Coefficient of tau^3
    p[2][l] = bi[5][3] * ak5[l] + bi[6][3] * ak6[l]
              + ((bi[3][3] * ak3[l] + bi[9][3] * ak9[l]) + (bi[10][3] * ak10[l] + bi[8][3] * ak8[l])
                 + bi[1][3] * dydx[l])
              + ((bi[4][3] * ak4[l] + bi[11][3] * ak11[l]) + bi[7][3] * ak7[l]);
    //  Coefficient of tau^2
    p[1][l] = bi[5][2] * ak5[l] + ((bi[6][2] * ak6[l] + bi[8][2] * ak8[l]) + bi[1][2] * dydx[l])
              + ((bi[3][2] * ak3[l] + bi[9][2] * ak9[l]) + bi[10][2] * ak10[l])
              + ((bi[4][2] * ak4[l] + bi[11][2] * ak2[l]) + bi[7][2] * ak7[l]);
  }
...
void G4BogackiShampine45::PrepareConstants()
{
  ...
  bi[1][6] = -12134338393.0 / 1050809760.0, bi[1][5] = -1620741229.0 / 50038560.0,
  bi[1][4] = -2048058893.0 / 59875200.0, bi[1][3] = -87098480009.0 / 5254048800.0,
  bi[1][2] = -11513270273.0 / 3502699200.0,
  //
    bi[3][6] = -33197340367.0 / 1218433216.0, bi[3][5] = -539868024987.0 / 6092166080.0,
  bi[3][4] = -39991188681.0 / 374902528.0, bi[3][3] = -69509738227.0 / 1218433216.0,
  bi[3][2] = -29327744613.0 / 2436866432.0,
  //
    bi[4][6] = -284800997201.0 / 19905339168.0, bi[4][5] = -7896875450471.0 / 165877826400.0,
  bi[4][4] = -333945812879.0 / 5671036800.0, bi[4][3] = -16209923456237.0 / 497633479200.0,
  bi[4][2] = -2382590741699.0 / 331755652800.0,
  //
    bi[5][6] = -540919.0 / 741312.0, bi[5][5] = -103626067.0 / 43243200.0,
  bi[5][4] = -633779.0 / 211200.0, bi[5][3] = -32406787.0 / 18532800.0,
  bi[5][2] = -36591193.0 / 86486400.0,
  //
    bi[6][6] = 7157998304.0 / 374350977.0, bi[6][5] = 30405842464.0 / 623918295.0,
  bi[6][4] = 183022264.0 / 5332635.0, bi[6][3] = -3357024032.0 / 1871754885.0,
  bi[6][2] = -611586736.0 / 89131185.0,
  //
    bi[7][6] = -138073.0 / 9408.0, bi[7][5] = -719433.0 / 15680.0, bi[7][4] = -1620541.0 / 31360.0,
  bi[7][3] = -385151.0 / 15680.0, bi[7][2] = -65403.0 / 15680.0,
  //
    bi[8][6] = 1245.0 / 64.0, bi[8][5] = 3991.0 / 64.0, bi[8][4] = 4715.0 / 64.0,
  bi[8][3] = 2501.0 / 64.0, bi[8][2] = 149.0 / 16.0, bi[8][1] = 1.0,
  //
    bi[9][6] = 55.0 / 3.0, bi[9][5] = 71.0, bi[9][4] = 103.0, bi[9][3] = 199.0 / 3.0,
  bi[9][2] = 16.0,
  //
    bi[10][6] = -1774004627.0 / 75810735.0, bi[10][5] = -1774004627.0 / 25270245.0,
  bi[10][4] = -26477681.0 / 359975.0, bi[10][3] = -11411880511.0 / 379053675.0,
  bi[10][2] = -423642896.0 / 126351225.0,
  //
    bi[11][6] = 35.0, bi[11][5] = 105.0, bi[11][4] = 117.0, bi[11][3] = 59.0, bi[11][2] = 12.0;
...
void G4BogackiShampine45::InterpolateHigh(G4double tau, G4double* yOut) const
{
  ...
  G4Exception("G4BogackiShampine45::InterpolateHigh()", "GeomField0001", FatalException,
  ...
  for (G4int i = 0; i < numberOfVariables; ++i)
  {
    yOut[i] = yIn[i]
              + Step
                  * (b[1] * dydx[i] + b[2] * ak2[i] + b[3] * ak3[i] + b[4] * ak4[i] + b[5] * ak5[i]
