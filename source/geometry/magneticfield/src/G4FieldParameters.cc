...
G4String G4FieldParameters::EquationTypeName(G4EquationType equation)
{
  ...
  switch (equation) {
    ...
    case kEqGravity:
      return G4String("EqGravity");
    case kEqMonopole:
      return G4String("EqMonopole");
    case kEqReplate:
      return G4String("EqReplate");
    case kUserEquation:
...
G4String G4FieldParameters::StepperTypeName(G4StepperType stepper)
{
  ...
  switch (stepper) {
    ...
    case kTCashKarpRKF45:
      return G4String("TCashKarpRKF45");
    case kTDormandPrince45:
      return G4String("TDormandPrince45");
    case kTMagErrorStepper:
      return G4String("TMagErrorStepper");
    case kQSStepper:
      return G4String("QSStepper");
  }
