...
// Constructor
//
G4CashKarpRKF45::G4CashKarpRKF45(G4EquationOfMotion* EqRhs, G4int noIntegrationVariables,
                                 G4bool primary)
...
//
void G4CashKarpRKF45::Stepper(const G4double yInput[], const G4double dydx[], G4double Step,
