...
G4Mag_SpinEqRhs::G4Mag_SpinEqRhs(G4MagneticField* MagField) : G4Mag_EqRhs(MagField) {}

void G4Mag_SpinEqRhs::SetChargeMomentumMass(G4ChargeState particleCharge, G4double MomentumXc,
...
void G4Mag_SpinEqRhs::EvaluateRhsGivenB(const G4double y[], const G4double B[3],
                                        G4double dydx[]) const
{
