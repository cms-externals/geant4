...
//       7267/94080     0 2479/34992    0            123/416          612941/3411720  43/1440
  ...
  : G4VFSALIntegrationStepper(EqRhs, noIntegrationVariables)
{
  ...
  if (primary)
  {
    fAuxStepper = new G4FSALBogackiShampine45(EqRhs, numberOfVariables, !primary);
  }
...
//
void G4FSALBogackiShampine45::Stepper(const G4double yInput[], const G4double dydx[], G4double Step,
                                      G4double yOut[], G4double yErr[], G4double nextDydx[])
{
  G4int i;
  ...
  const G4double b21 = 1.0 / 6.0, b31 = 2.0 / 27.0, b32 = 4.0 / 27.0,
    ...
    dc1 = b81 - 2479.0 / 34992.0, dc2 = 0.0, dc3 = b83 - 123.0 / 416.0,
...
void G4FSALBogackiShampine45::interpolate(const G4double yInput[], const G4double dydx[],
                                          G4double yOut[], G4double Step, G4double tau)
{
