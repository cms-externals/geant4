...
class G4EnclosingCylinder
{
  public:
     ...
     */
    G4EnclosingCylinder(const G4ReduciblePolygon* rz, G4bool phiIsOpen, G4double startPhi,
                        G4double totalPhi);
  ...
  private:
    ...
    G4double rx1 = 0.0, ry1 = 0.0, dx1 = 0.0, dy1 = 0.0;
    G4double rx2 = 0.0, ry2 = 0.0, dx2 = 0.0, dy2 = 0.0;
