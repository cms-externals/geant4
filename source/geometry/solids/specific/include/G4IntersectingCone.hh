...
class G4IntersectingCone
{
  public:
     ...
     */
    G4int LineHitsCone(const G4ThreeVector& p, const G4ThreeVector& v, G4double* s1,
                       G4double* s2) const;
     ...
     */
    G4bool HitOn(const G4double r, const G4double z) const;
  ...
  private:
     ...
     */
    G4int LineHitsCone1(const G4ThreeVector& p, const G4ThreeVector& v, G4double* s1,
                        G4double* s2) const;
    G4int LineHitsCone2(const G4ThreeVector& p, const G4ThreeVector& v, G4double* s1,
                        G4double* s2) const;
    G4int LineHitsCylinder(const G4ThreeVector& p, const G4ThreeVector& v, G4double* s1,
                           G4double* s2) const;
