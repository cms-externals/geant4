...
// used in G4TessellatedSolid and G4MultiUnion. Can also be used in solids
// requiring voxelisation along a subset of axes.
 ...
 * G4TessellatedSolid and G4MultiUnion. Can also be used in solids requiring
 * voxelisation along a subset of axes.
 *
...
class G4Voxelizer
{
  public:
     ...
     * A zero component in reductionRatio collapses the corresponding axis
     * to one slice, allowing voxelisation along the remaining axis/axes.
     */
  ...
  private:
    ...
    unsigned int GetCandidateMaskWord(G4int word, G4int totalCandidates) const;
