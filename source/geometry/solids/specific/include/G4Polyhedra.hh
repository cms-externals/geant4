...
class G4Polyhedra : public G4VCSGfaceted
{
  ...
  private:
    ...
    inline G4bool HasRZQueryFastPath() const;
    EInside InsideFacetedIndexed(const G4ThreeVector& p) const;
    G4ThreeVector SurfaceNormalFacetedIndexed(const G4ThreeVector& p) const;
    G4double DistanceToFacetedIndexed(const G4ThreeVector& p,
                                      G4bool outgoing) const;
    G4double DistanceToOpenRZ(const G4ThreeVector& p,
                              G4bool outgoing) const;
    G4double PhiFacePlaneDistance(G4int faceIndex,
    ...
    inline G4double ProjectToRZRadius(const G4ThreeVector& p,
                                      G4double* midCos = nullptr,
                                      G4double* midSin = nullptr) const;
  ...
  private:
    ...
    std::vector<G4double> fRZMidCos;
    std::vector<G4double> fRZMidSin;
    G4double fRZDeltaPhi = 0.;
    G4double fRZCosHalfPhi = 1.;
