...
class G4ReduciblePolygon
{
  ...
  public:
    ...
    /** Returns true when every non-collinear turn has the same orientation.
        Construction validates that the polygon is simple, so this is a
        linear-time convexity test. */
