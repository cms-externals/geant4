...
/**
 * @brief G4TwistedTrap is a general twisted trapezoid.
 * @ingroup geometry_solids_specific
 *
 * The faces perpendicular to the Z planes are trapezia,
 * and their centres are not necessarily on a line parallel to the Z axis.
 */
...
class G4TwistedTrap : public G4VTwistedFaceted
{
  public:
     ...
     */
    G4TwistedTrap(const G4String& pName, G4double pPhiTwist,
