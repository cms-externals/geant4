...
G4bool compareEllipsoidtoOrb(G4int M)
{
...
G4bool compareEllipsoidtoSphere(G4int M)
{
...
G4bool compareEllipticalTubetoTubs(G4int M)
{
...
G4bool compareBoxtoTrap(G4int M)
{
...
G4bool compareSpheretoOrb(G4int M)
{
...
G4bool compareBoxtoExtruded(G4int M)
{  
