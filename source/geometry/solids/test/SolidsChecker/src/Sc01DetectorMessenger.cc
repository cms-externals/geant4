  ...
  : myDetector(myDC)
{
  ...
  selDetCmd->SetCandidates("Sphere Orb Box Cone Tube Hype Torus Para Trd b1Ib2 b1Ub2 b1Sb2 b1Ub1 b1Ib1 b1Sb1 TwistedBox TwistedTrd TwistedTrap TwistedTrap2");
