...
namespace
{
  ...
  G4bool CreateTaskGeometryWorkspace()
  {
  ...
  void CleanupTaskGeometryWorkspace()
  {
    G4GeometryWorkspace::GetPool()->CleanUpAndDestroyAllWorkspaces();
  }

  const G4bool registeredGeometryWorkspaceCallbacks = []
  {
    G4GeomTaskHelper::RegisterWorkspaceCallbacks(0, CreateTaskGeometryWorkspace,
                                                 CleanupTaskGeometryWorkspace);
    return true;
  }();
}  // namespace
