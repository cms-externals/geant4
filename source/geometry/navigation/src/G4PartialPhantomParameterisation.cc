...
//------------------------------------------------------------------
G4Material* G4PartialPhantomParameterisation::ComputeMaterial(const G4int copyNo,
                                                              G4VPhysicalVolume*,
                                                              const G4VTouchable*)
{
  CheckCopyNo(copyNo);
...
//------------------------------------------------------------------
size_t G4PartialPhantomParameterisation::GetMaterialIndex(std::size_t nx, std::size_t ny,
                                                          std::size_t nz) const
{
...
//------------------------------------------------------------------
G4Material* G4PartialPhantomParameterisation::GetMaterial(std::size_t nx, std::size_t ny,
                                                          std::size_t nz) const
{
...
//------------------------------------------------------------------
void G4PartialPhantomParameterisation::ComputeVoxelIndices(const G4int copyNo, std::size_t& nx,
                                                     ...
                                                     const G4ThreeVector& localDir)
{
  ...
  if (!isOK)
  {
    ...
    G4Exception("G4PartialPhantomParameterisation::GetReplicaNo()", "GeomNav1002", JustWarning,
                message);
  }
...
void G4PartialPhantomParameterisation::CheckCopyNo(const G4long copyNo) const
{
  if (copyNo < 0 || copyNo >= G4int(fNoVoxels))
  {
    ...
    G4Exception("G4PartialPhantomParameterisation::CheckCopyNo()", "GeomNav0002",
