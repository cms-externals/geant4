...
// Constructor
//
G4LocatorChangeLogger::G4LocatorChangeLogger(const std::string& name) : fName(name) {}
  ...
  do
  {
    ...
    if (((G4int)eventA > prevA) && ((G4int)eventB > prevB))
    {
      ...
      os << setw(7) << eventA << "  " << setw(4) << (*itrecA).GetIteration() << "  " << setw(3)
         << codeLocA << " " << setw(15) << G4LocatorChangeRecord::GetNameChangeLocation(codeLocA)
    ...
    else
    {
      if ((G4int)eventA > prevA)
      {
        ...
        os << setw(7) << (*itrecA).GetCount() << "  " << setw(4) << (*itrecA).GetIteration() << "  "
           << setw(3) << codeLocA << " " << setw(15)
           << G4LocatorChangeRecord::GetNameChangeLocation(codeLocA) << " " << setw(prec + 9)
           << (*itrecA).GetLength() << "  " << setw(prec + 9) << "       " << "  ";
      }
      else
      {
        ...
        os << setw(7) << eventB << "  " << setw(4) << (*itrecB).GetIteration() << "  " << setw(3)
           << codeLocB << " " << setw(15) << G4LocatorChangeRecord::GetNameChangeLocation(codeLocB)
           << " " << setw(prec + 9) << "       " << "  " << setw(prec + 9) << (*itrecB).GetLength()
           << "  ";
      }
    }
