...
int main()
{
  ...
  G4cout << G4endl << "Voxels for:" << (*G4LogicalVolumeStore::GetInstance())[1]->GetName()
         << G4endl << *(*G4LogicalVolumeStore::GetInstance())[1]->GetVoxelHeader() << G4endl;
#endif

  G4SmartVoxelHeader* top = (*G4LogicalVolumeStore::GetInstance())[1]->GetVoxelHeader();
  if (top)
  {
