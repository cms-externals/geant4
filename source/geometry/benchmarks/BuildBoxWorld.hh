...
G4VPhysicalVolume* BuildBoxWorld()
{
  ...
  G4LogicalVolume* myTargetLog = new G4LogicalVolume(myTargetBox, 0, "YLog", 0, 0, 0);
  G4PVPlacement* myWorldPhys =
    new G4PVPlacement(0, G4ThreeVector(), "WPhys", myWorldLog, 0, false, 0);
  // G4PVPlacement *myTargetPhys=
  new G4PVPlacement(0, G4ThreeVector(10 * mm, 10 * mm, 10 * mm), "TPhys", myTargetLog, myWorldPhys,
                    false, 0);
