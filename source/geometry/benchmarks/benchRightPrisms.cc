...
G4ThreeVector PointOnPrism(G4int nsect, G4double sphi, G4double dphi, G4double rmax, G4double rmin,
                           G4double dz);
G4TessellatedSolid* CreatePrism(G4int nsect, G4double sphi, G4double dphi, G4double rmax,
                                G4double rmin, G4double dz);
...
int main()
{
  ...
  for (G4int i = 0; i < NP; ++i)
  {
    ...
    G4ThreeVector p = PointOnPrism(nsect1 = 6, sphi1 = 30 * deg, dphi1 = 360 * deg, rmax1 = 25 * cm,
                                   rmin1 = 0, dz1 = 20 * cm);
  ...
  {
    G4int k = (i % 3) - 1;  // k = -1, 0, +1
    G4ThreeVector p = PointOnPrism(nsect2 = 3, sphi2 = 90 * deg, dphi2 = 180 * deg, rmax2 = 25 * cm,
                                   rmin2 = 12.5 * cm, dz2 = 20 * cm);
    prism2_Surface[i] = (1.0 + k * ksur) * p;
    prism2_Inside[i] = PointOnPrism(nsect2, sphi2 + 5 * deg, dphi2 - 10 * deg, rmax2 - 5 * cm,
                                    rmin2 + 4 * cm, dz2 - 2 * cm);
    prism2_Outside[i] = PointOnPrism(nsect2, sphi2 - 5 * deg, dphi2 + 10 * deg, rmax2 + 5 * cm,
                                     rmin2 - 4 * cm, dz2 + 2 * cm);
  }
  PointOnPrism(0, 0, 0, 0, 0, 0);
  ...
  if (ifxtru1)
  {
    ...
    Check_Inside(xtru1, prism1_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(xtru1, prism1_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(xtru1, prism1_Outside, NLOOP, kOutside);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::Inside(p) - Convex prism ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_Inside(tess1, prism1_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(tess1, prism1_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(tess1, prism1_Outside, NLOOP, kOutside);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::Inside(p) - Convex prism ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_Inside(poly1, prism1_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(poly1, prism1_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(poly1, prism1_Outside, NLOOP, kOutside);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    ...
    G4cout << "   Points Inside     ";
    Check_Inside(xtru2, prism2_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(xtru2, prism2_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(xtru2, prism2_Outside, NLOOP, kOutside);
  }
  if (iftess2)
  {
    G4cout << "****** Time test for G4TessellatedSolid::Inside(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_Inside(tess2, prism2_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(tess2, prism2_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(tess2, prism2_Outside, NLOOP, kOutside);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::Inside(p) - Non-convex prism ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_Inside(poly2, prism2_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(poly2, prism2_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(poly2, prism2_Outside, NLOOP, kOutside);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::SurfaceNormal(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(xtru1, prism1_Surface, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::SurfaceNormal(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(tess1, prism1_Surface, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::SurfaceNormal(p) - Convex prism ******" << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(poly1, prism1_Surface, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::SurfaceNormal(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(xtru2, prism2_Surface, NLOOP);
  }
  if (iftess2)
  {
    G4cout << "****** Time test for G4TessellatedSolid::SurfaceNormal(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(tess2, prism2_Surface, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::SurfaceNormal(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(poly2, prism2_Surface, NLOOP);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToIn(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(xtru1, prism1_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(xtru1, prism1_Outside, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToIn(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(tess1, prism1_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(tess1, prism1_Outside, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToIn(p) - Convex prism ******" << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(poly1, prism1_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(poly1, prism1_Outside, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToIn(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(xtru2, prism2_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(xtru2, prism2_Outside, NLOOP);
  }
  if (iftess2)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToIn(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(tess2, prism2_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(tess2, prism2_Outside, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToIn(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(poly2, prism2_Surface, NLOOP);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(poly2, prism2_Outside, NLOOP);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(xtru1, prism1_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(xtru1, prism1_Surface, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToOut(p) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(tess1, prism1_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(tess1, prism1_Surface, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p) - Convex prism ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(poly1, prism1_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(poly1, prism1_Surface, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(xtru2, prism2_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(xtru2, prism2_Surface, NLOOP);
  }
  if (iftess2)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToOut(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(tess2, prism2_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(tess2, prism2_Surface, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(poly2, prism2_Inside, NLOOP);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(poly2, prism2_Surface, NLOOP);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToIn(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(xtru1, p1, vecInCone, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToIn(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(tess1, p1, vecInCone, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToIn(p,v) - Convex prism ******" << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(poly1, p1, vecInCone, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToIn(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(xtru2, p2, vecInCone, NLOOP);
  }
  if (iftess2)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToIn(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(tess2, p2, vecInCone, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToIn(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(poly2, p2, vecInCone, NLOOP);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(xtru1, prism1_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(xtru1, prism1_Surface, vecOnSphere, false, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tess1, prism1_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tess1, prism1_Surface, vecOnSphere, false, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(poly1, prism1_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(poly1, prism1_Surface, vecOnSphere, false, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(xtru2, prism2_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(xtru2, prism2_Surface, vecOnSphere, false, NLOOP);
  }
  if (iftess2)
  {
    G4cout
      << "****** Time test for G4TessellatedSolid::DistanceToOut(p,v) - Non-convex prism ******"
      << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tess2, prism2_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tess2, prism2_Surface, vecOnSphere, false, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(poly2, prism2_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(poly2, prism2_Surface, vecOnSphere, false, NLOOP);
  }
  ...
  if (ifxtru1)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(xtru1, prism1_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(xtru1, prism1_Surface, vecOnSphere, true, NLOOP);
  }
  if (iftess1)
  {
    G4cout << "****** Time test for G4TessellatedSolid::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tess1, prism1_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tess1, prism1_Surface, vecOnSphere, true, NLOOP);
  }
  if (ifpoly1)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p,v) - Convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(poly1, prism1_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(poly1, prism1_Surface, vecOnSphere, true, NLOOP);
  }
  G4cout << G4endl;
  if (ifxtru2)
  {
    G4cout << "****** Time test for G4ExtrudedSolid::DistanceToOut(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(xtru2, prism2_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(xtru2, prism2_Surface, vecOnSphere, true, NLOOP);
  }
  if (iftess2)
  {
    G4cout
      ...
      << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tess2, prism2_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tess2, prism2_Surface, vecOnSphere, true, NLOOP);
  }
  if (ifpoly2)
  {
    G4cout << "****** Time test for G4Polyhedra::DistanceToOut(p,v) - Non-convex prism ******"
           << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(poly2, prism2_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(poly2, prism2_Surface, vecOnSphere, true, NLOOP);
  }
                           ...
                           G4double dz)
{
  ...
  if (counts[0] == 0 && counts[1] == 0 && counts[2] == 0 && counts[3] == 0 && counts[4] == 0)
  {
    ...
    G4cout << "areas   = " << sint * nsect << ", " << sext * nsect << ", " << sbase * nsect << ", "
           << sbase * nsect << ", " << scut * 2 << G4endl;
  }
  if (nsect == 0)
  {
    G4cout << "npoints = ";
                                ...
                                G4double rmin, G4double dz)
{
  ...
  for (G4int i = 0; i < nsect; ++i)
  {
    ...
    {
      faces.push_back(
        new G4TriangularFacet(baseRminA[i], baseRminA[i + 1], baseRmaxA[i + 1], ABSOLUTE));
    }
  }
  ...
  for (G4int i = 0; i < nsect; ++i)
  {
    ...
    {
      faces.push_back(
        new G4TriangularFacet(baseRminB[i], baseRmaxB[i + 1], baseRminB[i + 1], ABSOLUTE));
    }
  }
  ...
  for (G4int i = 0; i < nsect; ++i)
  {
    faces.push_back(new G4QuadrangularFacet(baseRmaxA[i], baseRmaxA[i + 1], baseRmaxB[i + 1],
                                            baseRmaxB[i], ABSOLUTE));
  }
  ...
  if (rmin > 0)
  {
    for (G4int i = 0; i < nsect; ++i)
    {
      faces.push_back(new G4QuadrangularFacet(baseRminA[i + 1], baseRminA[i], baseRminB[i],
                                              baseRminB[i + 1], ABSOLUTE));
    }
  }
  ...
  {
    faces.push_back(
      new G4QuadrangularFacet(baseRminA[0], baseRmaxA[0], baseRmaxB[0], baseRminB[0], ABSOLUTE));
    faces.push_back(new G4QuadrangularFacet(baseRmaxA[nsect], baseRminA[nsect], baseRminB[nsect],
                                            baseRmaxB[nsect], ABSOLUTE));
  }
