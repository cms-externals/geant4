...
G4ThreeVector PointInTriangle(const G4ThreeVector& p1, const G4ThreeVector& p2,
                              const G4ThreeVector& p3)
{
  G4double r1 = G4UniformRand();
  G4double r2 = G4UniformRand();
  return (r1 + r2 < 1.) ? p1 + (p2 - p1) * r1 + (p3 - p1) * r2
...
G4ThreeVector PointOnTet(const G4ThreeVector& p1, const G4ThreeVector& p2, const G4ThreeVector& p3,
...
int main()
{
  ...
  if (iftrd)
  {
    ...
    G4cout << "   Points Inside     ";
    Check_Inside(trd, tet_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(trd, tet_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(trd, tet_Outside, NLOOP, kOutside);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::Inside(p) ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_Inside(tet, tet_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_Inside(tet, tet_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_Inside(tet, tet_Outside, NLOOP, kOutside);
  }
  ...
  if (iftrd)
  {
    ...
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(trd, tet_Surface, NLOOP, kSurface);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::SurfaceNormal(p) ******" << G4endl;
    G4cout << "   Points on Surface ";
    Check_SurfaceNormal(tet, tet_Surface, NLOOP, kSurface);
  }
  ...
  if (iftrd)
  {
    ...
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(trd, tet_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(trd, tet_Outside, NLOOP, kOutside);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::DistanceToIn(p) ******" << G4endl;
    G4cout << "   Points on Surface ";
    Check_SafetyToIn(tet, tet_Surface, NLOOP, kSurface);
    G4cout << "   Points Outside    ";
    Check_SafetyToIn(tet, tet_Outside, NLOOP, kOutside);
  }
  ...
  if (iftrd)
  {
    ...
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(trd, tet_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(trd, tet_Surface, NLOOP, kSurface);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::DistanceToOut(p) ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_SafetyToOut(tet, tet_Inside, NLOOP, kInside);
    G4cout << "   Points on Surface ";
    Check_SafetyToOut(tet, tet_Surface, NLOOP, kSurface);
  }
  ...
  if (iftrd)
  {
    ...
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(trd, p_tet, vecInCone, NLOOP);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::DistanceToIn(p,v) ******" << G4endl;
    G4cout << "   DistanceToIn      ";
    Check_DistanceToIn(tet, p_tet, vecInCone, NLOOP);
  }
  ...
  if (iftrd)
  {
    ...
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(trd, tet_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(trd, tet_Surface, vecOnSphere, false, NLOOP);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::DistanceToOut(p,v) ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tet, tet_Inside, vecOnSphere, false, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tet, tet_Surface, vecOnSphere, false, NLOOP);
  }
  ...
  if (iftrd)
  {
    G4cout << "****** Time test for G4Trd::DistanceToOut(p,v) ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(trd, tet_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(trd, tet_Surface, vecOnSphere, true, NLOOP);
  }
  if (iftet)
  {
    G4cout << "****** Time test for G4Tet::DistanceToOut(p,v) ******" << G4endl;
    G4cout << "   Points Inside     ";
    Check_DistanceToOut(tet, tet_Inside, vecOnSphere, true, NLOOP);
    G4cout << "   Points on Surface ";
    Check_DistanceToOut(tet, tet_Surface, vecOnSphere, true, NLOOP);
  }
                         ...
                         const std::vector<G4ThreeVector>& vv, G4bool calcNorm, G4int NLOOP)
{
  ...
  if (calcNorm)
  {
    ...
    for (int i = 0; i < (NLOOP / 20); i++)
    {
      n += (t1->DistanceToOut(p[k], v[k], true, &trueNorm, &norm) == 0);
      ++k;
      n += (t1->DistanceToOut(p[k], v[k], true, &trueNorm, &norm) == 0);
      ++k;
      n += (t1->DistanceToOut(p[k], v[k], true, &trueNorm, &norm) == 0);
