...
G4VPhysicalVolume* BuildCalorimeter()
{
  ...
  G4LogicalVolume* myWorldLog = new G4LogicalVolume(myWorldBox, 0, "WLog", 0, 0, 0);
  G4LogicalVolume* myCalLog = new G4LogicalVolume(myCalBox, 0, "CLog", 0, 0, 0);
  G4LogicalVolume* myTargetLog = new G4LogicalVolume(myTargetTube, 0, "TLog", 0, 0, 0);

  G4PVPlacement* myWorldPhys =
    new G4PVPlacement(0, G4ThreeVector(), "WPhys", myWorldLog, 0, false, 0);
  G4PVPlacement* myCalPhys =
    new G4PVPlacement(0, G4ThreeVector(), "CalPhys", myCalLog, myWorldPhys, false, 0);
  ...
  for (j = 1; j <= 25; j++)
  {
    ...
    for (i = 1; i <= 50; i++)
    {
      ...
      new G4PVPlacement(0, G4ThreeVector(xTlate * mm, yTlate * mm, 0), tName1, myTargetLog,
  ...
  for (j = 1; j <= 26; j++)
  {
    ...
    for (i = 1; i <= 50; i++)
    {
      ...
      // G4PVPlacement *myTargetPhys=
      new G4PVPlacement(0, G4ThreeVector(xTlate * mm, yTlate * mm, 0), tName2, myTargetLog,
                        myCalPhys, false, copyNo);
    }
  }
