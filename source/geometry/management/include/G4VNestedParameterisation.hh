 ...
 * copy/instance of this volume.
 * @ingroup geometry_management
 *
 * This is in addition to using the current
...
class G4VNestedParameterisation : public G4VPVParameterisation, public G4VVolumeMaterialScanner
{
  public:
     ...
     */
    virtual G4Material* ComputeMaterial(G4VPhysicalVolume* currentVol, const G4int repNo,
