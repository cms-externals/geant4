...
G4bool G4GeometryManager::fForceSerialGetMass = false;
// Records user choice to force GetMass() serial processing

G4bool G4GeometryManager::fForceSerialGetPointOnSurface = false;
// Records user choice to force GetPointOnSurface() serial processing

G4bool G4GeometryManager::fForceSerialOverlapsCheck = false;
// Records user choice to force overlaps checking serial processing
...
// ***************************************************************************
// Forces serial GetMass() processing
// ***************************************************************************
//
void G4GeometryManager::ForceSerialGetMass(G4bool val)
{
  fForceSerialGetMass = val;
}

// ***************************************************************************
// Reports whether serial GetMass() processing is forced
// ***************************************************************************
//
G4bool G4GeometryManager::IsSerialGetMassForced()
{
  return fForceSerialGetMass;
}

// ***************************************************************************
// Forces serial GetPointOnSurface() processing
// ***************************************************************************
//
void G4GeometryManager::ForceSerialGetPointOnSurface(G4bool val)
{
  fForceSerialGetPointOnSurface = val;
}

// ***************************************************************************
// Reports whether serial GetPointOnSurface() processing is forced
// ***************************************************************************
//
G4bool G4GeometryManager::IsSerialGetPointOnSurfaceForced()
{
  return fForceSerialGetPointOnSurface;
}

// ***************************************************************************
// Forces serial overlaps checking
// ***************************************************************************
//
void G4GeometryManager::ForceSerialOverlapsCheck(G4bool val)
{
  fForceSerialOverlapsCheck = val;
}

// ***************************************************************************
// Reports whether serial overlaps checking is forced
// ***************************************************************************
//
G4bool G4GeometryManager::IsSerialOverlapsCheckForced()
{
  return fForceSerialOverlapsCheck;
}
