...
#define G4PARAMETERISATIONTRD_HH
...
class G4VParameterisationTrd : public G4VDivisionParameterisation
{
  public:
     ...
     */
    G4VParameterisationTrd(EAxis axis, G4int nCopies, G4double offset, G4double step,
...
class G4ParameterisationTrdX : public G4VParameterisationTrd
{
  public:
     ...
     *  @param[in] divType String identifier for the kind of division.
     */
    G4ParameterisationTrdX(EAxis axis, G4int nCopies, G4double width, G4double offset,
                           G4VSolid* pSolid, DivisionType divType);
...
class G4ParameterisationTrdY : public G4VParameterisationTrd
{
  public:
     ...
     *  @param[in] divType String identifier for the kind of division.
     */
    G4ParameterisationTrdY(EAxis axis, G4int nCopies, G4double width, G4double offset,
                           G4VSolid* pSolid, DivisionType divType);
...
class G4ParameterisationTrdZ : public G4VParameterisationTrd
{
  public:
     ...
     *  @param[in] divType String identifier for the kind of division.
     */
    G4ParameterisationTrdZ(EAxis axis, G4int nCopies, G4double width, G4double offset,
                           G4VSolid* pSolid, DivisionType divType);
