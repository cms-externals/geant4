...
class G4DigiManager
{
  ...
  public:
    ...
    inline G4int GetCollectionCapacity() const { return DCtable->entries(); }
    inline G4int GetModuleCapacity() const { return G4int(DMtable.size()); }
    inline G4DCtable* GetDCtable() const { return DCtable; }
