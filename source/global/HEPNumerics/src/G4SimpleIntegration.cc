...
G4SimpleIntegration::G4SimpleIntegration(function pFunction) : fFunction(pFunction) {}

G4SimpleIntegration::G4SimpleIntegration(function pFunction, G4double pTolerance)
  : fFunction(pFunction), fTolerance(pTolerance)
{}

// Simple integration methods

G4double G4SimpleIntegration::Trapezoidal(G4double xInitial, G4double xFinal, G4int iterationNumber)
{
...
G4double G4SimpleIntegration::MidPoint(G4double xInitial, G4double xFinal, G4int iterationNumber)
{
  G4double Step = (xFinal - xInitial) / iterationNumber;
...
G4double G4SimpleIntegration::Gauss(G4double xInitial, G4double xFinal, G4int iterationNumber)
{
  G4double x = 0.;
...
G4double G4SimpleIntegration::Simpson(G4double xInitial, G4double xFinal, G4int iterationNumber)
{
  G4double Step = (xFinal - xInitial) / iterationNumber;
  G4double x = xInitial;
...
G4double G4SimpleIntegration::AdaptGaussIntegration(G4double xInitial, G4double xFinal)
{
  G4int depth = 0;
  G4double sum = 0.0;
...
void G4SimpleIntegration::AdaptGauss(G4double xInitial, G4double xFinal, G4double& sum,
                                     G4int& depth)
{
  if (depth > fMaxDepth)
  {
