...
//     |--> patch number
  ...
  #define G4VERSION_TAG "$Name: geant4-11-01-ref-04 $"
#endif
...
static const G4String G4Version = "$Name: geant4-11-01-ref-04 [MT]$";
#else
static const G4String G4Version = "$Name: geant4-11-01-ref-04 $";
#endif
static const G4String G4Date = "(30-April-2023)";
