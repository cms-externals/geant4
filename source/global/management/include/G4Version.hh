...
//     |--> patch number
  ...
  #define G4VERSION_TAG "$Name: geant4-11-01-cand-00 $"
#endif
...
static const G4String G4Version = "$Name: geant4-11-01-cand-00 [MT]$";
#else
static const G4String G4Version = "$Name: geant4-11-01-cand-00 $";
#endif
static const G4String G4Date = "(14-November-2022)";
