...
G4ThreadFunReturnType myfunc( G4ThreadFunArgType /*val*/)
{
  ...
  //Something here...
  A* a = new A( std::hash<std::thread::id>{}(G4Threading::G4GetPidId()) );
...
{
  CHECKVAL( test == G4SingletonExample::GetInstance() ,
            "Second call to G4SingletonExample::GetInstance() returns different address in function");
}
