...
int main()
{
 ...
 // 
  ...
  G4cout << G4endl
         << "##### Testing table by value and ascii data format ...";
 ...
 //
  ...
  G4cout << "##### Testing table by pointer and binary data format ...";
 ...
 // Now access the data contained in the table 
  ...
  aTablePtr->Store("OrdTable.dat",false) ; 

  aTablePtr->clearAndDestroy();

 // Retrieve from file
  aTablePtr->Retrieve("OrdTable.dat",false) ; 
