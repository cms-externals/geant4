...
G4Physics2DVector::G4Physics2DVector(std::size_t nx, std::size_t ny)
{
  if (nx < 2 || ny < 2)
  {
    ...
    G4Exception("G4Physics2DVector::G4Physics2DVector()", "glob03", FatalException, ed,
                                  ...
                                  std::size_t& idy) const
{
  ...
  const G4double x = std::min(std::max(xx, xVector[0]), xVector[numberOfXNodes - 1]);
  const G4double y = std::min(std::max(yy, yVector[0]), yVector[numberOfYNodes - 1]);
...
G4double G4Physics2DVector::BicubicInterpolation(const G4double x, const G4double y,
                                                 const std::size_t idx, const std::size_t idy) const
{
  ...
  return f1 + f1y * h2 + (3 * (f4 - f1) - 2 * f1y - f4y) * h22 + (2 * (f1 - f4) + f1y + f4y) * h23
         + f1x * h1 + f1xy * h1 * h2 + (3 * (f4x - f1x) - 2 * f1xy - f4xy) * h1 * h22
         + (2 * (f1x - f4x) + f1xy + f4xy) * h1 * h23 + (3 * (f2 - f1) - 2 * f1x - f2x) * h12
         + (3 * f2y - 3 * f1y - 2 * f1xy - f2xy) * h12 * h2
         + (9 * (f1 - f2 + f3 - f4) + 6 * f1x + 3 * f2x - 3 * f3x - 6 * f4x + 6 * f1y - 6 * f2y
            - 3 * f3y + 3 * f4y + 4 * f1xy + 2 * f2xy + f3xy + 2 * f4xy)
             * h12 * h22
         + (6 * (-f1 + f2 - f3 + f4) - 4 * f1x - 2 * f2x + 2 * f3x + 4 * f4x - 3 * f1y + 3 * f2y
            + 3 * f3y - 3 * f4y - 2 * f1xy - f2xy - f3xy - 2 * f4xy)
             * h12 * h23
         + (2 * (f1 - f2) + f1x + f2x) * h13 + (2 * (f1y - f2y) + f1xy + f2xy) * h13 * h2
         + (6 * (-f1 + f2 - f3 + f4) + 3 * (-f1x - f2x + f3x + f4x) - 4 * f1y + 4 * f2y + 2 * f3y
            - 2 * f4y - 2 * f1xy - 2 * f2xy - f3xy - f4xy)
             * h13 * h22
         + (4 * (f1 - f2 + f3 - f4) + 2 * (f1x + f2x - f3x - f4x) + 2 * (f1y - f2y - f3y + f4y)
            + f1xy + f2xy + f3xy + f4xy)
             * h13 * h23;
}
...
void G4Physics2DVector::Store(std::ofstream& out) const
{
  ...
  out << G4int(type) << " " << numberOfXNodes << " " << numberOfYNodes << G4endl;
...
G4double G4Physics2DVector::FindLinearX(G4double rand, G4double yy, std::size_t& idy) const
{
...
G4double G4Physics2DVector::InterpolateLinearX(G4PV2DDataVector& v, G4double rand) const
{
