...
class G4VParticleChange
{
  ...
  protected:
    ...
    inline void InitializeTrueStepLength(const G4Track&);
    inline void InitializeLocalEnergyDeposit(const G4Track&);
    inline void InitializeSteppingControl(const G4Track&);
    inline void InitializeParentWeight(const G4Track&);
    inline void InitializeParentGlobalTime(const G4Track&);
    inline void InitializeStatusChange(const G4Track&);
    inline void InitializeSecondaries();
    inline void InitializeStepInVolumeFlags(const G4Track&);
