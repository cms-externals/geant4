...
class G4Track
{
  public:
    ...
    G4Track();
    // Default constructor
    G4Track(G4DynamicParticle* apValueDynamicParticle, G4double aValueTime,
    ...
    inline std::map<G4int, G4VAuxiliaryTrackInformation*>* GetAuxiliaryTrackInformationMap() const;
