...
class G4NistManager
{
  public:
    ...
    inline G4Material* FindOrBuildMaterial(const G4String& name, G4bool isotopes = true,
    ...
    G4Material* BuildMaterialWithNewDensity(const G4String& name, const G4String& basename,
                                            G4double density = 0.0, G4double temp = NTP_Temperature,
    ...
    inline G4Material* ConstructNewMaterial(const G4String& name, const std::vector<G4String>& elm,
                                            ...
                                            G4bool isotopes = true, G4State state = kStateSolid,
...
inline std::size_t G4NistManager::GetNumberOfMaterials() const
{
  return nMaterials;
}
...
inline G4Element* G4NistManager::FindElement(G4int Z) const
{
...
inline std::size_t G4NistManager::GetNumberOfElements() const
{
  return nElements;
}
...
inline G4Material* G4NistManager::ConstructNewMaterial(const G4String& name,
                                                       const std::vector<G4String>& elm,
                                                       const std::vector<G4int>& nbAtoms,
                                                       G4double dens, G4bool, G4State state,
                                                       G4double T, G4double P)
...
inline G4Material* G4NistManager::ConstructNewGasMaterial(const G4String& name,
                                                          const G4String& nameNist, G4double temp,
                                                          G4double pres, G4bool)
{
