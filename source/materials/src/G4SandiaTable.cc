...
const G4double G4SandiaTable::funitc[5] = {
  CLHEP::keV, CLHEP::cm2* CLHEP::keV / CLHEP::g, CLHEP::cm2* CLHEP::keV* CLHEP::keV / CLHEP::g,
...
void G4SandiaTable::GetSandiaCofPerAtom(G4int Z, G4double energy,
...
G4SandiaTable::G4SandiaTable(G4int matIndex)
{
  ...
  {
    G4Exception("G4SandiaTable::G4SandiaTable(G4int matIndex)", "mat401", FatalException,
                "wrong matIndex");
  }
}
