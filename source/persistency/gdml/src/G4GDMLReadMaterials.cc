...
G4double G4GDMLReadMaterials::AtomRead(const xercesc::DOMElement* const atomElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    {
      G4Exception("G4GDMLReadMaterials::AtomRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return value;
    }
                                         ...
                                         G4String& ref)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::CompositeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return n;
    }
    const G4String attName = Transcode(attribute->getName());
...
G4double G4GDMLReadMaterials::MEERead(const xercesc::DOMElement* const PElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::MEERead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return value;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadMaterials::ElementRead(const xercesc::DOMElement* const elementElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::ElementRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  if (nComponents > 0)
  {
    MixtureRead(elementElement, new G4Element(Strip(name), formula, nComponents));
  }
  else
  {
                                           ...
                                           G4String& ref)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::FractionRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return n;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadMaterials::IsotopeRead(const xercesc::DOMElement* const isotopeElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::IsotopeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadMaterials::MaterialRead(const xercesc::DOMElement* const materialElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::MaterialRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  for (xercesc::DOMNode* iter = materialElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
                                      ...
                                      G4Element* element)
{
       ...
       iter = iter->getNextSibling())
  {
    ...
    if (child == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::MixtureRead()", "InvalidRead", FatalException,
                  "No child found!");
      return;
    }
    const G4String tag = Transcode(child->getTagName());
                                      ...
                                      G4Material* material)
{
       ...
       iter = iter->getNextSibling())
  {
    ...
    if (tag == "fraction")
    {
      ...
      {
        G4String error_msg =
          "Referenced material/element '" + GenerateName(ref, true) + "' was not found!";
        G4Exception("G4GDMLReadMaterials::MixtureRead()", "InvalidSetup", FatalException,
                    error_msg);
      }
    }
                                       ...
                                       G4Material* material)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::PropertyRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
#endif
  for (xercesc::DOMNode* iter = materialsElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
    ...
    if (child == nullptr)
    {
      G4Exception("G4GDMLReadMaterials::MaterialsRead()", "InvalidRead", FatalException,
                  "No child found!");
      return;
    }
    const G4String tag = Transcode(child->getTagName());
    ...
    else
    {
      ...
      G4Exception("G4GDMLReadMaterials::MaterialsRead()", "InvalidSetup", FatalException,
                  error_msg);
    }
  }
}
...
// --------------------------------------------------------------------
G4Element* G4GDMLReadMaterials::GetElement(const G4String& ref, G4bool verbose) const
{
  ...
  if (verbose && elementPtr == nullptr)
  {
    ...
    G4Exception("G4GDMLReadMaterials::GetElement()", "InvalidRead", FatalException, error_msg);
  }
...
// --------------------------------------------------------------------
G4Isotope* G4GDMLReadMaterials::GetIsotope(const G4String& ref, G4bool verbose) const
{
  ...
  if (verbose && isotopePtr == nullptr)
  {
    ...
    G4Exception("G4GDMLReadMaterials::GetIsotope()", "InvalidRead", FatalException, error_msg);
  }
...
// --------------------------------------------------------------------
G4Material* G4GDMLReadMaterials::GetMaterial(const G4String& ref, G4bool verbose) const
{
  ...
  if (verbose && materialPtr == nullptr)
  {
    ...
    G4Exception("G4GDMLReadMaterials::GetMaterial()", "InvalidRead", FatalException, error_msg);
  }
