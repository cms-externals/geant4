                                   ...
                                   const BooleanOp op)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    {
      G4Exception("G4GDMLReadSolids::BooleanRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
       ...
       iter = iter->getNextSibling())
  {
    ...
    else
    {
      ...
      G4Exception("G4GDMLReadSolids::BooleanRead()", "ReadError", FatalException, error_msg);
    }
  }
      ...
      || ((firstposition.x() != 0.0) || (firstposition.y() != 0.0) || (firstposition.z() != 0.0)))
  {
    ...
    firstSolid =
      new G4DisplacedSolid(GenerateName("displaced_" + first), firstSolid, firsttransform);
  }
...
void G4GDMLReadSolids::ElconeRead(const xercesc::DOMElement* const elconeElement)
{
  ...
  const xercesc::DOMNamedNodeMap* const attributes = elconeElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::ElconeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::EllipsoidRead(const xercesc::DOMElement* const ellipsoidElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::EllipsoidRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::EltubeRead(const xercesc::DOMElement* const eltubeElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::EltubeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::XtruRead(const xercesc::DOMElement* const xtruElement)
{
       ...
       iter = iter->getNextSibling())
  {
    ...
    if (child == nullptr)
    {
      G4Exception("G4GDMLReadSolids::XtruRead()", "InvalidRead", FatalException, "No child found!");
      return;
    }
    const G4String tag = Transcode(child->getTagName());
                                          ...
                                          G4MultiUnion* const multiUnionSolid)
{
  ...
  const xercesc::DOMNamedNodeMap* const attributes = unionNodeElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::MultiUnionNodeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  for (xercesc::DOMNode* iter = unionNodeElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
    ...
    else
    {
      ...
      G4Exception("G4GDMLReadSolids::MultiUnionNodeRead()", "ReadError", FatalException, error_msg);
    }
  }
...
void G4GDMLReadSolids::MultiUnionRead(const xercesc::DOMElement* const unionElement)
{
  ...
  const xercesc::DOMNamedNodeMap* const attributes = unionElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::MultiUnionRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
       ...
       iter = iter->getNextSibling())
  {
    ...
    {
      G4String error_msg = "Unknown tag in MultiUnion structure: " + tag;
      G4Exception("G4GDMLReadSolids::MultiUnionRead()", "ReadError", FatalException, error_msg);
    }
  }
  multiUnion->Voxelize();
}
...
void G4GDMLReadSolids::ParaboloidRead(const xercesc::DOMElement* const paraElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::ParaboloidRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::PolyconeRead(const xercesc::DOMElement* const polyconeElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::PolyconeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  new G4Polycone(name, startphi, deltaphi, (G4int)numZPlanes, z_array, rmin_array, rmax_array);
...
void G4GDMLReadSolids::GenericPolyconeRead(const xercesc::DOMElement* const polyconeElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::GenericPolyconeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  new G4GenericPolycone(name, startphi, deltaphi, (G4int)numRZPoints, r_array, z_array);
  delete[] r_array;
  delete[] z_array;
}
...
void G4GDMLReadSolids::PolyhedraRead(const xercesc::DOMElement* const polyhedraElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::PolyhedraRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  for (xercesc::DOMNode* iter = polyhedraElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
  ...
  new G4Polyhedra(name, startphi, deltaphi, numsides, (G4int)numZPlanes, z_array, rmin_array,
                  rmax_array);
...
void G4GDMLReadSolids::GenericPolyhedraRead(const xercesc::DOMElement* const polyhedraElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::GenericPolyhedraRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  new G4Polyhedra(name, startphi, deltaphi, numsides, (G4int)numRZPoints, r_array, z_array);
...
// --------------------------------------------------------------------
G4QuadrangularFacet*
G4GDMLReadSolids::QuadrangularRead(const xercesc::DOMElement* const quadrangularElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::QuadrangularRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return nullptr;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  return new G4QuadrangularFacet(vertex1 * lunit, vertex2 * lunit, vertex3 * lunit, vertex4 * lunit,
                                 type);
}
...
void G4GDMLReadSolids::ReflectedSolidRead(const xercesc::DOMElement* const reflectedSolidElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::ReflectedSolidRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
// --------------------------------------------------------------------
void G4GDMLReadSolids::DisplacedSolidRead(const xercesc::DOMElement* const displacedSolidElement)
{
  G4String name;
  ...
  const xercesc::DOMNamedNodeMap* const attributes =
    displacedSolidElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
      ...
      ++attribute_index)
  {
    ...
    if(attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::DisplacedSolidRead()", "InvalidRead",
  ...
  for(xercesc::DOMNode* iter = displacedSolidElement->getFirstChild();
                        iter != nullptr; iter = iter->getNextSibling())
  {
    ...
    {
      G4String error_msg = "Unknown tag in displaced solid: " + tag;
      G4Exception("G4GDMLReadSolids::DisplacedSolidRead()", "ReadError",
  ...
  new G4DisplacedSolid(name, solid, transform);
}
...
void G4GDMLReadSolids::ScaledSolidRead(const xercesc::DOMElement* const scaledSolidElement)
{
  ...
  const xercesc::DOMNamedNodeMap* const attributes = scaledSolidElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::ScaledSolidRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  for (xercesc::DOMNode* iter = scaledSolidElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
    ...
    else
    {
      ...
      G4Exception("G4GDMLReadSolids::ScaledSolidRead()", "ReadError", FatalException, error_msg);
      return;
    }
  }
...
G4GDMLReadSolids::SectionRead(const xercesc::DOMElement* const sectionElement, G4double lunit)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::SectionRead()", "InvalidRead", FatalException,
                  "No attribute found!");
...
void G4GDMLReadSolids::SphereRead(const xercesc::DOMElement* const sphereElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::SphereRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::TessellatedRead(const xercesc::DOMElement* const tessellatedElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TessellatedRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  for (xercesc::DOMNode* iter = tessellatedElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
...
void G4GDMLReadSolids::TorusRead(const xercesc::DOMElement* const torusElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TorusRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::GenTrapRead(const xercesc::DOMElement* const gtrapElement)
{
  ...
  G4double lunit = 1.0;
  G4double dz = 0.0;
  G4double v1x = 0.0, v1y = 0.0, v2x = 0.0, v2y = 0.0, v3x = 0.0, v3y = 0.0, v4x = 0.0, v4y = 0.0,
           v5x = 0.0, v5y = 0.0, v6x = 0.0, v6y = 0.0, v7x = 0.0, v7y = 0.0, v8x = 0.0, v8y = 0.0;

  const xercesc::DOMNamedNodeMap* const attributes = gtrapElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::GenTrapRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
// --------------------------------------------------------------------
G4TriangularFacet*
G4GDMLReadSolids::TriangularRead(const xercesc::DOMElement* const triangularElement)
{
  G4ThreeVector vertex1;
  G4ThreeVector vertex2;
  G4ThreeVector vertex3;
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TriangularRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return nullptr;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::CutTubeRead(const xercesc::DOMElement* const cuttubeElement)
{
  ...
  const xercesc::DOMNamedNodeMap* const attributes = cuttubeElement->getAttributes();
  XMLSize_t attributeCount = attributes->getLength();
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::CutTubeRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::TwistedboxRead(const xercesc::DOMElement* const twistedboxElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TwistedboxRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::TwistedtrapRead(const xercesc::DOMElement* const twistedtrapElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TwistedtrapRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::TwistedtrdRead(const xercesc::DOMElement* const twistedtrdElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TwistedtrdRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::TwistedtubsRead(const xercesc::DOMElement* const twistedtubsElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TwistedtubsRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  {
    if (nseg != 0)
      new G4TwistedTubs(name, twistedangle, midinnerrad, midouterrad, negativeEndz, positiveEndz,
                        nseg, totphi);
    else
      new G4TwistedTubs(name, twistedangle, midinnerrad, midouterrad, negativeEndz, positiveEndz,
                        phi);
                                               ...
                                               G4double lunit)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::TwoDimVertexRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return vec;
    }
    const G4String attName = Transcode(attribute->getName());
...
G4GDMLReadSolids::ZplaneRead(const xercesc::DOMElement* const zplaneElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::ZplaneRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return zplane;
    }
    const G4String attName = Transcode(attribute->getName());
...
G4GDMLReadSolids::RZPointRead(const xercesc::DOMElement* const zplaneElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::RZPointRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return rzpoint;
    }
    const G4String attName = Transcode(attribute->getName());
                                    ...
                                    G4OpticalSurface* opticalsurface)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::PropertyRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
...
void G4GDMLReadSolids::OpticalSurfaceRead(const xercesc::DOMElement* const opticalsurfaceElement)
{
  ...
  for (XMLSize_t attribute_index = 0; attribute_index < attributeCount; ++attribute_index)
  {
    ...
    if (attribute == nullptr)
    {
      G4Exception("G4GDMLReadSolids::OpticalSurfaceRead()", "InvalidRead", FatalException,
                  "No attribute found!");
      return;
    }
    const G4String attName = Transcode(attribute->getName());
  ...
  G4OpticalSurface* opticalsurface = new G4OpticalSurface(name, model, finish, type, value);

  for (xercesc::DOMNode* iter = opticalsurfaceElement->getFirstChild(); iter != nullptr;
       iter = iter->getNextSibling())
  {
    if (iter->getNodeType() != xercesc::DOMNode::ELEMENT_NODE)
    {
...
void G4GDMLReadSolids::SolidsRead(const xercesc::DOMElement* const solidsElement)
{
       ...
       iter = iter->getNextSibling())
  {
    ...
    if (child == nullptr)
    {
      G4Exception("G4GDMLReadSolids::SolidsRead()", "InvalidRead", FatalException,
                  "No child found!");
      return;
    }
    const G4String tag = Transcode(child->getTagName());
    ...
    else if (tag == "displacedSolid")
    {
      DisplacedSolidRead(child);
    }
    ...
    else
    {
      ...
      G4Exception("G4GDMLReadSolids::SolidsRead()", "ReadError", FatalException, error_msg);
    }
  }
}
...
{
  G4VSolid* solidPtr = G4SolidStore::GetInstance()->GetSolid(ref, false, reverseSearch);

  if (solidPtr == nullptr)
  {
    G4String error_msg = "Referenced solid '" + ref + "' was not found!";
    G4Exception("G4GDMLReadSolids::GetSolid()", "ReadError", FatalException, error_msg);
  }
...
G4SurfaceProperty* G4GDMLReadSolids::GetSurfaceProperty(const G4String& ref) const
{
  ...
  G4Exception("G4GDMLReadSolids::GetSurfaceProperty()", "ReadError", FatalException, error_msg);
