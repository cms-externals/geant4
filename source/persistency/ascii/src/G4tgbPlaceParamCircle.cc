  ...
  : G4tgbPlaceParameterisation(tgrParam)
{
  ...
  if (tgrParam->GetParamType() == "CIRCLE")
  {
    ...
    theCircleAxis = G4ThreeVector(tgrParam->GetExtraData()[4], tgrParam->GetExtraData()[5],
  ...
  {
    G4Exception("G4tgbPlaceParamCircle::G4tgbPlaceParamCircle()", "InvalidSetup", FatalException,
                "Circle axis is zero !");
  }
  ...
  {
    G4cout << " G4tgbPlaceParamCircle::G4tgbPlaceParamCircle():" << G4endl << " param type "
           << tgrParam->GetParamType() << G4endl << "   no copies - " << theNCopies << G4endl
           << "   step - " << theStep << G4endl << "   offset - " << theOffset << G4endl
           << "   radius - " << theRadius << G4endl << "   circle axis - " << theCircleAxis
           << G4endl << "   dir in plane - " << theDirInPlane << G4endl;
  }
#endif
}
                                                  ...
                                                  G4VPhysicalVolume* physVol) const
{
  ...
  *pvRm = *theRotationMatrix * rm;
  ...
  {
    G4cout << " G4tgbPlaceParamCircle::ComputeTransformation():" << physVol->GetName() << G4endl
           << "   no copies - " << theNCopies << G4endl << "   centre - " << origin << G4endl
