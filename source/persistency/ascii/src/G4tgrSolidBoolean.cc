...
G4tgrSolidBoolean::G4tgrSolidBoolean(const std::vector<G4String>& wl)
{
  ...
  if (wl.size() != 9)
  {
    ...
    G4Exception("G4tgrSolidBoolean::G4tgrSolidBoolean()", "InvalidInput", FatalException,
                "Line read with less or more than 9 words.");
  }
  ...
  theRelativePlace = G4ThreeVector(G4tgrUtils::GetDouble(wl[6]), G4tgrUtils::GetDouble(wl[7]),
...
{
  os << "G4tgrSolidBoolean= " << sol.theName << " of type " << sol.theType << " PARAMS: ";
