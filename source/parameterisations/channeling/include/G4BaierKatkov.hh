...
#ifndef G4BAIERKATKOV_HH
#define G4BAIERKATKOV_HH
...
class G4BaierKatkov
{
  public:
    ...
    {
      SetSpectrumEnergyRange(emin, fMaxPhotonEnergy, fNBinsSpectrum);
    }
    void SetMaxPhotonEnergy(G4double emax)
    {
      SetSpectrumEnergyRange(fMinPhotonEnergy, emax, fNBinsSpectrum);
    }
    void SetNBinsSpectrum(G4int nbin)
    {
      SetSpectrumEnergyRange(fMinPhotonEnergy, fMaxPhotonEnergy, nbin);
    }
                                   ...
                                   G4double virtualCollimatorAngularCenterY = 0.)
    {
      fVirtualCollimatorAngularHalfWidthX2 =
        virtualCollimatorAngularRadius * virtualCollimatorAngularRadius;
    ...
    {
      fVirtualCollimatorAngularHalfWidthX2 =
        virtualCollimatorAngularRadiusX * virtualCollimatorAngularRadiusX;
      fVirtualCollimatorAngularHalfWidthY2 =
        virtualCollimatorAngularRadiusY * virtualCollimatorAngularRadiusY;
      fVirtualCollimatorAngularCenterX = virtualCollimatorAngularCenterX;
      fVirtualCollimatorAngularCenterY = virtualCollimatorAngularCenterY;
      fVirtualCollimatorTypeID = 1;
    }
    ...
    G4bool DoRadiation(G4double etotal, G4double mass, G4double angleX, G4double angleY,
                       G4double angleScatteringX, G4double angleScatteringY, G4double step,
                       G4double globalTime, G4ThreeVector coordinateXYZ,
  ...
  private:
    ...
    void SetPhotonSamplingParameters(G4double ekin, G4double minPhotonAngleX,
    ...
    G4double fSinglePhotonRadiationProbabilityLimit =
      0.25;  // Maximal radiation
    ...
    std::vector<G4double>
      fSpectrum;  // spectrum normalized by the total
