...
#ifndef G4CHANNELINGFASTSIMMODEL_HH
#define G4CHANNELINGFASTSIMMODEL_HH
...
class G4ChannelingFastSimModel : public G4VFastSimulationModel
{
  public:
    ...
    /// special functions
    void Input(const G4Material* crystal, const G4String& lattice) { Input(crystal, lattice, ""); }
    ...
    {
      fLowEnergyLimit[particleTable->FindParticle(particleName)->GetParticleDefinitionID()] =
        ekinetic;
    }
    ...
    {
      fHighAngleLimit[particleTable->FindParticle(particleName)->GetParticleDefinitionID()] =
        anglemax;
    }

    void SetDefaultLowKineticEnergyLimit(G4double ekinetic) { fDefaultLowEnergyLimit = ekinetic; }
    void SetDefaultLindhardAngleNumberHighLimit(G4double angleNumber)
    {
      fDefaultLindhardAngleNumberHighLimit = angleNumber;
    }
    void SetDefaultHighAngleLimit(G4double anglemax) { fDefaultHighAngleLimit = anglemax; }
    ...
    void SetMaxPhotonsProducedPerStep(G4double nPhotons) { fMaxPhotonsProducedPerStep = nPhotons; }
