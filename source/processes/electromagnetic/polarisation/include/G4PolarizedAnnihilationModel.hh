...
#ifndef G4POLARIZEDANNIHILATIONMODEL_HH
#define G4POLARIZEDANNIHILATIONMODEL_HH
...
class G4PolarizedAnnihilationModel : public G4eeToTwoGammaModel
{
  public:
    ...
    void ComputeAsymmetriesPerElectron(G4double gammaEnergy, G4double& valueX, G4double& valueA,
                                       G4double& valueT);
