...
G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, Ionisation_DissociationDecay)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, A1B1_DissociationDecay)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, B1A1_DissociationDecay)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, B1A1_DissociationDecay2)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, AutoIonisation)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, DissociativeAttachment)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, DoubleIonisation_DissociationDecay1)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, DoubleIonisation_DissociationDecay2)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, DoubleIonisation_DissociationDecay3)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, TripleIonisation_DissociationDecay)

G4CT_COUNT_IMPL(G4DNAWaterDissociationDisplacer, QuadrupleIonisation_DissociationDecay)
  ...
  switch (decayType)
  {
    ...
    case DoubleIonisation_DissociationDecay1: {
      ...
      for (G4int i = 0, num_H3O = 0; i < nbProducts; i++)
      {
        ...
        theProductDisplacementVector[i] = radialDistributionOfProducts(theRMSmap[prod_def]);
      }
    ...
    case DoubleIonisation_DissociationDecay2: {
      ...
      const auto OH_disp = radialDistributionOfProducts(theRMSmap[G4OH::Definition()]);
      ...
      for (G4int i = 0, num_H3O = 0; i < nbProducts; i++)
      {
        ...
        if (prod_def == G4H3O::Definition())
        {
          ...
          if (num_H3O == 2)
          {
            ...
            theProductDisplacementVector[i] = radialDistributionOfProducts(OH_rms);
    ...
    case TripleIonisation_DissociationDecay: {
      ...
      for (G4int i = 0, num_H3O = 0; i < nbProducts; i++)
      {
        ...
        if (prod_def == G4H3O::Definition())
        {
          ...
          {
            constexpr G4double H3Op_rms = 0.3 * nanometer;
            theProductDisplacementVector[i] = radialDistributionOfProducts(H3Op_rms);
            theProductDisplacementVector[i] += OH_disp;
            continue;
          }
        }
    ...
    case QuadrupleIonisation_DissociationDecay: {
      ...
      const auto OH_disp1 = radialDistributionOfProducts(theRMSmap[G4OH::Definition()]);
      const auto OH_disp2 = radialDistributionOfProducts(theRMSmap[G4OH::Definition()]);
