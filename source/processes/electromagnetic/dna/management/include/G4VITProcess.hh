...
#ifndef G4VITPROCESS_HH
#define G4VITPROCESS_HH
...
class G4VITProcess : public G4VProcess
{
  public:
    ...
    size_t GetProcessID() const { return fProcessID; }
    ...
    void ResetProcessState() { fpState.reset(); }
  ...
  protected:
    ...
    struct G4ProcessState : public G4ProcessState_Lock
    {
      public:
        ...
        virtual G4String GetType() { return "G4ProcessState"; }
    ...
    class G4ProcessStateBase : public G4ProcessState
    {
      public:
        ...
        G4String GetType() override { return typeid(T).name(); }
    };
    ...
    void SetInstantiateProcessState(G4bool flag) { fInstantiateProcessState = flag; }
...
inline void G4VITProcess::SubtractNumberOfInteractionLengthLeft(G4double previousStepSize)
{
  if (fpState->currentInteractionLength > 0.0)
  {
    fpState->theNumberOfInteractionLengthLeft -=
      previousStepSize / fpState->currentInteractionLength;
  ...
  else
  {
    ...
    msg += theProcessName;
    G4Exception("G4VITProcess::SubtractNumberOfInteractionLengthLeft()", "ProcMan201",
