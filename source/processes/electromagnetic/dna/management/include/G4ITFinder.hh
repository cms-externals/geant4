...
class G4ITFinder : public G4VITFinder
{
  public:
    ...
    G4KDTreeResultHandle FindNearestInRange(const T* point /*from this point*/,
                                            G4int key /*for this type*/, G4double /*range*/);
    G4KDTreeResultHandle FindNearest(const G4ThreeVector&, G4int key /*for this type*/);
    G4KDTreeResultHandle FindNearest(const T* /*from this point*/, G4int key /*for this type*/);
    G4KDTreeResultHandle FindNearestInRange(const G4ThreeVector& /*from this point*/,
                                            G4int key /*for this type*/, G4double /*range*/);
    G4KDTreeResultHandle FindNearest(const T* /*from this point*/, const T* /*for this type*/);
