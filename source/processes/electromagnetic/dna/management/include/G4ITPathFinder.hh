...
class G4ITPathFinder : public G4TrackStateDependent<G4ITPathFinder>
{
  public:  // with description
    ...
    G4double ComputeStep(const G4FieldTrack& pFieldTrack, G4double pCurrentProposedStepLength,
  ...
  protected:  // without description
    ...
    void ReportMove(const G4ThreeVector& OldV, const G4ThreeVector& NewV,
...
inline G4VPhysicalVolume* G4ITPathFinder::GetLocatedVolume(G4int navId) const
{
  ...
  if ((navId < G4ITNavigator::fMaxNav) && (navId >= 0))
  {
    vol = fpTrackState->fLocatedVolume[navId];
  }
  return vol;
}
...
inline G4double G4ITPathFinder::LastPreSafety(G4int navId, G4ThreeVector& globalCenterPoint,
                                              G4double& minSafety)
{
