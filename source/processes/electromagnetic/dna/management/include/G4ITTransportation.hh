...
#ifndef G4ITTRANSPORTATION_HH
#define G4ITTRANSPORTATION_HH
...
class G4ITTransportation : public G4VITProcess
{
  ...
  public:
    ...
    virtual void ComputeStep(const G4Track&, const G4Step&, const double timeStep,
                             double& spaceStep);
  ...
  protected:
    ...
    struct G4ITTransportationState : public G4ProcessState
    {
      public:
        ...
        G4String GetType() override { return "G4ITTransportationState"; }
