...
class G4KDNode : public G4KDNode_Base
{
  public:
    ...
    inline PointT* GetPoint() { return fPoint; }
    ...
    G4bool IsValid() const override { return fValid; }
...
class G4KDNodeCopy : public G4KDNode_Base
{
  public:
    ...
    void operator delete(void* aNode) { fgAllocator->FreeSingle((G4KDNodeCopy<PointCopyT>*)aNode); }

    inline const PointCopyT& GetPoint() { return fPoint; }

    double operator[](std::size_t i) const override { return fPoint[i]; }
  ...
  private:
    ...
    G4KDNodeCopy(const G4KDNodeCopy<PointCopyT>& right) : G4KDNode_Base(right), fPoint(0)
    {
      fValid = false;
    }
