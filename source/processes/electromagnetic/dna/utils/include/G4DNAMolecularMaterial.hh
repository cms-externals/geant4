...
class G4DNAMolecularMaterial : public G4VStateDependent
{
  public:
    ...
    inline const std::vector<ComponentMap>* GetDensityTable() const { return fpCompDensityTable; }
  ...
  protected:
    ...
    void RecordMolecularMaterial(G4Material* parentMaterial, G4Material* molecularMaterial,
                                 G4double fraction);
    void SearchMolecularMaterial(G4Material* parentMaterial, G4Material* material,
    ...
    mutable std::map<const G4Material*, std::vector<G4double>*, CompareMaterial> fAskedDensityTable;
    ...
    std::map<G4int /*Material ID*/, G4MolecularConfiguration*> fMaterialToMolecularConf;
