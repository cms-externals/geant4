...
#ifndef G4VPHYSCHEMIO_HH
#define G4VPHYSCHEMIO_HH
...
class G4VPhysChemIO
{
  public:
     ...
     */
    virtual void CreateWaterMolecule(G4int electronicModif, G4int /*electronicLevel*/,
                                     G4double energy, const G4Track* /*theIncomingTrack*/) = 0;
