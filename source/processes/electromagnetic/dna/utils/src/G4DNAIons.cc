...
G4DNAIons::G4DNAIons(const G4String& aName, G4double mass, G4double width, G4double charge,
  ...
  : G4ParticleDefinition(aName, mass, width, charge, iSpin, iParity, iConjugation, iIsospin,
                         ...
                         decaytable, shortlived, subType, anti_encoding),
