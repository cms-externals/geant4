...
G4bool G4DNACrossSectionDataSet::LoadData(const G4String& argFileName)
{
  ...
  if (!in.is_open())
  {
    ...
    message += "\" not found";
    G4Exception("G4DNACrossSectionDataSet::LoadData", "em0003", FatalException, message);
    return false;
  }
  ...
  if (maxI < 2)
  {
    ...
    G4Exception("G4DNACrossSectionDataSet::LoadData", "em0005", FatalException, message);
    return false;
  }
...
G4bool G4DNACrossSectionDataSet::SaveData(const G4String& argFileName) const
{
  ...
  if (n == 0)
  {
    G4Exception("G4DNACrossSectionDataSet::SaveData", "em0005", FatalException,
  ...
  if (!out.is_open())
  {
    ...
    message += fullFileName;
    message += "\"";
    G4Exception("G4DNACrossSectionDataSet::SaveData", "em0005", FatalException, message);
    return false;
  }
...
G4String G4DNACrossSectionDataSet::FullFileName(const G4String& argFileName) const
{
  ...
  if (path == nullptr)
  {
    G4Exception("G4DNACrossSectionDataSet::FullFileName", "em0006", FatalException,
...
void G4DNACrossSectionDataSet::SetEnergiesData(G4DataVector* argEnergies, G4DataVector* argData,
                                               G4int argComponentId)
{
  ...
  G4Exception("G4DNACrossSectionDataSet::SetEnergiesData", "em0005", FatalException,
              message.str().c_str());
}

void G4DNACrossSectionDataSet::SetLogEnergiesData(G4DataVector* argEnergies, G4DataVector* argData,
                                                  ...
                                                  G4DataVector* argLogData, G4int argComponentId)
{
  ...
  G4Exception("G4DNACrossSectionDataSet::SetLogEnergiesData", "em0005", FatalException,
              message.str().c_str());
}
