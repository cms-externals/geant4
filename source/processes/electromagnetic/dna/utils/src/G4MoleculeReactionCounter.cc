...
G4String
G4MoleculeReactionCounterIndex::FormattedReactionString(const G4DNAMolecularReactionData* reactionData) const
{
...
G4MoleculeReactionCounter::G4MoleculeReactionCounter(G4String name)
  : G4VUserMoleculeReactionCounter(name, MoleculeReactionCounterType::Basic)
{}
...
void G4MoleculeReactionCounter::InitializeUser()
{
  ...
  //       continue;
  //     }
  //     std::shared_ptr<G4MoleculeReactionCounterIndex> mapIndex =
  //       ConvertBaseIndexPointer(BuildSimpleIndex(mol_iterator.value()));
  //     fCounterMap[*mapIndex];
  //   }
  // TBD: loop over reaction table and set indices as above
}

//------------------------------------------------------------------------------
//no needed
//std::shared_ptr<G4VMoleculeReactionCounter::G4VMoleculeReactionCounterIndex>
//G4MoleculeReactionCounter::BuildIndex(const G4Track*, const G4Track*,
//                                      const G4DNAMolecularReactionData* reactionData) const
//{
//  return BuildSimpleIndex(reactionData);
//}
...
{
  return std::make_shared<G4MoleculeReactionCounterIndex>(reactionData);
}
