...
int main()
{
  G4MoleculeTable* moleculeTable = G4MoleculeTable::Instance()->GetMoleculeTable();
  ...
  G4MoleculeDefinition* molDef1 = moleculeTable->CreateMoleculeDefinition("mol1", 3);

  G4MolecularConfiguration* mol1 = moleculeTable->CreateConfiguration("mol1", molDef1);
  ...
  //---------------------------------------------------------------------------
  // Test 2
  G4MoleculeDefinition* molDef2 = moleculeTable->CreateMoleculeDefinition("mol2", 5);
  G4MolecularConfiguration* mol2 = moleculeTable->CreateConfiguration("mol2", molDef2, -1, 9.);
  assert(mol2->GetCharge() == -1);
  assert(mol2->GetName() == "mol2^-1");

  //---------------------------------------------------------------------------
  // Test 3
  G4MoleculeDefinition* molDef3 = moleculeTable->CreateMoleculeDefinition("mol3", 5);
