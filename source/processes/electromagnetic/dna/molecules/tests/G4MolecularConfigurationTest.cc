...
int main()
{
  ...
  G4MolecularConfiguration* conf1 =
    G4MolecularConfiguration::GetOrCreateMolecularConfiguration(e_aq, occ);
  ...
  G4MolecularConfiguration* conf2 =
    G4MolecularConfiguration::GetOrCreateMolecularConfiguration(e_aq, occ2);
