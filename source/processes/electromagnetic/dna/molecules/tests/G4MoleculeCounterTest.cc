...
void Test2()
{
  ...
  double remove_times[N] = {24, 25, 27, 27.5, 29};
  /* 4, 3, 2, 1, 0*/
  ...
  double testTimes[Ntests] = {0, 1, 3, 5, 6, 10, 12, 15, 20, 24, 26, 27, 27.5, 29};
  double resultTests[Ntests] = {0, 1, 1, 2, 2, 3, 4, 4, 5, 4, 3, 2, 1, 0};

  for (size_t i = 0; i < Ntests; i++)
  {
    G4cout << i << " " << testTimes[i] << " : " << counter->GetNMoleculesAtTime(e_aq, testTimes[i])
           << G4endl;
