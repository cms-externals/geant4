...
class G4VMoleculeReactionCounter : public G4VMoleculeCounterInternalBase
{
  ...
  private:
    ...
    G4VMoleculeReactionCounter(G4String, MoleculeReactionCounterType = MoleculeReactionCounterType::Basic);
  ...
  public:
    virtual std::shared_ptr<G4VMoleculeReactionCounterIndex> BuildIndex(const G4Track*, const G4Track*, const G4DNAMolecularReactionData*) const = 0;
    virtual std::shared_ptr<G4VMoleculeReactionCounterIndex> BuildSimpleIndex(const G4DNAMolecularReactionData*) const = 0;

    virtual void RecordReaction(std::shared_ptr<G4VMoleculeReactionCounterIndex>, G4double, G4int = 1) = 0;
