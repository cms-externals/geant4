...
class G4MoleculeCounterManagerMessenger : public G4UImessenger
{
  ...
  private:
    ...
    std::shared_ptr<G4UIdirectory> fpManagerDir;
    std::shared_ptr<G4UIcmdWithABool> fpActiveCmd;
    std::shared_ptr<G4UIcmdWithABool> fpResetBeforeEventCmd;
    std::shared_ptr<G4UIcmdWithABool> fpResetBeforeRunCmd;
    std::shared_ptr<G4UIcmdWithABool> fpAccumulateIntoMasterCmd;
    std::shared_ptr<G4UIcmdWithAnInteger> fpVerboseCmd;
};
