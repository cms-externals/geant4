...
class G4VMoleculeCounter : public G4VMoleculeCounterInternalBase
{
  ...
  private:
    G4VMoleculeCounter();
    G4VMoleculeCounter(G4String, MoleculeCounterType = MoleculeCounterType::Other);
  ...
  public:
    virtual std::shared_ptr<G4VMoleculeCounterIndex> BuildIndex(const G4Track*) const = 0;
    virtual std::shared_ptr<G4VMoleculeCounterIndex> BuildIndex(const G4Track*, const G4StepPoint*) const = 0;
    virtual std::shared_ptr<G4VMoleculeCounterIndex> BuildSimpleIndex(const G4MolecularConfiguration*) const = 0;

    virtual void AddMolecule(std::shared_ptr<G4VMoleculeCounterIndex>, G4double, G4int = 1) = 0;
    virtual void RemoveMolecule(std::shared_ptr<G4VMoleculeCounterIndex>, G4double, G4int = 1) = 0;
