...
class G4VMoleculeCounterInternalBase
{
  ...
  private:
    ...
    G4VMoleculeCounterInternalBase(G4String);
  ...
  public:
    ...
    virtual void AbsorbCounter(std::weak_ptr<G4VMoleculeCounterInternalBase>) = 0;

  private:
    G4ThreadLocalStatic G4int _createdCounters;
