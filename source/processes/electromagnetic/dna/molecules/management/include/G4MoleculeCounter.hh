...
struct G4MoleculeCounterIndex : public G4VMoleculeCounter::G4VMoleculeCounterIndex
{
    ...
    G4String GetInfo() const override {
      G4String null = "null";
      if(Molecule == nullptr) {return null;}
      else{
...
class G4MoleculeCounter : public G4VUserMoleculeCounter<G4MoleculeCounterIndex>
{
  ...
  public:
    std::shared_ptr<G4VMoleculeCounterIndex> BuildIndex(const G4Track*) const override;
    std::shared_ptr<G4VMoleculeCounterIndex> BuildIndex(const G4Track*,
                                                        const G4StepPoint*) const override;
    std::shared_ptr<G4VMoleculeCounterIndex>
