...
// constructor
G4LEPTSAttachmentModel::G4LEPTSAttachmentModel(const G4String& modelName) : G4VLEPTSModel(modelName)
{
...
void G4LEPTSAttachmentModel::Initialise(const G4ParticleDefinition* aParticle, const G4DataVector&)
{
  Init();
