...
G4LEPTSExcitationModel::G4LEPTSExcitationModel(const G4String& modelName) : G4VLEPTSModel(modelName)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void G4LEPTSExcitationModel::Initialise(const G4ParticleDefinition* aParticle, const G4DataVector&)
{
  Init();
...
std::map<G4int, std::vector<G4double>> G4LEPTSExcitationModel::ReadIXS(const G4String& fileTXS,
                                                                       const G4Material* aMaterial)
{
  ...
  {
    if (integralXS[XSDissociation][jj] > 0.001)
      LowestExcitationEnergy = integralXS[XSTotal][jj - 1];
    if (integralXS[XSVibration][jj] > 0.001)
      LowestNeutralDisociationEnergy = integralXS[XSTotal][jj - 1] * CLHEP::eV;
                                               ...
                                               G4double)
{
  ...
  G4ThreeVector P1Dir =
    SampleNewDirection(aMaterial, P0Dir, P0KinEn / CLHEP::eV, Energylost / CLHEP::eV);
