                                                  ...
                                                  const G4DataVector& /*cuts*/)
{
  ...
  G4String fileElectron("dna/sigma_excitation_e_emfietzoglou-x");
...
G4double G4DNAEmfietzoglouExcitationModel::CrossSectionPerVolume(
...
G4int G4DNAEmfietzoglouExcitationModel::RandomSelect(G4double k, const G4String& particle)
{
  ...
  {
    G4Exception("G4DNAEmfietzoglouExcitationModel::RandomSelect", "em0002", FatalException,
