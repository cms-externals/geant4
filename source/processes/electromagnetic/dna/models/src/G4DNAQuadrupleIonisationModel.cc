...
// constructor
G4DNAQuadrupleIonisationModel::G4DNAQuadrupleIonisationModel(const G4ParticleDefinition* p,
                                                              ...
                                                              G4double ekin, G4double, G4double)
{
  if (verbose_level_ > 3)
  {
    G4cout << "Calling G4DNAQuadrupleIonisationModel::CrossSectionPerVolume()" << G4endl;
  }
  ...
  if (ekin <= upp_energy_lim)
  {
    ...
    if (pos == xs_tab_.end())
    {
      G4Exception("G4DNAQuadrupleIonisationModel::CrossSectionPerVolume", "em0002", FatalException,
                                                      ...
                                                      G4double)
{
  if (verbose_level_ > 3)
  {
    G4cout << "Calling SampleSecondaries() of G4DNAQuadrupleIonisationModel" << G4endl;
  }
  ...
  if (mioni_manager_->CheckShellEnergy(eQuadrupleIonisedMolecule, shell_energy))
  {
    G4Exception("G4DNAQuadrupleIonisatioModel::SampleSecondaries()", "em2050", FatalException,
  ...
  tot_ioni_energy = shell_energy[0] + shell_energy[1] + shell_energy[2] + shell_energy[3];
  ...
  mioni_manager_->CreateMultipleIonisedWaterMolecule(eQuadrupleIonisedMolecule, ioni_shell,
                                                     the_track);
  // ***************************************************************************
}
