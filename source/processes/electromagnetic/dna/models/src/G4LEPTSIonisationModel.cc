...
G4LEPTSIonisationModel::G4LEPTSIonisationModel(const G4String& modelName) : G4VLEPTSModel(modelName)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
G4LEPTSIonisationModel::~G4LEPTSIonisationModel() = default;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void G4LEPTSIonisationModel::Initialise(const G4ParticleDefinition* aParticle, const G4DataVector&)
{
  Init();
...
#ifdef DEBUG_LEPTS
  G4cout << " G4LEPTSIonisationModel::SampleSecondaries( SetProposedKineticEnergy " << P1KinEn
         << " " << P0KinEn << " - " << Energylost << G4endl;
#endif

  G4double P2KinEn;

  if (Energylost < theIonisPotInt[aMaterial])
  {  // External Ionisation
