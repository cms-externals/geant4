                                           ...
                                           const G4DataVector& /*cuts*/)
{
  ...
  {
    if (fasterCode)
      G4Exception("G4DNABornIonisationModel1::Initialise", "em0003", FatalException,
...
G4double
G4DNABornIonisationModel1::CrossSectionPerVolume(const G4Material* material,
                                                 const G4ParticleDefinition* particleDefinition,
                                                 G4double ekin, G4double, G4double)
{
  if (verboseLevel > 3)
  {
    G4cout << "Calling CrossSectionPerVolume() of G4DNABornIonisationModel1" << G4endl;
  }
  ...
  if (ekin >= lowLim && ekin <= highLim)
  {
    ...
    {
      G4Exception("G4DNABornIonisationModel1::CrossSectionPerVolume", "em0002", FatalException,
                                                  ...
                                                  G4double)
{
  if (verboseLevel > 3)
  {
    G4cout << "Calling SampleSecondaries() of G4DNABornIonisationModel1" << G4endl;
  }
  ...
  if (k >= lowLim && k <= highLim)
  {
    ...
    if (bindingEnergy < 0.0)
      G4Exception("G4DNABornIonisatioModel1::SampleSecondaries()", "em2050", FatalException,
...
G4double
G4DNABornIonisationModel1::RandomizeEjectedElectronEnergy(G4ParticleDefinition* particleDefinition,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double
G4DNABornIonisationModel1::DifferentialCrossSection(G4ParticleDefinition* particleDefinition,
...
G4double G4DNABornIonisationModel1::Interpolate(G4double e1, G4double e2, G4double e, G4double xs1,
                                                G4double xs2)
{
  G4double value = 0.;
...
G4double G4DNABornIonisationModel1::QuadInterpolator(G4double e11, G4double e12, G4double e21,
...
G4int G4DNABornIonisationModel1::RandomSelect(G4double k, const G4String& particle)
{
  G4int level = 0;
  ...
  {
    G4Exception("G4DNABornIonisationModel1::RandomSelect", "em0002", FatalException,
                "Model not applicable to particle type.");
  }
...
G4double G4DNABornIonisationModel1::RandomizeEjectedElectronEnergyFromCumulatedDcs(
