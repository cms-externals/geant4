...
G4DNACrossSectionDataSet* G4DNARuddIonisationDynamicModel::xsdata_alpha = nullptr;
G4DNACrossSectionDataSet* G4DNARuddIonisationDynamicModel::xsdata_alphap = nullptr;
...
void G4DNARuddIonisationDynamicModel::LoadData()
{
  ...
  xsdata_alpha = new G4DNACrossSectionDataSet(new G4LogLogInterpolation, CLHEP::eV, scaleFactor);
  xsdata_alpha->LoadData(filename);

  filename = "dna/sigma_ionisation_alphaplus_rudd";
  xsdata_alphap = new G4DNACrossSectionDataSet(new G4LogLogInterpolation, CLHEP::eV, scaleFactor);
  xsdata_alphap->LoadData(filename);
