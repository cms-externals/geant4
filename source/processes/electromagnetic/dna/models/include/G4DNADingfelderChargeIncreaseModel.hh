...
#ifndef G4DNADINGFELDERCHARGEINCREASEMODEL_HH
#define G4DNADINGFELDERCHARGEINCREASEMODEL_HH
...
class G4DNADingfelderChargeIncreaseModel : public G4VEmModel
{
  public:
    ...
    explicit G4DNADingfelderChargeIncreaseModel(
    ...
    operator=(const G4DNADingfelderChargeIncreaseModel& right) = delete;
  ...
  private:
    ...
    G4double PartialCrossSection(const G4double& energy, const G4int& level,
    ...
    G4double IncomingParticleBindingEnergyConstant(G4ParticleDefinition* particleDefinition,
                                                   G4int finalStateIndex);
