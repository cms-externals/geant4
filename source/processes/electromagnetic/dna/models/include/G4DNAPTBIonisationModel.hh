...
#ifndef G4DNAPTBIONISATIONMODEL_HH
#define G4DNAPTBIONISATIONMODEL_HH
...
class G4DNAPTBIonisationModel : public G4VDNAModel
{
  public:
    ...
    operator=(const G4DNAPTBIonisationModel& right) = delete;  // prevent assignement
  ...
  private:
     ...
     */
    G4double RandomizeEjectedElectronEnergyFromCumulated(const G4ParticleDefinition*, G4double k,
                                                         G4int shell,
    ...
    G4double QuadInterpolator(G4double e11, G4double e12, G4double e21, G4double e22, G4double xs11,
                              G4double xs12, G4double xs21, G4double xs22, G4double t1, G4double t2,
