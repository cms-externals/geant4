...
#ifndef G4DNARUDDIONISATIONDYNAMICMODEL_HH
#define G4DNARUDDIONISATIONDYNAMICMODEL_HH
...
class G4DNARuddIonisationDynamicModel : public G4VEmModel, public G4VSIntegration
{
  public:
    ...
    operator=(const G4DNARuddIonisationDynamicModel& right) = delete;
