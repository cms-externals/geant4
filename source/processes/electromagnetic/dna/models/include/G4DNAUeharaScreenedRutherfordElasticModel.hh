...
#ifndef G4DNAUEHARASCREENEDRUTHERFORDELASTICMODEL_HH
#define G4DNAUEHARASCREENEDRUTHERFORDELASTICMODEL_HH
...
inline void G4DNAUeharaScreenedRutherfordElasticModel::SelectHighEnergyLimit(G4double threshold)
{
...
inline void G4DNAUeharaScreenedRutherfordElasticModel::SetKillBelowThreshold(G4double)
{
  ...
  G4Exception("G4DNAUeharaScreenedRutherfordElasticModel::SetKillBelowThreshold", "DEPRECATED",
              JustWarning, errMsg);
}

inline G4double G4DNAUeharaScreenedRutherfordElasticModel::GetKillBelowThreshold()
{
  G4ExceptionDescription errMsg;
  errMsg << "*** WARNING : "
  ...
  G4Exception("G4DNAUeharaScreenedRutherfordElasticModel::GetKillBelowThreshold", "DEPRECATED",
              JustWarning, errMsg);
