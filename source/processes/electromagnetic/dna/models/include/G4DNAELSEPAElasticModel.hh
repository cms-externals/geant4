...
#ifndef G4DNAELSEPAELASTICMODEL_HH
#define G4DNAELSEPAELASTICMODEL_HH
...
class G4DNAELSEPAElasticModel : public G4VEmModel
{
  public:
    ...
    G4double CrossSectionPerVolume(const G4Material* material, const G4ParticleDefinition* particle,
    ...
    {
      fhighEnergyLimit = input;
      SetHighEnergyLimit(input);
    };
  ...
  private:
    ...
    G4double Theta(G4int Z, G4ParticleDefinition* aParticleDefinition, G4double k,
                   G4double integrDiff);
