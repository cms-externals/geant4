...
#ifndef G4DNA_DOUBLE_IONISATION_MODEL_HH
#define G4DNA_DOUBLE_IONISATION_MODEL_HH
...
using CrossSectionDataTable = std::map<G4String, G4DNACrossSectionDataSet*, std::less<G4String>>;
...
class G4DNADoubleIonisationModel : public G4VEmModel
{
  public:
    ...
    // constructor
    G4DNADoubleIonisationModel(const G4ParticleDefinition* p = nullptr,
