...
#ifndef G4DNAIONCHARGEINCREASEMODEL_HH
#define G4DNAIONCHARGEINCREASEMODEL_HH
...
class G4DNAIonChargeIncreaseModel : public G4VEmModel
{
  public:
    ...
    G4DNAIonChargeIncreaseModel& operator=(const G4DNAIonChargeIncreaseModel& right) = delete;
