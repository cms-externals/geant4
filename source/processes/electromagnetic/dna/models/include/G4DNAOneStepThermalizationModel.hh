...
using G4DNAOneStepThermalizationModel =
  G4TDNAOneStepThermalizationModel<DNA::Penetration::Meesungnoen2002>;

// typedef G4TDNAOneStepThermalizationModel<DNA::Penetration::Terrisol1990>
// G4DNAOneStepThermalizationModel; Note: if you use the above distribution, it would be better to
// follow the electrons down to 6 eV and only then apply the one step thermalization
