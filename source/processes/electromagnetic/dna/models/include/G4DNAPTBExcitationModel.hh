...
#ifndef G4DNAPTBEXCITATIONMODEL_HH
#define G4DNAPTBEXCITATIONMODEL_HH
...
class G4DNAPTBExcitationModel : public G4VDNAModel
{
  public:
    ...
    operator=(const G4DNAPTBExcitationModel& right) = delete;  // prevent assignement
     ...
     * called. The method sets the incident particle characteristics after the ModelInterface.
     * \param materialName \param particleChangeForGamma \param tmin \param tmax
     */
