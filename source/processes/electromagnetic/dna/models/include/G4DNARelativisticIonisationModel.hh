...
#ifndef G4DNARELATIVISTICIONISATIONMODEL_HH
#define G4DNARELATIVISTICIONISATIONMODEL_HH
...
class G4DNARelativisticIonisationModel : public G4VEmModel
{
  public:
    ...
    operator=(const G4DNARelativisticIonisationModel& right) = delete;
    ...
    virtual G4double GetTotalCrossSection(const G4Material* material, const G4ParticleDefinition*,
                                          G4double kineticEnergy);
    G4double GetPartialCrossSection(const G4Material* material, G4int level,
                                    const G4ParticleDefinition*, G4double kineticEnergy) override;
    virtual G4double GetDifferentialCrossSection(const G4Material* material,
                                                 const G4ParticleDefinition* particle,
                                                 G4double kineticEnergy, G4double secondaryEnergy,
                                                 G4int level);
  ...
  private:
    ...
    using TriDimensionVecMapZ =
      std::map<G4int, std::map<G4int, std::map<G4double, std::vector<G4double>>>>;
    TriDimensionVecMapZ eProbaShellMapZ;

    using QuadDimensionMapZ =
      std::map<G4int, std::map<G4int, std::map<G4double, std::map<G4double, G4double>>>>;
    ...
    G4double GetEjectedElectronEnergy(const G4Material* material, const G4ParticleDefinition*,
                                      G4double energy, G4int shell);
    G4ThreeVector GetEjectedElectronDirection(const G4ParticleDefinition*, G4double energy,
