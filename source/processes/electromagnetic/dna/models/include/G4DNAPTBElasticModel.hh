...
#ifndef G4DNAPTBELASTICMODEL_HH
#define G4DNAPTBELASTICMODEL_HH
...
class G4DNAPTBElasticModel : public G4VDNAModel
{
  public:
    ...
    operator=(const G4DNAPTBElasticModel& right) = delete;  // prevent assignement
  ...
  private:
    ...
    /*!
     * \brief Theta
     * To return an angular theta value from the differential file. This method uses interpolations
     * to calculate the theta value. \param fParticleDefinition \param k \param integrDiff \param
