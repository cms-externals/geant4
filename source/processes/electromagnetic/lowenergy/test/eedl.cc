  ...
  */
  ...
  do {
	...
	size_t jmax  = jmax1 + jmax2 + 1;
	  ...
	  // log
          G4double dx2 = G4Log(x3/xmax)/range2;
          x4 = x3*G4Exp(dx2);
	      ...
	      x = xmax*G4Exp(dx2 * (G4double)(i - jmax1));
	    }
	  ...
	  if(iiii == iiiimax-1 || zdelm <= zgood ) {
            ...
            for(G4double edu=1.0; edu<11.; edu *=3.0) {
              ...
              if(edu > dv2[0] && edu < dv3[0]){
                ...
                G4double u  = G4Log(edu)/g4pow->logZ(10);
                G4double u1 = G4Log(dv1[0])/g4pow->logZ(10);
                G4double u2 = G4Log(dv2[0])/g4pow->logZ(10);
                G4double u3 = G4Log(dv3[0])/g4pow->logZ(10);
                dv4[0]      = edu; 
