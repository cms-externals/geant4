...
G4double G4hBetheBlochModel::HighEnergyLimit(const G4ParticleDefinition*, const G4Material*) const
{
...
{
  G4double taul = (material->GetIonisation()->GetTaul()) * (aParticle->GetPDGMass());
  return taul;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double G4hBetheBlochModel::HighEnergyLimit(const G4ParticleDefinition*) const
{
  return highEnergyLimit;
}
...
G4double G4hBetheBlochModel::LowEnergyLimit(const G4ParticleDefinition*) const
{
...
G4bool G4hBetheBlochModel::IsInCharge(const G4DynamicParticle*, const G4Material*) const
{
  return true;
}
...
G4bool G4hBetheBlochModel::IsInCharge(const G4ParticleDefinition*, const G4Material*) const
{
  return true;
}
...
G4double G4hBetheBlochModel::BetheBlochFormula(const G4Material* material, G4double kineticEnergy,
