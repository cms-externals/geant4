...
G4MicroElecElasticModel::G4MicroElecElasticModel(const G4ParticleDefinition*, const G4String& nam)
...
{
  if (verboseLevel > 3) G4cout << "Calling G4MicroElecElasticModel::Initialise()" << G4endl;

  // Energy limits
  if (LowEnergyLimit() < lowEnergyLimit)
  {
    G4cout << "G4MicroElecElasticModel: low energy limit increased from " << LowEnergyLimit() / eV
  ...
  if (!path)
  {
    G4Exception("G4MicroElecElasticModel::Initialise", "em0006", FatalException,
...
G4double G4MicroElecElasticModel::Theta(G4ParticleDefinition* particleDefinition, G4double k,
                                        G4double integrDiff)
{
  G4double theta = 0.;
  G4double valueT1 = 0;
...
G4double G4MicroElecElasticModel::LinLogInterpolate(G4double e1, G4double e2, G4double e,
...
G4double G4MicroElecElasticModel::LinLinInterpolate(G4double e1, G4double e2, G4double e,
                                                    G4double xs1, G4double xs2)
{
  G4double d1 = xs1;
  G4double d2 = xs2;
...
G4double G4MicroElecElasticModel::LogLogInterpolate(G4double e1, G4double e2, G4double e,
                                                    G4double xs1, G4double xs2)
{
...
G4double G4MicroElecElasticModel::QuadInterpolator(G4double e11, G4double e12, G4double e21,
