...
G4hICRU49p::G4hICRU49p() : G4VhElectronicStoppingPower(), protonMassAMU(1.007276), iMolecula(0)
{
  ;
}
...
G4bool G4hICRU49p::HasMaterial(const G4Material* material)
{
  ...
  static const G4String name[numberOfMolecula] = {"Al_2O_3",
                                                  "CO_2",
                                                  "CH_4",
...
G4double G4hICRU49p::StoppingPower(const G4Material* material, G4double kineticEnergy)
{
  ...
  else if (iMolecula < 11)
  {
    ...
    static const G4double a[11][5] = {{1.187E+1, 1.343E+1, 1.069E+4, 7.723E+2, 2.153E-2},
    ...
    else if (T < 10000.0)
    {
      ...
      G4double shigh =
        std::log(1.0 + a[iMolecula][3] / T + a[iMolecula][4] * T) * a[iMolecula][2] / T;
...
G4double G4hICRU49p::ElectronicStoppingPower(G4double z, G4double kineticEnergy) const
{
  ...
  static const G4double a[92][5] = {{1.254E+0, 1.440E+0, 2.426E+2, 1.200E+4, 1.159E-1},
