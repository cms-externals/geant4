...
G4bool G4MicroElecCrossSectionDataSet::LoadData(const G4String& argFileName)
{
  ...
  if (!in.is_open())
  {
    ...
    message += "\" not found";
    G4Exception("G4MicroElecCrossSectionDataSet::LoadData", "em0003", FatalException, message);
    return false;
  }
  ...
  if (maxI < 2)
  {
    ...
    G4Exception("G4MicroElecCrossSectionDataSet::LoadData", "em0005", FatalException, message);
    return false;
  }
...
G4bool G4MicroElecCrossSectionDataSet::SaveData(const G4String& argFileName) const
{
  ...
  if (n == 0)
  {
    G4Exception("G4MicroElecCrossSectionDataSet::SaveData", "em0005", FatalException,
  ...
  if (!out.is_open())
  {
    ...
    message += fullFileName;
    message += "\"";
    G4Exception("G4MicroElecCrossSectionDataSet::SaveData", "em0005", FatalException, message);
    return false;
  }
...
G4String G4MicroElecCrossSectionDataSet::FullFileName(const G4String& argFileName) const
{
  ...
  if (!path)
  {
    G4Exception("G4MicroElecCrossSectionDataSet::FullFileName", "em0006", FatalException,
...
G4double G4MicroElecCrossSectionDataSet::FindValue(G4double argEnergy,
...
void G4MicroElecCrossSectionDataSet::SetEnergiesData(G4DataVector* argEnergies,
                                                     G4DataVector* argData, G4int argComponentId)
{
  ...
  G4Exception("G4MicroElecCrossSectionDataSet::SetEnergiesData", "em0005", FatalException,
              message.str().c_str());
}
                                                        ...
                                                        G4int argComponentId)
{
  ...
  G4Exception("G4MicroElecCrossSectionDataSet::SetLogEnergiesData", "em0005", FatalException,
              message.str().c_str());
}
