...
G4IonYangFluctuationModel::G4IonYangFluctuationModel(const G4String& name) : G4VLowEnergyModel(name)
{
  ;
}
...
G4double G4IonYangFluctuationModel::LowEnergyLimit(const G4ParticleDefinition*) const
{
  return 0.0;
}
...
G4bool G4IonYangFluctuationModel::IsInCharge(const G4DynamicParticle*, const G4Material*) const
{
  return true;
}
...
G4bool G4IonYangFluctuationModel::IsInCharge(const G4ParticleDefinition*, const G4Material*) const
{
  return true;
}
                                                         ...
                                                         G4double charge) const
{
  ...
  G4double q = factor * x * b[i][0] / ((energy - b[i][1]) * (energy - b[i][1]) + x * x);
