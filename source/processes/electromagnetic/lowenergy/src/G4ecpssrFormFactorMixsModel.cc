...
G4double G4ecpssrFormFactorMixsModel::CalculateMiCrossSection(G4int zTarget, G4double massIncident,
...
G4double G4ecpssrFormFactorMixsModel::CalculateM1CrossSection(G4int zTarget, G4double massIncident,
                                                              G4double energyIncident)
{
  // mShellId
...
G4double G4ecpssrFormFactorMixsModel::CalculateM2CrossSection(G4int zTarget, G4double massIncident,
                                                              G4double energyIncident)
{
  // mShellId
...
G4double G4ecpssrFormFactorMixsModel::CalculateM3CrossSection(G4int zTarget, G4double massIncident,
                                                              G4double energyIncident)
{
...
G4double G4ecpssrFormFactorMixsModel::CalculateM4CrossSection(G4int zTarget, G4double massIncident,
                                                              G4double energyIncident)
{
...
G4double G4ecpssrFormFactorMixsModel::CalculateM5CrossSection(G4int zTarget, G4double massIncident,
                                                              G4double energyIncident)
{
