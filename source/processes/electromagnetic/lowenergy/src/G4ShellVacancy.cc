                                                               ...
                                                               G4double eLoss) const
{
  ...
  {
    G4double averageNumberOfIonisations = AverageNOfIonisations(couple, i, incidentEnergy, eLoss);
    G4int ionisations = 0;
...
G4double G4ShellVacancy::AverageNOfIonisations(const G4MaterialCutsCouple* couple, G4int index,
                                               G4double energy, G4double eLoss) const
