...
{
  if (fVerboseLevel > 3) G4cout << "Calling G4PenelopeRayleighModel::Initialise()" << G4endl;
...
{
  if (fVerboseLevel > 3) G4cout << "Calling  G4PenelopeRayleighModel::InitialiseLocal()" << G4endl;
  //
  ...
  if (part == fParticle)
  {
    ...
    const G4PenelopeRayleighModel* theModel = static_cast<G4PenelopeRayleighModel*>(masterModel);
...
G4double G4PenelopeRayleighModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
                                                             G4double energy, G4double Z, G4double,
                                                             G4double, G4double)
{
  ...
  if (!fLogAtomicCrossSection[iZ])
  {
    ...
    if (fVerboseLevel > 0)
    {
      ...
      G4Exception("G4PenelopeRayleighModel::ComputeCrossSectionPerAtom()", "em2040", JustWarning,
                  ed);
    }
  ...
  if (!atom)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::ComputeCrossSectionPerAtom()", "em2041", FatalException,
                ed);
    return 0;
  }
...
void G4PenelopeRayleighModel::BuildFormFactorTable(const G4Material* material)
{
  ...
  */
  ...
  if (MaxStechiometricFactor < 1e-16)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::BuildFormFactorTable()", "em2042", FatalException, ed);
  }
  // Normalize
  for (std::size_t i = 0; i < nElements; ++i)
  ...
  */
  ...
  for (std::size_t k = 0; k < fLogQSquareGrid.size(); ++k)
  {
    ...
    if (ff2)
      theFFVec->PutValue(k, fLogQSquareGrid[k],
                         G4Log(ff2));  // NOTICE: THIS IS log(Q^2) vs. log(F^2)
  }
                                                ...
                                                G4double)
{
  ...
  if (!fSamplingTable->count(theMat))
  {
    ...
    if (fVerboseLevel > 0)
    {
      ...
      G4Exception("G4PenelopeRayleighModel::SampleSecondaries()", "em2019", JustWarning, ed);
    }
...
void G4PenelopeRayleighModel::ReadDataFile(const G4int Z)
{
  ...
  if (!path)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::ReadDataFile()", "em0006", FatalException, excep);
    return;
  }
  ...
  */
  ...
  if (!file.is_open())
  {
    ...
    G4Exception("G4PenelopeRayleighModel::ReadDataFile()", "em0003", FatalException, excep);
  }
  G4int readZ = 0;
  ...
  if (readZ != Z || nPoints <= 0 || nPoints >= 5000)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::ReadDataFile()", "em0005", FatalException, ed);
    return;
  }
  ...
  */
  ...
  if (!fLogQSquareGrid.size()) fillQGrid = true;
  for (std::size_t i = 0; i < nPoints; ++i)
  {
    file >> q >> ff >> incoh;
...
G4double G4PenelopeRayleighModel::GetFSquared(const G4Material* mat, const G4double QSquared)
{
  ...
  if (!theVec)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::GetFSquared()", "em2046", FatalException, ed);
    return 0;
  }
...
void G4PenelopeRayleighModel::InitializeSamplingAlgorithm(const G4Material* mat)
{
  ...
  if (np < 16)
  {
    G4Exception("G4PenelopeRayleighModel::InitializeSamplingAlgorithm()", "em2047", FatalException,
                "Too few points to initialize the sampling algorithm");
  }
  if (q2min > (q2max - 1e-10))
  {
    G4cout << "q2min= " << q2min << " q2max= " << q2max << G4endl;
    G4Exception("G4PenelopeRayleighModel::InitializeSamplingAlgorithm()", "em2048", FatalException,
  ...
  ********************************************************************************/
  ...
  if (x->size() != NUNIF || a->size() != NUNIF || err->size() != NUNIF || area->size() != NUNIF)
  {
    ...
    G4Exception("G4PenelopeRayleighModel::InitializeSamplingAlgorithm()", "em2049", FatalException,
                ed);
  }
  ...
  ********************************************************************************/
  ...
  {
    G4Exception(
      "G4PenelopeRayleighModel::InitializeSamplingAlgorithm()", "em2050", FatalException,
  ...
  ********************************************************************************/
  ...
  {
    G4Exception("G4PenelopeRayleighModel::InitializeSamplingAlgorithm()", "em2051", FatalException,
...
void G4PenelopeRayleighModel::GetPMaxTable(const G4Material* mat)
{
  ...
  if (!fSamplingTable)
  {
    G4Exception("G4PenelopeRayleighModel::GetPMaxTable()", "em2052", FatalException,
  ...
  if (!fSamplingTable->count(mat))
  {
    ...
    G4Exception("G4PenelopeRayleighModel::GetPMaxTable()", "em2052", FatalException, ed);
    return;
  }
