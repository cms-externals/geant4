...
G4bool G4CrossSectionDataSet::LoadData(const G4String& argFileName)
{
  ...
  if (!in.is_open())
  {
    ...
    message += "\" not found";
    G4Exception("G4CrossSectionDataSet::LoadData", "em0003", FatalException, message);
    return false;
  }
  ...
  if (maxI < 2)
  {
    ...
    G4Exception("G4CrossSectionDataSet::LoadData", "em0005", FatalException, message);
    return false;
  }
...
G4bool G4CrossSectionDataSet::LoadNonLogData(const G4String& argFileName)
{
  ...
  if (!in.is_open())
  {
    ...
    message += fullFileName;
    message += "\" not found";
    G4Exception("G4CrossSectionDataSet::LoadNonLogData", "em0003", FatalException, message);
    return false;
  }
  ...
  if (maxI < 2)
  {
    ...
    message += fullFileName;
    message += "\" should have at least two columns";
    G4Exception("G4CrossSectionDataSet::LoadNonLogData", "em0005", FatalException, message);
    return false;
  }
  ...
  while (i < maxI)
  {
    ...
    AddComponent(new G4EMDataSet(i - 1, argEnergies, argData, GetAlgorithm()->Clone(),
...
G4bool G4CrossSectionDataSet::SaveData(const G4String& argFileName) const
{
  ...
  if (n == 0)
  {
    G4Exception("G4CrossSectionDataSet::SaveData", "em0005", FatalException,
  ...
  if (!out.is_open())
  {
    ...
    message += fullFileName;
    message += "\"";
    G4Exception("G4CrossSectionDataSet::SaveData", "em0003", FatalException, message);
    return false;
  }
...
G4String G4CrossSectionDataSet::FullFileName(const G4String& argFileName) const
{
  ...
  if (!path)
  {
    G4Exception("G4CrossSectionDataSet::FullFileName", "em0006", FatalException,
...
void G4CrossSectionDataSet::SetEnergiesData(G4DataVector* argEnergies, G4DataVector* argData,
                                            G4int argComponentId)
{
  ...
  G4Exception("G4CrossSectionDataSet::SetEnergiesData", "em0005", FatalException,
              message.str().c_str());
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void G4CrossSectionDataSet::SetLogEnergiesData(G4DataVector* argEnergies, G4DataVector* argData,
                                               ...
                                               G4DataVector* argLogData, G4int argComponentId)
{
  ...
  G4Exception("G4CrossSectionDataSet::SetLogEnergiesData", "em0005", FatalException,
              message.str().c_str());
}
