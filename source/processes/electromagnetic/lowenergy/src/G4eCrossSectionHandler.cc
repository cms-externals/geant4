...
G4eCrossSectionHandler::G4eCrossSectionHandler(G4VDataSetAlgorithm* alg, G4double emin,
...
G4eCrossSectionHandler::BuildCrossSectionsForMaterials(const G4DataVector&, const G4DataVector*)
{
