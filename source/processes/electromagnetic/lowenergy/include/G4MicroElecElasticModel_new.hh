...
#define G4MICROELECELASTICMODEL_NEW_HH
...
class G4MicroElecElasticModel_new : public G4VEmModel
{
  public:
    ...
    G4double AcousticCrossSectionPerVolume(G4double ekin, G4double kbz, G4double rho, G4double cs,
                                           G4double Aac, G4double Eac, G4double prefactor);
