...
class G4VIonDEDXScalingAlgorithm
{
  public:
    ...
    virtual G4double ScalingFactorEnergy(const G4ParticleDefinition*,  // Projectile (ion)
    ...
    virtual G4double ScalingFactorDEDX(const G4ParticleDefinition*,  // Projectile (ion)
                                       const G4Material*,  // Target material
    ...
    /// particle.
    virtual G4int AtomicNumberBaseIon(G4int atomicNumberIon,  // Atomic number of ion
                                      const G4Material*)  // Target material
    {
