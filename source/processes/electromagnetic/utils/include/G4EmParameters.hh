...
#ifndef G4EMPARAMETERS_HH
#define G4EMPARAMETERS_HH
...
class G4EmParameters
{
  public:
    ...
    G4bool UseParallelInitialisation() const;
    void SetUseParallelInitialisation(G4bool v);
    ...
    void ActivateForcedInteraction(const G4String& procname, const G4String& region,
                                   G4double length, G4bool wflag);

    void ActivateSecondaryBiasing(const G4String& name, const G4String& region, G4double factor,
  ...
  private:
    ...
    G4bool fParallelInitialisation;
