...
#ifndef G4VENERGYLOSSPROCESS_HH
#define G4VENERGYLOSSPROCESS_HH
...
class G4VEnergyLossProcess : public G4VContinuousDiscreteProcess
{
  ...
  public:
    ...
    G4double GetDEDXDispersion(const G4MaterialCutsCouple* couple, const G4DynamicParticle* dp,
                               G4double length);
    ...
    G4double ContinuousStepLimit(const G4Track& track, G4double previousStepSize,
  ...
  public:
    ...
    inline G4VEmModel* SelectModelForMaterial(G4double kinEnergy, std::size_t& idxCouple) const;
    ...
    // energy interval
    void AddEmModel(G4int, G4VEmModel*, G4VEmFluctuationModel* fluc = nullptr,
  ...
  public:
    ...
    G4VEnergyLossProcess& operator=(const G4VEnergyLossProcess&) = delete;
    ...
    inline G4double GetCSDADEDX(G4double kineticEnergy, const G4MaterialCutsCouple*);
    inline G4double GetDEDX(G4double kineticEnergy, const G4MaterialCutsCouple*,
                            G4double logKineticEnergy);
    ...
    inline void SetTablesAreBuilt(G4bool);
  ...
  private:
    ...
    //------------------------------------------------------------------------
    inline G4double GetDEDXForScaledEnergy(const G4double scaledKinE);
    inline G4double GetDEDXForScaledEnergy(const G4double scaledKinE, const G4double logScaledKinE);
    inline G4double GetIonisationForScaledEnergy(const G4double scaledKinE);
    inline G4double GetScaledRangeForScaledEnergy(const G4double scaledKinE);
    inline G4double GetScaledRangeForScaledEnergy(const G4double scaledKinE,
                                                  const G4double logScaledKinE);

    inline G4double GetLimitScaledRangeForScaledEnergy(const G4double scaledKinE);
    inline G4double GetLimitScaledRangeForScaledEnergy(const G4double scaledKinE,
                                                       const G4double logScaledKinE);

    inline G4double ScaledKinEnergyForLoss(const G4double range);
    inline G4double GetLambdaForScaledEnergy(const G4double scaledKinE);
    inline G4double GetLambdaForScaledEnergy(const G4double scaledKinE,
                                             const G4double logScaledKinE);

    inline G4double LogScaledEkin(const G4Track& aTrack);

    void ComputeLambdaForScaledEnergy(const G4double scaledKinE, const G4Track& aTrack);
...
inline G4VEmModel* G4VEnergyLossProcess::SelectModelForMaterial(G4double kinEnergy,
...
inline G4double G4VEnergyLossProcess::GetDEDXForScaledEnergy(const G4double e)
{
  G4double x = fFactor * (*theDEDXTable)[basedCoupleIndex]->Value(e, idxDEDX);
  if (e < minKinEnergy)
  {
    x *= std::sqrt(e / minKinEnergy);
  }
  return x;
}
...
inline G4double G4VEnergyLossProcess::GetDEDXForScaledEnergy(const G4double e, const G4double loge)
{
...
inline G4double G4VEnergyLossProcess::GetIonisationForScaledEnergy(const G4double e)
{
  G4double x = fFactor * (*theIonisationTable)[basedCoupleIndex]->Value(e, idxIonisation);
  if (e < minKinEnergy)
  {
    x *= std::sqrt(e / minKinEnergy);
  }
...
inline G4double G4VEnergyLossProcess::GetScaledRangeForScaledEnergy(const G4double e)
{
  if (currentCoupleIndex != coupleIdxRange || fRangeEnergy != e)
  {
    ...
    if (e < minKinEnergy)
    {
      fRange *= std::sqrt(e / minKinEnergy);
    }
  }
  return fRange;
}
...
inline G4double G4VEnergyLossProcess::GetLimitScaledRangeForScaledEnergy(const G4double e)
{
...
inline G4double G4VEnergyLossProcess::ScaledKinEnergyForLoss(const G4double r)
{
...
inline G4double G4VEnergyLossProcess::GetLambdaForScaledEnergy(const G4double e)
{
...
inline G4double G4VEnergyLossProcess::GetDEDX(const G4double kinEnergy,
...
inline G4double G4VEnergyLossProcess::GetRange(const G4double kinEnergy,
                                               const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double G4VEnergyLossProcess::GetCSDARange(const G4double kineticEnergy,
                                                   const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
  return (nullptr == theCSDARangeTable)
           ? DBL_MAX
...
inline G4double G4VEnergyLossProcess::GetKineticEnergy(const G4double range,
                                                       const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double G4VEnergyLossProcess::GetLambda(const G4double kinEnergy,
                                                const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
  return (nullptr != theLambdaTable) ? GetLambdaForScaledEnergy(kinEnergy * massRatio) : 0.0;
}
...
inline G4bool G4VEnergyLossProcess::Spline() const
{
  return spline;
}
...
inline void G4VEnergyLossProcess::SetTablesAreBuilt(G4bool val)
{
  tablesAreBuilt = val;
}
...
inline std::vector<G4double>* G4VEnergyLossProcess::EnergyOfCrossSectionMax() const
{
...
inline G4VEmModel* G4VEnergyLossProcess::GetModelByIndex(std::size_t idx, G4bool ver) const
{
