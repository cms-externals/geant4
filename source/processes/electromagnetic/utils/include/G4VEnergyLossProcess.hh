...
public:
  ...
  inline G4VEmModel* GetModelByIndex(std::size_t idx = 0,
...
public:
  ...
  void SetDEDXTable(G4PhysicsTable* p, G4EmTableType tType, G4bool);
  void SetCSDARangeTable(G4PhysicsTable* pRange);
  void SetRangeTableForLoss(G4PhysicsTable* p);
  void SetInverseRangeTable(G4PhysicsTable* p);
  void SetLambdaTable(G4PhysicsTable* p, G4bool);
...
private:
  ...
  inline G4double
  GetLimitScaledRangeForScaledEnergy(const G4double scaledKinE,
                                     const G4double logScaledKinE);
  ...
  void ComputeLambdaForScaledEnergy(const G4double scaledKinE,
...
inline G4double
G4VEnergyLossProcess::GetDEDXForScaledEnergy(const G4double e,
                                             const G4double loge)
{
  G4double x =
    fFactor*(*theDEDXTable)[basedCoupleIndex]->LogVectorValue(e, loge);
  if(e < minKinEnergy) { x *= std::sqrt(e/minKinEnergy); }
  return x;
}
...
inline G4double
G4VEnergyLossProcess::GetIonisationForScaledEnergy(const G4double e)
{
  G4double x = 
...
inline G4double
G4VEnergyLossProcess::GetScaledRangeForScaledEnergy(const G4double e)
{
...
inline G4double 
G4VEnergyLossProcess::GetLimitScaledRangeForScaledEnergy(const G4double e)
{
...
{
  G4double x =
    ((*theCSDARangeTable)[basedCoupleIndex])->LogVectorValue(e, loge);
  x = std::max(x, 0.0);
  if (e < minKinEnergy) { x *= std::sqrt(e/minKinEnergy); }
  return x;
}
...
inline G4double
G4VEnergyLossProcess::GetLambdaForScaledEnergy(const G4double e)
{
...
inline G4double 
G4VEnergyLossProcess::GetDEDX(const G4double kinEnergy,
                              const G4MaterialCutsCouple* couple)
{
...
inline G4double 
G4VEnergyLossProcess::GetRange(const G4double kinEnergy,
                               const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double 
G4VEnergyLossProcess::GetCSDARange(const G4double kineticEnergy, 
                                   const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double 
G4VEnergyLossProcess::GetKineticEnergy(const G4double range,
                                       const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline G4double 
G4VEnergyLossProcess::GetLambda(const G4double kinEnergy,
                                const G4MaterialCutsCouple* couple)
{
  DefineMaterial(couple);
...
inline void G4VEnergyLossProcess::ResetFlagPrepared()
{
  isPrepared = false;
}
