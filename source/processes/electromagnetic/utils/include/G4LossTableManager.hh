...
// ********************************************************************
//
// $Id: G4LossTableManager.hh 111233 2018-07-25 18:58:18Z vnivanch $
//
//
// -------------------------------------------------------------------
//
...
public:
  ...
  inline void SetGammaSuperProcess(G4VEmProcess*); 

  inline G4VEmProcess* GetGammaSuperProcess(); 

  inline void SetElectronSuperProcess(G4VEnergyLossProcess*); 

  inline G4VEnergyLossProcess* GetElectronSuperProcess(); 
...
inline void G4LossTableManager::SetGammaSuperProcess(G4VEmProcess* ptr)
{
  gSuper = ptr;
} 
...
inline G4VEmProcess* G4LossTableManager::GetGammaSuperProcess()
{
  return gSuper;
} 
...
inline 
void G4LossTableManager::SetElectronSuperProcess(G4VEnergyLossProcess* ptr)
{
  eSuper = ptr;
} 
...
inline G4VEnergyLossProcess* G4LossTableManager::GetElectronSuperProcess()
{
  return eSuper;
} 
