...
//
//
#ifndef G4EMSATURATION_HH
#define G4EMSATURATION_HH
...
class G4EmSaturation
{
  public:
    ...
    virtual G4double VisibleEnergyDeposition(const G4ParticleDefinition*,
                                             const G4MaterialCutsCouple*, G4double length,
                                             G4double edepTotal, G4double edepNIEL = 0.0) const;
...
inline G4double G4EmSaturation::VisibleEnergyDepositionAtAStep(const G4Step* step) const
{
  return VisibleEnergyDeposition(
    step->GetTrack()->GetParticleDefinition(), step->GetTrack()->GetMaterialCutsCouple(),
    step->GetStepLength(), step->GetTotalEnergyDeposit(), step->GetNonIonizingEnergyDeposit());
}
