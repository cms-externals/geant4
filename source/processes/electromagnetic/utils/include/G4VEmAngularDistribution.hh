...
public:
  ...
  inline void SetPolarisationFlag(G4bool);

  inline G4bool PolarisationFlag() const;
...
inline void G4VEmAngularDistribution::SetPolarisationFlag(G4bool val)
{
  fPolarisation = val;
}

inline G4bool G4VEmAngularDistribution::PolarisationFlag() const
{
