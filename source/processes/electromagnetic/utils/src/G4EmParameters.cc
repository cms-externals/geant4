...
void G4EmParameters::SetSuperProcessActive(G4bool val)
{
  if(IsLocked()) { return; }
  super = val;
  // if super interaction is possible then sub-cutoff and 
...
G4bool G4EmParameters::SuperProcessActive() const
{
  return super;
}
