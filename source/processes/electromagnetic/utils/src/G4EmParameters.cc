...
void G4EmParameters::SetDNAMultipleIonisation(G4bool val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetDNAMultipleIonisation(val);
  fDNA = true;
}

G4bool G4EmParameters::DNAMultipleIonisation() const
{
  return fCParameters->DNAMultipleIonisation();
}
...
G4bool G4EmParameters::UseParallelInitialisation() const
{
  return fParallelInitialisation;
}

void G4EmParameters::SetUseParallelInitialisation(G4bool v)
{
  if (IsLocked())
  {
    return;
  }
  fParallelInitialisation = v;
}
...
void G4EmParameters::SetMinEnergy(G4double val)
{
  ...
  else
  {
    ...
    ed << "Value of MinKinEnergy - is out of range: " << val / CLHEP::MeV << " MeV is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMaxEnergy(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of MaxKinEnergy is out of range: " << val / CLHEP::GeV
...
void G4EmParameters::SetMaxEnergyForCSDARange(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of MaxKinEnergyCSDA is out of range: " << val / CLHEP::GeV
       << " GeV is ignored; allowed range " << minKinEnergy << " MeV - 100 TeV";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetLinearLossLimit(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of linLossLimit is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetBremsstrahlungTh(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of bremsstrahlung threshold is out of range: " << val / GeV << " GeV is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetLambdaFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of lambda factor is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetFactorForAngleLimit(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of factor for enegry limit is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscThetaLimit(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of polar angle limit is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscEnergyLimit(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of msc energy limit is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscRangeFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of rangeFactor is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscMuHadRangeFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of rangeFactorMuHad is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscGeomFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of geomFactor is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscSafetyFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of safetyFactor is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscLambdaLimit(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of lambdaLimit is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMscSkin(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of skin is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetScreeningFactor(G4double val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of factorScreen is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::SetMinDNAElectronEnergy(G4double val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetMinDNAElectronEnergy(val);
  fDNA = true;
}

G4double G4EmParameters::MinDNAElectronEnergy() const
{
  return fCParameters->MinDNAElectronEnergy();
}

void G4EmParameters::SetMinDNAProtonEnergy(G4double val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetMinDNAProtonEnergy(val);
  fDNA = true;
}

G4double G4EmParameters::MinDNAProtonEnergy() const
{
  return fCParameters->MinDNAProtonEnergy();
}

void G4EmParameters::SetMinDNAIonEnergy(G4double val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetMinDNAIonEnergy(val);
  fDNA = true;
}

G4double G4EmParameters::MinDNAIonEnergy() const
{
  return fCParameters->MinDNAIonEnergy();
}
...
void G4EmParameters::SetMaxDNAProtonEnergy(G4double val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetMaxDNAProtonEnergy(val);
  fDNA = true;
}

G4double G4EmParameters::MaxDNAProtonEnergy() const
{
  return fCParameters->MaxDNAProtonEnergy();
}

void G4EmParameters::SetMaxDNAIonEnergyPerNucleon(G4double val)
{
  if (IsLocked())
  {
    return;
  }
  fCParameters->SetMaxDNAIonEnergyPerNucleon(val);
  fDNA = true;
}

G4double G4EmParameters::MaxDNAIonEnergyPerNucleon() const
{
  return fCParameters->MaxDNAIonEnergyPerNucleon();
}
...
void G4EmParameters::SetNumberOfBinsPerDecade(G4int val)
{
  ...
  {
    G4ExceptionDescription ed;
    ed << "Value of number of bins per decade is out of range: " << val << " is ignored";
    PrintWarning(ed);
  }
}
...
void G4EmParameters::AddPAIModel(const G4String& particle, const G4String& region,
                                 const G4String& type)
{
  if (IsLocked())
  {
...
void G4EmParameters::SetDeexActiveRegion(const G4String& region, G4bool adeex, G4bool aauger,
                                         G4bool apixe)
{
  if (IsLocked())
  {
...
void G4EmParameters::SetProcessBiasingFactor(const G4String& procname, G4double val, G4bool wflag)
{
  if (IsLocked())
  {
    return;
...
void G4EmParameters::ActivateForcedInteraction(const G4String& procname, const G4String& region,
                                               G4double length, G4bool wflag)
{
  if (IsLocked() && !gener)
  {
    return;
...
void G4EmParameters::ActivateSecondaryBiasing(const G4String& procname, const G4String& region,
                                              G4double factor, G4double energyLim)
{
  if (IsLocked())
  {
    return;
...
void G4EmParameters::StreamInfo(std::ostream& os) const
{
  ...
  os << "Enable sampling of quantum entanglement            " << fBParameters->QuantumEntanglement()
     << "\n";
  ...
  os << "Bremsstrahlung energy threshold above which \n"
     << "  primary e+- is added to the list of secondary    " << G4BestUnit(bremsTh, "Energy")
     << "\n";
  os << "Bremsstrahlung energy threshold above which primary\n"
     << "  muon/hadron is added to the list of secondary    " << G4BestUnit(bremsMuHadTh, "Energy")
     << "\n";
  G4String name3g = "SimplePositronium";
  if (fPositronium == fAllisonPositronium)
  {
    name3g = "AllisonPositronium";
  }
  else if (fPositronium == fOrePowell)
  {
    name3g = "OrePowell";
  }
  else if (fPositronium == fOrePowellPolar)
  {
    name3g = "OrePowellPolar";
  }
  os << "Positron annihilation at rest model                " << name3g << "\n";

  os << "Enable 3 gamma annihilation on fly                 " << f3GammaAnnihilationOnFly << "\n";
  ...
  {
    os << "5D gamma conversion limit for muon pair            " << max5DEnergyForMuPair / CLHEP::GeV
       << " GeV\n";
  }
  os << "Use RiGe 5D e+e- pair production model by muons    " << fUseRiGePairProductionModel
     << "\n";
  ...
  if (fFluct == fUrbanFluctuation)
  {
    namef = "Urban";
  }
  else if (fFluct == fDummyFluctuation)
  {
    namef = "Dummy";
  }
  ...
  os << "Enable angular generator interface                 " << useAngGeneratorForIonisation
     << "\n";
  os << "Enable parallel initialisation of physics tables   " << fParallelInitialisation << "\n";
  os << "Max kinetic energy for CSDA tables                 "
     << G4BestUnit(maxKinEnergyCSDA, "Energy") << "\n";
  os << "Max kinetic energy for NIEL computation            " << G4BestUnit(maxNIELEnergy, "Energy")
     << "\n";
  ...
  os << "Fixed angular limit between single \n"
     << "  and multiple scattering                          " << thetaLimit / CLHEP::rad
     << " rad\n";
  os << "Upper energy limit for e+- multiple scattering     " << energyLimit / CLHEP::MeV
     << " MeV\n";
  ...
  if (fCParameters->Fluo())
  {
    ...
    {
      named = "fluor_XDB_EADL";
    }
    os << "Directory in G4LEDATA for fluorescence data files  " << named << "\n";
    os << "Auger electron cascade enabled                     " << fCParameters->Auger() << "\n";
  ...
  if (fDNA)
  {
    ...
    os << "=======================================================================" << "\n";
    os << "Min DNA electron energy                            "
       << fCParameters->MinDNAElectronEnergy() / CLHEP::eV << " eV\n";
    os << "Min DNA proton energy                              "
       << fCParameters->MinDNAProtonEnergy() / CLHEP::eV << " eV\n";
    os << "Min DNA ion energy                                 "
       << fCParameters->MinDNAIonEnergy() / CLHEP::eV << " eV\n";
    os << "Max DNA electron energy                            "
       << fCParameters->MaxDNAElectronEnergy() / CLHEP::MeV << " MeV\n";
    os << "Max DNA proton energy                              "
       << fCParameters->MaxDNAProtonEnergy() / CLHEP::eV << " MeV\n";
    os << "Max DNA ion energy                                 "
       << fCParameters->MaxDNAIonEnergyPerNucleon() / CLHEP::MeV << " MeV/u\n";
    ...
    os << "Use DNA with multiple scattering of e-             " << fCParameters->DNAElectronMsc()
       << "\n";
    os << "Use DNA multiple ionisation                        "
       << fCParameters->DNAMultipleIonisation() << "\n";
