...
void G4EmParameters::SetTransportationWithMsc(G4bool val)
{
  if(IsLocked()) { return; }
  fTransportationWithMsc = val;
}

G4bool G4EmParameters::TransportationWithMsc() const
{
...
void G4EmParameters::StreamInfo(std::ostream& os) const
{
  ...
  os << "Use combined TransportationWithMsc                 " <<fTransportationWithMsc << "\n";
