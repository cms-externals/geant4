  ...
  : theParameters(ptr)
{
  ...
  transWithMscCmd = new G4UIcmdWithABool("/process/em/transportationWithMsc",this);
  ...
  transWithMscCmd->SetDefaultValue(false);
                                          ...
                                          G4String newValue)
{
  ...
  if (command == flucCmd) {
    ...
    theParameters->SetTransportationWithMsc(transWithMscCmd->GetNewBoolValue(newValue));
