  ...
  : theParameters(ptr)
{
  ...
  sharkCmd = new G4UIcmdWithABool("/process/em/UseSuperProcess",this);
  sharkCmd->SetGuidance("Enable gamma, e+- super-process");
  sharkCmd->SetParameterName("super",true);
  ...
  icru90Cmd = new G4UIcmdWithABool("/process/msc/UseICRU90",this);
                                          ...
                                          G4String newValue)
{
  ...
  if (command == flucCmd) {
    ...
    theParameters->SetSuperProcessActive(sharkCmd->GetNewBoolValue(newValue));
