...
G4EmParametersMessenger::G4EmParametersMessenger(G4EmParameters* ptr) : theParameters(ptr)
{
...
void G4EmParametersMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  else if (command == posiCmd)
  {
    ...
    if (newValue == "Allison")
    {
      x = fAllisonPositronium;
    }
    else if (newValue == "OrePowell")
    {
      x = fOrePowell;
    }
    else if (newValue == "OrePowellPolar")
    {
      x = fOrePowellPolar;
    }
