...
#ifndef G4HIMPACTIONISATION_HH
#define G4HIMPACTIONISATION_HH
...
class G4hImpactIonisation : public G4hRDEnergyLoss
{
  public:  // With description
    ...
    G4double ComputeDEDX(const G4ParticleDefinition* aParticle, const G4MaterialCutsCouple* couple,
  ...
  private:
    ...
    G4double DeltaRaysEnergy(const G4MaterialCutsCouple* couple, G4double kineticEnergy,
    ...
    G4double ElectronicLossFluctuation(const G4DynamicParticle* particle,
                                       const G4MaterialCutsCouple* material, G4double meanLoss,
                                       G4double step) const;
...
inline G4double G4hImpactIonisation::GetContinuousStepLimit(const G4Track& track, G4double,
