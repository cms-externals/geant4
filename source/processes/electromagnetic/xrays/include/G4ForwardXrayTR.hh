...
#ifndef G4FORWARDXRAYTR_HH
#define G4FORWARDXRAYTR_HH
...
class G4ForwardXrayTR : public G4TransitionRadiation
{
  ...
  protected:  // for access from X-ray TR fast simulation models
    ...
    static constexpr G4double fTheMinEnergyTR = 1. * CLHEP::keV;  //  static min TR energy
    static constexpr G4double fTheMaxEnergyTR = 100. * CLHEP::keV;  //  static max TR energy
    ...
    static constexpr G4double fMinProtonTkin = 100. * CLHEP::GeV;  // min Tkin of proton in tables
    static constexpr G4double fMaxProtonTkin = 100. * CLHEP::TeV;  // max Tkin of proton in tables
    static constexpr G4double fPlasmaCof =
      4.0 * CLHEP::pi * CLHEP::fine_structure_const * CLHEP::hbarc * CLHEP::hbarc * CLHEP::hbarc
    ...
    static constexpr G4int fSympsonNumber = 100;  // Accuracy of Sympson integration
