...
private:
  ...
  G4VXRayModel* fCurentModel{nullptr};

  G4double fMaxBetaChange{0.1};
  G4double fMinBeta{DBL_MAX};
  ...
  static std::map<const G4LogicalVolume*, G4int>* fLVandModel;
  ...
  // vector of names of logical volumes for master
