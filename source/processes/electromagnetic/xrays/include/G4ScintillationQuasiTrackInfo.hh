...
//
#ifndef G4SCINTILLATIONQUASITRACKINFO_HH
#define G4SCINTILLATIONQUASITRACKINFO_HH
...
class G4ScintillationQuasiTrackInfo : public G4VAuxiliaryTrackInformation
{
  public:
    ...
    explicit G4ScintillationQuasiTrackInfo(const G4QuasiOpticalData& data, G4double scint_time,
                                           G4double rise_time);
    ...
    G4ScintillationQuasiTrackInfo* Clone() const override;
...
extern G4DLLEXPORT G4Allocator<G4ScintillationQuasiTrackInfo>*& aScintillationATIAllocator();
#else
extern G4DLLIMPORT G4Allocator<G4ScintillationQuasiTrackInfo>*& aScintillationATIAllocator();
#endif
...
inline void* G4ScintillationQuasiTrackInfo::operator new(size_t)
{
  ...
  {
    aScintillationATIAllocator() = new G4Allocator<G4ScintillationQuasiTrackInfo>;
  }
  return (void*)aScintillationATIAllocator()->MallocSingle();
}

inline void G4ScintillationQuasiTrackInfo::operator delete(void* aScintillationATI)
{
  aScintillationATIAllocator()->FreeSingle((G4ScintillationQuasiTrackInfo*)aScintillationATI);
}
