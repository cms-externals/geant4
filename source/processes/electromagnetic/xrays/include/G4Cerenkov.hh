...
#ifndef G4CERENKOV_HH
#define G4CERENKOV_HH
...
inline G4int G4Cerenkov::GetMaxNumPhotonsPerStep() const
{
  return fMaxPhotons;
}

inline G4bool G4Cerenkov::GetStackPhotons() const
{
  return fStackingFlag;
}

inline G4int G4Cerenkov::GetNumPhotons() const
{
  return fNumPhotons;
}
