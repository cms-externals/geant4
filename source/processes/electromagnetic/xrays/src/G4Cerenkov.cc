...
G4Cerenkov::G4Cerenkov(const G4String& processName, G4ProcessType type)
  : G4VDiscreteProcess(processName, type), fNumPhotons(0)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4Cerenkov::GetMeanFreePath(const G4Track&, G4double, G4ForceCondition*)
{
  return DBL_MAX;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4Cerenkov::PostStepGetPhysicalInteractionLength(const G4Track& aTrack, G4double,
                                                          G4ForceCondition* condition)
{
  *condition = NotForced;
  ...
  auto const MPT = ((*materialTable)[materialIndex])->GetMaterialPropertiesTable();
  if (nullptr == MPT)
  {
    return StepLimit;
  }
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4Cerenkov::GetAverageNumberOfPhotons(const G4double charge, const G4double beta,
...
// Geant4-unit (millimeter) in the current medium.
{
  ...
  else
  {
    ...
    G4Exception("G4Cerenkov::GetAverageNumberOfPhotons", "Cerenkov01", FatalException, ed);
  }
