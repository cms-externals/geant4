...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void G4GeneralCerenkov::AddModelForVolume(G4VXRayModel* model, const G4String& nameLogVolume)
{
  if (isPrepared || !isInitializer || nullptr == model)
  {
    ...
    ed << " Attempt to add Cerenkov model <" << nam << "> for LogicalVolume " << nameLogVolume
       << " is failed!\n isPrepared:" << isPrepared << " isInitilizer:" << isInitializer;
    G4Exception("G4GeneralCerenkov::AddModelForVolume", "em0304", FatalException, ed, "");
    return;
  }
...
void G4GeneralCerenkov::BuildPhysicsTable(const G4ParticleDefinition&)
{
  ...
  else if (verboseLevel > 0)
  {
    ...
    G4cout << std::setw(20) << "fMaxNphot=" << fMaxPhotons << "  Nlv=" << nn
           << "  fStackingFlag:" << fStackingFlag
           << "  fTrackSecondariesFirst:" << fTrackSecondariesFirst << G4endl;
    for (G4int i = 0; i < nModels; ++i)
    {
      G4int n = (G4int)((*fLV)[i]->size());
      G4cout << std::setw(10) << (*fSharedModels)[i]->GetName() << std::setw(30) << "Nvolumes=" << n
             << "  Volumes:" << G4endl;
      G4cout << std::setw(12);
      for (G4int j = 0; j < n; ++j)
      {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4GeneralCerenkov::PostStepGetPhysicalInteractionLength(const G4Track& aTrack, G4double,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* G4GeneralCerenkov::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
  aParticleChange.Initialize(aTrack);
  if (fCurrentModel == nullptr)
  {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4GeneralCerenkov::GetMeanFreePath(const G4Track&, G4double, G4ForceCondition*)
{
  return DBL_MAX;
}
