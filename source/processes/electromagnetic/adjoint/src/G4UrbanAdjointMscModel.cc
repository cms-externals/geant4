...
G4UrbanAdjointMscModel::G4UrbanAdjointMscModel(const G4String& nam) : G4VMscModel(nam)
{
  masslimite = 0.6 * MeV;
  lambdalimit = 1. * mm;
  fr = 0.02;
...
G4double G4UrbanAdjointMscModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition* part,
                                                            ...
                                                            G4double, G4double)
{
  ...
  static constexpr G4double hecorr[15] = {120.70, 117.50, 105.00, 92.92,  79.23,
  ...
  static constexpr G4double epsfactor = 2. * CLHEP::electron_mass_c2 * CLHEP::electron_mass_c2
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4UrbanAdjointMscModel::SampleCosineTheta(G4double trueStepLength, G4double KineticEnergy)
{
  G4double cth = 1.;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double G4UrbanAdjointMscModel::ComputeTheta0(G4double trueStepLength, G4double KineticEnergy)
{
