...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::LinearInterpolation(G4double& x, G4double& x1, G4double& x2,
...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::LogarithmicInterpolation(G4double& x, G4double& x1, G4double& x2,
                                                         G4double& y1, G4double& y2)
{
...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::ExponentialInterpolation(G4double& x, G4double& x1, G4double& x2,
                                                         G4double& y1, G4double& y2)
{
...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::Interpolation(G4double& x, G4double& x1, G4double& x2, G4double& y1,
                                              G4double& y2, const G4String& InterPolMethod)
{
  ...
  else
  {
    ...
    G4Exception("G4AdjointInterpolator::Interpolation", "adoint001", FatalException, ed);
    return 0.;
  }
}
...
std::size_t G4AdjointInterpolator::FindPosition(G4double& x, std::vector<G4double>& x_vec,
...
///////////////////////////////////////////////////////
// only valid if x_vec is monotically increasing
std::size_t G4AdjointInterpolator::FindPositionForLogVector(G4double& log_x,
                                                            std::vector<G4double>& log_x_vec)
{
  // most rapid method could be used probably
...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::Interpolate(G4double& x, std::vector<G4double>& x_vec,
...
///////////////////////////////////////////////////////
G4double G4AdjointInterpolator::InterpolateForLogVector(G4double& log_x,
                                                        std::vector<G4double>& log_x_vec,
                                                        std::vector<G4double>& log_y_vec)
{
  ...
  G4double log_y =
    LinearInterpolation(log_x, log_x_vec[i], log_x_vec[i + 1], log_y_vec[i], log_y_vec[i + 1]);
  return log_y;
}
