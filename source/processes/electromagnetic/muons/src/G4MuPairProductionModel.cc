...
G4MuPairProductionModel::G4MuPairProductionModel(const G4ParticleDefinition* p, const G4String& nam)
  : G4VEmModel(nam),
...
G4double G4MuPairProductionModel::MinPrimaryEnergy(const G4Material*, const G4ParticleDefinition*,
                                                   G4double cut)
{
...
G4double G4MuPairProductionModel::ComputMuPairLoss(G4double Z, G4double tkin, G4double cutEnergy,
                                                   G4double tmax)
{
  G4double loss = 0.0;
...
G4double G4MuPairProductionModel::ComputeMicroscopicCrossSection(G4double tkin, G4double Z,
                                                                 G4double cutEnergy)
{
  G4double cross = 0.;
...
G4double G4MuPairProductionModel::ComputeDMicroscopicCrossSection(G4double tkin, G4double Z,
                                                                  G4double pairEnergy)
                                                ...
                                                G4double tmin, G4double tmax)
{
  ...
  G4double totalMomentum = std::sqrt(kinEnergy * (kinEnergy + 2.0 * particleMass));
  ...
  //
  GetAngularDistribution()->SamplePairDirections(aDynamicParticle, eEnergy, pEnergy, eDirection,
                                                 pDirection);
...
G4double G4MuPairProductionModel::FindScaledEnergy(G4int iz, G4double rand, G4double logTkin,
