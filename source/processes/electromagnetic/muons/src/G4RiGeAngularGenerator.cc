...
G4RiGeAngularGenerator::G4RiGeAngularGenerator() : G4VEmAngularDistribution("RiGeAngularGen") {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4ThreeVector& G4RiGeAngularGenerator::SampleDirection(const G4DynamicParticle* dp,
                                                       G4double gEnergy, G4int, const G4Material*)
{
...
G4double G4RiGeAngularGenerator::SampleCosTheta(G4double primKinEnergy, G4double gEnergy,
                                                G4double mass)
{
...
void G4RiGeAngularGenerator::Sample5DPairDirections(
  const G4DynamicParticle* dp, G4ThreeVector& dirElectron, G4ThreeVector& dirPositron,
  const G4double gEnergy, const G4double q2, const G4double gMomentum,
  const G4double muFinalMomentum, const G4double muFinalEnergy, const G4double* randNumbs,
  const G4double* W)
{
  ...
  else if (randNumbs[7] >= W[0] && randNumbs[7] < W[1])
  {
    ...
    G4double Ap =
      muMomentum * muMomentum + muFinalMomentum * muFinalMomentum + gMomentum * gMomentum;
...
G4LorentzVector G4RiGeAngularGenerator::eDP2(G4double x1, G4double x2, G4double x3, G4double x4,
                                             G4double x5)
{
