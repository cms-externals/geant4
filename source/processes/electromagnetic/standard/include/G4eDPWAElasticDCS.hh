...
#ifndef G4EDPWAELASTICDCS_HH
#define G4EDPWAELASTICDCS_HH
...
class G4eDPWAElasticDCS
{
  public:
    ...
    void ComputeCSPerAtom(G4int iz, G4double ekin, G4double& elcs, G4double& tr1cs, G4double& tr2cs,
                          G4double mumin = 0.0, G4double mumax = 1.0);
    ...
    G4double SampleCosineTheta(std::size_t iz, G4double lekin, G4double r1, G4double r2,
                               G4double r3);
    ...
    G4double SampleCosineThetaRestricted(std::size_t iz, G4double lekin, G4double r1, G4double r2,
