...
class G4PAIxSection
{
  public:
    ...
    G4PAIxSection(G4int materialIndex,  // for proton loss table
                  G4double maxEnergyTransfer, G4double betaGammaSq, G4double** photoAbsCof,
                  G4int intNumber);
  ...
  private:
    ...
    static const G4int fRefGammaNumber;  // The number of gamma for creation of spline (15)
    ...
    static const G4int fMaxSplineSize;  // Max size of output splain arrays = 500
...
inline G4double G4PAIxSection::GetIntegralPAIxSection(G4int i) const
{
  if (i < 1 || i > fSplineNumber)
  {
    CallError(i, "GetIntegralPAIxSection");
  }
...
inline G4double G4PAIxSection::GetIntegralPAIdEdx(G4int i) const
{
  if (i < 1 || i > fSplineNumber)
  {
    CallError(i, "GetIntegralPAIdEdx");
  }
...
inline G4double G4PAIxSection::GetIntegralCerenkov(G4int i) const
{
  if (i < 1 || i > fSplineNumber)
  {
    CallError(i, "GetIntegralCerenkov");
  }
...
inline G4double G4PAIxSection::GetIntegralPlasmon(G4int i) const
{
  if (i < 1 || i > fSplineNumber)
  {
    CallError(i, "GetIntegralPlasmon");
  }
...
inline G4double G4PAIxSection::GetIntegralResonance(G4int i) const
{
  if (i < 1 || i > fSplineNumber)
  {
    CallError(i, "GetIntegralResonance");
  }
