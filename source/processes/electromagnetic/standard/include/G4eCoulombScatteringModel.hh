...
#ifndef G4ECOULOMBSCATTERINGMODEL_HH
#define G4ECOULOMBSCATTERINGMODEL_HH
...
inline void G4eCoulombScatteringModel::DefineMaterial(const G4MaterialCutsCouple* cup)
{
...
inline void G4eCoulombScatteringModel::SetupParticle(const G4ParticleDefinition* p)
{
