...
class G4LowPAIH2O : public G4VEmModel, public G4VEmFluctuationModel
{
  public:
    ...
    G4double CrossSectionPerAtom(const G4ParticleDefinition*, G4double kineticEnergy, G4double Z,
                                 G4double A, G4double cutEnergy, G4double maxEnergy);
...
G4double G4LowPAIH2O::ComputeMeanFreePath(const G4ParticleDefinition* pd, G4double Tkin,
                                          const G4Material*,
