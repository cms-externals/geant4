...
private:
  ...
  G4int    fTotBin, fBinTr, fBias;
  G4double fCof, fBeta, fBe2,  fTkin;

  G4double fBmin, fBmax, fWmin, fWmax;
  G4double fOmega, fElectronDensity, fNat, fNel, fMass;
  ...
  G4PhysicsLogVector*  fBetaVector;
  G4PhysicsTable*      fPrEnergyTable;
  G4PhysicsTable*      fElEnergyTable;
  G4PhysicsLogVector*  fTransferVector;
