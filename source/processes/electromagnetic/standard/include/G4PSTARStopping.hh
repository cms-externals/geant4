...
#ifndef G4PSTARSTOPPING_HH
#define G4PSTARSTOPPING_HH
...
inline G4double G4PSTARStopping::GetElectronicDEDX(G4int idx, G4double energy) const
{
  G4double res = 0.0;
...
inline G4double G4PSTARStopping::GetElectronicDEDX(const G4Material* mat, G4double energy) const
{
