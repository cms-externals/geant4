...
#ifndef G4UNIVERSALFLUCTUATION_HH
#define G4UNIVERSALFLUCTUATION_HH
...
class G4UniversalFluctuation : public G4VEmFluctuationModel
{
  ...
  protected:
    ...
    virtual G4double SampleGlandz(CLHEP::HepRandomEngine* rndm, const G4Material*,
                                  const G4double tcut);

    inline void AddExcitation(CLHEP::HepRandomEngine* rndm, const G4double ax, const G4double ex,
                              G4double& eav, G4double& eloss, G4double& esig2);

    inline void SampleGauss(CLHEP::HepRandomEngine* rndm, const G4double eav, const G4double esig2,
                            G4double& eloss);
...
inline void G4UniversalFluctuation::AddExcitation(CLHEP::HepRandomEngine* rndm, const G4double ax,
                                                  const G4double ex, G4double& eav, G4double& eloss,
                                                  G4double& esig2)
{
  if (ax > nmaxCont)
  {
...
inline void G4UniversalFluctuation::SampleGauss(CLHEP::HepRandomEngine* rndm, const G4double eav,
                                                const G4double esig2, G4double& eloss)
{
  G4double x = eav;
