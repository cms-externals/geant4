...
#ifndef G4GSPWACORRECTIONS_HH
#define G4GSPWACORRECTIONS_HH
...
class G4GSPWACorrections
{
  ...
  private:
    ...
    std::vector<DataPerMaterial*>
      fDataPerElement;  // size will be gMaxZet+1; won't be null only at used Z indices
    std::vector<DataPerMaterial*>
      fDataPerMaterial;  // size will #materials; won't be null only at used mat. indices
};
