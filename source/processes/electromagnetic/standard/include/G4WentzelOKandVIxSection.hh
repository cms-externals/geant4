...
#ifndef G4WENTZELOKANDVIXSECTION_HH
#define G4WENTZELOKANDVIXSECTION_HH
...
class G4WentzelOKandVIxSection
{
  public:
    ...
    G4ThreeVector& SampleSingleScattering(G4double CosThetaMin, G4double CosThetaMax,
                                          G4double elecRatio);

    G4double ComputeSecondTransportMoment(G4double CosThetaMax);

    inline G4double ComputeNuclearCrossSection(G4double CosThetaMin, G4double CosThetaMax);

    inline G4double ComputeElectronCrossSection(G4double CosThetaMin, G4double CosThetaMax);
...
inline G4double G4WentzelOKandVIxSection::ComputeNuclearCrossSection(G4double cosTMin,
                                                                     G4double cosTMax)
{
...
inline G4double G4WentzelOKandVIxSection::ComputeElectronCrossSection(G4double cosTMin,
                                                                      G4double cosTMax)
{
  G4double cost1 = std::max(cosTMin, cosTetMaxElec);
  G4double cost2 = std::max(cosTMax, cosTetMaxElec);
  return (cost1 <= cost2) ? 0.0
                          : kinFactor * fMottFactor * (cost1 - cost2)
