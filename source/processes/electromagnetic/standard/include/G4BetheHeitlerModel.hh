...
#ifndef G4BETHEHEITLERMODEL_HH
#define G4BETHEHEITLERMODEL_HH
...
inline void G4BetheHeitlerModel::ScreenFunction12(const G4double delta, G4double& f1, G4double& f2)
{
  if (delta > 1.4)
  {
