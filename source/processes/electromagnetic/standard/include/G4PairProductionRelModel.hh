...
#ifndef G4PAIRPRODUCTIONRELMODEL_HH
#define G4PAIRPRODUCTIONRELMODEL_HH
...
class G4PairProductionRelModel : public G4VEmModel
{
  ...
  private:
    ...
    void ComputeLPMfunctions(G4double& fXiS, G4double& fGS, G4double& fPhiS, const G4double eps,
...
inline void G4PairProductionRelModel::ComputePhi12(const G4double delta, G4double& phi1,
                                                   G4double& phi2)
{
  if (delta > 1.4)
  {
...
inline void G4PairProductionRelModel::ScreenFunction12(const G4double delta, G4double& f1,
                                                       G4double& f2)
{
  if (delta > 1.4)
  {
