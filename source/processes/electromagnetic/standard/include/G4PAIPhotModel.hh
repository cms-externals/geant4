...
#ifndef G4PAIPHOTMODEL_HH
#define G4PAIPHOTMODEL_HH
...
class G4PAIPhotModel final : public G4VEmModel, public G4VEmFluctuationModel
{
  public:
    ...
    explicit G4PAIPhotModel(const G4ParticleDefinition* p = nullptr, const G4String& nam = "PAI");
...
inline const std::vector<const G4MaterialCutsCouple*>& G4PAIPhotModel::GetVectorOfCouples()
{
