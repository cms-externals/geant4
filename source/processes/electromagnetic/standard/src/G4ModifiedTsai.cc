...
G4ModifiedTsai::G4ModifiedTsai(const G4String&) : G4VEmAngularDistribution("ModifiedTsai") {}
...
G4ThreeVector& G4ModifiedTsai::SampleDirection(const G4DynamicParticle* dp, G4double, G4int,
                                               const G4Material*)
{
...
void G4ModifiedTsai::SamplePairDirections(const G4DynamicParticle* dp, G4double elecKinEnergy,
...
void G4ModifiedTsai::PrintGeneratorInformation() const
{
  ...
  G4cout << "Distribution suggested by L.Urban (Geant3 manual (1993) Phys211)" << G4endl;
