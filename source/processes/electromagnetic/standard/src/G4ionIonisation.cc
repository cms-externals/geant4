...
G4ionIonisation::G4ionIonisation(const G4String& name) : G4VEnergyLossProcess(name)
{
...
G4double G4ionIonisation::MinPrimaryEnergy(const G4ParticleDefinition* p, const G4Material*,
                                           G4double cut)
{
