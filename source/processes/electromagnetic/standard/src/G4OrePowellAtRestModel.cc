                                               ...
                                               G4double&, const G4Material*) const
{
  ...
  auto aGamma1 = new G4DynamicParticle(G4Gamma::Gamma(), PhotonMomentum1, r1 * PositronMass);
  ...
  auto aGamma2 = new G4DynamicParticle(G4Gamma::Gamma(), PhotonMomentum2, r2 * PositronMass);
  ...
  auto aGamma3 = new G4DynamicParticle(G4Gamma::Gamma(), PhotonMomentum3, r3 * PositronMass);
