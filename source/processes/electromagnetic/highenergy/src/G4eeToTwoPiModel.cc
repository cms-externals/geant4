...
G4eeToTwoPiModel::G4eeToTwoPiModel(G4eeCrossSections* cr, G4double maxkinEnergy, G4double binWidth)
  : G4Vee2hadrons(cr, 2.0 * G4PionPlus::PionPlus()->GetPDGMass(), maxkinEnergy, binWidth)
{
...
void G4eeToTwoPiModel::SampleSecondaries(std::vector<G4DynamicParticle*>* newp, G4double e,
                                         const G4ThreeVector& direction)
{
  ...
  G4DynamicParticle* pip = new G4DynamicParticle(G4PionPlus::PionPlus(), dir, tkin);
  G4DynamicParticle* pin = new G4DynamicParticle(G4PionMinus::PionMinus(), -dir, tkin);
  newp->push_back(pip);
  newp->push_back(pin);
}
