...
G4double G4eeCrossSections::Width2p(G4double s_inv, G4double mres, G4double gconst, G4double br,
                                    G4double mp)
{
...
G4double G4eeCrossSections::Width3p(G4double s_inv, G4double mres, G4double gconst, G4double br)
{
...
G4double G4eeCrossSections::WidthPg(G4double s_inv, G4double mres, G4double gconst, G4double br,
                                    G4double mp)
{
  G4double mp2 = mp * mp;
  G4double s0 = mres * mres;
...
G4double G4eeCrossSections::WidthOm(G4double e)
{
  G4double s_inv = e * e;
  G4double w =
    (Width3p(s_inv, MsOm, GOm, BrOm3Pi) + WidthPg(s_inv, MsOm, GOm, BrOmPi0G, MsPi0)
     + WidthPg(s_inv, MsOm, GOm, BrOmEtaG, MsEta) + Width2p(s_inv, MsOm, GOm, BrOm2Pi, MsPi))
...
G4double G4eeCrossSections::WidthPhi(G4double e)
{
  G4double s_inv = e * e;
  G4double w =
    (Width3p(s_inv, MsPhi, GPhi, BrPhi3Pi) + WidthPg(s_inv, MsPhi, GPhi, BrPhiPi0G, MsPi0)
     + WidthPg(s_inv, MsPhi, GPhi, BrPhiEtaG, MsEta) + Width2p(s_inv, MsPhi, GPhi, BrPhi2Kc, MsKc)
