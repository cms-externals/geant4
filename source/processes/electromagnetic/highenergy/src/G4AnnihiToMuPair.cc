...
G4AnnihiToMuPair::G4AnnihiToMuPair(const G4String& processName, G4ProcessType type)
...
G4double G4AnnihiToMuPair::ComputeCrossSectionPerAtom(const G4double energy, const G4double Z)
{
...
G4double G4AnnihiToMuPair::CrossSectionPerVolume(G4double energy, const G4Material* aMaterial)
{
...
G4double G4AnnihiToMuPair::GetMeanFreePath(const G4Track& aTrack, G4double, G4ForceCondition*)
