...
G4ee2KNeutralModel::G4ee2KNeutralModel(G4eeCrossSections* cr, G4double maxkinEnergy,
                                       G4double binWidth)
  : G4Vee2hadrons(cr, 2.0 * G4KaonZeroLong::KaonZeroLong()->GetPDGMass(), maxkinEnergy, binWidth)
{
...
void G4ee2KNeutralModel::SampleSecondaries(std::vector<G4DynamicParticle*>* newp, G4double e,
                                           const G4ThreeVector& direction)
{
  ...
  G4DynamicParticle* p1 = new G4DynamicParticle(G4KaonZeroLong::KaonZeroLong(), dir, tkin);
  G4DynamicParticle* p2 = new G4DynamicParticle(G4KaonZeroShort::KaonZeroShort(), -dir, tkin);
  newp->push_back(p1);
  newp->push_back(p2);
}
