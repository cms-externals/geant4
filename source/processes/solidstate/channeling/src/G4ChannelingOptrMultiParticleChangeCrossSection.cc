...
G4ChannelingOptrMultiParticleChangeCrossSection::G4ChannelingOptrMultiParticleChangeCrossSection()
  : G4VBiasingOperator("ChannelingChangeXS-Many"), fCurrentOperator(0), fnInteractions(0)
{
  AddChargedParticles();
}
...
void G4ChannelingOptrMultiParticleChangeCrossSection::AddParticle(const G4String& particleName)
{
  ...
  if (particle == 0)
  {
    ...
    G4Exception("G4ChannelingOptrMultiParticleChangeCrossSection::AddParticle(...)", "G4Channeling",
                JustWarning, ed);
    return;
  }
...
G4VBiasingOperation*
G4ChannelingOptrMultiParticleChangeCrossSection::ProposeOccurenceBiasingOperation(
...
void G4ChannelingOptrMultiParticleChangeCrossSection::StartTracking(const G4Track* track)
{
  ...
  std::map<const G4ParticleDefinition*, G4ChannelingOptrChangeCrossSection*>::iterator it =
...
void G4ChannelingOptrMultiParticleChangeCrossSection::OperationApplied(
