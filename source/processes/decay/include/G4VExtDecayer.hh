...
// ------------------------------------------------------------
//
#ifndef G4VEXTDECAYER_HH
#define G4VEXTDECAYER_HH
...
inline G4VExtDecayer::G4VExtDecayer(const G4String& name) : decayerName(name) {}

inline const G4String& G4VExtDecayer::GetName() const
{
  return decayerName;
}
