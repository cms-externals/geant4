...
G4double G4OpBoundaryProcess::GetReflectivityThroughThinLayer(G4double sinTL,
  ...
  if (sinTL >= 1.0) {
    if (fCoatedFrustratedTransmission) { //Frustrated transmission
      ...
      if (cost1 != 0.0)
      {
        rTE = (r1toTL + rTLto2 * exp(-2 * k0 * fCoatedThickness * gammaTL)) /
                 (1.0 + r1toTL * rTLto2 * exp(-2 * k0 * fCoatedThickness * gammaTL));
      }
      // TM
      ...
      if (cost1 != 0.0)
      {
        rTM = (r1toTL + rTLto2 * exp(-2 * k0 * fCoatedThickness * gammaTL)) /
                 (1.0 + r1toTL * rTLto2 * exp(-2 * k0 * fCoatedThickness * gammaTL));
      }
    }
    else
  ...
  else //if (sinTL < 1.0)
  {
    ...
    if (cost1 != 0.0)
    {
      rTE = (r1toTL + rTLto2 * exp(2.0 * i * k0 * fCoatedRindex * fCoatedThickness * costTL)) /
            (1.0 + r1toTL * rTLto2 * exp(2.0 * i * k0 * fCoatedRindex * fCoatedThickness * costTL));
    }
    // TM
    ...
    if (cost1 != 0.0)
    {
      rTM = (r1toTL + rTLto2 * exp(2.0 * i * k0 * fCoatedRindex * fCoatedThickness * costTL)) /
            (1.0 + r1toTL * rTLto2 * exp(2.0 * i * k0 * fCoatedRindex * fCoatedThickness * costTL));
    }
  }
