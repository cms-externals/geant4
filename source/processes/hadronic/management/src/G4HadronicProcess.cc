...
void G4HadronicProcess::InitialiseLocal() {  
  ...
  GetEnergyMomentumCheckEnvvars();  // To be removed in G4 11.0
}

void G4HadronicProcess::GetEnergyMomentumCheckEnvvars() {
  // This method is deprecated and will be removed in the next major release, Geant4 version 11.0
  if ( std::getenv("G4Hadronic_epReportLevel") ) {
    epReportLevel = std::strtol(std::getenv("G4Hadronic_epReportLevel"),0,10);
    G4ExceptionDescription ed;
    ed << "The environmental variable  G4Hadronic_epReportLevel  is valid but deprecated \n"
       << "and will be removed in the next major release, Geant4 version 11.0 .\n"
       << "It is recommended to use instead the UI command: /process/had/heptst/reportLevel \n";
    G4Exception( "G4HadronicProcess::GetEnergyMomentumCheckEnvvars", "had116", JustWarning, ed );
  }
  if ( std::getenv("G4Hadronic_epCheckRelativeLevel") ) {
    epCheckLevels.first = std::strtod(std::getenv("G4Hadronic_epCheckRelativeLevel"),0);
    G4ExceptionDescription ed;
    ed << "The environmental variable  G4Hadronic_epCheckRelativeLevel  is valid but deprecated \n"
       << "and will be removed in the next major release, Geant4 version 11.0 .\n"
       << "It is recommended to use instead the UI command: /process/had/heptst/processRelLevel \n";
    G4Exception( "G4HadronicProcess::GetEnergyMomentumCheckEnvvars", "had117", JustWarning, ed );
  }
  if ( std::getenv("G4Hadronic_epCheckAbsoluteLevel") ) {
    ...
    G4ExceptionDescription ed;
    ed << "The environmental variable  G4Hadronic_epCheckAbsoluteLevel  is valid but deprecated \n"
       << "and will be removed in the next major release, Geant4 version 11.0 .\n"
       << "It is recommended to use instead the UI command: /process/had/heptst/processAbsLevel \n";
    G4Exception( "G4HadronicProcess::GetEnergyMomentumCheckEnvvars", "had118", JustWarning, ed );
  }
}
