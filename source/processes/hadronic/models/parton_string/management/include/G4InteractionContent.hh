...
#ifndef G4INTERACTIONCONTENT_HH
#define G4INTERACTIONCONTENT_HH
...
inline void G4InteractionContent::Dump()
{
  ...
  G4cout << " G4InteractionContent " << this << G4endl << "Hard/Soft/Diff " << theNumberOfHard
         << " / " << theNumberOfSoft << " / " << theNumberOfDiffractive << G4endl << "Projectile ";
