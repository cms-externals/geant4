...
G4int G4FTFModel::AdjustNucleonsAlgorithm_beforeSampling( G4int interactionCase,
  ...
  if ( Stopping ) {
    ...
    if ( interactionCase == 1  ||  interactionCase == 3 ) {
      ...
      common.Ptmp.setE( sqrt( sqr( common.TResidualMass + TargetResidualExcitationEnergy ) + common.Ptmp.vect().mag2() ) ); 
      //---
      #ifdef debugAdjust
    ...
    if ( interactionCase == 2  ||  interactionCase == 3 ) {
      ...
      if ( interactionCase == 2 ) {
        ...
        common.Ptmp.setE( sqrt( sqr( common.PResidualMass + ProjectileResidualExcitationEnergy ) + common.Ptmp.vect().mag2() ) ); 
        //---
      }
      #ifdef debugAdjust
