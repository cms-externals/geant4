                                                ...
                                                G4FTFParameters* theParameters) const
{
  ...
  PZcms2 = (S * S + sqr(M0projectile2) + sqr(M0target2) - 2 * S * M0projectile2 - 2 * S * M0target2
            - 2 * M0projectile2 * M0target2)
           / 4.0 / S;
  ...
  PZcms2 = (S * S + sqr(ProjMassT2) + sqr(TargMassT2) - 2.0 * S * ProjMassT2 - 2.0 * S * TargMassT2
            - 2.0 * ProjMassT2 * TargMassT2)
           / 4.0 / S;

  if (PZcms2 < 0.0)
  {
    PZcms2 = 0.0;
  };  // to avoid the exactness problem
