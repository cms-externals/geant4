...
#ifndef G4DIFFRACTIVEEXCITATION_HH
#define G4DIFFRACTIVEEXCITATION_HH
...
class G4DiffractiveExcitation
{
  public:
    ...
    virtual void CreateStrings(G4VSplitableHadron* aHadron, G4bool isProjectile,
                               G4ExcitedString*& FirstString, G4ExcitedString*& SecondString,
  ...
  private:
    ...
    struct CommonVariables
    {
        ...
        G4double M0projectile = 0.0, M0projectile2 = 0.0, M0target = 0.0, M0target2 = 0.0,
                 ...
                 MminProjectile = 0.0, MminTarget = 0.0, ProjectileDiffStateMinMass = 0.0,
                 ProjectileDiffStateMinMass2 = 0.0, ProjectileNonDiffStateMinMass = 0.0,
                 ProjectileNonDiffStateMinMass2 = 0.0, TargetDiffStateMinMass = 0.0,
                 TargetDiffStateMinMass2 = 0.0, TargetNonDiffStateMinMass = 0.0,
                 TargetNonDiffStateMinMass2 = 0.0, S = 0.0, SqrtS = 0.0, Pt2 = 0.0, PZcms = 0.0,
                 PZcms2 = 0.0, AveragePt2 = 0.0, maxPtSquare = 0.0, ProbExc = 0.0, Qminus = 0.0,
                 Qplus = 0.0, PMinusNew = 0.0, PPlusNew = 0.0, TMinusNew = 0.0, TPlusNew = 0.0,
                 PMinusMin = 0.0, PMinusMax = 0.0, TPlusMin = 0.0, TPlusMax = 0.0,
                 ProbProjectileDiffraction = 0.0, ProbTargetDiffraction = 0.0,
                 ProbOfDiffraction = 0.0;
