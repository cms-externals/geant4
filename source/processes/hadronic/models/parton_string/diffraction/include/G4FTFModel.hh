...
#ifndef G4FTFMODEL_HH
#define G4FTFMODEL_HH
...
class G4FTFModel : public G4VPartonStringModel
{
  ...
  private:
    ...
    G4bool AdjustNucleons(G4VSplitableHadron* SelectedAntiBaryon, G4Nucleon* ProjectileNucleon,
                          G4VSplitableHadron* SelectedTargetNucleon, G4Nucleon* TargetNucleon,
                          G4bool Annihilation);
    ...
    struct CommonVariables
    {
        ...
        G4double SqrtS = 0.0, S = 0.0, SumMasses = 0.0, TResidualExcitationEnergy = 0.0,
                 TResidualMass = 0.0, TNucleonMass = 0.0, PResidualExcitationEnergy = 0.0,
                 PResidualMass = 0.0, PNucleonMass = 0.0, Mprojectile = 0.0, M2projectile = 0.0,
                 Pzprojectile = 0.0, Eprojectile = 0.0, WplusProjectile = 0.0, Mtarget = 0.0,
                 M2target = 0.0, Pztarget = 0.0, Etarget = 0.0, WminusTarget = 0.0,
                 ...
                 YtargetNucleus = 0.0, YprojectileNucleus = 0.0, XminusNucleon = 0.0,
                 XplusNucleon = 0.0, XminusResidual = 0.0, XplusResidual = 0.0;
    ...
    G4bool SamplingNucleonKinematics(G4double averagePt2, const G4double maxPt2, G4double dCor,
                                     G4V3DNucleus* nucleus, const G4LorentzVector& pResidual,
    ...
    G4int ProjectileResidualLambdaNumber;  // Number of (anti-)lambdas for projectile
                                           // (anti-)hypernucleus
