...
class G4FTFParameters {
  public:
    ...
    G4ComponentGGHadronNucleusXsc* FTFxsManager;
  ...
  private:
    ...
    // G4-MT changes
    static G4ThreadLocal bool GGComponentXSisInitialized;
    static G4ThreadLocal G4ComponentGGHadronNucleusXsc* csGGinstance;
