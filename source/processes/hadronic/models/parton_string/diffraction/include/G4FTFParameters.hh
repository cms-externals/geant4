...
//
//
#ifndef G4FTFPARAMETERS_HH
#define G4FTFPARAMETERS_HH
...
class G4FTFParameters
{
  public:
    ...
    void SetParams(const G4int ProcN, const G4double A1, const G4double B1, const G4double A2,
                   const G4double B2, const G4double A3, const G4double Atop, const G4double Ymin);
    ...
    G4bool EnableDiffDissociationForBGreater10;  ///< Control over whether to do nucleon-hadron
                                                 ///< diffractive dissociation or not.
...
inline void G4FTFParameters::SetParams(const G4int ProcN, const G4double A1, const G4double B1,
                                       const G4double A2, const G4double B2, const G4double A3,
                                       const G4double Atop, const G4double Ymin)
{
  ProcParams[ProcN][0] = A1;
  ProcParams[ProcN][1] = B1;
  ProcParams[ProcN][2] = A2;
  ProcParams[ProcN][3] = B2;
  ProcParams[ProcN][4] = A3;
  ProcParams[ProcN][5] = Atop;
  ProcParams[ProcN][6] = Ymin;
}
...
// Set parameters of nuclear destruction
inline void G4FTFParameters::SetMaxNumberOfCollisions(const G4double Plab, const G4double Pbound)
{
  if (Plab > Pbound)
  {
