...
// ********************************************************************
//
#ifndef G4QGSPARTICIPANTS_HH
#define G4QGSPARTICIPANTS_HH
...
class G4QGSParticipants : public G4VParticipants
{
  ...
  protected:
    ...
    {
        void operator()(G4InteractionContent* aC) { delete aC; }
    };
    std::vector<G4InteractionContent*> theInteractions;
    struct DeleteSplitableHadron
    {
        void operator()(G4VSplitableHadron* aS) { delete aS; }
    };
    std::vector<G4VSplitableHadron*> theTargets;
    struct DeletePartonPair
    {
        void operator()(G4PartonPair* aP) { delete aP; }
    };
