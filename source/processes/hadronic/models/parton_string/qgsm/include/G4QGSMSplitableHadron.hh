...
// ********************************************************************
//
#ifndef G4QGSMSPLITABLEHADRON_HH
#define G4QGSMSPLITABLEHADRON_HH
...
class G4QGSMSplitableHadron : public G4VSplitableHadron
{
  ...
  private:
    ...
    void GetValenceQuarkFlavors(const G4ParticleDefinition* aPart, G4Parton*& Parton1,
                                G4Parton*& Parton2);
