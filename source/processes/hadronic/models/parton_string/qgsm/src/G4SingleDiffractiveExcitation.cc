...
G4bool G4SingleDiffractiveExcitation::ExciteParticipants(G4VSplitableHadron* projectile,
...
G4double G4SingleDiffractiveExcitation::ChooseX(G4double Xmin, G4double Xmax) const
{
  ...
  // G4double x = 1.0/sqr(1.0/std::sqrt(Xmin) - G4UniformRand() * (1.0/std::sqrt(Xmin)
  // - 1.0/std::sqrt(Xmax)));
  return x;
}
