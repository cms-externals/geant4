...
#ifndef G4FRAGMENTINGSTRING_HH
#define G4FRAGMENTINGSTRING_HH
...
inline G4bool G4FragmentingString::operator==(const G4FragmentingString& right) const
{
  return this == &right;
}
...
inline G4ParticleDefinition* G4FragmentingString::GetStableParton() const
{
  return theStableParton;
}

inline G4ParticleDefinition* G4FragmentingString::GetDecayParton() const
{
  return theDecayParton;
}

inline G4ParticleDefinition* G4FragmentingString::GetLeftParton(void) const
{
  return LeftParton;
}

inline G4ParticleDefinition* G4FragmentingString::GetRightParton(void) const
{
  return RightParton;
}

//+++++++++++++++++++++++++++
inline void G4FragmentingString::LorentzRotate(const G4LorentzRotation& rotation)
{
...
inline G4LorentzRotation G4FragmentingString::TransformToCenterOfMass()
{
...
inline void G4FragmentingString::SetPleft(G4LorentzVector a4momentum)
{
  Pleft = a4momentum;
  Ptleft = Pleft.vect();
  Ptleft.setZ(0.);
...
inline void G4FragmentingString::SetPright(G4LorentzVector a4momentum)
{
  Pright = a4momentum;
  Ptright = Pright.vect();
  Ptright.setZ(0.);
