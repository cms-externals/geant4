...
// -----------------------------------------------------------------------------
#ifndef G4VLONGITUDINALSTRINGDECAY_HH
#define G4VLONGITUDINALSTRINGDECAY_HH
...
class G4VLongitudinalStringDecay : public G4HadronicInteraction
{
  ...
  protected:
    ...
    typedef G4ParticleDefinition* (G4HadronBuilder::*Pcreate)(G4ParticleDefinition*,
                                                              G4ParticleDefinition*);

    // Used by ProduceOneHadron method for estimation of lowest possible mass of
    // given quark system -- string.
    G4double PossibleHadronMass(const G4FragmentingString* const string, Pcreate build = 0,
                                pDefPair* pdefs = 0);
    ...
    virtual void Sample4Momentum(G4LorentzVector* Mom, G4double Mass, G4LorentzVector* AntiMom,
                                 G4double AntiMass, G4double InitialMass) = 0;
  ...
  protected:
    ...
    virtual G4double GetLightConeZ(G4double zmin, G4double zmax, G4int PartonEncoding,
                                   G4ParticleDefinition* pHadron, G4double Px, G4double Py) = 0;
