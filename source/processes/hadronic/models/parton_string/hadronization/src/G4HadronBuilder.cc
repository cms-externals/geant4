                                             ...
                                             G4ParticleDefinition* white, Spin theSpin)
{
  ...
  if (std::abs(charge) > 2
      || std::abs(3. * charge - 3 * G4int(charge * 1.001))
           > perCent)  // 1.001 to avoid int(.9999) -> 0
  {
  ...
  if (id1 + id2 == 0)
  {
    ...
    {  // light quarks: u, d or s
      ...
      {
        PDGEncoding = 110
                        * (1 + (G4int)(rmix + scalarMesonMixings[imix - 1])
      ...
      {
        PDGEncoding = 110
                        * (1 + (G4int)(rmix + vectorMesonMixings[imix - 1])
  ...
  if (std::abs(PDGEncoding) == 10411)  // D*0(2400)+   ->  D+
    ...
    (PDGEncoding > 0 ? PDGEncoding = 431 : PDGEncoding = -431);
  else if (std::abs(PDGEncoding) == 10441)
    PDGEncoding = 441;  // chi_c0(1P) ->  eta_c
  else if (std::abs(PDGEncoding) == 100441)
    PDGEncoding = 441;  // eta_c(2S)  ->  eta_c
  else if (std::abs(PDGEncoding) == 10443)
    PDGEncoding = 443;  // h_c(1P)    ->  J/psi
  else if (std::abs(PDGEncoding) == 20443)
    PDGEncoding = 443;  // chi_c1(1P) ->  J/psi
  else if (std::abs(PDGEncoding) == 100443)
    PDGEncoding = 443;  // psi(2S)    ->  J/psi
  else if (std::abs(PDGEncoding) == 30443)
    PDGEncoding = 443;  // psi(3770)  ->  J/psi
  else if (std::abs(PDGEncoding) == 9000443)
    PDGEncoding = 443;  // psi(4040)  ->  J/psi
  else if (std::abs(PDGEncoding) == 9010443)
    PDGEncoding = 443;  // psi(4160)  ->  J/psi
  else if (std::abs(PDGEncoding) == 9020443)
    PDGEncoding = 443;  // psi(4415)  ->  J/psi
  else if (std::abs(PDGEncoding) == 445)
    PDGEncoding = 443;  // chi_c2(1P) ->  J/psi
  else if (std::abs(PDGEncoding) == 100445)
    PDGEncoding = 443;  // chi_c2(2P) ->  J/psi
  // Bottom mesons
    ...
    (PDGEncoding > 0 ? PDGEncoding = 541 : PDGEncoding = -541);
  else if (std::abs(PDGEncoding) == 551)
    PDGEncoding = 553;  // eta_b(1S)       ->  Upsilon
  else if (std::abs(PDGEncoding) == 10551)
    PDGEncoding = 553;  // chi_b0(1P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 100551)
    PDGEncoding = 553;  // eta_b(2S)       ->  Upsilon
  else if (std::abs(PDGEncoding) == 110551)
    PDGEncoding = 553;  // chi_b0(2P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 200551)
    PDGEncoding = 553;  // eta_b(3S)       ->  Upsilon
  else if (std::abs(PDGEncoding) == 210551)
    PDGEncoding = 553;  // chi_b0(3P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 10553)
    PDGEncoding = 553;  // h_b(1P)         ->  Upsilon
  else if (std::abs(PDGEncoding) == 20553)
    PDGEncoding = 553;  // chi_b1(1P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 30553)
    PDGEncoding = 553;  // Upsilon_1(1D)   ->  Upsilon
  else if (std::abs(PDGEncoding) == 100553)
    PDGEncoding = 553;  // Upsilon(2S)     ->  Upsilon
  else if (std::abs(PDGEncoding) == 110553)
    PDGEncoding = 553;  // h_b(2P)         ->  Upsilon
  else if (std::abs(PDGEncoding) == 120553)
    PDGEncoding = 553;  // chi_b1(2P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 130553)
    PDGEncoding = 553;  // Upsilon_1(2D)   ->  Upsilon
  else if (std::abs(PDGEncoding) == 200553)
    PDGEncoding = 553;  // Upsilon(3S)     ->  Upsilon
  else if (std::abs(PDGEncoding) == 210553)
    PDGEncoding = 553;  // h_b(3P)         ->  Upsilon
  else if (std::abs(PDGEncoding) == 220553)
    PDGEncoding = 553;  // chi_b1(3P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 300553)
    PDGEncoding = 553;  // Upsilon(4S)     ->  Upsilon
  else if (std::abs(PDGEncoding) == 9000553)
    PDGEncoding = 553;  // Upsilon(10860)  ->  Upsilon
  else if (std::abs(PDGEncoding) == 9010553)
    PDGEncoding = 553;  // Upsilon(11020)  ->  Upsilon
  else if (std::abs(PDGEncoding) == 555)
    PDGEncoding = 553;  // chi_b2(1P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 10555)
    PDGEncoding = 553;  // eta_b2(1D)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 20555)
    PDGEncoding = 553;  // Upsilon_2(1D)   ->  Upsilon
  else if (std::abs(PDGEncoding) == 100555)
    PDGEncoding = 553;  // chi_b2(2P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 110555)
    PDGEncoding = 553;  // eta_b2(2D)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 120555)
    PDGEncoding = 553;  // Upsilon_2(2D)   ->  Upsilon
  else if (std::abs(PDGEncoding) == 200555)
    PDGEncoding = 553;  // chi_b2(3P)      ->  Upsilon
  else if (std::abs(PDGEncoding) == 557)
    PDGEncoding = 553;  // Upsilon_3(1D)   ->  Upsilon
  else if (std::abs(PDGEncoding) == 100557)
    PDGEncoding = 553;  // Upsilon_3(2D)   ->  Upsilon
#ifdef debug_heavyHadrons
  ...
  G4ParticleDefinition* MesonDef = G4ParticleTable::GetParticleTable()->FindParticle(PDGEncoding);
  ...
  else if ((black->GetPDGCharge() + white->GetPDGCharge() - MesonDef->GetPDGCharge()) > perCent)
  {
    G4cerr << " G4HadronBuilder - Warning: Incorrect Charge : "
           << " Quark1/2 = " << black->GetParticleName() << " / " << white->GetParticleName()
           << " resulting Hadron " << MesonDef->GetParticleName() << G4endl;
  }
#endif
                                              ...
                                              G4ParticleDefinition* white, Spin theSpin)
{
  ...
  {  // Xi_cc++      ->  Sigma_c++ (use Sigma to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 4222 : PDGEncoding = -4222);
#ifdef debug_heavyHadrons
    charmViolation = 1;
#endif
  ...
  {  // Omega_cc+    ->  Xi_c+ (use Xi to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 4232 : PDGEncoding = -4232);
#ifdef debug_heavyHadrons
    charmViolation = 1;
#endif
  ...
  {  // Omega_ccc++  ->  Sigma_c++ (use Sigma to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 4222 : PDGEncoding = -4222);
#ifdef debug_heavyHadrons
    charmViolation = 2;
#endif
  ...
  {  // Xi_bc+       ->  Sigma_b+ (use Sigma to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5222 : PDGEncoding = -5222);
#ifdef debug_heavyHadrons
    charmViolation = 1;
#endif
  ...
  {  // Omega_bc0    ->  Xi_b0 (use Xi to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5232 : PDGEncoding = -5232);
#ifdef debug_heavyHadrons
    charmViolation = 1;
#endif
  ...
  {  // Omega_bc'0   ->  Xi_b0 (use Xi to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5232 : PDGEncoding = -5232);
#ifdef debug_heavyHadrons
    charmViolation = 1;
#endif
  ...
  {  // Omega_bcc+   ->  Sigma_b+ (use Sigma to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5222 : PDGEncoding = -5222);
#ifdef debug_heavyHadrons
    charmViolation = 2;
#endif
  ...
  {  // Omega_bbc0   ->  Xi_b0 (use Xi to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5232 : PDGEncoding = -5232);
#ifdef debug_heavyHadrons
    charmViolation = 1;
    bottomViolation = 1;
  ...
  {  // Omega_bbc*0  ->  Xi_b0 (use Xi to conserve charge)
    (PDGEncoding > 0 ? PDGEncoding = 5232 : PDGEncoding = -5232);
#ifdef debug_heavyHadrons
    charmViolation = 1;
    bottomViolation = 1;
  ...
  G4ParticleDefinition* BarionDef = G4ParticleTable::GetParticleTable()->FindParticle(PDGEncoding);
  ...
  else if ((black->GetPDGCharge() + white->GetPDGCharge() - BarionDef->GetPDGCharge()) > perCent)
  {
    G4cerr << " G4HadronBuilder - Warning: Incorrect Charge : "
           << " DiQuark/Quark = " << black->GetParticleName() << " / " << white->GetParticleName()
