...
#ifndef G4PARTICLEHPINELASTICBASEFS_HH
#define G4PARTICLEHPINELASTICBASEFS_HH
...
class G4ParticleHPInelasticBaseFS : public G4ParticleHPFinalState
{
  public:
    ...
    void Init(G4double A, G4double Z, G4int M, const G4String& dirName, const G4String& bit,
