...
G4ParticleHPInelasticDataPT::G4ParticleHPInelasticDataPT()
  : G4VCrossSectionDataSet("NeutronHPInelasticXSPT")
{
...
G4bool G4ParticleHPInelasticDataPT::IsIsoApplicable(const G4DynamicParticle* dp, G4int /*Z*/,
...
G4double G4ParticleHPInelasticDataPT::GetIsoCrossSection(const G4DynamicParticle* dp, G4int /*Z*/,
                                                         G4int /*A*/, const G4Isotope* iso,
                                                         const G4Element* element,
                                                         const G4Material* material)
{
  return G4ParticleHPProbabilityTablesStore::GetInstance()->GetIsoCrossSectionPT(dp, 3, iso,
                                                                                 element, material);
}
...
void G4ParticleHPInelasticDataPT::BuildPhysicsTable(const G4ParticleDefinition& aP)
{
  ...
  else if (G4HadronicParameters::Instance()->GetTypeTablePT() == "calendf")
  {
    ...
    {
      // sets the overall limits of the URR, which are stored at the last position of URRlimits -
      // min and max URR(all elements) defines URR model energy range
