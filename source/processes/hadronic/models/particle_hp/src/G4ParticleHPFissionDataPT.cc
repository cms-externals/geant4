...
G4ParticleHPFissionDataPT::G4ParticleHPFissionDataPT()
  : G4VCrossSectionDataSet("NeutronHPFissionXSPT")
{
...
G4bool G4ParticleHPFissionDataPT::IsIsoApplicable(const G4DynamicParticle* dp, G4int /*Z*/,
...
G4double G4ParticleHPFissionDataPT::GetIsoCrossSection(const G4DynamicParticle* dp, G4int /*Z*/,
                                                       G4int /*A*/, const G4Isotope* iso,
                                                       const G4Element* element,
                                                       const G4Material* material)
{
  return G4ParticleHPProbabilityTablesStore::GetInstance()->GetIsoCrossSectionPT(dp, 18, iso,
                                                                                 element, material);
}
