...
///--------------------------------------------------------------------------------------
void G4ParticleHPIsoProbabilityTable_NJOY::Init(G4int theZ, G4int theA, G4int them, G4double theT,
                                                const G4String& dirName)
{
  ...
  m = them;
  T = theT;
  G4cout << "The NJOY probability tables are being initialized for Z=" << Z << " A=" << A
         << " and T=" << T << " K." << G4endl;
...
///--------------------------------------------------------------------------------------
G4double G4ParticleHPIsoProbabilityTable_NJOY::GetCorrelatedIsoCrossSectionPT(
...
///--------------------------------------------------------------------------------------
G4double G4ParticleHPIsoProbabilityTable_NJOY::GetIsoCrossSectionPT(
  const G4DynamicParticle* dp, G4int MTnumber, const G4Element* ele, G4double& kineticEnergy,
