		 ...
		 const G4HadProjectile& aTrack, G4Nucleus& targetNucleus)
{
  ...
  const G4ParticleDefinition* theSecondary = 
    fXSection->SampleSecondaryType(part, Z, A, ekin);
  ...
  G4double mass3 = G4NucleiProperties::GetNuclearMass(A, Z);
  ...
  if (Z == 1 && A == 2) theRecoil = G4Deuteron::Deuteron();
