...
G4LEHadronProtonElastic::G4LEHadronProtonElastic() : G4HadronElastic("G4LEHadronProtonElastic")
{
...
G4double G4LEHadronProtonElastic::SampleInvariantT(const G4ParticleDefinition* p, G4double plab,
                                                   G4int, G4int)
{
