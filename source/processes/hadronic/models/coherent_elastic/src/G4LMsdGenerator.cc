...
G4LMsdGenerator::G4LMsdGenerator(const G4String& name) : G4HadronicInteraction(name), secID(-1)
...
G4bool G4LMsdGenerator::IsApplicable(const G4HadProjectile& aTrack, G4Nucleus& targetNucleus)
{
  ...
  if ((aTrack.GetDefinition() == G4Proton::Proton()
      ...
      aTrack.GetKineticEnergy() > 300 * CLHEP::MeV)  //  750*CLHEP::MeV )
  {
    applied = true;
  }
  else if ((aTrack.GetDefinition() == G4PionPlus::PionPlus()
            || aTrack.GetDefinition() == G4PionMinus::PionMinus())
           && targetNucleus.GetA_asInt() >= 1 && aTrack.GetKineticEnergy() > 2340 * CLHEP::MeV)
  {
    applied = true;
  }
  else if ((aTrack.GetDefinition() == G4KaonPlus::KaonPlus()
            || aTrack.GetDefinition() == G4KaonMinus::KaonMinus())
           && targetNucleus.GetA_asInt() >= 1 && aTrack.GetKineticEnergy() > 1980 * CLHEP::MeV)
  {
    applied = true;
  }
  return applied;
...
G4HadFinalState* G4LMsdGenerator::ApplyYourself(const G4HadProjectile& aTrack,
                                                G4Nucleus& targetNucleus)
{
  ...
  G4double eTarg =
    std::sqrt(targMass2 + pTarg.mag2());  // std::sqrt( targMass*targMass + pTarg.mag2() );
  ...
  if (eRecoil > 100. * CLHEP::MeV)  // add recoil nucleus
  {
    ...
    if (Z == 1 && A == 1)
    {
      recoilDef = G4Proton::Proton();
    }
    else if (Z == 1 && A == 2)
    {
      recoilDef = G4Deuteron::Deuteron();
    }
    else if (Z == 1 && A == 3)
    {
      recoilDef = G4Triton::Triton();
    }
    else if (Z == 2 && A == 3)
    {
      recoilDef = G4He3::He3();
    ...
    {
      recoilDef = G4Alpha::Alpha();
    }
    else
    {
      recoilDef = G4ParticleTable::GetParticleTable()->GetIonTable()->GetIon(Z, A, 0.0);
    }
  ...
  G4ParticleDefinition* ddPart = G4ParticleTable::GetParticleTable()->FindParticle(fPDGencoding);

  // G4cout<<fPDGencoding<<", "<<ddPart->GetParticleName()<<", "<<ddPart->GetPDGMass()<<" MeV; lvRes
  // = "<<lvRes<<G4endl;
...
const G4double G4LMsdGenerator::fProbMx[60][2] = {
  {1.000000e+00, 1.000000e+00}, {1.025000e+00, 1.000000e+00}, {1.050000e+00, 1.000000e+00},
  {1.075000e+00, 1.000000e+00}, {1.100000e+00, 9.975067e-01}, {1.125000e+00, 9.934020e-01},
  {1.150000e+00, 9.878333e-01}, {1.175000e+00, 9.805002e-01}, {1.200000e+00, 9.716846e-01},
  {1.225000e+00, 9.604761e-01}, {1.250000e+00, 9.452960e-01}, {1.275000e+00, 9.265278e-01},
  {1.300000e+00, 9.053632e-01}, {1.325000e+00, 8.775566e-01}, {1.350000e+00, 8.441969e-01},
  {1.375000e+00, 8.076336e-01}, {1.400000e+00, 7.682520e-01}, {1.425000e+00, 7.238306e-01},
  {1.450000e+00, 6.769306e-01}, {1.475000e+00, 6.303898e-01}, {1.500000e+00, 5.824632e-01},
  {1.525000e+00, 5.340696e-01}, {1.550000e+00, 4.873736e-01}, {1.575000e+00, 4.422901e-01},
  {1.600000e+00, 3.988443e-01}, {1.625000e+00, 3.583727e-01}, {1.650000e+00, 3.205405e-01},
  {1.675000e+00, 2.856655e-01}, {1.700000e+00, 2.537508e-01}, {1.725000e+00, 2.247863e-01},
  {1.750000e+00, 1.985798e-01}, {1.775000e+00, 1.750252e-01}, {1.800000e+00, 1.539777e-01},
  {1.825000e+00, 1.352741e-01}, {1.850000e+00, 1.187157e-01}, {1.875000e+00, 1.040918e-01},
  {1.900000e+00, 9.118422e-02}, {1.925000e+00, 7.980909e-02}, {1.950000e+00, 6.979378e-02},
  {1.975000e+00, 6.097771e-02}, {2.000000e+00, 5.322122e-02}, {2.025000e+00, 4.639628e-02},
  {2.050000e+00, 4.039012e-02}, {2.075000e+00, 3.510275e-02}, {2.100000e+00, 3.044533e-02},
  {2.125000e+00, 2.633929e-02}, {2.150000e+00, 2.271542e-02}, {2.175000e+00, 1.951295e-02},
  {2.200000e+00, 1.667873e-02}, {2.225000e+00, 1.416633e-02}, {2.250000e+00, 1.193533e-02},
  {2.275000e+00, 9.950570e-03}, {2.300000e+00, 8.181515e-03}, {2.325000e+00, 6.601664e-03},
  {2.350000e+00, 5.188025e-03}, {2.375000e+00, 3.920655e-03}, {2.400000e+00, 2.782246e-03},
  {2.425000e+00, 1.757765e-03}, {2.450000e+00, 8.341435e-04}, {2.475000e+00, 0.000000e+00}};
...
const G4double G4LMsdGenerator::fMxBdata[23][2] = {
  {1.09014, 17.8620}, {1.12590, 19.2831}, {1.18549, 17.6907}, {1.21693, 16.4760},
  {1.25194, 15.3867}, {1.26932, 14.4236}, {1.29019, 13.2931}, {1.30755, 12.2882},
  {1.31790, 11.4509}, {1.33888, 10.6969}, {1.34911, 9.44130}, {1.37711, 8.56148},
  {1.39101, 7.76593}, {1.42608, 6.88582}, {1.48593, 6.13019}, {1.53179, 5.87723},
  {1.58111, 5.37308}, {1.64105, 4.95217}, {1.69037, 4.44803}, {1.81742, 3.89879},
  {1.88096, 3.68693}, {1.95509, 3.43278}, {2.02219, 3.30445}};
