...
public:
  ...
  inline const G4ParticleDefinition* Hadron() {return hadr;}
...
private:
  ...
  G4double HadronNucleusQ2_2(G4ElasticData *pElD, G4double plabGeV, 
                             G4double tmax);

  void DefineHadronValues(G4int Z);
  void FillFq2(G4int A); 
