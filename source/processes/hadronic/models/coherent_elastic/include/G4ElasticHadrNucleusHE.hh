...
#ifndef G4ELASTICHADRNUCLEUSHE_HH
#define G4ELASTICHADRNUCLEUSHE_HH
...
class G4ElasticHadrNucleusHE : public G4HadronElastic
{
  ...
  private:
    ...
    void InterpolateHN(G4int n, const G4double EnP[], const G4double C0P[], const G4double C1P[],
    ...
    inline G4double LineInterpol(G4double p0, G4double p2, G4double c1, G4double c2, G4double p);
...
inline G4double G4ElasticHadrNucleusHE::LineInterpol(G4double p1, G4double p2, G4double c1,
                                                     G4double c2, G4double p)
{
...
inline G4double G4ElasticHadrNucleusHE::GetBinomCof(G4int numN, G4int numM)
{
