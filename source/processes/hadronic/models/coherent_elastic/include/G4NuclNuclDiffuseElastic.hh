...
#ifndef G4NUCLNUCLDIFFUSEELASTIC_HH
#define G4NUCLNUCLDIFFUSEELASTIC_HH
...
class G4NuclNuclDiffuseElastic : public G4HadronElastic  // G4HadronicInteraction
{
  public:
    ...
    void InitParameters(const G4ParticleDefinition* theParticle, G4double partMom, G4double Z,
                        G4double A);

    void InitDynParameters(const G4ParticleDefinition* theParticle, G4double partMom);

    void InitParametersGla(const G4DynamicParticle* aParticle, G4double partMom, G4double Z,
                           G4double A);

    G4double GetHadronNucleonXscNS(G4ParticleDefinition* pParticle, G4double pTkin,
...
inline G4double G4NuclNuclDiffuseElastic::CalculateZommerfeld(G4double beta, G4double Z1,
                                                              G4double Z2)
{
...
G4NuclNuclDiffuseElastic::GetCoulombIntegralXsc(const G4ParticleDefinition* particle,
                                                G4double momentum, G4double Z, G4double theta1,
                                                G4double theta2)
{
...
inline G4double G4NuclNuclDiffuseElastic::GetSint(G4double x)
{
  ...
  G4double out = integral.Legendre96(this, &G4NuclNuclDiffuseElastic::GetSinHaPit2, 0., x);
...
inline G4double G4NuclNuclDiffuseElastic::ProfileNear(G4double theta)
{
  ...
  if (std::abs(dTheta) < 0.001)
    result = fProfileAlpha * fProfileDelta;
  else
  {
...
inline G4double G4NuclNuclDiffuseElastic::CalcMandelstamS(const G4double mp, const G4double mt,
                                                          const G4double Plab)
{
