...
{
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> pp(
    G4Proton::ProtonDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> pn(
    G4Proton::ProtonDefinition(), G4Neutron::NeutronDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> piPlusp(
    G4PionPlus::PionPlusDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> piMinusp(
    G4PionMinus::PionMinusDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> KPlusp(
    G4KaonPlus::KaonPlusDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> KPlusn(
    G4KaonPlus::KaonPlusDefinition(), G4Neutron::NeutronDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> KMinusp(
    G4KaonMinus::KaonMinusDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> KMinusn(
    G4KaonMinus::KaonMinusDefinition(), G4Neutron::NeutronDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> gp(
    G4Gamma::GammaDefinition(), G4Proton::ProtonDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> gg(
    G4Gamma::GammaDefinition(), G4Gamma::GammaDefinition());
  std::pair<const G4ParticleDefinition*, const G4ParticleDefinition*> nn(
  ...
  if (xMap.find(trkPair) != xMap.end())
  {
    ...
    for (iter = xMap.begin(); iter != xMap.end(); ++iter)
    {
      ...
      if (thePair == trkPair)
      {
        ...
        {
          G4cout << "WARNING! G4XPDGTotal::PDGTotal extrapolating cross section at " << sqrtS / GeV
                 << " GeV outside the PDG fit range " << eMinFit / GeV << " - " << eMaxFit / GeV
                 << " GeV " << G4endl;
        }
        ...
        sigma = ((xFit * G4Pow::GetInstance()->powA(S, epsilon))
                 ...
                 + (coeff * y2Fit * G4Pow::GetInstance()->powA(S, eta2)))
                * millibarn;
        ...
        if (sigma < 0.)
        {
          ...
          G4cout << "WARNING! G4XPDGTotal::PDGTotal " << name1 << "-" << name2
                 << " total cross section: Ecm " << sqrtS / GeV << " GeV, negative cross section "
