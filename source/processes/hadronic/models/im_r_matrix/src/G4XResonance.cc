...
G4XResonance::G4XResonance(const G4ParticleDefinition* in1, const G4ParticleDefinition* in2,
  ...
  : isoOut1(iIsospinOut1),
    iSpinOut1(spinOut1),
    mOut1(massOut1),
    isoOut2(iIsospinOut2),
    iSpinOut2(spinOut2),
    mOut2(massOut2)
...
G4double G4XResonance::CrossSection(const G4KineticTrack& trk1, const G4KineticTrack& trk2) const
{
  ...
  sigma *=
    IsospinCorrection(trk1, trk2, isoOut1, isoOut2, iSpinOut1, iSpinOut2);  // from G4VXResonance
  //   G4cout << " "<<sigma<<G4endl;
