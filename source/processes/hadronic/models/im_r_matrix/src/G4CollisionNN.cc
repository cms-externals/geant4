...
typedef GROUP8(G4CollisionnpElastic, G4CollisionNNElastic, G4CollisionNNToNDelta,
...
const std::vector<G4String>& G4CollisionNN::GetListOfColliders(G4int) const
{
  throw G4HadronicException(__FILE__, __LINE__,
                            "G4CollisionNN::GetListOfColliders - Argument outside valid range");
  return colliders1;
}

G4double G4CollisionNN::CrossSection(const G4KineticTrack& aTrk1, const G4KineticTrack& aTrk2) const
{
  G4double sigma = 0.;
