...
#ifndef G4CONCRETEMESONBARYONTORESONANCE_HH
#define G4CONCRETEMESONBARYONTORESONANCE_HH
...
class G4ConcreteMesonBaryonToResonance : public G4VAnnihilationCollision
{
  public:
    ...
    virtual G4String GetName() const { return "ConcreteMesonBaryonToResonance"; }
