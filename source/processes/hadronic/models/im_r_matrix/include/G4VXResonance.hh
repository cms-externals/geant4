...
class G4VXResonance : public G4VCrossSectionSource
{
  ...
  protected:
    ...
    G4double DegeneracyFactor(const G4KineticTrack& trk1, const G4KineticTrack& trk2,
                              G4double iSpinOut1, G4double iSpinOut2) const;

    G4double DetailedBalance(const G4KineticTrack& trk1, const G4KineticTrack& trk2, G4int isoOut1,
                             G4int isoOut2, G4double iSpinOut1, G4double iSpinOut2, G4double mOut1,
                             G4double mOut2) const;

    G4double IsospinCorrection(const G4KineticTrack& trk1, const G4KineticTrack& trk2,
