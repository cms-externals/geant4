...
// ********************************************************************
//
#ifndef G4RESONANCEID_HH
#define G4RESONANCEID_HH
...
class G4ResonanceID
{
  public:
    ...
    {
      return pdg == 2224 || pdg == 2214 || pdg == 2114 || pdg == 1114;
    }
    G4bool IsDelta1600(G4int pdg)
    {
      return pdg == 31114 || pdg == 32114 || pdg == 32214 || pdg == 32224;
    }
    G4bool IsDelta1620(G4int pdg)
    {
      return pdg == 1112 || pdg == 1212 || pdg == 2122 || pdg == 2222;
    }
    G4bool IsDelta1700(G4int pdg)
    {
      return pdg == 11114 || pdg == 12114 || pdg == 12214 || pdg == 12224;
    }
    G4bool IsDelta1900(G4int pdg)
    {
      return pdg == 11112 || pdg == 11212 || pdg == 12122 || pdg == 12222;
    }
    G4bool IsDelta1905(G4int pdg)
    {
      return pdg == 1116 || pdg == 1216 || pdg == 2126 || pdg == 2226;
    }
    G4bool IsDelta1910(G4int pdg)
    {
      return pdg == 21112 || pdg == 21212 || pdg == 22122 || pdg == 22222;
    }
    G4bool IsDelta1920(G4int pdg)
    {
      return pdg == 21114 || pdg == 22114 || pdg == 22214 || pdg == 22224;
    }
    G4bool IsDelta1930(G4int pdg)
    {
      return pdg == 11116 || pdg == 11216 || pdg == 12126 || pdg == 12226;
    }
    G4bool IsDelta1950(G4int pdg)
    {
      return pdg == 1118 || pdg == 2118 || pdg == 2218 || pdg == 2228;
    }
