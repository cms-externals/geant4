...
class G4ConcreteNNTwoBodyResonance : public G4VScatteringCollision
{
  public:
    ...
    G4ConcreteNNTwoBodyResonance(void* s1, void* s2, void* s3, void* s4, void* s5, void* s6,
                                 void* s7);
    ...
    virtual const std::vector<G4String>& GetListOfColliders(G4int) const
    {
      throw G4HadronicException(
        __FILE__, __LINE__,
        "Tried to call G4ConcreteNNTwoBodyResonance::GetListOfColliders. Please find out why!");
      std::vector<G4String>* aList = new std::vector<G4String>;
      return *aList;
    }

    virtual G4String GetName() const { return "G4ConcreteNNTwoBodyResonance"; }
