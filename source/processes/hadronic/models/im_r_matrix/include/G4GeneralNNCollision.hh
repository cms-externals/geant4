...
// ********************************************************************
//
#ifndef G4GENERALNNCOLLISION_HH
#define G4GENERALNNCOLLISION_HH
  ...
  public:
    ...
    G4bool IsInCharge(const G4KineticTrack& trk1, const G4KineticTrack& trk2) const
    {
      ...
      if ((aD == G4Proton::Proton() || aD == G4Neutron::Neutron())
          && (bD == G4Proton::Proton() || bD == G4Neutron::Neutron()))
        result = true;
      return result;
    }
  ...
  protected:
    ...
    struct MakeNNToDeltaDelta
    {
        static void Make(G4CollisionComposite* aC)
        {
          ...
          typedef GROUP10(theC1, theC2, theC3, theC4, theC5, theC6, theC7, theC8, theC9, theC10)
            theChannels;
          G4CollisionComposite::Resolve aR;
          G4ForEach<theChannels>::Apply(&aR, aC);
        }
