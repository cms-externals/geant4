...
// ********************************************************************
//
#ifndef G4COLLISIONNNTODELTADELTA1920_HH
#define G4COLLISIONNNTODELTADELTA1920_HH
  ...
  public:
    ...
    virtual const std::vector<G4String>& GetListOfColliders(G4int) const
    {
      throw G4HadronicException(
        __FILE__, __LINE__,
        "Tried to call G4CollisionNNToDeltaDelta1920::GetListOfColliders. Please find out why!");
