...
G4ANuElNucleusNcModel::G4ANuElNucleusNcModel(const G4String& name) : G4NeutrinoNucleusModel(name)
{
...
G4bool G4ANuElNucleusNcModel::IsApplicable(const G4HadProjectile& aPart, G4Nucleus&)
{
  G4bool result = false;
