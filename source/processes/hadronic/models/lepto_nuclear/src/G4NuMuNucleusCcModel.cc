...
{
  // if(fDeExcitation) delete fDeExcitation;
  // if(fPreCompound)  delete fPreCompound;
...
void G4NuMuNucleusCcModel::RecoilDeexcitation( G4Fragment& fragment)
{
