...
G4NuTauNucleusNcModel::G4NuTauNucleusNcModel(const G4String& name) : G4NeutrinoNucleusModel(name)
{
...
G4bool G4NuTauNucleusNcModel::IsApplicable(const G4HadProjectile& aPart, G4Nucleus&)
{
  G4bool result = false;
...
G4HadFinalState* G4NuTauNucleusNcModel::ApplyYourself(const G4HadProjectile& aTrack,
