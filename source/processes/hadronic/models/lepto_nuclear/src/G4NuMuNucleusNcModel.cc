...
G4NuMuNucleusNcModel::G4NuMuNucleusNcModel(const G4String& name) : G4NeutrinoNucleusModel(name)
{
...
G4bool G4NuMuNucleusNcModel::IsApplicable(const G4HadProjectile& aPart, G4Nucleus&)
{
  G4bool result = false;
