...
#ifndef G4QUASIELRATIOS_HH
#define G4QUASIELRATIOS_HH
...
class G4QuasiElRatios
{
  public:
    ...
    std::pair<G4LorentzVector, G4LorentzVector> Scatter(G4int NPDG, G4LorentzVector N4M, G4int pPDG,
                                                        G4LorentzVector p4M);
    ...
    std::pair<G4LorentzVector, G4LorentzVector> ChExer(G4int NPDG, G4LorentzVector N4M, G4int pPDG,
                                                       G4LorentzVector p4M);
    ...
    G4bool RelDecayIn2(G4LorentzVector& theMomentum, G4LorentzVector& f4Mom, G4LorentzVector& s4Mom,
