...
void G4Analyser::printResultsSimple()
{
  ...
  G4cout << " Number of events " << G4int(eventNumber + 0.1) << G4endl << " average multiplicity "
         << averageMultiplicity / eventNumber << G4endl << " average proton number "
         << averageProtonNumber / eventNumber << G4endl << " average neutron number "
         << averageNeutronNumber / eventNumber << G4endl << " average nucleon Ekin "
         << averageNucleonKinEnergy / (averageProtonNumber + averageNeutronNumber) << G4endl
         << " average proton Ekin " << averageProtonKinEnergy / (averageProtonNumber + 1.0e-10)
         << G4endl << " average neutron Ekin "
         << averageNeutronKinEnergy / (averageNeutronNumber + 1.0e-10) << G4endl
         << " average pion number " << averagePionNumber / eventNumber << G4endl
         << " average pion Ekin " << averagePionKinEnergy / (averagePionNumber + 1.0e-10) << G4endl;
  if (withNuclei)
  {
    G4cout << " average Excitation Energy " << averageExitationEnergy / averageOutgoingNuclei
           << G4endl << " average num of fragments " << averageOutgoingNuclei / eventNumber
           << G4endl;
...
void G4Analyser::printResults()
{
  ...
  G4cout << " Number of events " << G4int(eventNumber + 0.1) << G4endl << " average multiplicity "
         ...
         << " average pion number " << averagePionNumber / eventNumber << G4endl
         << " average pion Ekin " << averagePionKinEnergy / (averagePionNumber + 1.0e-10) << G4endl
         << " average pi+ " << averagePionPl / eventNumber << G4endl << " average pi- "
         << averagePionMin / eventNumber << G4endl << " average pi0 " << averagePion0 / eventNumber
         << G4endl;

  if (withNuclei)
  {
    G4cout << " average A " << averageA / eventNumber << G4endl << " average Z "
           << averageZ / eventNumber << G4endl << " average Excitation Energy "
...
void G4Analyser::handleWatcherStatistics()
{
  ...
  if (verboseLevel > 3)
  {
    G4cout << " total exper c.s. " << tot_exper << " err " << tot_exper_err << " tot inucl c.s. "
           << tot_inucl << " err " << tot_inucl_err << G4endl;
    G4cout << " checked total " << checked << " lhood " << fgr << G4endl << " average ratio "
           << averat << " err " << ave_err << G4endl << " global chsq " << gl_chsq << G4endl;
  }
}
...
void G4Analyser::printResultsNtuple()
{
  ...
  G4cout << std::setw(15) << int(eventNumber + 0.1) << std::setw(15)
         << averageMultiplicity / eventNumber << std::setw(15) << averageProtonNumber / eventNumber
         << std::setw(15) << averageNeutronNumber / eventNumber << " " << std::setw(15)
         ...
         << std::setw(15) << averagePionNumber / eventNumber << " " << std::setw(15)
