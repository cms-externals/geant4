...
static const G4double hn1Frac[10] = {0.0,    0.0,    0.2980, 0.7196, 0.9812,
                                     0.8363, 0.5602, 0.9601, 0.9901, 1.0};
}  // namespace

// Constructor passes arrays to templated base class

G4HadNElastic1AngDst::G4HadNElastic1AngDst(G4int verbose)
  : G4ParamExpTwoBodyAngDst<10>("G4HadNElastic1AngDist", hn1ke, hn1Frac, hn1A, hn1C, hn1Cos,
                                verbose)
{
  ;
}
