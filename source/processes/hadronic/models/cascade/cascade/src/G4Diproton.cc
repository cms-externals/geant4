...
G4Diproton::G4Diproton()
  : G4VShortLivedParticle("diproton", 2. * proton_mass_c2, 0.0 * MeV, +2. * eplus, 2, +1, 0, 2, +2,
                          0, "nucleus", 0, +2, 0, /* ? 100020020 */
                          true, 0., NULL)
{}
...
G4Diproton* G4Diproton::DiprotonDefinition()
{
  return Definition();
}
G4Diproton* G4Diproton::Diproton()
{
  return Definition();
}
