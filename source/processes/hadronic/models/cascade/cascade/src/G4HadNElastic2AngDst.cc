...
static const G4double hn2Cos[10] = {-1.0,  -1.0,  -0.235, -0.259, -0.276,
                                    0.336, 0.250, 0.732,  0.875,  0.9};
static const G4double hn2Frac[10] = {1.0,    1.0,    0.6918, 0.6419, 0.7821,
                                     0.6542, 0.8382, 0.9722, 0.9784, 1.0};
}  // namespace

// Constructor passes arrays to templated base class

G4HadNElastic2AngDst::G4HadNElastic2AngDst(G4int verbose)
  : G4ParamExpTwoBodyAngDst<10>("G4HadNElastic2AngDist", hn2ke, hn2Frac, hn2A, hn2C, hn2Cos,
                                verbose)
{
  ;
}
