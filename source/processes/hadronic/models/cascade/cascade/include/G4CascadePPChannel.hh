...
class G4CascadePPChannel : public G4CascadeFunctions<G4CascadePPChannelData, G4PionNucSampler>
{
  public:

    G4CascadePPChannel() : G4CascadeFunctions<G4CascadePPChannelData, G4PionNucSampler>() { ; }
