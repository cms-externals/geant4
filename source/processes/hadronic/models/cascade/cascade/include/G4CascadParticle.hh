...
class G4CascadParticle
{
  public:
    ...
    G4CascadParticle(const G4InuclElementaryParticle& particle, const G4ThreeVector& pos,
    ...
    void fill(const G4InuclElementaryParticle& particle, const G4ThreeVector& pos, G4int izone,
    ...
    void updateParticleMomentum(const G4LorentzVector& mom) { theParticle.setMomentum(mom); }
