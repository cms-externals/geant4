...
G4double G4PreCompoundFragment::CrossSection(G4double ekin)
{
  ...
  {
    recentXS = G4ChatterjeeCrossSection::ComputeCrossSection(ekin, theCoulombBarrier, theResA13,
                                                             muu, index, theZ, theResA);
  }
  else
  {
    recentXS = G4KalbachCrossSection::ComputeCrossSection(ekin, theCoulombBarrier, theResA13, muu,
