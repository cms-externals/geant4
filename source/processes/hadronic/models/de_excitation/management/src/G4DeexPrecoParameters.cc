...
std::ostream& G4DeexPrecoParameters::StreamInfo(std::ostream& os) const
{
  ...
  os << "Pre-compound excitation low energy                  " << fPrecoLowEnergy / CLHEP::MeV
     << " MeV \n";
  os << "Pre-compound excitation high energy                 " << fPrecoHighEnergy / CLHEP::MeV
     << " MeV \n";
  ...
  os << "Min excitation energy                               " << fMinExcitation / CLHEP::keV
     << " keV \n";
  ...
  os << "Time limit for long lived isomeres                  " << fMaxLifeTime / CLHEP::ns
     << " ns \n";
  os << "Isomer production flag                              " << fIsomerFlag << "\n";
  os << "Internal e- conversion flag                         " << fInternalConversion << "\n";
...
{
  return (!G4Threading::IsMasterThread() || (fStateManager->GetCurrentState() != G4State_PreInit));
}
