...
G4EvaporationChannel::G4EvaporationChannel(G4int anA, G4int aZ, G4EvaporationProbability* aprob)
...
G4double G4EvaporationChannel::GetEmissionProbability(G4Fragment* fragment)
{
  ...
  */
  ...
  G4double prob = theProbability->TotalProbability(*fragment, ekinmin, ekinmax, bCoulomb, exEnergy);
  return prob;
}
