...
G4double G4DeexPrecoUtility::CorrectionFactor(const G4int index, const G4int Z, const G4double A13,
                                              const G4double CB, const G4double ekin)
{
...
G4double G4DeexPrecoUtility::ProtonKValue(const G4int Z)
{
  ...
  {
    res = 0.68 + (Z - 30) * 0.0045;
  }
  else if (70 > Z)
  {
    res = 0.77 + (Z - 50) * 0.0015;
  }
  else
  {
    res = 0.8;
...
G4double G4DeexPrecoUtility::ProtonCValue(const G4int Z)
{
  ...
  {
    res = 0.20 - (Z - 30) * 0.0025;
  }
  else if (70 > Z)
  {
    res = 0.15 - (Z - 50) * 0.0025;
  }
  else
  {
    res = 0.1;
...
G4double G4DeexPrecoUtility::LevelDensity(const G4int Z, const G4int A, const G4int idx)
{
  G4double a = 0.05 * A;
