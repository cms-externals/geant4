...
#ifndef G4CAMERONTRURANHILFSHELLCORRECTIONS_HH
#define G4CAMERONTRURANHILFSHELLCORRECTIONS_HH
...
class G4CameronTruranHilfShellCorrections
{
  ...
  private:
    ...
    operator=(const G4CameronTruranHilfShellCorrections& right) = delete;
