...
G4VStatMFMacroCluster::G4VStatMFMacroCluster(const G4VStatMFMacroCluster&)
{
  throw G4HadronicException(__FILE__, __LINE__,
                            "G4VStatMFMacroCluster::copy_constructor meant to not be accessible");
}
...
{
  throw G4HadronicException(__FILE__, __LINE__,
                            "G4VStatMFMacroCluster::operator= meant to not be accessible");
  return *this;
}

G4bool G4VStatMFMacroCluster::operator==(const G4VStatMFMacroCluster&) const
{
  //	throw G4HadronicException(__FILE__, __LINE__, "G4VStatMFMacroCluster::operator== meant to not
  // be accessible");
  return false;
}
