...
G4NeutronRadCapture::G4NeutronRadCapture()
  : G4HadronicInteraction("nRadCapture"), photonEvaporation(nullptr), lab4mom(0., 0., 0., 0.)
{
                                                    ...
                                                    G4Nucleus& theNucleus)
{
  ...
  if (A <= 4)
  {
    ...
    if (verboseLevel > 1)
    {
      G4cout << "G4NeutronRadCapture::DoIt: Eini(MeV)=" << aTrack.GetKineticEnergy() / MeV
    ...
    if (verboseLevel > 1)
    {
      G4cout << "Gamma 4-mom: " << lv2 << "   " << theDef->GetParticleName() << "   " << lab4mom
             << G4endl;
    }
    if (theDef)
    {
  ...
  else
  {
    ...
    for (std::size_t i = 0; i < n; ++i)
    {
      ...
      if (verboseLevel > 1)
      {
        G4cout << i << ". " << theDef->GetParticleName() << " Ekin(MeV)= " << etot / MeV
