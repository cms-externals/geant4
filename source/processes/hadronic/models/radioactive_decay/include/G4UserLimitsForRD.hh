...
// ********************************************************************
//
#ifndef G4USERLIMITSFORRD_HH
#define G4USERLIMITSFORRD_HH
...
class G4UserLimitsForRD : public G4UserLimits
{
  ...
  public:
    ...
    G4UserLimitsForRD(const G4String aType = "RD") : G4UserLimits(aType)
    {
#ifdef G4VERBOSE
      if (GetVerboseLevel() > 1) G4cerr << "G4UserLimitsForRD constructor" << endl;
#endif
    }
    ~G4UserLimitsForRD() { ; }
