...
class G4BinaryCascade : public G4VIntraNuclearTransportModel
{
  ...
  private:
    ...
    G4ReactionProductVector* ProductsAddFinalState(G4ReactionProductVector* products,
                                                   G4KineticTrackVector& finalState);
    G4ReactionProductVector* ProductsAddPrecompound(G4ReactionProductVector* products,
    ...
    G4double CorrectShortlivedPrimaryForFermi(G4KineticTrack* primary,
    ...
    G4ReactionProductVector* HighEnergyModelFSProducts(
      G4ReactionProductVector*,
      G4KineticTrackVector* secondaries);  // add secondaries of string model to G4RPV
    G4ReactionProductVector* FillVoidNucleusProducts(
      G4ReactionProductVector*);  // nucleus destroyed, add secondaries to G4RPV
    // utility methods
    ...
    G4bool DebugFinalEpConservation(const G4HadProjectile& aTrack,
