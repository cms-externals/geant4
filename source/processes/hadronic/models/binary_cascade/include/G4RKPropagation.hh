...
#ifndef G4RKPROPAGATION_HH
#define G4RKPROPAGATION_HH
...
class G4RKPropagation : public G4VFieldPropagation
{
  ...
  private:
    ...
    G4bool GetSphereIntersectionTimes(const G4double radius, const G4ThreeVector& currentPos,
                                      const G4LorentzVector& momentum, G4double& t1, G4double& t2);
    // implementation
