...
class G4Clebsch
{
  public:
    ...
    // phase convention.
    static G4double ClebschGordanCoeff(G4int twoJ1, G4int twoM1, G4int twoJ2, G4int twoM2,
                                       G4int twoJ);
    ...
    static std::vector<G4double> GenerateIso3(G4int twoJ1, G4int twoM1, G4int twoJ2, G4int twoM2,
                                              G4int twoJOut1, G4int twoJOut2);

    static G4double Weight(G4int twoJ1, G4int twoM1, G4int twoJ2, G4int twoM2, G4int twoJOut1,
                           G4int twoJOut2);
    ...
    static G4double Wigner3J(G4double j1, G4double j2, G4double j3, G4double m1, G4double m2,
                             G4double m3);
    ...
    static G4double NormalizedClebschGordan(G4int twoJ, G4int twom, G4int twoJ1, G4int twoJ2,
    ...
    static G4double Wigner6J(G4int twoJ1, G4int twoJ2, G4int twoJ3, G4int twoJ4, G4int twoJ5,
                             G4int twoJ6);

    // Racah's W Coeffs (6J's with a different phase and normalization)
    static G4double RacahWCoeff(G4int twoJ1, G4int twoJ2, G4int twoJ, G4int twoJ3, G4int twoJ12,
                                G4int twoJ23);

    // Wigner's 9J symbols (generalization of CG's for coupling of 4 angular momenta).
    static G4double Wigner9J(G4int twoJ1, G4int twoJ2, G4int twoJ3, G4int twoJ4, G4int twoJ5,
