...
#ifndef G4EXCITEDSTRING_HH
#define G4EXCITEDSTRING_HH
...
class G4ExcitedString
{
  public:
    ...
    G4ExcitedString(G4Parton* Color, G4Parton* Gluon, G4Parton* AntiColor,
...
inline G4bool G4ExcitedString::operator==(const G4ExcitedString& right) const
{
  return this == &right;
}
...
inline G4double G4ExcitedString::GetTimeOfCreation() const
{
  return theTimeOfCreation;
}

inline void G4ExcitedString::SetTimeOfCreation(G4double aTime)
{
  theTimeOfCreation = aTime;
}

inline const G4ThreeVector& G4ExcitedString::GetPosition() const
{
  return thePosition;
}

inline void G4ExcitedString::SetPosition(const G4ThreeVector& aPosition)
{
  thePosition = aPosition;
}

inline G4LorentzVector G4ExcitedString::Get4Momentum() const
{
...
inline void G4ExcitedString::LorentzRotate(const G4LorentzRotation& rotation)
{
  if (IsExcited())
  {
    for (unsigned int index = 0; index < thePartons.size(); index++)
...
inline void G4ExcitedString::InsertParton(G4Parton* aParton, const G4Parton* addafter)
{
...
inline G4LorentzRotation G4ExcitedString::TransformToCenterOfMass()
{
...
inline G4LorentzRotation G4ExcitedString::TransformToAlignedCms()
{
  G4LorentzVector momentum = Get4Momentum();
...
inline const G4PartonVector* G4ExcitedString::GetPartonList() const
{
  return &thePartons;
}

inline G4KineticTrack* G4ExcitedString::GetKineticTrack() const
{
  return theTrack;
}

inline G4bool G4ExcitedString::IsExcited() const
{
  return theTrack == 0;
}
