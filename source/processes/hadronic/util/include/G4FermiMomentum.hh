...
//
//
#ifndef G4FERMIMOMENTUM_HH
#define G4FERMIMOMENTUM_HH
...
class G4FermiMomentum
{
  public:
    ...
    inline void Init(G4int anA, G4int aZ)
    {
      theA = anA;
      theZ = aZ;
    }
    ...
    inline G4ThreeVector GetMomentum(G4double density, G4double maxMomentum = -1.)
    {
      ...
      do
      {
        p = G4ThreeVector(2. * G4UniformRand() - 1., 2. * G4UniformRand() - 1.,
                          2. * G4UniformRand() - 1.);
