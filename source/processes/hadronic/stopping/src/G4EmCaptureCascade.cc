...
G4EmCaptureCascade::G4EmCaptureCascade() : G4HadronicInteraction("emCaptureCascade")
{
  ...
  static const G4int listK[nlevels] = {1,  2,  4,  6,  8,  11, 14, 17, 18, 21, 24, 26, 29, 32,
                                       38, 40, 41, 44, 49, 53, 55, 60, 65, 70, 75, 81, 85, 92};
  static const G4double listKEnergy[nlevels] = {
    0.00275, 0.011, 0.043, 0.098, 0.173, 0.326,  0.524,  0.765, 0.853, 1.146,
    1.472,   1.708, 2.081, 2.475, 3.323, 3.627,  3.779,  4.237, 5.016, 5.647,
    5.966,   6.793, 7.602, 8.421, 9.249, 10.222, 10.923, 11.984};
...
G4HadFinalState* G4EmCaptureCascade::ApplyYourself(const G4HadProjectile& projectile,
