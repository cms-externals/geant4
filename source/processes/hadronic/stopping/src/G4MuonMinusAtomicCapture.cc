...
G4double G4MuonMinusAtomicCapture::AtRestGetPhysicalInteractionLength(const G4Track&,
...
G4VParticleChange* G4MuonMinusAtomicCapture::AtRestDoIt(const G4Track& track, const G4Step&)
{
  ...
  G4ParticleDefinition* muonicAtom =
    itp->GetMuonicAtom(nucleus->GetZ_asInt(), nucleus->GetA_asInt());
