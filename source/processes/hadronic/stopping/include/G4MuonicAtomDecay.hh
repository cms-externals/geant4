...
// ********************************************************************
//
#ifndef G4MUONICATOMDECAY_HH
#define G4MUONICATOMDECAY_HH
...
class G4MuonicAtomDecay : public G4VRestDiscreteProcess
{
  ...
  public:  // with description
    ...
    inline virtual G4VParticleChange* AtRestDoIt(const G4Track& theTrack, const G4Step& theStep)
    {
      return DecayIt(theTrack, theStep);
    }

    inline virtual G4VParticleChange* PostStepDoIt(const G4Track& theTrack, const G4Step& theStep)
    {
      return DecayIt(theTrack, theStep);
    }
