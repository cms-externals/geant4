...
#ifndef G4MUMINUSCAPTUREPRECOMPOUND_HH
#define G4MUMINUSCAPTUREPRECOMPOUND_HH
...
class G4MuMinusCapturePrecompound : public G4HadronicInteraction
{
  ...
  private:
    ...
    inline void AddNewParticle(const G4ParticleDefinition* aParticle, G4ThreeVector& direction,
                               G4double kinEnergy);
...
inline void G4MuMinusCapturePrecompound::AddNewParticle(const G4ParticleDefinition* aParticle,
                                                        G4ThreeVector& direction,
                                                        G4double kinEnergy)
{
  G4DynamicParticle* dp = new G4DynamicParticle(aParticle, direction, kinEnergy);
