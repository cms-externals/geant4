...
#ifndef G4EMCAPTURECASCADE_HH
#define G4EMCAPTURECASCADE_HH
...
inline void G4EmCaptureCascade::AddNewParticle(G4ParticleDefinition* aParticle, G4double kinEnergy)
{
