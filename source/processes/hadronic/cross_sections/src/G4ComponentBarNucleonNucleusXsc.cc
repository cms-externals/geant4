...
G4int G4ComponentBarNucleonNucleusXsc::theZ[] = {2,  4,  6,  7,  8,  11, 13, 14, 20,
...
G4double
G4ComponentBarNucleonNucleusXsc::GetTotalIsotopeCrossSection(const G4ParticleDefinition* aParticle,
...
G4double
G4ComponentBarNucleonNucleusXsc::GetTotalElementCrossSection(const G4ParticleDefinition* aParticle,
...
G4double G4ComponentBarNucleonNucleusXsc::GetInelasticIsotopeCrossSection(
  const G4ParticleDefinition* aParticle, G4double kinEnergy, G4int Z, G4int)
{
  ComputeCrossSections(aParticle, kinEnergy, Z);
...
G4double G4ComponentBarNucleonNucleusXsc::GetInelasticElementCrossSection(
  const G4ParticleDefinition* aParticle, G4double kinEnergy, G4int Z, G4double)
{
  ComputeCrossSections(aParticle, kinEnergy, Z);
  return fInelasticXsc;
}
...
void G4ComponentBarNucleonNucleusXsc::ComputeCrossSections(const G4ParticleDefinition* aParticle,
                                                           G4double kineticEnergy, G4int ZZ)
{
...
G4double G4ComponentBarNucleonNucleusXsc::Interpolate(G4int Z1, G4int Z2, G4int Z, G4double x1,
                                                      G4double x2) const
{
