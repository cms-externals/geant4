                ...
                G4double kinEnergy, G4int Z, G4int A)
{
  ...
  //
  G4double sigma, cofInelastic, cofTotal;
      ...
      aParticle == thePiMinus      )
  {
    ...
    cofTotal     = 2.0;
           ...
           aParticle == theK0L) 
  {
    sigma = Z*hnXsc->KaonNucleonXscGG(aParticle, theProton, kinEnergy);
    hpInXsc = hnXsc->GetInelasticHadronNucleonXsc();
  ...
  { 
    ...
    fProductionXsc *= GetParticleBarCorIn(aParticle, Z);
  }
  else // H
  {
    fTotalXsc = sigma;
                                                 ...
                                                 G4int At, G4int /*Zt*/)
{
  ...
  {
    xsection = aa*(0.0677*g4calc->powA(sMand,0.0808) + 0.129*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == theNeutron) // as proton ??? 
  {
    xsection = aa*(21.70*g4calc->powA(sMand,0.0808) + 56.08*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == theProton) 
  {
    xsection = aa*(21.70*g4calc->powA(sMand,0.0808) + 56.08*g4calc->powA(sMand,-0.4525));
    // xsection = At*( 49.51*g4calc->powA(sMand,-0.097) + 0.314*G4Log(sMand)*G4Log(sMand) );
    // xsection = At*( 38.4 + 0.85*std::abs(g4calc->powA(log(sMand),1.47)) );
  } 
  else if(theParticle == theAProton) 
  {
    xsection = aa*( 21.70*g4calc->powA(sMand,0.0808) + 98.39*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == thePiPlus) 
  {
    xsection = aa*(13.63*g4calc->powA(sMand,0.0808) + 27.56*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == thePiMinus) 
  {
    // xsection = At*( 55.2*g4calc->powA(sMand,-0.255) + 0.346*G4Log(sMand)*G4Log(sMand) );
    xsection = aa*(13.63*g4calc->powA(sMand,0.0808) + 36.02*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == theKPlus) 
  {
    xsection = aa*(11.82*g4calc->powA(sMand,0.0808) + 8.15*g4calc->powA(sMand,-0.4525));
  } 
  else if(theParticle == theKMinus) 
  {
    xsection = aa*(11.82*g4calc->powA(sMand,0.0808) + 26.36*g4calc->powA(sMand,-0.4525));
  }
  else  // as proton ??? 
  {
    xsection = aa*(21.70*g4calc->powA(sMand,0.0808) + 56.08*g4calc->powA(sMand,-0.4525));
                                                    ...
                                                    G4int At, G4int Zt)
{
  ...
  {
    xsection = zz*( 35.80 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 40.15*g4calc->powA(sMand,-eta1) - 30.*g4calc->powA(sMand,-eta2));
    xsection  += nn*( 35.45 + B*g4calc->powA(G4Log(sMand/s0),2.) 
		      + 42.53*g4calc->powA(sMand,-eta1) - 33.34*g4calc->powA(sMand,-eta2)); // pp for nn
  } 
  else if(theParticle == theProton) 
  {
      
      xsection  = zz*( 35.45 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 42.53*g4calc->powA(sMand,-eta1) - 33.34*g4calc->powA(sMand,-eta2));

      xsection += nn*( 35.80 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 40.15*g4calc->powA(sMand,-eta1) - 30.*g4calc->powA(sMand,-eta2));
  } 
  else if(theParticle == theAProton) 
  {
  ...
  {
    xsection  = aa*( 20.86 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 19.24*g4calc->powA(sMand,-eta1) - 6.03*g4calc->powA(sMand,-eta2));
  } 
  else if(theParticle == thePiMinus) 
  {
    xsection  = aa*( 20.86 + B*g4calc->powA(G4Log(sMand/s0),2.) 
  ...
  {
    xsection  = zz*( 17.91 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 7.14*g4calc->powA(sMand,-eta1) - 13.45*g4calc->powA(sMand,-eta2));

    xsection += nn*( 17.87 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 5.17*g4calc->powA(sMand,-eta1) - 7.23*g4calc->powA(sMand,-eta2));
  } 
  ...
  {
    xsection  = aa*( 35.20 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          - 199.*g4calc->powA(sMand,-eta1) + 264.*g4calc->powA(sMand,-eta2));
  } 
  else if(theParticle == theGamma) // modify later on
  {
    xsection  = aa*( 0.0 + B*g4calc->powA(G4Log(sMand/s0),2.) 
                          + 0.032*g4calc->powA(sMand,-eta1) - 0.0*g4calc->powA(sMand,-eta2));
        ...
        const G4DynamicParticle* aParticle, G4int At, G4int Zt)
{
  ...
  if(theParticle == theNeutron) 
  {
    ...
    // if( proj_momentum >= 2.)
    {
      ...
      //AR-12Aug2016  if(proj_momentum >= 10.)
      {
        ...
        xsection = A0 + B0*G4Log(proj_energy) - 11
                  + 103*g4calc->powA(2*0.93827*proj_energy + proj_mass*proj_mass+
    ...
    else
    {
      ...
      {
        hnXscv = 23 + 50*( g4calc->powA( G4Log(0.73/proj_momentum), 3.5 ) );
      }
      ...
      {
         hnXscv = 39.0+
              75*(proj_momentum - 1.2)/(g4calc->powA(proj_momentum,3.0) + 0.15);
      }
      // pn to be np

      if( proj_momentum < 0.8 )
      {
        hpXscv = 33+30*g4calc->powA(G4Log(proj_momentum/1.3),4.0);
      }      
      else if( proj_momentum < 1.4 )
      {
        hpXscv = 33+30*g4calc->powA(G4Log(proj_momentum/0.95),2.0);
      }
      else    // if( proj_momentum < 10.  )
      {
        hpXscv = 33.3+
              20.8*(g4calc->powA(proj_momentum,2.0)-1.35)/
                 (g4calc->powA(proj_momentum,2.50)+0.95);
      }
  ...
  else if(theParticle == theProton) 
  {
    ...
    else
    {
      ...
      if( proj_momentum < 0.73 )
      {
        hpXscv = 23 + 50*( g4calc->powA( G4Log(0.73/proj_momentum), 3.5 ) );
      }
      else if( proj_momentum < 1.05  )
      {
      ...
      if( proj_momentum < 0.8 )
      {
        hnXscv = 33+30*g4calc->powA(G4Log(proj_momentum/1.3),4.0);
      }      
      else if( proj_momentum < 1.4 )
      {
        hnXscv = 33+30*g4calc->powA(G4Log(proj_momentum/0.95),2.0);
      }
      else   // if( proj_momentum < 10.  )
      {
        hnXscv = 33.3+
  ...
  {
    // xsection  = Zt*( 35.45 + B*g4calc->powA(G4Log(sMand/s0),2.) 
    //                       + 42.53*g4calc->powA(sMand,-eta1) + 33.34*g4calc->powA(sMand,-eta2));

    // xsection += Nt*( 35.80 + B*g4calc->powA(G4Log(sMand/s0),2.) 
    //                    + 40.15*g4calc->powA(sMand,-eta1) + 30.*g4calc->powA(sMand,-eta2));
    ...
    {
      xsection  = zz*( 41.1 + 77.2*g4calc->powA( proj_momentum, -0.68) 
                       + 0.293*logP*logP - 1.82*logP );
    }
    if ( nn > 0.)  
    {
      xsection += nn*( 41.9 + 96.2*g4calc->powA( proj_momentum, -0.99) - 0.154*logP);
    }
    else // H
    {
      fInelasticXsc =   38.0 + 38.0*g4calc->powA( proj_momentum, -0.96) 
	                - 0.169*logP*logP;
  ...
  else if( theParticle == thePiPlus ) 
  {
    ...
    {
      hpXscv = 10.6+2.*G4Log(proj_energy)+25*g4calc->powA(proj_energy,-0.43);
    }
    // pi+n = pi-p??
    ...
    {
      hnXscv = 10.6+2*G4Log(proj_energy)+30*g4calc->powA(proj_energy,-0.43); 
    }
    xsection = hpXscv*zz + hnXscv*nn;
  } 
  else if(theParticle == thePiMinus) 
  {
    ...
    {
      hnXscv = 10.6+2.*G4Log(proj_energy)+25*g4calc->powA(proj_energy,-0.43);
    }
    // pi-p
    ...
    {
      hpXscv = 10.6+2*G4Log(proj_energy)+30*g4calc->powA(proj_energy,-0.43); 
    }
    xsection = hpXscv*zz + hnXscv*nn;
  } 
  else if(theParticle == theKPlus) 
                                                 ...
                                                 G4int At, G4int Zt)
{
  ...
  {
       G4double XtotPP = 48.0 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.522*sqrLogPlab - 4.51*LogPlab;

       G4double XtotPN = 47.3 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.513*sqrLogPlab - 4.27*LogPlab;

       G4double XelPP  = 11.9 + 26.9*g4calc->powA(Plab,-1.21) +
                         0.169*sqrLogPlab - 1.85*LogPlab;

       G4double XelPN  = 11.9 + 26.9*g4calc->powA(Plab,-1.21) +
                         0.169*sqrLogPlab - 1.85*LogPlab;
  ...
  {
       G4double XtotPiP = 16.4 + 19.3 *g4calc->powA(Plab,-0.42) +
                          0.19 *sqrLogPlab - 0.0 *LogPlab;

       G4double XtotPiN = 33.0 + 14.0 *g4calc->powA(Plab,-1.36) +
                          0.456*sqrLogPlab - 4.03*LogPlab;

       G4double XelPiP  =  0.0 + 11.4*g4calc->powA(Plab,-0.40) +
                           0.079*sqrLogPlab - 0.0 *LogPlab;

       G4double XelPiN  = 1.76 + 11.2*g4calc->powA(Plab,-0.64) +
  ...
  {
       G4double XtotPiP = 33.0 + 14.0 *g4calc->powA(Plab,-1.36) +
                          0.456*sqrLogPlab - 4.03*LogPlab;

       G4double XtotPiN = 16.4 + 19.3 *g4calc->powA(Plab,-0.42) +
                          0.19 *sqrLogPlab - 0.0 *LogPlab;

       G4double XelPiP  = 1.76 + 11.2*g4calc->powA(Plab,-0.64) +
                          0.043*sqrLogPlab - 0.0 *LogPlab;

       G4double XelPiN  =  0.0 + 11.4*g4calc->powA(Plab,-0.40) +
                           0.079*sqrLogPlab - 0.0 *LogPlab;
  ...
  {
       G4double XtotKP = 18.1 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.26 *sqrLogPlab - 1.0 *LogPlab;
       G4double XtotKN = 18.7 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.21 *sqrLogPlab - 0.89*LogPlab;

       G4double XelKP  =  5.0 +  8.1*g4calc->powA(Plab,-1.8 ) +
                          0.16 *sqrLogPlab - 1.3 *LogPlab;

       G4double XelKN  =  7.3 +  0. *g4calc->powA(Plab,-0.  ) +
  ...
  {
       G4double XtotKP = 32.1 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.66 *sqrLogPlab - 5.6 *LogPlab;
       G4double XtotKN = 25.2 +  0. *g4calc->powA(Plab, 0.  ) +
                         0.38 *sqrLogPlab - 2.9 *LogPlab;

       G4double XelKP  =  7.3 +  0. *g4calc->powA(Plab,-0.  ) +
                          0.29 *sqrLogPlab - 2.4 *LogPlab;

       G4double XelKN  =  5.0 +  8.1*g4calc->powA(Plab,-1.8 ) +
                          0.16 *sqrLogPlab - 1.3 *LogPlab;
