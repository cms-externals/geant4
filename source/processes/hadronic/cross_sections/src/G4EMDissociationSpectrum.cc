...
////////////////////////////////////////////////////////////////////////////////
//
G4double G4EMDissociationSpectrum::GetGeneralE1Spectrum(G4double Eg, G4double b0, G4double bmin)
{
...
////////////////////////////////////////////////////////////////////////////////
//
G4double G4EMDissociationSpectrum::GetGeneralE2Spectrum(G4double Eg, G4double b0, G4double bmin)
{
  G4double b = std::max(b0, 1.e-6);
  G4double b2 = b * b;
  G4double b4 = b2 * b2;
...
////////////////////////////////////////////////////////////////////////////////
//
G4double G4EMDissociationSpectrum::GetClosestApproach(const G4double AP, const G4double ZP,
                                                      G4double AT, G4double ZT, G4double b0)
{
  G4double b = std::max(b0, 1.e-6);
  G4double bsq = b * b;
