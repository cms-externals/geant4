...
void G4ElNucleusSFcs::CrossSectionDescription(std::ostream& outFile) const
{
  outFile << "G4ElNucleusSFcs provides the inelastic\n"
          << "cross section for e- and e+ interactions with nuclei according to the structure "
             "function approach."
          << "all energies.\n";
}

G4bool G4ElNucleusSFcs::IsElementApplicable(const G4DynamicParticle* aPart, G4int Z,
                                            const G4Material*)
{
...
G4double G4ElNucleusSFcs::GetIsoCrossSection(const G4DynamicParticle* aPart, G4int ZZ, G4int AA,
...
const G4double G4ElNucleusSFcs::fZZ[19] = {2.,  6.,  7.,  8.,  13., 14., 18., 22., 26., 29.,
                                           32., 42., 46., 47., 48., 74., 79., 82., 92.};

/////////////////////////////////////////

const G4double G4ElNucleusSFcs::fRR[19] = {1.81, 2.26, 2.47, 2.61, 2.57, 2.49, 2.72,
                                           2.71, 2.79, 2.78, 2.87, 3.02, 3.02, 2.99,
                                           3.,   3.44, 3.49, 3.48, 2.88};
