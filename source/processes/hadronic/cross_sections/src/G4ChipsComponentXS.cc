...
G4ChipsComponentXS::G4ChipsComponentXS()
  : G4VComponentCrossSection("G4ChipsComponentXS"), fUpperLimit(10000 * GeV), fLowerLimit(10 * MeV)
{
  PxsManagerEl =
    (G4ChipsProtonElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsProtonElasticXS::Default_Name());
  PxsManagerInEl =
    (G4ChipsProtonInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsProtonInelasticXS::Default_Name());
  ...
  NxsManagerInEl =
    (G4ChipsNeutronInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsNeutronInelasticXS::Default_Name());

  PBARxsManagerEl =
    (G4ChipsAntiBaryonElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsAntiBaryonElasticXS::Default_Name());
  PBARxsManagerInEl = (G4ChipsAntiBaryonInelasticXS*)G4CrossSectionDataSetRegistry::Instance()
                        ->GetCrossSectionDataSet(G4ChipsAntiBaryonInelasticXS::Default_Name());

  PIPxsManagerEl =
    (G4ChipsPionPlusElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsPionPlusElasticXS::Default_Name());
  PIPxsManagerInEl =
    (G4ChipsPionPlusInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsPionPlusInelasticXS::Default_Name());

  PIMxsManagerEl =
    (G4ChipsPionMinusElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsPionMinusElasticXS::Default_Name());
  PIMxsManagerInEl =
    (G4ChipsPionMinusInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsPionMinusInelasticXS::Default_Name());

  KPxsManagerEl =
    (G4ChipsKaonPlusElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
  ...
  KMxsManagerEl =
    (G4ChipsKaonMinusElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
  ...
  KZxsManagerEl =
    (G4ChipsKaonZeroElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsKaonZeroElasticXS::Default_Name());
  KZxsManagerInEl =
    (G4ChipsKaonZeroInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsKaonZeroInelasticXS::Default_Name());

  HxsManagerEl =
    (G4ChipsHyperonElasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
      G4ChipsHyperonElasticXS::Default_Name());
  HxsManagerInEl =
    (G4ChipsHyperonInelasticXS*)G4CrossSectionDataSetRegistry::Instance()->GetCrossSectionDataSet(
                                                         ...
                                                         G4double kinEnergy, G4int Z, G4double N)
{
  ...
  else if (PDGcode == -3122 || PDGcode == -3222 || PDGcode == -3212 || PDGcode == -3112
           || PDGcode == -3322 || PDGcode == -3312
           || PDGcode == -3334)  // Projectile is other Anti-baryon
  {
    Xelastic = PBARxsManagerEl->GetChipsCrossSection(momentum, Z, (G4int)N, PDGcode);
    Xinelastic = PBARxsManagerInEl->GetChipsCrossSection(momentum, Z, (G4int)N, PDGcode);
  }
  ...
  else if (PDGcode == 130 || PDGcode == 310 || PDGcode == 311
           || PDGcode == -311)  // Projectile is K0
  {
