...
G4NeutrinoElectronNcXsc::G4NeutrinoElectronNcXsc() : G4VCrossSectionDataSet("NuElectronNcXsc")
{
...
G4bool G4NeutrinoElectronNcXsc::IsElementApplicable(const G4DynamicParticle* aPart, G4int,
                                                    const G4Material*)
{
  G4bool result = false;
...
G4double G4NeutrinoElectronNcXsc::GetElementCrossSection(const G4DynamicParticle* aPart, G4int ZZ,
                                                         const G4Material*)
{
