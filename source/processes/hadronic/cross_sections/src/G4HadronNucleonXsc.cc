...
{  
  ...
  G4double xsection = 
    HadronNucleonXscPDG(theParticle, nucleon, ekin)/CLHEP::millibarn;

  G4double logP = G4Log(pLab);
  G4double logM = G4Log(sMand);
  ...
  if( theParticle == theNeutron) 
  {
    ...
    else  // pLab < 10 GeV/c
    {
      if( neutron )      // nn to be pp
      {
        ...
        if( pLab < 0.4 )
        {
          xsection = 23 + 50*std::sqrt(g4calc->powN(-x, 7));
          fElasticXsc = xsection;
        }
        else if( pLab < 0.73 )
        {
          xsection = 23 + 50*std::sqrt(g4calc->powN(-x, 7));
        ...
        {
          xsection = 39.0+75*(pLab - 1.2)/(g4calc->powN(pLab,3) + 0.15);
          fElasticXsc =  6 + 20/( (logP-0.182)*(logP-0.182) + 1.0 );
        }
      }
      if( proton )   // pn to be np
      {
        if( pLab < 0.02 )
        {
          xsection = 4100+30*G4Exp(G4Log(G4Log(1.3/pLab))*3.6); 
	  fElasticXsc = xsection;
        }      
        else if( pLab < 0.8 )
        {
          xsection = 33+30*g4calc->powN(G4Log(pLab/1.3),4);
	  fElasticXsc = xsection;
        }      
        else if( pLab < 1.4 )
        {
          xsection = 33+30*g4calc->powN(G4Log(pLab/0.95),2);
          G4double x = G4Log(0.511/pLab);
          fElasticXsc =  6 + 52/( x*x + 1.6 );
        }
        else    // 1.4 < pLab < 10.  )
        {
          xsection = 33.3 + 20.8*(pLab*pLab - 1.35)
  ...
  ////// proton //////////////////////////////////////////////
  {
    ...
    else
    {
      ...
      if( proton )
      {
        if( pLab < 0.73 )
        {
          xsection = 23 + 50*std::sqrt(g4calc->powN(G4Log(0.73/pLab),7));
          fElasticXsc = xsection;
        }
        else if( pLab < 1.05  )
        {
  ...
  // pi+ /////////////////////////////////////////////
  {
    if( proton ) // pi+ p
    {
      if( pLab < 0.28 )
      {
        xsection = 10./((logP + 1.273)*(logP + 1.273) + 0.05);
        fElasticXsc = xsection;
      }
      else if( pLab < 0.4 )
      {
        xsection = 14./( (logP + 1.273)*(logP + 1.273) + 0.07);
        fElasticXsc = xsection;
      }
      else if( pLab < 0.68 )
      {
      ...
      else if( pLab < 0.85 )
      {
        ...
        xsection = 88.*x*x + 14.9;
        fElasticXsc = xsection*G4Exp(-3.*(pLab - 0.68));  
      }
      else if( pLab < 1.15 )
      {
        G4double x = G4Log(pLab/0.77);
      ...
      {
        xsection = 10.6 + 2.*G4Log(pE) + 25*G4Exp(-G4Log(pE)*0.43 ); 
        fElasticXsc = 3.0 + 6.20/( (logP - 0.336)*(logP - 0.336) + 0.8);    
      }
      else //  pLab > 100 // my
      {
    ...
    if( neutron )  // pi+ n = pi- p??
    {
      if( pLab < 0.28 ) 
      {
        xsection = 0.288/((pLab - 0.28)*(pLab - 0.28) + 0.004);
        fElasticXsc = 1.8/((logP + 1.273)*(logP + 1.273) + 0.07);
      }
      else if( pLab < 0.395676 ) // first peak
      {
        xsection = 0.648/((pLab - 0.28)*(pLab - 0.28) + 0.009);
        fElasticXsc = 0.257/((pLab - 0.28)*(pLab - 0.28) + 0.01);
       }
      else if( pLab < 0.5 )
      {
        xsection = 26 + 110*(G4Log(pLab/0.48))*(G4Log(pLab/0.48));
        fElasticXsc = 0.37*xsection;
      }
      else if( pLab < 0.65 )
      {
      ...
      {
        xsection = 36.1 + 10*G4Exp(-(pLab-0.72)*(pLab-0.72)/0.06/0.06)+
      ...
      {
        xsection = 36.1 + 0.079-4.313*G4Log(pLab)+
  ...
  /// pi- ////////////////////////////////////////////
  {
	...
	G4double x = G4Log(pLab/0.77);
      ...
      {
        xsection = 3.2*G4Exp(-(pLab-2.55)*(pLab-2.55)/0.55/0.55)
	  + 12*G4Exp(-(pLab-1.47)*(pLab-1.47)/0.225/0.225) + 27.5;
        fElasticXsc = 6.0 + 1.4/(( pLab - 1.4)*( pLab - 1.4) + 0.1);
      }
      else if( pLab < 2.0 ) // ns original
      {
      ...
      {
        xsection = 10.6 + 2.*G4Log(pE) + 25*std::pow(pE, -0.43 ); // ns original
        fElasticXsc = 3.0 + 6.20/( (logP - 0.336)*(logP - 0.336) + 0.8);    
      }
      else //  pLab > 100 // my
      {
  ...
  else if( (theParticle == theKMinus) && proton )   // K-p
  {
    ...
    else
    {
      ...
      xsection   = 14./psp + (1.1*cofLogT*ld2 + 19.5)/(1. - .21/sp + .52/p4) 
  ...
  else if( (theParticle == theKMinus) && neutron )  // K-n
  {
    ...
    else
    {
      ...
      fElasticXsc = 5.0 +  8.1*std::pow(pLab,-1.8 ) + 0.16*sqrLogPlab - 1.3*LogPlab + .15/hd;
      xsection    = 25.2 +  0.38*sqrLogPlab - 2.9*LogPlab + 0.30/hd ;
    }
  }
  else if( (theParticle == theKPlus) && proton  )  // K+p
  {
    ...
    else
    {
      ...
      xsection     = LE + (cofLogT*ld2 + 19.5)/(1. + .46/sp + 1.6/p4) + 2.6/md;
    }
  }
  else if(  (theParticle == theKPlus) && neutron) // K+n  
  {
    ...
    else
    {
      ...
      xsection     = (cofLogT*ld2 + 19.5)/(1. + .46/sp + 1.6/p4) + 4.6/md;
    }
  } 
  fTotalXsc   = xsection*CLHEP::millibarn; 
