...
G4MuNeutrinoNucleusTotXsc::G4MuNeutrinoNucleusTotXsc() : G4VCrossSectionDataSet("NuMuNuclTotXsc")
{
...
G4bool G4MuNeutrinoNucleusTotXsc::IsIsoApplicable(const G4DynamicParticle* aPart, G4int, G4int,
...
G4double G4MuNeutrinoNucleusTotXsc::GetElementCrossSection(const G4DynamicParticle* part, G4int Z,
...
G4double G4MuNeutrinoNucleusTotXsc::GetIsoCrossSection(const G4DynamicParticle* aPart, G4int Z,
...
G4double G4MuNeutrinoNucleusTotXsc::GetNuMuTotCsXsc(G4int index, G4double energy, G4int zz,
                                                    G4int aa)
{
...
G4double G4MuNeutrinoNucleusTotXsc::GetANuMuTotCsXsc(G4int index, G4double energy, G4int zz,
                                                     G4int aa)
{
  G4double xsc(0.), qexsc(0.), inxsc(0.);
