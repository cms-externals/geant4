...
G4ComponentAntiNuclNuclearXS::G4ComponentAntiNuclNuclearXS()
  : G4VComponentCrossSection("AntiAGlauber"),
    ...
    fElasticXsc(0.0),
    fInelasticXsc(0.0),
    fAntiHadronNucleonTotXsc(0.0),
    fAntiHadronNucleonElXsc(0.0),
    Elab(0.0),
    S(0.0),
    SqrtS(0)
{
...
G4double
G4ComponentAntiNuclNuclearXS::GetTotalElementCrossSection(const G4ParticleDefinition* aParticle,
                                                          G4double kinEnergy, G4int Z, G4double A)
{
  if (aParticle == nullptr)
  {
    ...
    G4Exception("G4ComponentAntiNuclNuclearXS::GetTotalElementCrossSection", "antiNuclNuclearXS001",
                JustWarning, ed);
    return 0.0;
  }
  ...
  else if (theParticle == theADeuteron)
  {
    i = 1;
  }
  else if (theParticle == theATriton)
  {
    i = 2;
  }
  else if (theParticle == theAHe3)
  {
    i = 3;
  }
  else if (theParticle == theAAlpha)
  {
    i = 4;
  }
  else
  ...
  {
    G4ExceptionDescription ed;
    ed << "Unknown anti-nucleus : " << theParticle->GetParticleName() << G4endl << "Target (Z, A)=("
       << Z << "," << A << ")" << G4endl;
    G4Exception("G4ComponentAntiNuclNuclearXS::GetTotalElementCrossSection", "antiNuclNuclearXS002",
                JustWarning, ed);
  }
  ...
  if (i < 0 && j >= 0)
  {
    fRadiusEff = ReffTot[4][j];
  }  // Treat all anti-hypernuclei as anti-alpha
  if (i == 0 && j == 0) return sigmaTotal * millibarn;  // Pbar/Nbar + P
  if (i >= 0 && j >= 0)
  {
    fRadiusEff = ReffTot[i][j];
  }  // Light anti-nuclei + Light nuclei

  if (j < 0)
  {
    if (i == 0)
    {
      fRadiusEff = 1.34 * theG4Pow->powZ(intA, 0.23)  // Anti-proton/Anti-neutron + Nucleus
                   + 1.35 / theG4Pow->Z13(intA);
    }
    else if (i == 1)
    {
      fRadiusEff = 1.46 * theG4Pow->powZ(intA, 0.21)  // Anti-deuteron + Nucleus
                   + 1.45 / theG4Pow->Z13(intA);
    }
    else if (i == 2)
    {
      fRadiusEff = 1.40 * theG4Pow->powZ(intA, 0.21)  // Anti-tritium + Nucleus
                   + 1.63 / theG4Pow->Z13(intA);
    }
    else if (i == 3)
    {
      fRadiusEff = 1.40 * theG4Pow->powZ(intA, 0.21)  // Anti-He3 + Nucleus
                   + 1.63 / theG4Pow->Z13(intA);
    }
    else if (i == 4)
    {
      fRadiusEff = 1.35 * theG4Pow->powZ(intA, 0.21)  // Anti-alpha + Nucleus
                   + 1.10 / theG4Pow->Z13(intA);
    }
    else if (i < 0)
    {
      fRadiusEff = 1.35 * theG4Pow->powZ(intA, 0.21)  // Anti-hypernucleus + Nucleus
                   + 1.10 / theG4Pow->Z13(intA);
    }  // is treated as Anti-alpha + Nucleus
    else
    {}
  }
  ...
  G4double xsection =
    millibarn * 2. * pi * R2 * 10. * G4Log(1. + (ApAt * sigmaTotal / (2. * pi * R2 * 10.)));  // mb
  fTotalXsc = xsection;
...
G4double
G4ComponentAntiNuclNuclearXS::GetTotalIsotopeCrossSection(const G4ParticleDefinition* aParticle,
  ...
  const G4ParticleDefinition* aParticle, G4double kinEnergy, G4int Z, G4double A)
{
  ...
  if (j < 0)
  {
    if (i == 0)
    {
      fRadiusEff = 1.31 * theG4Pow->powZ(intA, 0.22)  // Anti-proton/Anti-neutron + Nucleus
                   + 0.90 / theG4Pow->Z13(intA);
    }
    else if (i == 1)
    {
      fRadiusEff = 1.38 * theG4Pow->powZ(intA, 0.21)  // Anti-deuteron + Nucleus
                   + 1.55 / theG4Pow->Z13(intA);
    }
    else if (i == 2)
    {
      fRadiusEff = 1.34 * theG4Pow->powZ(intA, 0.21)  // Anti-tritium + Nucleus
                   + 1.51 / theG4Pow->Z13(intA);
    }
    else if (i == 3)
    {
      fRadiusEff = 1.34 * theG4Pow->powZ(intA, 0.21)  // Anti-He3 + Nucleus
                   + 1.51 / theG4Pow->Z13(intA);
    }
    else if (i == 4)
    {
      fRadiusEff = 1.30 * theG4Pow->powZ(intA, 0.21)  // Anti-alpha + Nucleus
                   + 1.05 / theG4Pow->Z13(intA);
    }
    else if (i < 0)
    {
      fRadiusEff = 1.30 * theG4Pow->powZ(intA, 0.21)  // Anti-hypernucleus + Nucleus
                   + 1.05 / theG4Pow->Z13(intA);
    }  // is treated as Anti-alpha + Nucleus
    else
    {}
  ...
  G4double inelxsection =
    millibarn * pi * R2 * 10. * G4Log(1. + (ApAt * sigmaTotal / (pi * R2 * 10.)));  // mb
...
G4double
G4ComponentAntiNuclNuclearXS::GetInelasticIsotopeCrossSection(const G4ParticleDefinition* aParticle,
                                                              G4double kinEnergy, G4int Z, G4int A)
{
...
G4double
G4ComponentAntiNuclNuclearXS::GetElasticElementCrossSection(const G4ParticleDefinition* aParticle,
                                                            G4double kinEnergy, G4int Z, G4double A)
{
...
G4double
G4ComponentAntiNuclNuclearXS::GetElasticIsotopeCrossSection(const G4ParticleDefinition* aParticle,
                                                            G4double kinEnergy, G4int Z, G4int A)
{
...
G4double
G4ComponentAntiNuclNuclearXS::GetAntiHadronNucleonTotCrSc(const G4ParticleDefinition* aParticle,
                                                          G4double kinEnergy)
{
  ...
  xsection =
    SigAss
    * (1
       + 1. / (std::sqrt(S - 4. * Mn * Mn)) / (theG4Pow->powN(R0, 3)) * C
           * (1 + d1 / SqrtS + d2 / (theG4Pow->powN(SqrtS, 2)) + d3 / (theG4Pow->powN(SqrtS, 3))));
...
G4double
G4ComponentAntiNuclNuclearXS ::GetAntiHadronNucleonElCrSc(const G4ParticleDefinition* aParticle,
                                                          G4double kinEnergy)
{
  G4double xsection;
  G4double SigAss;
