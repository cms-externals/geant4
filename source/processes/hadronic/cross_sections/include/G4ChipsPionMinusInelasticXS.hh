...
#ifndef G4CHIPSPIONMINUSINELASTICXS_HH
#define G4CHIPSPIONMINUSINELASTICXS_HH
...
class G4ChipsPionMinusInelasticXS : public G4VCrossSectionDataSet
{
  ...
  private:
    ...
    G4double ThresholdMomentum(G4int targZ,
                               G4int targN);  // Threshold of pA reaction (MeV/c) // Uzhi
