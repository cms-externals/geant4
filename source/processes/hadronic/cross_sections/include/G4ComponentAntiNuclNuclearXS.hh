...
#ifndef G4COMPONENTANTINUCLNUCLEARXS_HH
#define G4COMPONENTANTINUCLNUCLEARXS_HH
...
class G4ComponentAntiNuclNuclearXS : public G4VComponentCrossSection
{
  ...
  private:
    ...
    const G4double ReffTot[5][5] = {
      {0.000, 3.800, 3.300, 3.300, 2.376},  // Pbar   + p, d, t, He3, He4
    ...
    const G4double ReffInel[5][5] = {
      {0.000, 3.582, 3.105, 3.105, 2.209},  // Pbar   + p, d, t, He3, He4
