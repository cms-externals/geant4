...
#ifndef G4ELNEUTRINONUCLEUSTOTXSC_HH
#define G4ELNEUTRINONUCLEUSTOTXSC_HH
...
class G4ElNeutrinoNucleusTotXsc : public G4VCrossSectionDataSet
{
  public:
    ...
    G4bool IsIsoApplicable(const G4DynamicParticle*, G4int, G4int, const G4Element*,
    ...
    G4double GetElementCrossSection(const G4DynamicParticle* dynPart, G4int Z,
                                    const G4Material* mat) override;

    G4double GetIsoCrossSection(const G4DynamicParticle* aPart, G4int Z, G4int A, const G4Isotope*,
