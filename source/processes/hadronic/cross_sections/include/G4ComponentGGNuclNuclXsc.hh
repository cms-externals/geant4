...
#ifndef G4COMPONENTGGNUCLNUCLXSC_HH
#define G4COMPONENTGGNUCLNUCLXSC_HH
...
class G4ComponentGGNuclNuclXsc : public G4VComponentCrossSection
{
  public:
    ...
    G4double GetTotalElementCrossSection(const G4ParticleDefinition* aParticle, G4double kinEnergy,
                                         G4int Z, G4double A) final;

    G4double GetTotalIsotopeCrossSection(const G4ParticleDefinition* aParticle, G4double kinEnergy,
                                         G4int Z, G4int A) final;

    G4double GetInelasticElementCrossSection(const G4ParticleDefinition* aParticle,
                                             G4double kinEnergy, G4int Z, G4double A) final;

    G4double GetInelasticIsotopeCrossSection(const G4ParticleDefinition* aParticle,
                                             G4double kinEnergy, G4int Z, G4int A) final;
    ...
    G4double ComputeQuasiElasticRatio(const G4ParticleDefinition* aParticle, G4double kinEnergy,
                                      G4int Z, G4int A) final;
    ...
    inline G4double GetZandACrossSection(const G4DynamicParticle*, G4int Z, G4int A);

    inline G4double GetCoulombBarier(const G4DynamicParticle*, G4double Z, G4double A, G4double pR,
                                     G4double tR);

    G4double ComputeCoulombBarier(const G4ParticleDefinition* aParticle, G4double kinEnergy,
                                  G4int Z, G4int A, G4double pR, G4double tR);
    ...
    G4ComponentGGNuclNuclXsc& operator=(const G4ComponentGGNuclNuclXsc& right) = delete;
...
inline G4double G4ComponentGGNuclNuclXsc::GetElasticGlauberGribov(const G4DynamicParticle* dp,
                                                                  G4int Z, G4int A)
{
...
inline G4double G4ComponentGGNuclNuclXsc::GetInelasticGlauberGribov(const G4DynamicParticle* dp,
                                                                    G4int Z, G4int A)
{
  ComputeCrossSections(dp->GetDefinition(), dp->GetKineticEnergy(), Z, A);
...
inline G4double G4ComponentGGNuclNuclXsc::GetZandACrossSection(const G4DynamicParticle* dp, G4int Z,
                                                               G4int A)
{
  ComputeCrossSections(dp->GetDefinition(), dp->GetKineticEnergy(), Z, A);
  return fInelasticXsc;
...
inline G4double G4ComponentGGNuclNuclXsc::GetCoulombBarier(const G4DynamicParticle* dp, G4double Z,
                                                           G4double A, G4double pR, G4double tR)
{
  return ComputeCoulombBarier(dp->GetDefinition(), dp->GetKineticEnergy(), G4lrint(Z), G4lrint(A),
                              pR, tR);
}
