...
#define G4UCNBOUNDARYPROCESS_HH
...
enum G4UCNBoundaryProcessStatus
{
  Undefined,
  NotAtBoundary,
  SameMaterial,
...
class G4UCNBoundaryProcess : public G4VDiscreteProcess
{
  ...
  public:
    ...
    G4ThreeVector MRreflectHigh(G4double, G4double, G4double, G4ThreeVector, G4ThreeVector,
...
inline G4bool G4UCNBoundaryProcess::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return (&aParticleType == G4Neutron::NeutronDefinition());
}

inline G4UCNBoundaryProcessStatus G4UCNBoundaryProcess::GetStatus() const
{
  return theStatus;
}

inline G4bool G4UCNBoundaryProcess::High(G4double Energy, G4double FermiPotDiff)
{
...
inline void G4UCNBoundaryProcess::SetMicroRoughness(G4bool active)
{
  UseMicroRoughnessReflection = active;
}

inline G4bool G4UCNBoundaryProcess::GetMicroRoughness()
{
