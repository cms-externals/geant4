...
public:
  ...
  G4NuVacOscProcess(G4String anEnvelopeName , const G4String& procName = "nu-vacuum-oscillation");

  virtual ~G4NuVacOscProcess() override = default;
