...
G4NuVacOscProcess::G4NuVacOscProcess( G4String anEnvelopeName, const G4String& pName)
  : G4HadronicProcess( pName, fHadronInelastic ), fBiased(true)  // fHadronElastic???
{
  fLowestEnergy  = 1.*eV;
  fEnvelope      = nullptr;
...
G4double G4NuVacOscProcess::PostStepGetPhysicalInteractionLength( const G4Track& track,
...
G4VParticleChange* 
G4NuVacOscProcess::PostStepDoIt(const G4Track& track, const G4Step& )
{
...
void 
G4NuVacOscProcess::SetLowestEnergy(G4double val)
{
  fLowestEnergy = val;
}
