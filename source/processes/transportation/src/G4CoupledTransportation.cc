...
//
//
// $Id: G4CoupledTransportation.cc 111057 2018-07-09 13:59:36Z gcosmo $
//
// ------------------------------------------------------------
...
G4CoupledTransportation::G4CoupledTransportation( G4int verbosity )
  : G4VProcess( G4String("CoupledTransportation"), fTransportation ),
    ...
    fThreshold_Warning_Energy( 1.0 * CLHEP::kiloelectronvolt ), // was: 100 MeV ),  
    fThreshold_Important_Energy( 1.0 * MeV ), // was: 250 MeV 
    fThresholdTrials( 10 ), 
    fNoLooperTrials( 0 ),
