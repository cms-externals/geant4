...
// --------------------------------------------------------------------
void G4ProductionCutsTable::SetEnergyCutVector(const std::vector<G4double>& cutE, std::size_t idx)
{
  if (idx >= 4)
  {
    G4ExceptionDescription ed;
    ed << "Wrong index= " << idx << "; it should be < 4";
    G4Exception("G4ProductionCutsTable::SetEnergyCutVector()", "CUTS0100", FatalException, ed);
    return;
  }
...
void G4ProductionCutsTable::CreateCoupleTables()
{
  ...
  for (auto CoupleItr = coupleTable.cbegin(); CoupleItr != coupleTable.cend(); ++CoupleItr)
  {
...
G4double G4ProductionCutsTable::ConvertRangeToEnergy(const G4ParticleDefinition* particle,
                                                     const G4Material* material, G4double range)
{
  ...
  if (firstUse)
  {
    ...
    if (verboseLevel > 0)
    {
      ...
      G4Exception("G4ProductionCutsTable::ConvertRangeToEnergy()", "CUTS0100", JustWarning, ed);
    }
#endif
    return -1.0;
  }
  ...
  if (index < 0 || converters[index] == nullptr)
  {
    ...
    if (verboseLevel > 0)
    {
      ...
      G4Exception("G4ProductionCutsTable::ConvertRangeToEnergy()", "CUTS0101", JustWarning, ed);
    }
#endif
    return -1.0;
  }
...
// --------------------------------------------------------------------
void G4ProductionCutsTable::ScanAndSetCouple(G4LogicalVolume* aLV, G4MaterialCutsCouple* aCouple,
                                             G4Region* aRegion)
{
...
void G4ProductionCutsTable::DumpCouples() const
{
  ...
  for (auto cItr = coupleTable.cbegin(); cItr != coupleTable.cend(); ++cItr)
  {
    ...
    G4cout << G4endl;
    G4cout << "Index : " << aCouple->GetIndex() << "     used in the geometry : ";
    if (aCouple->IsUsed())
      G4cout << "Yes";
    else
      G4cout << "No ";
    ...
    G4cout << " Range cuts        : "
           << " gamma  " << G4BestUnit(aCut->GetProductionCut("gamma"), "Length") << "    e-  "
           << G4BestUnit(aCut->GetProductionCut("e-"), "Length") << "    e+  "
           << G4BestUnit(aCut->GetProductionCut("e+"), "Length") << " proton "
           << G4BestUnit(aCut->GetProductionCut("proton"), "Length") << G4endl;
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::StoreCutsTable(const G4String& dir, G4bool ascii)
{
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::RetrieveCutsTable(const G4String& dir, G4bool ascii)
{
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::CheckForRetrieveCutsTable(const G4String& directory, G4bool ascii)
{
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::StoreMaterialInfo(const G4String& directory, G4bool ascii)
{
...
#endif
    G4Exception("G4ProductionCutsTable::StoreMaterialInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
  ...
  if (ascii)
  {
    ...
    for (std::size_t idx = 0; static_cast<G4int>(idx) < numberOfMaterial; ++idx)
    {
      ...
      fOut << std::setw(FixedStringLengthForStore) << ((*matTable)[idx])->GetDensity() / (g / cm3)
           << G4endl;
    }
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::CheckMaterialInfo(const G4String& directory, G4bool ascii)
{
...
#endif
    G4Exception("G4ProductionCutsTable::CheckMaterialInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
...
#endif
    G4Exception("G4ProductionCutsTable::CheckMaterialInfo()", "ProcCuts103", JustWarning,
                "Bad Data Format");
    return false;
  }
  ...
  {
    G4Exception("G4ProductionCutsTable::CheckMaterialInfo()", "ProcCuts108", JustWarning,
...
#endif
      G4Exception("G4ProductionCutsTable::CheckMaterialInfo()", "ProcCuts104", JustWarning,
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::StoreMaterialCutsCoupleInfo(const G4String& directory, G4bool ascii)
{
...
#endif
    G4Exception("G4ProductionCutsTable::StoreMaterialCutsCoupleInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::CheckMaterialCutsCoupleInfo(const G4String& directory, G4bool ascii)
{
...
#endif
    G4Exception("G4ProductionCutsTable::CheckMaterialCutsCoupleInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
...
#endif
    G4Exception("G4ProductionCutsTable::CheckMaterialCutsCoupleInfo()", "ProcCuts103", JustWarning,
                "Bad Data Format");
    fIn.close();
    return false;
  }
  ...
  for (G4int idx = 0; idx < numberOfCouples; ++idx)
  {
    ...
    if (fOK)
    {
      ...
      if (verboseLevel > 1)
      {
        ...
        {
          G4cout << "G4ProductionCutTable::CheckMaterialCutsCoupleInfo()" << G4endl;
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::StoreCutsInfo(const G4String& directory, G4bool ascii)
{
  ...
  if (!fOut)
  {
    ...
    G4Exception("G4ProductionCutsTable::StoreCutsInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
...
// --------------------------------------------------------------------
G4bool G4ProductionCutsTable::RetrieveCutsInfo(const G4String& directory, G4bool ascii)
{
  ...
  if (!fIn)
  {
    ...
    G4Exception("G4ProductionCutsTable::RetrieveCutsInfo()", "ProcCuts102", JustWarning,
                "Cannot open file!");
    return false;
  }
  ...
  if (key != keyword)
  {
    ...
    G4Exception("G4ProductionCutsTable::RetrieveCutsInfo()", "ProcCuts103", JustWarning,
                "Bad Data Format");
    return false;
  }
  ...
  {
    G4Exception("G4ProductionCutsTable::RetrieveCutsInfo()", "ProcCuts109", JustWarning,
