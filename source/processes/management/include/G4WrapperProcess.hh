...
class G4WrapperProcess : public G4VProcess
{
  public:
    ...
    virtual G4bool RetrievePhysicsTable(const G4ParticleDefinition*, const G4String& directory,
                                        G4bool ascii = false);
...
inline G4bool G4WrapperProcess::operator==(const G4WrapperProcess& right) const
{
  return (this == &right);
}
