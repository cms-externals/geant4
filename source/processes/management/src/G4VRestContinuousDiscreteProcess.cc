...
{
  G4Exception("G4VRestContinuousDiscreteProcess::G4VRestContinuousDiscreteProcess()", "ProcMan102",
...
// --------------------------------------------------------------------
G4VRestContinuousDiscreteProcess::G4VRestContinuousDiscreteProcess(
  G4VRestContinuousDiscreteProcess& right)
  : G4VProcess(right), valueGPILSelection(right.valueGPILSelection)
{}

// --------------------------------------------------------------------
G4double
G4VRestContinuousDiscreteProcess::AtRestGetPhysicalInteractionLength(const G4Track& track,
...
// --------------------------------------------------------------------
G4VParticleChange* G4VRestContinuousDiscreteProcess::AtRestDoIt(const G4Track&, const G4Step&)
{
...
// --------------------------------------------------------------------
G4VParticleChange* G4VRestContinuousDiscreteProcess::AlongStepDoIt(const G4Track&, const G4Step&)
{
  return pParticleChange;
}
...
// --------------------------------------------------------------------
G4VParticleChange* G4VRestContinuousDiscreteProcess::PostStepDoIt(const G4Track&, const G4Step&)
{
  ClearNumberOfInteractionLengthLeft();
