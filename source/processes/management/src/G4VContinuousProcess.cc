...
// --------------------------------------------------------------------
G4VContinuousProcess::G4VContinuousProcess() : G4VProcess("No Name Continuous Process")
{
  G4Exception("G4VContinuousProcess::G4VContinuousProcess()", "ProcMan102", JustWarning,
...
// --------------------------------------------------------------------
G4VParticleChange* G4VContinuousProcess::AlongStepDoIt(const G4Track&, const G4Step&)
{
