...
// --------------------------------------------------------------------
G4VRestContinuousProcess::G4VRestContinuousProcess() : G4VProcess("No Name Discrete Process")
{
  G4Exception("G4VRestContinuousProcess::G4VRestContinuousProcess()", "ProcMan102", JustWarning,
...
// --------------------------------------------------------------------
G4VParticleChange* G4VRestContinuousProcess::AtRestDoIt(const G4Track&, const G4Step&)
{
...
// --------------------------------------------------------------------
G4VParticleChange* G4VRestContinuousProcess::AlongStepDoIt(const G4Track&, const G4Step&)
{
  return pParticleChange;
}
