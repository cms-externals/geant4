...
G4MinEkineCuts::G4MinEkineCuts(const G4String& aName) : G4SpecialCuts(aName)
{
  if (verboseLevel > 1)
  {
...
G4double G4MinEkineCuts::PostStepGetPhysicalInteractionLength(const G4Track& aTrack, G4double,
