...
G4MaxTimeCuts::G4MaxTimeCuts(const G4String& aName) : G4SpecialCuts(aName)
{
  if (verboseLevel > 1)
  {
...
G4double G4MaxTimeCuts::PostStepGetPhysicalInteractionLength(const G4Track& aTrack, G4double,
