...
G4WeightCutOffProcess::G4WeightCutOffProcess(G4double wsurvival, G4double wlimit, G4double isource,
                                             G4VIStore* istore, const G4String& aName, G4bool para)
  : G4VProcess(aName),
    ...
    fParaflag(para)
{
  if (!fParticleChange)
  {
    G4Exception("G4WeightCutOffProcess::G4WeightCutOffProcess()", "FatalError", FatalException,
...
void G4WeightCutOffProcess::StartTracking(G4Track* trk)
{
  ...
  if (fParaflag)
  {
    ...
    {
      G4Exception(
        "G4WeightCutOffProcess::StartTracking", "ProcParaWorld000", FatalException,
...
G4double G4WeightCutOffProcess::PostStepGetPhysicalInteractionLength(const G4Track&, G4double,
