...
class G4UIparameter 
{
  ...
  public: // with description
      ...
      // used to specify a unit. This methos can be used only for a
      // string-type parameter. With this set-methos, not only the
      // default unit but also candidate units that belong to the
      // unit category (a.k.a. dimension) same as the default unit.
  public:
