...
class G4ErrorMatrix
{
  ...
  private:
    ...
    friend void row_house(G4ErrorMatrix*, const G4ErrorMatrix&, G4double, G4int, G4int, G4int,
                          G4int);
    friend void back_solve(const G4ErrorMatrix& R, G4ErrorMatrix* b);
    friend void col_givens(G4ErrorMatrix* A, G4double c, G4double s, G4int k1, G4int k2,
                           G4int rowmin, G4int rowmax);
    // Does a column Givens update.

    friend void row_givens(G4ErrorMatrix* A, G4double c, G4double s, G4int k1, G4int k2,
                           G4int colmin, G4int colmax);
    friend void col_house(G4ErrorMatrix*, const G4ErrorMatrix&, G4double, G4int, G4int, G4int,
                          G4int);
...
void col_house(G4ErrorMatrix* a, const G4ErrorMatrix& v, G4double vnormsq, G4int row, G4int col,
               G4int row_start, G4int col_start);
void col_house(G4ErrorMatrix* a, const G4ErrorMatrix& v, G4int row, G4int col, G4int row_start,
               G4int col_start);
// Does a column Householder update.

void col_givens(G4ErrorMatrix* A, G4double c, G4double s, G4int k1, G4int k2, G4int row_min = 1,
                G4int row_max = 0);
// do a column Givens update

void row_givens(G4ErrorMatrix* A, G4double c, G4double s, G4int k1, G4int k2, G4int col_min = 1,
                G4int col_max = 0);
...
void row_house(G4ErrorMatrix* a, const G4ErrorMatrix& v, G4double vnormsq, G4int row, G4int col,
               G4int row_start, G4int col_start);
void row_house(G4ErrorMatrix* a, const G4ErrorMatrix& v, G4int row, G4int col, G4int row_start,
               G4int col_start);
