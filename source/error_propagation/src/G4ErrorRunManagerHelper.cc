...
G4ErrorRunManagerHelper::G4ErrorRunManagerHelper()
{
  ...
  {
    G4Exception("G4ErrorRunManagerHelper::G4ErrorRunManagerHelper()", "InvalidSetup",
                FatalException, "G4eRunManageKernel constructed twice.");
  }
...
void G4ErrorRunManagerHelper::InitializeGeometry()
{
  ...
  else
  {
    ...
    if (G4TransportationManager::GetTransportationManager()
        ...
        == 0)
    {
      G4Exception("G4ErrorRunManagerHelper::InitializeGeometry()", "InvalisSetup", FatalException,
  ...
  else
  {
        ...
        && G4RunManager::GetRunManager()->GetUserPhysicsList() != 0)
    {
          ...
          == 0)
      {
        ...
        G4Exception("G4ErrorRunManagerHelper::InitializePhysics()", "GEANT4e-Notification",
                    JustWarning, message);
      }
    }
    else
