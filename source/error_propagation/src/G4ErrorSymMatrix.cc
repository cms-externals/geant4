...
G4ErrorSymMatrix::G4ErrorSymMatrix(G4int p) : m(p * (p + 1) / 2), nrow(p)
{
  size = nrow * (nrow + 1) / 2;
  m.assign(size, 0);
}

G4ErrorSymMatrix::G4ErrorSymMatrix(G4int p, G4int init) : m(p * (p + 1) / 2), nrow(p)
{
  size = nrow * (nrow + 1) / 2;
...
G4ErrorMatrix operator*(const G4ErrorMatrix& mat1, const G4ErrorSymMatrix& mat2)
{
  ...
  for (mit1 = mat1.m.begin(); mit1 < mat1.m.begin() + mat1.num_row() * mat1.num_col(); mit1 = mit2)
  {
    snp = mat2.m.begin();
...
G4ErrorSymMatrix G4ErrorSymMatrix::apply(G4double (*f)(G4double, G4int, G4int)) const
{
  ...
  for (j = 1; j < nrow; j += ss)  // main loop over columns
  {
    ...
    else
    {
      ...
      else
      {
        ...
        for (k = j; k < pivrow; k++)
        {
          if (std::fabs(*ip) > sigma) sigma = std::fabs(*ip);
          ip++;
        }
        ...
        else if (std::fabs(*(m.begin() + pivrow * (pivrow - 1) / 2 + pivrow - 1)) >= alpha * sigma)
        {
          ss = 1;
        }
        else
      ...
      else  // ss=2, ie use a 2x2 pivot
      {
        ...
        if (j + 1 != pivrow)
        {
          ...
          temp1 = *(mjj + j + 1);
          *(mjj + j + 1) = *(m.begin() + pivrow * (pivrow - 1) / 2 + pivrow - 1);
          *(m.begin() + pivrow * (pivrow - 1) / 2 + pivrow - 1) = temp1;
          temp1 = *(mjj + j);
        ...
        if (temp2 == 0)
        {
          G4Exception("G4ErrorSymMatrix::bunch_invert()", "GEANT4e-Notification", JustWarning,
  ...
  for (j = nrow; j >= 1; j -= ss)  // loop over columns
  {
    ...
    else  // 2x2 pivot, compute columns j and j-1 of the inverse
    {
      if (piv[j - 1] != 0)
      {
        ...
        G4Exception("G4ErrorSymMatrix::invertBunchKaufman()", "GEANT4e-Notification", JustWarning,
                    message);
      }
      ss = 2;
      if (j < nrow)
...
void G4ErrorSymMatrix::invertHaywood5(G4int& ifail)
{
  ...
  G4double Det3_123_012 = m[A10] * Det2_23_12 - m[A11] * Det2_23_02 + m[A12] * Det2_23_01;
  G4double Det3_123_013 = m[A10] * Det2_23_13 - m[A11] * Det2_23_03 + m[A13] * Det2_23_01;
  G4double Det3_123_023 = m[A10] * Det2_23_23 - m[A12] * Det2_23_03 + m[A13] * Det2_23_02;
  G4double Det3_123_123 = m[A11] * Det2_23_23 - m[A12] * Det2_23_13 + m[A13] * Det2_23_12;
  G4double Det3_124_012 = m[A10] * Det2_24_12 - m[A11] * Det2_24_02 + m[A12] * Det2_24_01;
  G4double Det3_124_013 = m[A10] * Det2_24_13 - m[A11] * Det2_24_03 + m[A13] * Det2_24_01;
  G4double Det3_124_014 = m[A10] * Det2_24_14 - m[A11] * Det2_24_04 + m[A14] * Det2_24_01;
  G4double Det3_124_023 = m[A10] * Det2_24_23 - m[A12] * Det2_24_03 + m[A13] * Det2_24_02;
  G4double Det3_124_024 = m[A10] * Det2_24_24 - m[A12] * Det2_24_04 + m[A14] * Det2_24_02;
  G4double Det3_124_123 = m[A11] * Det2_24_23 - m[A12] * Det2_24_13 + m[A13] * Det2_24_12;
  G4double Det3_124_124 = m[A11] * Det2_24_24 - m[A12] * Det2_24_14 + m[A14] * Det2_24_12;
  G4double Det3_134_012 = m[A10] * Det2_34_12 - m[A11] * Det2_34_02 + m[A12] * Det2_34_01;
  G4double Det3_134_013 = m[A10] * Det2_34_13 - m[A11] * Det2_34_03 + m[A13] * Det2_34_01;
  G4double Det3_134_014 = m[A10] * Det2_34_14 - m[A11] * Det2_34_04 + m[A14] * Det2_34_01;
  G4double Det3_134_023 = m[A10] * Det2_34_23 - m[A12] * Det2_34_03 + m[A13] * Det2_34_02;
  G4double Det3_134_024 = m[A10] * Det2_34_24 - m[A12] * Det2_34_04 + m[A14] * Det2_34_02;
  G4double Det3_134_034 = m[A10] * Det2_34_34 - m[A13] * Det2_34_04 + m[A14] * Det2_34_03;
  G4double Det3_134_123 = m[A11] * Det2_34_23 - m[A12] * Det2_34_13 + m[A13] * Det2_34_12;
  G4double Det3_134_124 = m[A11] * Det2_34_24 - m[A12] * Det2_34_14 + m[A14] * Det2_34_12;
  ...
  G4double Det4_0123_0123 =
    m[A00] * Det3_123_123 - m[A01] * Det3_123_023 + m[A02] * Det3_123_013 - m[A03] * Det3_123_012;
  G4double Det4_0124_0123 =
    m[A00] * Det3_124_123 - m[A01] * Det3_124_023 + m[A02] * Det3_124_013 - m[A03] * Det3_124_012;
  G4double Det4_0124_0124 =
    m[A00] * Det3_124_124 - m[A01] * Det3_124_024 + m[A02] * Det3_124_014 - m[A04] * Det3_124_012;
  G4double Det4_0134_0123 =
    m[A00] * Det3_134_123 - m[A01] * Det3_134_023 + m[A02] * Det3_134_013 - m[A03] * Det3_134_012;
  G4double Det4_0134_0124 =
    m[A00] * Det3_134_124 - m[A01] * Det3_134_024 + m[A02] * Det3_134_014 - m[A04] * Det3_134_012;
  G4double Det4_0134_0134 =
    m[A00] * Det3_134_134 - m[A01] * Det3_134_034 + m[A03] * Det3_134_014 - m[A04] * Det3_134_013;
  G4double Det4_0234_0123 =
    m[A00] * Det3_234_123 - m[A01] * Det3_234_023 + m[A02] * Det3_234_013 - m[A03] * Det3_234_012;
  G4double Det4_0234_0124 =
    m[A00] * Det3_234_124 - m[A01] * Det3_234_024 + m[A02] * Det3_234_014 - m[A04] * Det3_234_012;
  G4double Det4_0234_0134 =
    m[A00] * Det3_234_134 - m[A01] * Det3_234_034 + m[A03] * Det3_234_014 - m[A04] * Det3_234_013;
  G4double Det4_0234_0234 =
    m[A00] * Det3_234_234 - m[A02] * Det3_234_034 + m[A03] * Det3_234_024 - m[A04] * Det3_234_023;
  ...
  G4double det = m[A00] * Det4_1234_1234 - m[A01] * Det4_1234_0234 + m[A02] * Det4_1234_0134
                 - m[A03] * Det4_1234_0124 + m[A04] * Det4_1234_0123;
...
void G4ErrorSymMatrix::invert4(G4int& ifail)
{
  ...
  G4double Det3_012_012 = m[A00] * Det2_12_12 - m[A01] * Det2_12_02 + m[A02] * Det2_12_01;
  G4double Det3_013_012 = m[A00] * Det2_13_12 - m[A01] * Det2_13_02 + m[A02] * Det2_13_01;
  G4double Det3_013_013 = m[A00] * Det2_13_13 - m[A01] * Det2_13_03 + m[A03] * Det2_13_01;
  G4double Det3_023_012 = m[A00] * Det2_23_12 - m[A01] * Det2_23_02 + m[A02] * Det2_23_01;
  G4double Det3_023_013 = m[A00] * Det2_23_13 - m[A01] * Det2_23_03 + m[A03] * Det2_23_01;
  G4double Det3_023_023 = m[A00] * Det2_23_23 - m[A02] * Det2_23_03 + m[A03] * Det2_23_02;
  G4double Det3_123_012 = m[A10] * Det2_23_12 - m[A11] * Det2_23_02 + m[A12] * Det2_23_01;
  G4double Det3_123_013 = m[A10] * Det2_23_13 - m[A11] * Det2_23_03 + m[A13] * Det2_23_01;
  G4double Det3_123_023 = m[A10] * Det2_23_23 - m[A12] * Det2_23_03 + m[A13] * Det2_23_02;
  G4double Det3_123_123 = m[A11] * Det2_23_23 - m[A12] * Det2_23_13 + m[A13] * Det2_23_12;
