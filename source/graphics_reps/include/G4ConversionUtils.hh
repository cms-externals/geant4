...
template<>
inline G4bool Convert(const G4String& myInput, G4DimensionedThreeVector& output)
{
  G4String input = G4StrUtil::strip_copy(myInput);
...
template<>
inline G4bool Convert(const G4String& myInput, G4ThreeVector& output)
{
  G4String input = G4StrUtil::strip_copy(myInput);
...
// Conversion specialisations.
template<>
inline G4bool Convert(const G4String& myInput, G4DimensionedDouble& min, G4DimensionedDouble& max)
{
  G4String input = G4StrUtil::strip_copy(myInput);
...
template<>
inline G4bool Convert(const G4String& myInput, G4DimensionedThreeVector& min,
                      G4DimensionedThreeVector& max)
{
  ...
  if (!(is >> valueMinX >> valueMinY >> valueMinZ >> unitMin >> valueMaxX >> valueMaxY >> valueMaxZ
        >> unitMax)
      || is.get(tester))
    return false;
...
template<>
inline G4bool Convert(const G4String& myInput, G4ThreeVector& min, G4ThreeVector& max)
{
  G4String input = G4StrUtil::strip_copy(myInput);
