...
G4TrajectoryPoint* G4TrajectoryPoint::CloneForMaster() const
{
  G4TrajectoryPoint* cloned = masterTrajectoryPointAllocator()->MallocSingle();
  cloned->fPosition = fPosition;
  return cloned;
}
