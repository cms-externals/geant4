...
class G4Trajectory : public G4VTrajectory
{
 ...
 public:
  ...
  G4Trajectory* CloneForMaster() const;
...
extern G4TRACKING_DLL G4Allocator<G4Trajectory>*& masterTrajectoryAllocator();
...
inline void* G4Trajectory::operator new(size_t)
{
  ...
  if (masterTrajectoryAllocator() == nullptr && G4Threading::IsMasterThread()) {
    masterTrajectoryAllocator() = aTrajectoryAllocator();
  }
