...
class G4TrajectoryPoint : public G4VTrajectoryPoint
{
 public:
  ...
  G4TrajectoryPoint* CloneForMaster() const;
  // Get/Set functions
...
extern G4TRACKING_DLL G4Allocator<G4TrajectoryPoint>*& masterTrajectoryPointAllocator();
...
inline void* G4TrajectoryPoint::operator new(size_t)
{
  ...
  if (masterTrajectoryPointAllocator() == nullptr && G4Threading::IsMasterThread()) {
    masterTrajectoryPointAllocator() = aTrajectoryPointAllocator();
  }
