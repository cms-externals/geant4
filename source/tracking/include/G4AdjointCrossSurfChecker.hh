...
#define G4ADJOINTCROSSSURFCHECKER_HH
...
class G4AdjointCrossSurfChecker
{
  public:
    ...
    G4bool GoingInOrOutOfaVolume(const G4Step* aStep, const G4String& volume_name,
    ...
    G4bool CrossingAGivenRegisteredSurface(const G4Step* aStep, const G4String& surface_name,
                                           G4ThreeVector& cross_pos, G4double& cos_to_surface,
                                           G4bool& GoingIn);
    ...
    G4bool CrossingAnInterfaceBetweenTwoVolumes(const G4Step* aStep, const G4String& vol1_name,
                                                const G4String& vol2_name, G4ThreeVector& cross_pos,
                                                G4double& cos_to_surface, G4bool& GoingIn);

    G4bool AddaSphericalSurface(const G4String& SurfaceName, G4double radius, G4ThreeVector pos,
                                G4double& area);
    G4bool AddaSphericalSurfaceWithCenterAtTheCenterOfAVolume(const G4String& SurfaceName,
                                                              ...
                                                              G4double& area);
    G4bool AddanExtSurfaceOfAvolume(const G4String& SurfaceName, const G4String& volume_name,
                                    G4double& area);
