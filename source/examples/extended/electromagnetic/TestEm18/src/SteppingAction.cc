...
//
// $Id: SteppingAction.cc 105252 2017-07-17 09:40:37Z gcosmo $
//
...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
 ...
 //
 fEventaction->SumEnergyDeposited (step->GetTotalEnergyDeposit());
 //
 ...
 for (G4int itr=0; itr<nbsec; itr++) {
    ...
    G4int ih = 0; 
         if (particle == G4Gamma::Gamma())       ih = 9;
    else if (particle == G4Electron::Electron()) ih = 10;
    else if (particle == G4Positron::Positron()) ih = 11;
