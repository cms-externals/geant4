...
//
// $Id: EventAction.cc 105252 2017-07-17 09:40:37Z gcosmo $
//
...
void EventAction::SumEnergyDeposited(G4double edep)
{
...
void EventAction::EndOfEventAction(const G4Event*)
{
 ...
 fRunAction->EnergyDeposited(fEnergyDeposited);
 if (EtransferedTotal > 0.) fRunAction->EnergyTransfered(EtransferedTotal);
 G4double energyLostTotal = fEnergyDeposited + EtransferedTotal;
 fRunAction->TotalEnergyLost(energyLostTotal);

 analysisManager->FillH1(2, fEnergyDeposited);
