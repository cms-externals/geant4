...
G4TrajectoryGenericDrawer::G4TrajectoryGenericDrawer(const G4String& name,
...
void G4TrajectoryGenericDrawer::Draw(const G4VTrajectory& traj, const G4bool& visible) const
{
