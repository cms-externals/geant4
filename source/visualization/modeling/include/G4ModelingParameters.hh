...
public: // With description
  ...
  struct TimeParameters {
    ...
    G4double fFadeFactor = 0.;  // 0: no fade; 1: maximum fade with time within range.
    G4bool   fDisplayHeadTime      = false; // Display head time (fEndTime) in 2D text.
    G4double fDisplayHeadTimeX     = -0.9;  // ) 2D screen coords of head time,
    G4double fDisplayHeadTimeY     = -0.9;  // ) bottom-left coorner.
