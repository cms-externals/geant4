  ...
  public:  // With description
    ...
    class PVNameCopyNo
    {
      public:
        ...
        // Normal constructor
        PVNameCopyNo(const G4String& name, G4int copyNo) : fName(name), fCopyNo(copyNo) {}
    ...
    class PVPointerCopyNo
    {
      public:
        ...
        // Normal constructor
        PVPointerCopyNo(G4VPhysicalVolume* pPV, G4int copyNo) : fpPV(pPV), fCopyNo(copyNo) {}
    ...
    class VisAttributesModifier
    {
      public:
        ...
        VisAttributesModifier(const G4VisAttributes& visAtts, VisAttributesSignifier signifier,
                              const PVNameCopyNoPath& path)
          : fVisAtts(visAtts), fSignifier(signifier), fPVNameCopyNoPath(path)
        {}
        const G4VisAttributes& GetVisAttributes() const { return fVisAtts; }
        VisAttributesSignifier GetVisAttributesSignifier() const { return fSignifier; }
        const PVNameCopyNoPath& GetPVNameCopyNoPath() const { return fPVNameCopyNoPath; }
        void SetVisAttributes(const G4VisAttributes& visAtts) { fVisAtts = visAtts; }
        void SetVisAttributesSignifier(VisAttributesSignifier signifier) { fSignifier = signifier; }
        ...
        G4bool operator==(const VisAttributesModifier& rhs) const { return !operator!=(rhs); }
    ...
    {
        G4double fStartTime =
          -G4VisAttributes::fVeryLongTime;  // ) Start and end time of drawn range,
        ...
        {
          if (fStartTime != rhs.fStartTime || fEndTime != rhs.fEndTime
              || fFadeFactor != rhs.fFadeFactor || fDisplayHeadTime != rhs.fDisplayHeadTime
    ...
    G4ModelingParameters(const G4VisAttributes* pDefaultVisAttributes, DrawingStyle drawingStyle,
                         G4bool isCulling, G4bool isCullingInvisible, G4bool isDensityCulling,
                         G4double visibleDensity, G4bool isCullingCovered, G4int noOfSides);
    ...
    friend std::ostream& operator<<(std::ostream& os, const PVNameCopyNoPath&);

    friend std::ostream& operator<<(std::ostream& os, const PVPointerCopyNoPath&);

    friend std::ostream& operator<<(std::ostream& os, const std::vector<VisAttributesModifier>&);
