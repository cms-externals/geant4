...
class G4ModelCmdSetDefaultColour : public G4ModelCmdApplyColour<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4Colour& colour) { G4VModelCommand<M>::Model()->SetDefault(colour); }
};
...
class G4ModelCmdAddString : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4String& newValue) { G4VModelCommand<M>::Model()->Add(newValue); }
};
...
class G4ModelCmdAddInt : public G4ModelCmdApplyInteger<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4int& newValue) { G4VModelCommand<M>::Model()->Add(newValue); }
};
...
class G4ModelCmdInvert : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4bool& newValue) { G4VModelCommand<M>::Model()->SetInvert(newValue); }
};
...
class G4ModelCmdActive : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4bool& newValue) { G4VModelCommand<M>::Model()->SetActive(newValue); }
};
...
class G4ModelCmdReset : public G4ModelCmdApplyNull<M>
{
  ...
  protected:
    ...
    virtual void Apply() { G4VModelCommand<M>::Model()->Reset(); }
};
...
class G4ModelCmdSetAuxPtsColour : public G4ModelCmdApplyColour<M>
{
  ...
  protected:
    ...
    void Apply(const G4Colour& colour) { G4VModelCommand<M>::Model()->SetAuxPtsColour(colour); }
};
...
class G4ModelCmdSetStepPtsColour : public G4ModelCmdApplyColour<M>
{
  ...
  protected:
    ...
    void Apply(const G4Colour& colour) { G4VModelCommand<M>::Model()->SetStepPtsColour(colour); }
};
...
class G4ModelCmdSetDrawLine : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetDrawLine(myBool); }
};
...
class G4ModelCmdSetLineVisible : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetLineVisible(myBool); }
};
...
class G4ModelCmdSetDrawAuxPts : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetDrawAuxPts(myBool); }
};
...
class G4ModelCmdSetAuxPtsVisible : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetAuxPtsVisible(myBool); }
};
...
class G4ModelCmdSetDrawStepPts : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetDrawStepPts(myBool); }
};
...
class G4ModelCmdSetStepPtsVisible : public G4ModelCmdApplyBool<M>
{
  ...
  protected:
    ...
    void Apply(const G4bool& myBool) { G4VModelCommand<M>::Model()->SetStepPtsVisible(myBool); }
};
...
class G4ModelCmdSetStepPtsType : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      if (type == "dots")
      {
        myType = G4Polymarker::dots;
      }
      else if (type == "circles")
      {
        myType = G4Polymarker::circles;
      }
      else if (type == "squares")
      {
        myType = G4Polymarker::squares;
      }
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetStepPtsType::Apply", "modeling0109", JustWarning, ed);
        return;
      }
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetAuxPtsType::Apply", "modeling0110", JustWarning, ed);
        return;
      }
...
class G4ModelCmdSetStepPtsSizeType : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      if (type == "none")
      {
        mySizeType = G4VMarker::none;
      }
      else if (type == "world")
      {
        mySizeType = G4VMarker::world;
      }
      else if (type == "screen")
      {
        mySizeType = G4VMarker::screen;
      }
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetStepPtsSizeType::Apply", "modeling0111", JustWarning, ed);
        return;
      }
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetAuxPtsSizeType::Apply", "modeling0112", JustWarning, ed);
        return;
      }
...
class G4ModelCmdSetStepPtsFillStyle : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      if (type == "noFill")
      {
        myFillStyle = G4VMarker::noFill;
      }
      else if (type == "hashed")
      {
        myFillStyle = G4VMarker::hashed;
      }
      else if (type == "filled")
      {
        myFillStyle = G4VMarker::filled;
      }
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetStepPtsFillStyle::Apply", "modeling0113", JustWarning, ed);
        return;
      }
  ...
  protected:
    ...
    void Apply(const G4String& type)
    {
      ...
      else
      {
        G4ExceptionDescription ed;
        ed << "Invalid argument. See command guidance for options.";
        G4Exception("G4ModelCmdSetAuxPtsFillStyle::Apply", "modeling0114", JustWarning, ed);
        return;
      }
...
class G4ModelCmdSetLineWidth : public G4ModelCmdApplyDouble<M>
{
  ...
  protected:
    ...
    void Apply(const G4double& width) { G4VModelCommand<M>::Model()->SetLineWidth(width); }
};
...
class G4ModelCmdSetLineColour : public G4ModelCmdApplyColour<M>
{
  ...
  protected:
    ...
    void Apply(const G4Colour& colour) { G4VModelCommand<M>::Model()->SetLineColour(colour); }
};
...
class G4ModelCmdSetTimeSliceInterval : public G4ModelCmdApplyDoubleAndUnit<M>
{
  public:
      ...
      : G4ModelCmdApplyDoubleAndUnit<M>(model, placement, cmdName)
    {
      ...
      cmd->SetGuidance("Set time slice interval.  Give unit, e.g., \"0.1 ns\"");
...
class G4ModelCmdCreateContextDir : public G4UImessenger
{
  public:
    ...
    virtual ~G4ModelCmdCreateContextDir() { delete cmd; }
...
class G4ModelCmdAddInterval : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4String& param) { G4VModelCommand<M>::Model()->AddInterval(param); }
};
...
class G4ModelCmdAddValue : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4String& param) { G4VModelCommand<M>::Model()->AddValue(param); }
};
...
class G4ModelCmdSetString : public G4ModelCmdApplyString<M>
{
  ...
  protected:
    ...
    virtual void Apply(const G4String& newValue) { G4VModelCommand<M>::Model()->Set(newValue); }
};
