...
G4OpenGLStoredQt::G4OpenGLStoredQt()
  : G4OpenGLQt("OpenGLStoredQt", "OGLSQt", G4VisFeaturesOfOpenGLSQt(), G4VGraphicsSystem::threeD)
{
...
G4VViewer* G4OpenGLStoredQt::CreateViewer(G4VSceneHandler& scene, const G4String& name)
{
  G4VViewer* pView = 0;
  pView = new G4OpenGLStoredQtViewer((G4OpenGLStoredSceneHandler&)scene, name);
  if (pView)
  {
