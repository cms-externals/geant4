...
void G4OpenGLXmViewer::drawing_style_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      style = G4ViewParameters::wireframe;
      G4Exception("G4OpenGLXmViewer::drawing_style_callback", "opengl2006", FatalException,
...
void G4OpenGLXmViewer::background_color_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      G4Exception("G4OpenGLXmViewer::background_color_callback", "opengl2008", FatalException,
...
void G4OpenGLXmViewer::transparency_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      G4Exception("G4OpenGLXmViewer::transparency_callback", "opengl2009", FatalException,
...
void G4OpenGLXmViewer::antialias_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      G4Exception("G4OpenGLXmViewer::antialias_callback", "opengl2010", FatalException,
...
void G4OpenGLXmViewer::haloing_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      G4Exception("G4OpenGLXmViewer::haloing_callback", "opengl2011", FatalException,
...
void G4OpenGLXmViewer::aux_edge_callback(Widget w, XtPointer clientData, XtPointer)
{
  G4long choice = (G4long)clientData;
  G4OpenGLXmViewer* pView;
  XtVaGetValues(XtParent(w), XmNuserData, &pView, NULL);
  ...
  switch (choice)
  {
    ...
    default:
      G4Exception("G4OpenGLXmViewer::aux_edge_callback", "opengl2012", FatalException,
...
void G4OpenGLXmViewer::projection_callback(Widget w, XtPointer clientData, XtPointer)
{
  ...
  switch (choice)
  {
    ...
    default: {
      G4Exception("G4OpenGLXmViewer::projection_callback", "opengl2013", FatalException,
