...
{
  return "    Dumb single buffered X Window, No Graphics Database."
...
{
  return "    Dumb double buffered X Window with Graphics Database."
...
{
  return "    Smart single buffered X Window, No Graphics Database."
...
{
  return "    Smart double buffered X Window with Graphics Database."
         "\n    Advantages:    resizable, and has Motif-based view-control panel."
