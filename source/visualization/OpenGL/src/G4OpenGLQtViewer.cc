...
//////////////////////////////////////////////////////////////////////////////
void G4OpenGLQtViewer::CreateMainWindow(G4QGLWidgetType* glWidget, const QString& name)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
#else
  ResizeWindow(glWidget->devicePixelRatio() * fVP.GetWindowSizeHintX(),
               glWidget->devicePixelRatio() * fVP.GetWindowSizeHintY());
#endif
  ...
  if (fUiQt)
  {
    if (!fBatchMode)
    {
      ...
      if (!interactorManager->IsExternalApp())
      {
        ...
        QObject::connect(fUiQt->GetViewerTabWidget(), SIGNAL(currentChanged(int)), this,
  ...
  {  // we have to do a dialog
...
#else
    G4int offset =
      QApplication::desktop()->height() - QApplication::desktop()->availableGeometry().height();
#endif

    G4int YPos = fVP.GetWindowAbsoluteLocationHintY(
    ...
    glDialogWidget->move(fVP.GetWindowAbsoluteLocationHintX(
  ...
  if (!fContextMenu) createPopupMenu();
}
    ...
    fIsDeleting(false)
{
  ...
  const char* const icon1[] = {/* columns rows colors chars-per-pixel */
                               "20 20 34 1",
                               "  c None",
                               ". c #7C7C7C7C7C7C",
                               "X c #7D7D7D7D7D7D",
  ...
  const char* const icon2[] = {
    "20 20 68 1",           "  c None",
    ". c #5F5F10102323",    "X c #40405F5F1010",
    "o c #696963632E2E",    "O c #101019194C4C",
    "+ c #101023237070",    "@ c #70702D2D6363",
    "# c #73732D2D6464",    "$ c #79792E2E6767",
    "% c #19194C4C5353",    "& c #2D2D63636161",
    "* c #2E2E61617070",    "= c #6F6F6E6E4343",
    "- c #707065655F5F",    "; c #727279795454",
    ": c #535341417070",    "> c #797954547979",
    ", c #434361617474",    "< c #414170707070",
    "1 c #686869696363",    "2 c #6C6C69696363",
    "3 c #656567676F6F",    "4 c #69696F6F6E6E",
    "5 c #747465656767",    "6 c #757562626C6C",
    "7 c #70706C6C6969",    "8 c #616174746565",
    "9 c #656573736969",    "0 c #616174746969",
    "q c #707075756262",    "w c #797970706565",
    "e c #636361617474",    "r c #67676F6F7272",
    "t c #727261617070",    "y c #616170707070",
    "u c #6F6F72727979",    "i c #67676E6ED1D1",
    "p c #808080808080",    "a c #828282828282",
    "s c #838383838383",    "d c #848484848484",
    "f c #858585858585",    "g c #868686868686",
    "h c #888888888888",    "j c #8A8A8A8A8A8A",
    "k c #8D8D8D8D8D8D",    "l c #8F8F8F8F8F8F",
    "z c #909090909090",    "x c #949494949494",
    "c c #9C9C9C9C9C9C",    "v c #9F9F9F9F9F9F",
    "b c #A2A2A2A2A2A2",    "n c #AEAEAEAEAEAE",
    "m c #B7B7B7B7B7B7",    "M c #C7C7C7C7C7C7",
    "N c #C9C9C9C9C9C9",    "B c #D1D1D1D1D1D1",
    "V c #D4D4D4D4D4D4",    "C c #D9D9D9D9D9D9",
    "Z c #E0E0E0E0E0E0",    "A c #E2E2E2E2E2E2",
    "S c #EEEEEEEEEEEE",    "D c #F0F0F0F0F0F0",
    "F c #F5F5F5F5F5F5",    "G c #F6F6F6F6F6F6",
    "H c #F9F9F9F9F9F9",    "J c #FCFCFCFCFCFC",
    "K c #FDFDFDFDFDFD",    "                    ",
    "                    ", "                    ",
    "                    ", "                    ",
    "     bC             ", "     zjnD           ",
  ...
  const char* const search[] = {
    ...
    "19 19 8 1", "  c #5C5C5C", ". c #7D7D7D", "X c #9B9B9B", "o c #C3C3C3", "O c None",
    "+ c #000000", "@ c #000000", "# c None",
    /* pixels */
    "OOOOOOOOOOOOOOOOOOO", "OOOOOOOOOOOOOOOOOOO", "OOOOOOOo.  .oOOOOOO", "OOOOOOX      XOOOOO",
    "OOOOOo  XOOX  oOOOO", "OOOOO. XOOOOX .OOOO", "OOOOO  OOOOOO  OOOO", "OOOOO  OOOOOO  OOOO",
    "OOOOO. XOOOOo .OOOO", "OOOOOo  oOOo  oOOOO", "OOOOOOX       XOOOO", "OOOOOOOo.  .   XOOO",
    "OOOOOOOOOOOOO.  XOO", "OOOOOOOOOOOOOO. XOO", "OOOOOOOOOOOOOOOoOOO", "OOOOOOOOOOOOOOOOOOO",
...
#if QT_VERSION < 0x060000
  G4cout << removeTempFolder().toStdString().c_str()
         << G4endl;  // G.Barrand: with Qt6, it crashes at exit if the viewer is in a detached
                     // dialog window.
#endif
}
...
void G4OpenGLQtViewer::createPopupMenu()
{
  ...
  fMouseRotateAction =
    mMouseAction->addAction("Rotate", this, [this]() { this->toggleMouseAction(1); });
  fMouseMoveAction =
    mMouseAction->addAction("Move", this, [this]() { this->toggleMouseAction(2); });
  fMousePickAction =
    mMouseAction->addAction("Pick", this, [this]() { this->toggleMouseAction(3); });
  fMouseZoomOutAction =
    mMouseAction->addAction("Zoom out", this, [this]() { this->toggleMouseAction(4); });
  fMouseZoomInAction =
    mMouseAction->addAction("Zoom in", this, [this]() { this->toggleMouseAction(5); });
  ...
  QObject::connect(shortcutsAction, SIGNAL(triggered(bool)), this, SLOT(showShortcuts()));
  ...
  // no more radioAction, not realy useful and could be confusing to use context menu and icon at
  // the same time
  fProjectionOrtho =
    mProjection->addAction("Orthographic", this, [this]() { this->toggleProjection(true); });
  fProjectionPerspective =
    mProjection->addAction("Perspective", this, [this]() { this->toggleProjection(false); });
  // === Drawing Menu ===
  QMenu* mDrawing = mStyle->addMenu("&Drawing");
  fDrawingWireframe =
    mDrawing->addAction("Wireframe", this, [this]() { this->toggleSurfaceAction(1); });
  fDrawingLineRemoval =
    mDrawing->addAction("Hidden line removal", this, [this]() { this->toggleSurfaceAction(2); });
  fDrawingSurfaceRemoval =
    mDrawing->addAction("Hidden Surface removal", this, [this]() { this->toggleSurfaceAction(3); });
  fDrawingLineSurfaceRemoval = mDrawing->addAction("Hidden line and surface removal", this,
  ...
  QObject ::connect(backgroundColorChooser, SIGNAL(triggered()), this,
  ...
  QObject ::connect(textColorChooser, SIGNAL(triggered()), this, SLOT(actionChangeTextColor()));
  ...
  QObject ::connect(defaultColorChooser, SIGNAL(triggered()), this,
                    SLOT(actionChangeDefaultColor()));

  // === Action Menu ===
  QMenu* mActions = fContextMenu->addMenu("&Actions");
  QAction* createEPS = mActions->addAction("Save as ...");
  QObject ::connect(createEPS, SIGNAL(triggered()), this, SLOT(actionSaveImage()));

  // === Action Menu ===
  QAction* movieParameters = mActions->addAction("Save as movie...");
  QObject ::connect(movieParameters, SIGNAL(triggered()), this, SLOT(actionMovieParameters()));
...
*/
void G4OpenGLQtViewer::createRadioAction(QAction* action1, QAction* action2,
                                         const std::string& method, unsigned int nCheck)
{
...
{
  if (check != fGLWidget->isFullScreen())
  {  // toggle
...
void G4OpenGLQtViewer::actionSaveImage()
{
  ...
  QString qFilename;
  qFilename = QFileDialog::getSaveFileName(fGLWidget, tr("Save as ..."), fFileSavePath, filters,
                                           selectedFormat);
  ...
  G4OpenGLQtExportDialog* exportDialog =
...
void G4OpenGLQtViewer::actionChangeBackgroundColor()
{
  ...
  const QColor color = QColorDialog::getColor(
    Qt::black, fGLWidget, " Get background color and transparency", QColorDialog::ShowAlphaChannel);
  if (color.isValid())
  {
    G4Colour colour(((G4double)color.red()) / 255, ((G4double)color.green()) / 255,
                    ((G4double)color.blue()) / 255, ((G4double)color.alpha()) / 255);
...
{
  const QColor& color = QColorDialog::getColor(
    Qt::yellow, fGLWidget, " Get text color and transparency", QColorDialog::ShowAlphaChannel);
  if (color.isValid())
  {
    G4Colour colour(((G4double)color.red()) / 255, ((G4double)color.green()) / 255,
                    ((G4double)color.blue()) / 255, ((G4double)color.alpha()) / 255);
...
{
  const QColor& color = QColorDialog::getColor(
    Qt::white, fGLWidget, " Get default color and transparency", QColorDialog::ShowAlphaChannel);
  if (color.isValid())
  {
    G4Colour colour(((G4double)color.red()) / 255, ((G4double)color.green()) / 255,
                    ((G4double)color.blue()) / 255, ((G4double)color.alpha()) / 255);
...
void G4OpenGLQtViewer::showMovieParametersDialog()
{
  if (!fMovieParametersDialog)
  {
    ...
    {
      setRecordingInfos(
        "ppmtompeg is needed to encode in video format. It is available here: "
...
void G4OpenGLQtViewer::G4MousePressEvent(QMouseEvent* evnt)
{
  ...
  if ((evnt->button() & Qt::LeftButton) && (!(evnt->modifiers() & Qt::ControlModifier)))
  {
    ...
    if (fUiQt != NULL)
    {
      ...
      {  // zoomOut
        // Move click point to center of OGL
        moveScene(((float)getWinWidth() / 2 - evnt->pos().x()),
                  ((float)getWinHeight() / 2 - evnt->pos().y()), 0, true);
    ...
    while (fAutoMove)
    {
      if (lastMoveTime.elapsed() >= (int)(1000 / fNbMaxFramesPerSec))
      {
        ...
        {  // rotate
          if (fNoKeyPress)
          {
            rotateQtScene(((float)delta.x()) / correctionFactor,
                          ((float)delta.y()) / correctionFactor);
          }
          else if (fAltKeyPress)
          {
            rotateQtSceneToggle(((float)delta.x()) / correctionFactor,
                                ((float)delta.y()) / correctionFactor);
          }
        }
        else if (move)
        {  // move
          moveScene(-((float)delta.x()) / correctionFactor, -((float)delta.y()) / correctionFactor,
                    0, true);
        }
      }
...
void G4OpenGLQtViewer::moveScene(float dx, float dy, float dz, bool mouseMove)
{
  ...
  updateQWidget();
  if (fAutoMove) ((QApplication*)G4Qt::getInstance())->processEvents();
...
*/
void G4OpenGLQtViewer::rescaleImage(int /* aWidth */
                                    ,
                                    int /* aHeight */
)
{
...
#if (QT_VERSION < QT_VERSION_CHECK(5, 14, 0))
  ZoomFromMouseWheel(delta, evnt->modifiers() & Qt::ShiftModifier, evnt->pos().x(),
                     evnt->pos().y());
#else
  ZoomFromMouseWheel(delta, evnt->modifiers() & Qt::ShiftModifier, evnt->position().x(),
                     evnt->position().y());
#endif
...
void G4OpenGLQtViewer::G4keyPressEvent(QKeyEvent* evnt)
{
  ...
  {
    if (evnt->key() == Qt::Key_Down)
    {  // go down
      moveScene(0, 1, 0, false);
    }
    else if (evnt->key() == Qt::Key_Up)
    {  // go up
      moveScene(0, -1, 0, false);
    }
    if (evnt->key() == Qt::Key_Left)
    {  // go left
      moveScene(-1, 0, 0, false);
    }
    else if (evnt->key() == Qt::Key_Right)
    {  // go right
      moveScene(1, 0, 0, false);
    }
    if (evnt->key() == Qt::Key_Minus)
    {  // go backward
      moveScene(0, 0, 1, false);
    }
    else if (evnt->key() == Qt::Key_Plus)
    {  // go forward
      moveScene(0, 0, -1, false);
    }
  ...
  if ((evnt->key() == Qt::Key_Return) || (evnt->key() == Qt::Key_Enter))
  {  // end of video
    stopVideo();
  }
  if (evnt->key() == Qt::Key_Space)
  {  // start/pause of video
    startPauseVideo();
  }

  // H : Return Home view
  if (evnt->key() == Qt::Key_H)
  {  // go Home
    ResetView();
...
void G4OpenGLQtViewer::displayRecordingStatus()
{
  ...
  else if ((fRecordingStep == BAD_ENCODER) || (fRecordingStep == BAD_OUTPUT)
...
void G4OpenGLQtViewer::initMovieParameters()
{
  ...
  QObject ::connect(fProcess, SIGNAL(finished(int)), this, SLOT(processLookForFinished()));
...
QString G4OpenGLQtViewer::setEncoderPath(QString path)
{
  if (path == "")
  {
    return "ppmtompeg is needed to encode in video format. It is available here: "
           "http://netpbm.sourceforge.net ";
  }
...
QString G4OpenGLQtViewer::createTempFolder()
{
  ...
  QString path =
    sep + "QtMovie_" + QDateTime::currentDateTime().toString("dd-MM-yyyy_hh-mm-ss") + sep;
...
bool G4OpenGLQtViewer::exportImage(std::string name, int width, int height)
{
  ...
  else
  {
    ...
    {
      G4cout << "File " << getRealPrintFilename().c_str() << " size: " << fGLWidget->width() << "x"
             << fGLWidget->height() << " has been saved " << G4endl;
...
bool G4OpenGLQtViewer::generateMpegEncoderParameters()
{
  ...
  setRecordingInfos("Parameter file " + fParameterFileName + " generated in "
                    + fMovieTempFolderPath);
...
void G4OpenGLQtViewer::encodeVideo()
{
  if ((getEncoderPath() != "") && (getSaveFileName() != ""))
  {
    ...
    fProcess = new QProcess();
    QObject ::connect(fProcess, SIGNAL(finished(int, QProcess::ExitStatus)), this,
                      SLOT(processEncodeFinished()));
    QObject ::connect(fProcess, SIGNAL(readyReadStandardOutput()), this,
                      SLOT(processEncodeStdout()));
#if (QT_VERSION < QT_VERSION_CHECK(5, 10, 0))
  ...
  if (fProcess->exitCode() != 0)
  {
    switch (fProcess->error())
    {
      ...
      case QProcess::Timedout:
        txt =
          "The last waitFor...() function timed out. The state of QProcess is unchanged, and you "
          "can try calling waitFor...() again.\n";
        break;
      case QProcess::WriteError:
        txt =
          "An error occurred when attempting to write to the process. For example, the process may "
          "not be running, or it may have closed its input channel.\n";
        break;
      case QProcess::ReadError:
        txt =
          "An error occurred when attempting to read from the process. For example, the process "
          "may not be running.\n";
        break;
...
QWidget* G4OpenGLQtViewer::getParentWidget()
{
  ...
  if (((QApplication*)interactorManager->GetMainInteractor()))
  {
    ...
    for (int i = 0; i < wl.size(); i++)
    {
      ...
      {
        dialog = new QDialog(widget, Qt::WindowTitleHint | Qt::WindowSystemMenuHint
...
void G4OpenGLQtViewer::createSceneTreeComponent()
{
  ...
  connect(fSceneTreeComponentTreeWidget, SIGNAL(itemChanged(QTreeWidgetItem*, int)),
          SLOT(sceneTreeComponentItemChanged(QTreeWidgetItem*, int)));
  connect(fSceneTreeComponentTreeWidget, SIGNAL(itemSelectionChanged()),
          SLOT(sceneTreeComponentSelected()));
  connect(fSceneTreeComponentTreeWidget, SIGNAL(itemDoubleClicked(QTreeWidgetItem*, int)),
          SLOT(changeColorAndTransparency(QTreeWidgetItem*, int)));
  ...
  connect(fSceneTreeDepthSlider, SIGNAL(valueChanged(int)), this,
          SLOT(changeDepthInSceneTree(int)));
...
void G4OpenGLQtViewer::createViewerPropertiesWidget()
{
  ...
  connect(fViewerPropertiesTableWidget, SIGNAL(itemChanged(QTableWidgetItem*)), this,
          SLOT(tableWidgetViewerSetItemChanged(QTableWidgetItem*)));
...
inline GLint project_point(GLdouble objx, GLdouble objy, GLdouble objz, const GLdouble model[16],
                           const GLdouble proj[16], const GLint viewport[4], GLdouble* winx,
...
static void render_text(QOpenGLWidget& widget, double world_x, double world_y, double world_z,
                        double offset_x, double offset_y, const QFont& font, const QColor& color,
                        const char* text)
{
  GLdouble model[4][4];
  ...
  project_point(world_x, world_y, world_z, &model[0][0], &proj[0][0], &view[0], &textPosX,
                &textPosY, &textPosZ);
...
#  endif
    xmove *= fudgeFactor;
    ymove *= fudgeFactor;
    qGLW->renderText((position.x() + (2 * xmove) / getWinWidth()),
                     (position.y() + (2 * ymove) / getWinHeight()), position.z(), textCString,
                     font);
#else
    QColor color((int)(c.GetRed() * 255), (int)(c.GetGreen() * 255), (int)(c.GetBlue() * 255),
                 (int)(c.GetAlpha() * 255));
    render_text(*qGLW, position.x(), position.y(), position.z(), xmove, ymove, font, color,
                textCString);
#endif
  }
}
...
void G4OpenGLQtViewer::addPVSceneTreeElement(const G4String& model, G4PhysicalVolumeModel* pPVModel,
                                             int currentPOIndex)
{
  ...
  if (!fPVRootNodeCreate)
  {
    ...
    fModelShortNameItem = createTreeWidgetItem(pPVModel->GetFullPVPath(), modelShortName,
                                               0,  // currentPVCopyNb
                                               -1,  // currentPVPOIndex
                                               "", Qt::Checked, NULL, color);
    fPVRootNodeCreate = true;
  }

  bool added =
    parseAndInsertInSceneTree(fModelShortNameItem, pPVModel, 0, modelShortName, 0, currentPOIndex);
  if (!added)
  {}
...
QTreeWidgetItem* G4OpenGLQtViewer::createTreeWidgetItem(
  const PVPath& fullPath, const QString& name, int copyNb, int POIndex, const QString& logicalName,
  Qt::CheckState state, QTreeWidgetItem* parentTreeNode, const G4Colour& color)
{
  // Set depth
  ...
  changeQColorForTreeWidgetItem(
    newItem, QColor((int)(color.GetRed() * 255), (int)(color.GetGreen() * 255),
                    (int)(color.GetBlue() * 255), (int)(color.GetAlpha() * 255)));
  ...
  if ((state == Qt::Unchecked) && (POIndex == -1))
  {
    ...
    // Set a tootip
    newItem->setToolTip(0, QString("This node exists in the geometry but has not been\n")
...
bool G4OpenGLQtViewer::parseAndInsertInSceneTree(
  QTreeWidgetItem* parentItem, G4PhysicalVolumeModel* pPVModel, unsigned int fullPathIndex,
  const QString& parentRoot, unsigned int currentIndexInTreeSceneHandler, int currentPVPOIndex)
{
  if (parentItem == NULL)
  {
    return false;
  ...
  std::string currentPVName =
    G4String(fullPath.at(fullPathIndex).GetPhysicalVolume()->GetName() + " [" + oss.str() + "]")
      .data();
  ...
  for (int i = 0; i < parentItemList.size(); ++i)
  {
    ...
    if (((parentRoot == fTouchableVolumes) && (currentPVCopyNb == parentItemCopyNb)
        ...
        ((parentRoot != fTouchableVolumes)
         && (currentPVCopyNb == parentItemCopyNb)
         ...
         && (currentPVName == parentItemName) && (currentPVPOIndex == parentItemPOIndex)))
    {
      ...
      if (parentItemPOIndex >= 0)
      {
        ...
        {
          if (fullPathTmp.at(fullPathTmp.size() - 1).GetTransform()
              == pPVModel->GetTransformation())
          {
            sameTransform = true;
          }
          else
      ...
      if (sameTransform == true)
      {
        ...
        if (currentIndexInTreeSceneHandler == (fullPath.size() - 1))
        {
          ...
          changeQColorForTreeWidgetItem(
            parentItemList.at(i),
            QColor((int)(color.GetRed() * 255), (int)(color.GetGreen() * 255),
                   (int)(color.GetBlue() * 255), (int)(color.GetAlpha() * 255)));
  ...
  if (currentIndexInTreeSceneHandler == (fullPath.size() - 1))
  {
    /* subItem =*/createTreeWidgetItem(
      fullPath, QString(currentPVName.c_str()), currentPVCopyNb, currentPVPOIndex,
      QString(fullPath.at(fullPathIndex).GetPhysicalVolume()->GetLogicalVolume()->GetName().data()),
      Qt::Checked, parentItem, color);
  ...
  else
  {
    ...
    if (subItem == NULL)
    {
      ...
      {
        subItem = createTreeWidgetItem(
          fullPath, QString(currentPVName.c_str()), currentPVCopyNb, -1,
          QString(
            fullPath.at(fullPathIndex).GetPhysicalVolume()->GetLogicalVolume()->GetName().data()),
          Qt::Unchecked, parentItem, color);
      }
    }

    return parseAndInsertInSceneTree(subItem, pPVModel, fullPathIndex + 1, parentRoot,
                                     currentIndexInTreeSceneHandler + 1, currentPVPOIndex);
  }
  return true;
}
  ...
  QTreeWidgetItem* subItem)
{
  ...
  if (foundItem == NULL)
  {  // PO should have change, parse all
  ...
  if (oldItem != NULL)
  {
    ...
    if (visAttrChange)
    {
      fOldVisAttrColorMap.insert(
        std::pair<int, QColor>(subItem->data(0, Qt::UserRole).toInt(), newVisAttrColor));
    }
    else
    {  // if no changes, get old PO value
      // if old PO found
...
bool G4OpenGLQtViewer::isSameSceneTreeElement(QTreeWidgetItem* parentOldItem,
                                              QTreeWidgetItem* parentNewItem)
{
  ...
  while ((parentOldItem != NULL) && (parentNewItem != NULL))
  {
    ...
    if ((oldPO >= 0) && (newPO >= 0))
    {
      ...
      if ((oldFullPath.size() > 0) && (newFullPath.size() > 0))
      {
        if (oldFullPath.size() != newFullPath.size())
        {
          return false;
        }
        if (oldFullPath.at(oldFullPath.size() - 1).GetTransform()
            == newFullPath.at(newFullPath.size() - 1).GetTransform())
        {
...
void G4OpenGLQtViewer::addNonPVSceneTreeElement(const G4String& model, int currentPOIndex,
                                                ...
                                                const G4Visible& visible)
{
  ...
  if (resItem.empty())
  {
    currentItem = createTreeWidgetItem(tmpFullPath, modelShortName,
                                       0,  // currentPVCopyNb
                                       -1,  // currentPVPOIndex
                                       "", Qt::Checked, NULL, color);
  }
  ...
  const QList<QTreeWidgetItem*>& resItems = fSceneTreeComponentTreeWidget->findItems(
  ...
  if (!alreadyPresent)
  {
    createTreeWidgetItem(tmpFullPath, modelShortName,
                         0,  // currentPVCopyNb
                         currentPOIndex, "", Qt::Checked, currentItem, color);
  }
  fSceneTreeComponentTreeWidget->blockSignals(false);
}
...
std::string G4OpenGLQtViewer::parseSceneTreeAndSaveState()
{
  ...
  {
    commandLine +=
      parseSceneTreeElementAndSaveState(fSceneTreeComponentTreeWidget->topLevelItem(b), 1) + "\n";
  }
  if (commandLine != "")
  {
    commandLine = std::string("# Disable auto refresh and quieten vis messages whilst scene and\n")
                  + "# trajectories are established:\n" + "/vis/viewer/set/autoRefresh false\n"
                  + "/vis/verbose errors" + commandLine
...
std::string G4OpenGLQtViewer::parseSceneTreeElementAndSaveState(QTreeWidgetItem* item,
                                                                unsigned int level)
{
  // parse current item
  ...
  if (item->text(3) != "")
  {
    ...
    // save check state
    commandLine += "/vis/geometry/set/visibility " + item->text(3).toStdString()
                   + " ! ";  // let default value for depth
    if (item->checkState(0) == Qt::Checked)
    {
      commandLine += "1";
    }
    ...
    commandLine += "/vis/geometry/set/colour " + item->text(3).toStdString() + " ! " + red.str()
                   + " " + green.str() + " " + blue.str() + " " + alpha.str() + "\n";
  }
  else
  {
    commandLine += "\n";
...
void G4OpenGLQtViewer::changeColorAndTransparency(QTreeWidgetItem* item, int)
{
  ...
  const QColor& color =
    QColorDialog::getColor(old, fSceneTreeComponentTreeWidget, " Get color and transparency",
                           QColorDialog::ShowAlphaChannel);

  if (color.isValid())
  {
    changeColorAndTransparency(
      item->data(0, Qt::UserRole).toInt(),
      G4Colour(((G4double)color.red()) / 255, ((G4double)color.green()) / 255,
               ((G4double)color.blue()) / 255, ((G4double)color.alpha()) / 255));
...
G4Colour G4OpenGLQtViewer::getColorForPoIndex(int poIndex)
{
  ...
  if (item != NULL)
  {
    ...
    G4Colour g4c(((G4double)color.red()) / 255, ((G4double)color.green()) / 255,
                 ((G4double)color.blue()) / 255, ((G4double)color.alpha()) / 255);
...
{
  static std::vector<G4ModelingParameters::VisAttributesModifier> privateVisAttributesModifiers;
...
void G4OpenGLQtViewer::changeSearchSelection()
{
  ...
  QList<QTreeWidgetItem*> itemList =
    fSceneTreeComponentTreeWidget->findItems(searchText, Qt::MatchContains | Qt::MatchRecursive, 0);
...
void G4OpenGLQtViewer::changeDepthOnSceneTreeItem(double lookForDepth, double currentDepth,
  ...
  if (item->data(0, Qt::UserRole).toInt() >= 0)
  {
        ...
        || ((color.GetAlpha() - transparencyLevel) < -0.000001))
    {
      if ((item->text(3) != ""))
      {
        ...
        changeQColorForTreeWidgetItem(
          item, QColor((int)(color.GetRed() * 255), (int)(color.GetGreen() * 255),
                       (int)(color.GetBlue() * 255), (int)(transparencyLevel * 255)));
      }
    }
  }
  ...
  if (fSceneTreeComponentTreeWidget)
  {
    if (fSceneTreeComponentTreeWidget->topLevelItemCount() > 0)
    {
      ...
      for (int b = 0; b < fSceneTreeComponentTreeWidget->topLevelItemCount(); b++)
      {
        ...
        if (poIndex != -1)
        {
          fOldPositivePoIndexSceneTreeWidgetQuickMap.insert(std::pair<int, QTreeWidgetItem*>(
            poIndex, cloneWidgetItem(fSceneTreeComponentTreeWidget->topLevelItem(b))));
        }
        else
        {
          fOldNullPoIndexSceneTreeWidgetQuickVector.push_back(
            cloneWidgetItem(fSceneTreeComponentTreeWidget->topLevelItem(b)));
        }
...
*/
void G4OpenGLQtViewer::cloneSceneTree(QTreeWidgetItem* rootItem)
{
  for (int b = 0; b < rootItem->childCount(); b++)
  {
    ...
    if (poIndex != -1)
    {
      fOldPositivePoIndexSceneTreeWidgetQuickMap.insert(
        std::pair<int, QTreeWidgetItem*>(poIndex, cloneWidgetItem(child)));
    }
    else
    {
...
*/
void G4OpenGLQtViewer::updatePositivePoIndexSceneTreeWidgetQuickMap(int POindex,
                                                                    QTreeWidgetItem* item)
{
  // Check state
...
void G4OpenGLQtViewer::updateToolbarAndMouseContextMenu()
{
  ...
  G4ViewParameters::DrawingStyle d_style = fVP.GetDrawingStyle();
...
void G4OpenGLQtViewer::updateViewerPropertiesTableWidget()
{
  ...
  if ((path->GetCommandEntry() - fTreeWidgetInfosIgnoredCommands)
      != fViewerPropertiesTableWidget->rowCount())
  {
    fViewerPropertiesTableWidget->clear();
  }

  fViewerPropertiesTableWidget->blockSignals(true);
  // TODO : Could be optimized by comparing current command to old commands. That should not change
  // so much

  fViewerPropertiesTableWidget->setColumnCount(2);
  fViewerPropertiesTableWidget->setRowCount(path->GetCommandEntry()
                                            - fTreeWidgetInfosIgnoredCommands);
  fViewerPropertiesTableWidget->setHorizontalHeaderLabels(QStringList()
  ...
  for (int a = 0; a < path->GetCommandEntry(); a++)
  {
    ...
    {
      params = QString().number(fVP.GetExplodeFactor()) + "  "
               + QString(G4String(G4BestUnit(fVP.GetExplodeFactor(), "Length")).data());
    }
    ...
    else if (commandTmp->GetCommandName() == "hiddenEdge")
    {
      ...
      if ((style == G4ViewParameters::hlr) || (style == G4ViewParameters::hlhsr))
      {
        params = "True";
      }
      else
    ...
    else if (commandTmp->GetCommandName() == "lightsThetaPhi")
    {
      ...
      // degree
      params = QString().number(direction.theta() / CLHEP::degree) + "  "
               + QString().number(direction.phi() / CLHEP::degree) + "  deg";
      if (commandTmp->GetParameterEntries() == 3)
      {
        if (commandTmp->GetParameter(2)->GetDefaultValue() != "deg")
        {
          params = QString().number(direction.theta()) + "  " + QString().number(direction.phi())
                   + " " + commandTmp->GetParameter(2)->GetDefaultValue().data();
        }
      }
    }
    ...
    else if (commandTmp->GetCommandName() == "projection")
    {
      ...
      {
        params = QString("perspective ") + QString().number(fVP.GetFieldHalfAngle() / CLHEP::degree)
                 + " deg";
      }
    }
    ...
    {
      if (fVP.GetDrawingStyle() == G4ViewParameters::wireframe
          || fVP.GetDrawingStyle() == G4ViewParameters::hlr)
      {
        params = "wireframe";
      }
      else
    ...
    else if (commandTmp->GetCommandName() == "targetPoint")
    {
      ...
      {
        G4String b = G4BestUnit(fSceneHandler.GetScene()->GetStandardTargetPoint()
    ...
    else if (commandTmp->GetCommandName() == "upThetaPhi")
    {
      ...
      // degree
      params = QString().number(up.theta() / CLHEP::degree) + "  "
               + QString().number(up.phi() / CLHEP::degree) + "  deg";
      if (commandTmp->GetParameterEntries() == 3)
      {
        if (commandTmp->GetParameter(2)->GetDefaultValue() != "deg")
        {
          params = QString().number(up.theta()) + "  " + QString().number(up.phi()) + " "
                   + commandTmp->GetParameter(2)->GetDefaultValue().data();
        }
      }
    }
    ...
    {
      G4Vector3D up = fVP.GetUpVector();
      params = QString().number(up.x()) + "  " + QString().number(up.y()) + "  "
               + QString().number(up.z()) + "  ";
    }
    ...
    {
      G4Vector3D direction = fVP.GetViewpointDirection();
      params = QString().number(direction.x()) + "  " + QString().number(direction.y()) + " "
    ...
    */
    ...
    if (params != "")
    {
      ...
      // already present ?
      QList<QTableWidgetItem*> list = fViewerPropertiesTableWidget->findItems(
        commandTmp->GetCommandName().data(), Qt::MatchExactly);
      if (list.size() == 1)
      {
        nameItem = list.first();
  ...
  if (!fViewerPropertiesTableWidgetIsInit)
  {
    ...
    int y = fViewerPropertiesTableWidget->verticalHeader()->length()
            + fViewerPropertiesTableWidget->horizontalHeader()->sizeHint().height() + 2;
...
void G4OpenGLQtViewer::updatePickInfosWidget(int aX, int aY)
{
  ...
  for (unsigned int a = 0; a < pickMapVector.size(); a++)
  {
    ...
    if (pickMapVector[a]->getAttributes().size())
    {
      ...
      connect(pickCoutButton, &QPushButton::clicked,
...
void G4OpenGLQtViewer::tableWidgetViewerSetItemChanged(QTableWidgetItem* item)
{
  ...
  if (UI != NULL)
  {
    QTableWidgetItem* previous =
      fViewerPropertiesTableWidget->item(fViewerPropertiesTableWidget->row(item), 0);
    if (previous)
    {
      fViewerPropertiesTableWidget->blockSignals(true);
      UI->ApplyCommand((std::string("/vis/viewer/set/") + previous->text().toStdString() + " "
  ...
  if (!interactorManager->IsExternalApp())
  {
    ...
    if (GetName()
        != fUiQt->GetViewerTabWidget()
             ->tabText(fUiQt->GetViewerTabWidget()->currentIndex())
             .toStdString()
             .c_str())
    {
      return false;
 ...
 */
QString G4OpenGLQtViewer::GetCommandParameterList(const G4UIcommand* aCommand)
{
...
void G4OpenGLQtViewer::MovingToVisSubThread()
{
  ...
  // Wait until SwitchToVisSubThread has found vis sub-thread QThread
  {
    ...
    G4CONDITIONWAITLAMBDA(&waitForVisSubThreadInitialized, &lock,
                          [] { return visSubThreadEstablished; })
  }
