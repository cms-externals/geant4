...
void G4OpenGLXmViewer::GetXmConnection()
{
  ...
  oss << "*glxarea*width: " << fVP.GetWindowSizeHintX()
      << "\n"
         "*glxarea*height: "
  ...
  //  interactorManager->AddSecondaryLoopPostAction
  //  ((G4SecondaryLoopAction)G4OpenGLXmViewerSecondaryLoopPostAction);

  shell = XtAppCreateShell((String)fName.data(), (String)fName.data(), topLevelShellWidgetClass,
  ...
  {
    fViewId = -1;  // This flags an error.
    G4cerr << "G4OpenGLXmViewer::GetXmConnection unable to connect to display." << G4endl;
    return;
  }
  ...
  {
    fViewId = -1;  // This flags an error.
    G4cerr << "G4OpenGLXmViewer::GetXmConnection. X Server has no GLX extension." << G4endl;
    ;
    return;
  }
}
...
void G4OpenGLXmViewer::CreateMainWindow()
{
  ...
  {
    XtVaSetValues(shell, XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap, XtNwidth,
                  getWinWidth(), XtNheight, getWinHeight(), XtNx, x_origin, XtNy, y_origin,
                  XtNborderColor, &borcol, XtNbackground, &bgnd, XmNtitle, fName.data(), NULL);
  }
  else if (fVP.IsWindowSizeHintX() && !(fVP.IsWindowLocationHintX() || fVP.IsWindowLocationHintY()))
  {
    XtVaSetValues(shell, XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap, XtNwidth,
                  getWinWidth(), XtNheight, getWinHeight(), XtNborderColor, &borcol, XtNbackground,
                  &bgnd, XmNtitle, fName.data(), NULL);
  }
  else if ((!fVP.IsWindowSizeHintX()) && fVP.IsWindowLocationHintX() && fVP.IsWindowLocationHintY())
  {
    XtVaSetValues(shell, XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap, XtNx,
                  x_origin, XtNy, y_origin, XtNborderColor, &borcol, XtNbackground, &bgnd, XmNtitle,
                  fName.data(), NULL);
  }
  else
  {
    XtVaSetValues(shell, XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap,
                  XtNborderColor, &borcol, XtNbackground, &bgnd, XmNtitle, fName.data(), NULL);
  }

  main_win = XtVaCreateManagedWidget("main_win", xmMainWindowWidgetClass, shell, XtNvisual,
                                     vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap,
  ...
  menubar = XmVaCreateSimpleMenuBar(
    main_win, (char*)menu_str[8].c_str(), XmVaCASCADEBUTTON, style_str,
    (KeySym)XK_S, /*G.Barrand : cast to KeySym and use XK_*/
    XmVaCASCADEBUTTON, actions_str, (KeySym)XK_A, XmVaCASCADEBUTTON, misc_str, (KeySym)XK_M,
    XmVaCASCADEBUTTON, spec_str, (KeySym)XK_p, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  style_cascade = XmVaCreateSimplePulldownMenu(
    menubar, (char*)menu_str[1].c_str(), 0, NULL, XmVaCASCADEBUTTON, draw_str, (KeySym)XK_D,
    XmVaCASCADEBUTTON, bgnd_str, (KeySym)XK_B, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  drawing_style_pullright = XmVaCreateSimplePulldownMenu(
    style_cascade, (char*)menu_str[15].c_str(), 1, drawing_style_callback, XmVaRADIOBUTTON,
    wireframe_str, (KeySym)XK_W, NULL, NULL, XmVaRADIOBUTTON, hlr_str, (KeySym)XK_L, NULL, NULL,
    XmVaRADIOBUTTON, hsr_str, (KeySym)XK_S, NULL, NULL, XmVaRADIOBUTTON, hlhsr_str, (KeySym)XK_H,
    NULL, NULL, XmNradioBehavior, True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual,
    vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd,
    NULL);
  ...
  {
    G4Exception("G4OpenGLXmViewer::CreateMainWindow", "opengl2015", FatalException,
  ...
  background_color_pullright = XmVaCreateSimplePulldownMenu(
    style_cascade, (char*)menu_str[18].c_str(), 2, background_color_callback, XmVaRADIOBUTTON,
    white_str, (KeySym)XK_W, NULL, NULL, XmVaRADIOBUTTON, black_str, (KeySym)XK_B, NULL, NULL,
    XmNradioBehavior, True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual, vi->visual,
    XtNdepth, vi->depth, XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);

  if (background.GetRed() == 1. && background.GetGreen() == 1. && background.GetBlue() == 1.)
  {
  ...
  actions_cascade = XmVaCreateSimplePulldownMenu(
    menubar, (char*)menu_str[3].c_str(), 1, actions_callback, XmVaPUSHBUTTON, rot_str, (KeySym)XK_R,
    NULL, NULL, XmVaPUSHBUTTON, pan_str, (KeySym)XK_P, NULL, NULL, XmVaPUSHBUTTON, set_str,
    (KeySym)XK_S, NULL, NULL, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  misc_cascade = XmVaCreateSimplePulldownMenu(
    menubar, (char*)menu_str[5].c_str(), 2, misc_callback, XmVaPUSHBUTTON, misc_str, (KeySym)XK_M,
    NULL, NULL, XmVaPUSHBUTTON, exit_str, (KeySym)XK_E, NULL, NULL, XmVaPUSHBUTTON, print_str,
    (KeySym)XK_P, NULL, NULL, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  spec_cascade = XmVaCreateSimplePulldownMenu(
    menubar, (char*)menu_str[7].c_str(), 3, NULL, XmVaCASCADEBUTTON, trans_str, (KeySym)XK_T,
    XmVaCASCADEBUTTON, anti_str, (KeySym)XK_A, XmVaCASCADEBUTTON, halo_str, (KeySym)XK_H,
    XmVaCASCADEBUTTON, aux_edge_str, (KeySym)XK_E, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  transparency_pullright = XmVaCreateSimplePulldownMenu(
    spec_cascade, (char*)menu_str[26].c_str(), 0, transparency_callback, XmVaRADIOBUTTON, off_str,
    (KeySym)XK_f, NULL, NULL, XmVaRADIOBUTTON, on_str, (KeySym)XK_n, NULL, NULL, XmNradioBehavior,
    True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  {
    G4Exception("G4OpenGLXmViewer::CreateMainWindow", "opengl2016", FatalException,
  ...
  antialias_pullright = XmVaCreateSimplePulldownMenu(
    spec_cascade, (char*)menu_str[28].c_str(), 1, antialias_callback, XmVaRADIOBUTTON, off_str,
    (KeySym)XK_f, NULL, NULL, XmVaRADIOBUTTON, on_str, (KeySym)XK_n, NULL, NULL, XmNradioBehavior,
    True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  {
    G4Exception("G4OpenGLXmViewer::CreateMainWindow", "opengl2017", FatalException,
  ...
  haloing_pullright = XmVaCreateSimplePulldownMenu(
    spec_cascade, (char*)menu_str[30].c_str(), 2, haloing_callback, XmVaRADIOBUTTON, off_str,
    (KeySym)XK_f, NULL, NULL, XmVaRADIOBUTTON, on_str, (KeySym)XK_n, NULL, NULL, XmNradioBehavior,
    True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  {
    G4Exception("G4OpenGLXmViewer::CreateMainWindow", "opengl2018", FatalException,
  ...
  aux_edge_pullright = XmVaCreateSimplePulldownMenu(
    spec_cascade, (char*)menu_str[32].c_str(), 3, aux_edge_callback, XmVaRADIOBUTTON, off_str,
    (KeySym)XK_f, NULL, NULL, XmVaRADIOBUTTON, on_str, (KeySym)XK_n, NULL, NULL, XmNradioBehavior,
    True, XmNradioAlwaysOne, True, XmNuserData, this, XtNvisual, vi->visual, XtNdepth, vi->depth,
    XtNcolormap, cmap, XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  frame = XtVaCreateManagedWidget((char*)menu_str[35].c_str(), xmFrameWidgetClass, main_win,
                                  XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap,
                                  XtNborderColor, borcol, XtNbackground, bgnd, NULL);

  glxarea = XtVaCreateManagedWidget((char*)menu_str[36].c_str(), xmDrawingAreaWidgetClass, frame,
                                    XtNvisual, vi->visual, XtNdepth, vi->depth, XtNcolormap, cmap,
                                    XtNborderColor, borcol, XtNbackground, bgnd, NULL);
  ...
  XtAddCallback(glxarea, XmNresizeCallback, resize_callback, this);

  XtAddCallback(glxarea, XmNexposeCallback, expose_callback, this);
}
