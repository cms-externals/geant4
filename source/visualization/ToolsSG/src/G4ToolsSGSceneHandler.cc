...
G4ToolsSGSceneHandler::~G4ToolsSGSceneHandler()
{
  ...
  if(fpTransient2DObjects.size()||fpPersistent2DObjects.size()||
     fpTransient3DObjects.size()||fpPersistent3DObjects.size()||
     fpTrash.size()) {
    ...
    G4cerr << "G4ToolsSGSceneHandler::~G4ToolsSGSceneHandler: some nodes are not cleared." << G4endl;
  }
