...
class G4ToolsSGQtGLESViewer : public G4ToolsSGViewer<toolx::Qt::session, toolx::Qt::sg_viewer>
{
  ...
  public:
    ...
    G4ToolsSGQtGLESViewer(toolx::Qt::session& a_session, G4ToolsSGSceneHandler& a_scene_handler,
  ...
  public:
    ...
    virtual void Initialise()
    {
      ...
      if (!fSGViewer)
      {
        G4cerr << "G4ToolsSGQtGLESViewer::Initialise: ERROR: G4ToolsSGQtGLESViewer has no "
                  "toolx::Qt::sg_viewer."
               << G4endl;
        return;
      }
      ...
      {
        G4cerr
          << "G4ToolsSGQtGLESViewer::Initialise: ERROR: toolx::Qt::sg_viewer has no QWidget shell."
          << G4endl;
        return;
      }
