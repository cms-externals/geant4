...
#ifndef G4RTJPEGMAKER_HH
#define G4RTJPEGMAKER_HH
...
class G4RTJpegMaker : public G4VFigureFileMaker
{
  ...
  public:
    ...
    virtual void CreateFigureFile(const G4String& fileName, int nColumn, int nRow, u_char* colorR,
                                  u_char* colorG, u_char* colorB);
};
