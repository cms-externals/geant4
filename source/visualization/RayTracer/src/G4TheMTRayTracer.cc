...
G4TheMTRayTracer::G4TheMTRayTracer(G4VFigureFileMaker* figMaker, G4VRTScanner* scanner)
  : G4TheRayTracer(figMaker, scanner)
{
  ...
  {
    G4Exception("G4TheMTRayTracer::G4TheMTRayTracer", "VisRayTracer00100", FatalException,
...
G4TheMTRayTracer* G4TheMTRayTracer::Instance()
{
  if (theInstance)
    ...
    return new G4TheMTRayTracer;
}

G4TheMTRayTracer* G4TheMTRayTracer::Instance(G4VFigureFileMaker* figMaker, G4VRTScanner* scanner)
{
  if (theInstance)
  {
    ...
    return new G4TheMTRayTracer(figMaker, scanner);
}
