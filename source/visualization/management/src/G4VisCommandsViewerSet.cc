    ...
    fViewpointVector(G4ThreeVector(0., 0., 1.))
{
  ...
  fpCommandAll->SetGuidance("Copies view parameters.");
  ...
  fpCommandAutoRefresh = new G4UIcmdWithABool("/vis/viewer/set/autoRefresh", this);
  ...
  fpCommandAuxEdge = new G4UIcmdWithABool("/vis/viewer/set/auxiliaryEdge", this);
  ...
  fpCommandBackground = new G4UIcommand("/vis/viewer/set/background", this);
  ...
  fpCommandCulling->SetGuidance("\"global\": enables/disables all other culling options.");
  ...
  fpCommandCulling->SetGuidance("\"invisible\": culls objects with the invisible attribute set.");
  fpCommandCulling->SetGuidance(
  ...
  parameter->SetParameterCandidates("global coveredDaughters invisible density");
  ...
  fpCommandCutawayMode = new G4UIcmdWithAString("/vis/viewer/set/cutawayMode", this);
  fpCommandCutawayMode->SetGuidance("Sets cutaway mode - add (union) or multiply (intersection).");
  ...
  fpCommandDefaultColour = new G4UIcommand("/vis/viewer/set/defaultColour", this);
  ...
  fpCommandDefaultTextColour = new G4UIcommand("/vis/viewer/set/defaultTextColour", this);
  ...
  fpCommandEdge->SetGuidance("Edges become visible/invisible in surface mode.");
  fpCommandEdge->SetParameterName("edge", omitable = true);
  fpCommandEdge->SetDefaultValue(true);

  fpCommandExplodeFactor = new G4UIcommand("/vis/viewer/set/explodeFactor", this);
  ...
  fpCommandGlobalLineWidthScale =
    new G4UIcmdWithADouble("/vis/viewer/set/globalLineWidthScale", this);
  fpCommandGlobalLineWidthScale->SetGuidance("Multiplies line widths by this factor.");
  fpCommandGlobalLineWidthScale->SetParameterName("scale-factor", omitable = true);
  fpCommandGlobalLineWidthScale->SetDefaultValue(1.);

  fpCommandGlobalMarkerScale = new G4UIcmdWithADouble("/vis/viewer/set/globalMarkerScale", this);
  fpCommandGlobalMarkerScale->SetGuidance("Multiplies marker sizes by this factor.");
  fpCommandGlobalMarkerScale->SetParameterName("scale-factor", omitable = true);
  fpCommandGlobalMarkerScale->SetDefaultValue(1.);

  fpCommandHiddenEdge = new G4UIcmdWithABool("/vis/viewer/set/hiddenEdge", this);
  fpCommandHiddenEdge->SetGuidance("Edges become hidden/seen in wireframe or surface mode.");
  fpCommandHiddenEdge->SetParameterName("hidden-edge", omitable = true);
  fpCommandHiddenEdge->SetDefaultValue(true);

  fpCommandHiddenMarker = new G4UIcmdWithABool("/vis/viewer/set/hiddenMarker", this);
  ...
  fpCommandLightsMove = new G4UIcmdWithAString("/vis/viewer/set/lightsMove", this);
  fpCommandLightsMove->SetGuidance("Lights move with camera or with object");
  fpCommandLightsMove->SetParameterName("lightsMove", omitable = false);
  fpCommandLightsMove->SetCandidates("cam camera with-camera obj object with-object");

  fpCommandLightsThetaPhi = new G4UIcommand("/vis/viewer/set/lightsThetaPhi", this);
  fpCommandLightsThetaPhi->SetGuidance("Set direction from target to lights.");
  ...
  fpCommandLightsVector = new G4UIcommand("/vis/viewer/set/lightsVector", this);
  fpCommandLightsVector->SetGuidance("Set direction from target to lights.");
  parameter = new G4UIparameter("x", 'd', omitable = true);
  parameter->SetDefaultValue(1);
  ...
  fpCommandLineSegments = new G4UIcmdWithAnInteger("/vis/viewer/set/lineSegmentsPerCircle", this);
  ...
  fpCommandLineWidth = new G4UIcmdWithoutParameter("/vis/viewer/set/lineWidth", this);
  ...
  fpCommandNumberOfCloudPoints =
    new G4UIcmdWithAnInteger("/vis/viewer/set/numberOfCloudPoints", this);
  ...
  fpCommandPicking = new G4UIcmdWithABool("/vis/viewer/set/picking", this);
  fpCommandPicking->SetGuidance("Sets picking, if available.");
  fpCommandPicking->SetGuidance("If true, view is set up for picking, if available.");
  fpCommandPicking->SetGuidance("You may need to issue \"/vis/viewer/update\".");
  fpCommandPicking->SetGuidance("For required actions, watch for instructions for viewer.");
  ...
  fpCommandRotationStyle = new G4UIcmdWithAString("/vis/viewer/set/rotationStyle", this);
  fpCommandRotationStyle->SetGuidance(
    "Set style of rotation - constrainUpDirection or freeRotation.");
  fpCommandRotationStyle->SetGuidance("constrainUpDirection: conventional HEP view.");
  fpCommandRotationStyle->SetGuidance("freeRotation: Google-like rotation, using mouse-grab.");
  ...
  fpCommandSectionPlane->SetGuidance("Set plane for drawing section (DCUT).");
  ...
  fpCommandSpecialMeshRendering =
    new G4UIcmdWithABool("/vis/viewer/set/specialMeshRendering", this);
  ...
  fpCommandSpecialMeshRenderingOption =
    new G4UIcmdWithAString("/vis/viewer/set/specialMeshRenderingOption", this);
  ...
  fpCommandSpecialMeshVolumes = new G4UIcommand("/vis/viewer/set/specialMeshVolumes", this);
  ...
  parameter->SetGuidance("List of physical volume names and copy number pairs");
  fpCommandSpecialMeshVolumes->SetParameter(parameter);

  fpCommandStyle = new G4UIcmdWithAString("/vis/viewer/set/style", this);
  fpCommandStyle->SetGuidance("Set style of drawing - w[ireframe] or s[urface] or c[loud].");
  ...
  fpCommandTargetPoint = new G4UIcmdWith3VectorAndUnit("/vis/viewer/set/targetPoint", this);
  fpCommandTargetPoint->SetGuidance("Set target point.");
  ...
  fpCommandTransparencyByDepth = new G4UIcommand("/vis/viewer/set/transparencyByDepth", this);
  fpCommandTransparencyByDepth->SetGuidance("Set overall transparency by depth in geometry tree.");
  ...
  fpCommandUpThetaPhi = new G4UIcommand("/vis/viewer/set/upThetaPhi", this);
  fpCommandUpThetaPhi->SetGuidance("Set up vector.");
  fpCommandUpThetaPhi->SetGuidance("Viewer will attempt always to show this direction upwards.");
  parameter = new G4UIparameter("theta", 'd', omitable = true);
  ...
  fpCommandUpVector = new G4UIcommand("/vis/viewer/set/upVector", this);
  fpCommandUpVector->SetGuidance("Set up vector.");
  fpCommandUpVector->SetGuidance("Viewer will attempt always to show this direction upwards.");
  parameter = new G4UIparameter("x", 'd', omitable = true);
  parameter->SetDefaultValue(0.);
  ...
  fpCommandViewpointThetaPhi = new G4UIcommand("/vis/viewer/set/viewpointThetaPhi", this);
  fpCommandViewpointThetaPhi->SetGuidance("Set direction from target to camera.");
  ...
  fpCommandViewpointVector = new G4UIcommand("/vis/viewer/set/viewpointVector", this);
  fpCommandViewpointVector->SetGuidance("Set direction from target to camera.");
  ...
  fpCommandTimeWindowDisplayHeadTime->SetGuidance("Display head time of range in 2D text.");
  ...
  fpCommandTimeWindowDisplayLightFront->SetGuidance("Display the light front at head time.");
  ...
  fpCommandTimeWindowEndTime = new G4UIcommand("/vis/viewer/set/timeWindow/endTime", this);
  ...
  fpCommandTimeWindowFadeFactor->SetGuidance("0: no fade; 1: maximum fade with time window.");
  ...
  fpCommandTimeWindowStartTime = new G4UIcommand("/vis/viewer/set/timeWindow/startTime", this);
  ...
  fpCommandZoomToCursor->SetGuidance(
...
void G4VisCommandsViewerSet::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  if (!currentViewer)
  {
    ...
    {
      G4warn << "ERROR: G4VisCommandsViewerSet::SetNewValue: no current viewer." << G4endl;
    }
    return;
  }
  ...
  if (command == fpCommandAll)
  {
    ...
    if (!fromViewer)
    {
      if (verbosity >= G4VisManager::errors)
      {
        G4warn << "ERROR: G4VisCommandsViewerSet::SetNewValue: all:"
    ...
    if (fromViewer == currentViewer)
    {
      ...
      {
        G4warn << "WARNING: G4VisCommandsViewerSet::SetNewValue: all:"
    ...
    const std::vector<G4ModelingParameters::VisAttributesModifier>* privateVAMs =
    ...
    if (verbosity >= G4VisManager::warnings)
    {
      G4warn << "You may need \"/vis/viewer/rebuild\"." << G4endl;
    }
  }
  ...
  else if (command == fpCommandAutoRefresh)
  {
    ...
    const G4ViewParameters& defaultVP = currentViewer->GetDefaultViewParameters();
    if (autoRefresh && !defaultVP.IsAutoRefresh())
    {
      if (verbosity >= G4VisManager::warnings)
      {
        G4warn << "WARNING: " << currentViewer->GetName() << " is NOT auto-refesh by default"
               << "\n  so cannot be set to auto-refresh." << G4endl;
      }
      return;
    }
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      ...
      G4cout << "be automatically refreshed after a change of view parameters." << G4endl;
    }
    if (!vp.IsAutoRefresh())
    {
  ...
  else if (command == fpCommandBackground)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Background colour " << vp.GetBackgroundColour() << " requested." << G4endl;
    }
  }
  ...
  else if (command == fpCommandCulling)
  {
    ...
    if (cullingOption == "global")
    {
      ...
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << "G4VisCommandsViewerSet::SetNewValue: culling: global culling flag"
                  " set to "
               << G4UIcommand::ConvertToString(boolFlag)
               << ".\n  Does not change specific culling flags." << G4endl;
      }
    }
    else if (cullingOption == "coveredDaughters")
    {
      ...
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << "G4VisCommandsViewerSet::SetNewValue: culling: culling covered"
    ...
    else if (cullingOption == "invisible")
    {
      ...
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << "G4VisCommandsViewerSet::SetNewValue: culling: culling invisible"
                  "\n  flag set to "
    ...
    {
      const G4String where = "G4VisCommandsViewerSet::SetNewValue: culling: culling by density";
      if (boolFlag)
      {
      ...
      {  // Reset flag but density unchanged.
        vp.SetDensityCulling(boolFlag);
      }
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << where << "\n  flag set to " << std::boolalpha << vp.IsDensityCulling()
               << ".  Volumes with density less than " << G4BestUnit(density, "Volumic Mass")
               << "\n  will be culled, i.e., not drawn, if this flag is true." << G4endl;
      }
    }
    else
    {
      if (verbosity >= G4VisManager::errors)
      {
        G4warn << "ERROR: G4VisCommandsViewerSet::SetNewValue: culling:"
  ...
  {
    if (newValue == "add" || newValue == "union") vp.SetCutawayMode(G4ViewParameters::cutawayUnion);
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      ...
      if (vp.GetCutawayMode() == G4ViewParameters::cutawayUnion) G4cout << "cutawayUnion";
  ...
  else if (command == fpCommandDefaultColour)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Default colour " << vp.GetDefaultVisAttributes()->GetColour() << " requested."
             << G4endl;
    }
  }
  ...
  else if (command == fpCommandDefaultTextColour)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Default colour " << vp.GetDefaultTextVisAttributes()->GetColour() << " requested."
             << G4endl;
    }
  }
  ...
  else if (command == fpCommandEdge)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Drawing style of viewer \"" << currentViewer->GetName() << "\" set to "
             << vp.GetDrawingStyle() << G4endl;
    }
  }
  ...
  else if (command == fpCommandExplodeFactor)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Explode factor changed to " << vp.GetExplodeFactor() << " from centre "
             << vp.GetExplodeCentre() << G4endl;
    }
  }

  else if (command == fpCommandGlobalLineWidthScale)
  {
    G4double globalLineWidthScale = fpCommandGlobalLineWidthScale->GetNewDoubleValue(newValue);
    vp.SetGlobalLineWidthScale(globalLineWidthScale);
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Global Line Width Scale changed to " << vp.GetGlobalLineWidthScale() << G4endl;
    }
  }

  else if (command == fpCommandGlobalMarkerScale)
  {
    G4double globalMarkerScale = fpCommandGlobalMarkerScale->GetNewDoubleValue(newValue);
    vp.SetGlobalMarkerScale(globalMarkerScale);
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Global Marker Scale changed to " << vp.GetGlobalMarkerScale() << G4endl;
    }
  }
  ...
  else if (command == fpCommandLightsMove)
  {
    ...
    else
    {
      if (verbosity >= G4VisManager::errors)
      {
        G4warn << "ERROR: \"" << newValue
               << "\" not recognised."
                  "  Looking for \"cam\" or \"obj\" in string."
               << G4endl;
      }
    }
    if (verbosity >= G4VisManager::confirmations)
    {
      ...
      if (vp.GetLightsMoveWithCamera())
        ...
        G4cout << "object (the viewer appears to be moving).";
      G4cout << G4endl;
    }
  }
  ...
  else if (command == fpCommandLightsThetaPhi)
  {
    ...
    if (ConvertToDoublePair(newValue, theta, phi))
    {
      ...
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << "Lights direction set to " << vp.GetLightpointDirection() << G4endl;
      }
    }
  }
  ...
  else if (command == fpCommandLineSegments)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Number of line segments per circle in polygon approximation is " << nSides
             << G4endl;
    }
  }
  ...
  else if (command == fpCommandNumberOfCloudPoints)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Number of points to be used in cloud representation of volumes is " << nPoints
             << G4endl;
    }
  }
  ...
  else if (command == fpCommandPicking)
  {
    ...
    if (verbosity >= G4VisManager::warnings)
    {
      G4warn << "You may need to issue \"/vis/viewer/update\"." << G4endl;
    }
  }
  ...
  else if (command == fpCommandProjection)
  {
    ...
    {  // "perspective"
      ...
      if (fieldHalfAngle > 89.5 * deg || fieldHalfAngle <= 0.0)
      {
        if (verbosity >= G4VisManager::errors)
        {
          G4warn << "ERROR: Field half angle should be 0 < angle <= 89.5 degrees.";
          G4warn << G4endl;
        }
        return;
      }
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Projection style of viewer \"" << currentViewer->GetName() << "\" set to ";
      if (fieldHalfAngle == 0.)
      {
        G4cout << "orthogonal.";
      }
      ...
      {
        G4cout << "perspective\n  with half angle " << fieldHalfAngle / deg << " degrees.";
      }
      G4cout << G4endl;
    }
  }
  ...
  else if (command == fpCommandRotationStyle)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Rotation style of viewer \"" << currentViewer->GetName() << "\" set to "
             << vp.GetRotationStyle() << G4endl;
    }
  }
  ...
  else if (command == fpCommandSectionPlane)
  {
    ...
    G4int iSelector = -1;
    if (G4StrUtil::icompare(choice, "off") == 0 || !G4UIcommand::ConvertToBool(choice))
      iSelector = 0;
    if (G4StrUtil::icompare(choice, "on") == 0 || G4UIcommand::ConvertToBool(choice)) iSelector = 1;
    if (iSelector < 0)
    {
      if (verbosity >= G4VisManager::errors)
      {
  ...
  write_result:
    if (verbosity >= G4VisManager::confirmations)
    {
      ...
      if (vp.IsSection())
        ...
        G4cout << "off";
      G4cout << ".\nSection plane is now: " << vp.GetSectionPlane();
      G4cout << G4endl;
    }
  }
  ...
  else if (command == fpCommandSpecialMeshRendering)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      ...
      {
        G4cout << " requested. Current option is \"" << vp.GetSpecialMeshRenderingOption()
               << "\" for ";
  ...
  else if (command == fpCommandSpecialMeshRenderingOption)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Special mesh rendering option set to \"" << vp.GetSpecialMeshRenderingOption()
             << "\"." << G4endl;
    }
  }
  ...
  else if (command == fpCommandSpecialMeshVolumes)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      if (vp.GetSpecialMeshVolumes().empty())
      {
        G4cout << "Special mesh list empty, which means \"all meshes\"." << G4endl;
      }
      else
      {
  ...
  {
    G4ThreeVector targetPoint = fpCommandTargetPoint->GetNew3VectorValue(newValue);
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Target point set to "
             << fpCommandTargetPoint->ConvertToStringWithBestUnit(targetPoint)
             << "\n\"Current Target Point\" set to  "
             << fpCommandTargetPoint->ConvertToStringWithBestUnit(vp.GetCurrentTargetPoint())
             << "\n\"Standard Target Point\" is "
             << fpCommandTargetPoint->ConvertToStringWithBestUnit(standardTargetPoint) << G4endl;
    }
  }
  ...
  else if (command == fpCommandTransparencyByDepth)
  {
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Transparency by depth set to " << transparencyByDepth << " with option " << option
             << G4endl;
    }
  }
  ...
  else if (command == fpCommandViewpointThetaPhi)
  {
    ...
    if (ConvertToDoublePair(newValue, theta, phi))
    {
      ...
      if (verbosity >= G4VisManager::confirmations)
      {
        G4cout << "Viewpoint direction set to " << vp.GetViewpointDirection() << G4endl;
        if (vp.GetLightsMoveWithCamera())
        {
          G4cout << "Lightpoint direction set to " << vp.GetActualLightpointDirection() << G4endl;
        }
      }
    }
  }
  ...
  else if (command == fpCommandTimeWindowDisplayHeadTime)
  {
    ...
    std::istringstream iss(newValue);
    iss >> display >> screenX >> screenY >> screenSize >> red >> green >> blue;
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Display head time flag set: " << vp << G4endl;
    }
  }
  ...
  else if (command == fpCommandTimeWindowDisplayLightFront)
  {
    ...
    std::istringstream iss(newValue);
    iss >> display >> originX >> originY >> originZ >> unitS >> originT >> unitT >> red >> green
      >> blue;
    auto timeParameters = vp.GetTimeParameters();
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Display light front flag set: " << vp << G4endl;
    }
  }
  ...
  else if (command == fpCommandTimeWindowEndTime)
  {
    ...
    auto endTime =
      command->ConvertToDimensionedDouble(G4String(end_time_string + ' ' + end_time_unit));
    auto timeRange =
      command->ConvertToDimensionedDouble(G4String(time_range_string + ' ' + time_range_unit));
    auto timeParameters = vp.GetTimeParameters();
    ...
    if (verbosity >= G4VisManager::confirmations)
    {
      G4cout << "Time window start time: " << vp.GetTimeParameters().fStartTime / ns << " ns"
  ...
  else if (command == fpCommandTimeWindowStartTime)
  {
    ...
    auto startTime =
      command->ConvertToDimensionedDouble(G4String(start_time_string + ' ' + start_time_unit));
    auto timeRange =
      command->ConvertToDimensionedDouble(G4String(time_range_string + ' ' + time_range_unit));
    auto timeParameters = vp.GetTimeParameters();
  ...
  else
  {
    if (verbosity >= G4VisManager::errors)
    {
      G4warn << "ERROR: G4VisCommandsViewerSet::SetNewValue: unrecognised command." << G4endl;
    }
    return;
  }
