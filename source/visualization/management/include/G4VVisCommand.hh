...
class G4VVisCommand : public G4UImessenger
{
  ...
  protected:
    ...
    void InterpolateViews(G4VViewer* currentViewer, const std::vector<G4ViewParameters>& viewVector,
                          const G4int nInterpolationPoints = 50,
                          const G4int waitTimePerPointmilliseconds = 20,
                          const G4String& exportString = "");

    void InterpolateToNewView(G4VViewer* currentViewer, const G4ViewParameters& oldVP,
                              const G4ViewParameters& newVP, const G4int nInterpolationPoints = 50,
                              const G4int waitTimePerPointmilliseconds = 20,
                              const G4String& exportString = "");
    ...
    void ConvertToColour(G4Colour& colour, const G4String& redOrString, G4double green,
    ...
    G4bool ProvideValueOfUnit(const G4String& where, const G4String& unit, const G4String& category,
                              G4double& value);
