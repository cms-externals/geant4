...
class G4VisCommandSceneAddArrow2D : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Arrow2D
    {
        Arrow2D(G4double x1, G4double y1, G4double x2, G4double y2, G4double width,
...
class G4VisCommandSceneAddDate : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Date
    {
        Date(G4VisManager* vm, G4int size, G4double x, G4double y, G4Text::Layout layout,
             const G4String& date)
          : fpVisManager(vm), fSize(size), fX(x), fY(y), fLayout(layout), fDate(date)
        {}
...
class G4VisCommandSceneAddEventID : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct EventID
    {
        EventID(ForWhat w, G4VisManager* vm, G4int size, G4double x, G4double y,
                G4Text::Layout layout)
          : fForWhat(w), fpVisManager(vm), fSize(size), fX(x), fY(y), fLayout(layout)
        {}
        void operator()(G4VGraphicsScene&, const G4ModelingParameters*);
        ForWhat fForWhat;
        G4VisManager* fpVisManager;
...
class G4VisCommandSceneAddExtent : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Extent
    {
        Extent(G4double xmin, G4double xmax, G4double ymin, G4double ymax, G4double zmin,
               G4double zmax);
        void operator()(G4VGraphicsScene&, const G4ModelingParameters*);
        G4VisExtent fExtent;
    };
...
class G4VisCommandSceneAddGhosts : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneAddGhosts& operator=(const G4VisCommandSceneAddGhosts&);
    G4UIcmdWithAString* fpCommand;
};
...
class G4VisCommandSceneAddLine : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Line
    {
        Line(G4double x1, G4double y1, G4double z1, G4double x2, G4double y2, G4double z2,
...
class G4VisCommandSceneAddLine2D : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Line2D
    {
        Line2D(G4double x1, G4double y1, G4double x2, G4double y2, G4double width,
               const G4Colour& colour);
        void operator()(G4VGraphicsScene&, const G4ModelingParameters*);
        G4Polyline fPolyline;
        G4double fWidth;
...
class G4VisCommandSceneAddLogicalVolume : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneAddLogicalVolume& operator=(const G4VisCommandSceneAddLogicalVolume&);
    G4UIcommand* fpCommand;
};
  ...
  private:
    ...
    struct Logo2D
    {
        Logo2D(G4VisManager* vm, G4int size, G4double x, G4double y, G4Text::Layout layout)
          : fpVisManager(vm), fSize(size), fX(x), fY(y), fLayout(layout)
        {}
        void operator()(G4VGraphicsScene&, const G4ModelingParameters*);
        G4VisManager* fpVisManager;
        G4int fSize;
...
class G4VisCommandSceneAddScale : public G4VVisCommandScene
{
  ...
  private:
    ...
    struct Scale
    {
        ...
        Scale(const G4VisAttributes& visAttribs, G4double length, const G4Transform3D&,
...
class G4VisCommandSceneAddTrajectories : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneAddTrajectories& operator=(const G4VisCommandSceneAddTrajectories&);
    G4UIcmdWithAString* fpCommand;
};
...
class G4VisCommandSceneAddUserAction : public G4VVisCommandScene
{
  ...
  private:
    ...
    void AddVisAction(const G4String& name, G4VUserVisAction*, G4Scene*, ActionType,
