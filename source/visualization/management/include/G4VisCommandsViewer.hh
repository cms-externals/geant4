...
class G4VisCommandViewerClearVisAttributesModifiers : public G4VVisCommand
{
  ...
  private:
    ...
    G4VisCommandViewerClearVisAttributesModifiers(
      const G4VisCommandViewerClearVisAttributesModifiers&);
    G4VisCommandViewerClearVisAttributesModifiers&
    operator=(const G4VisCommandViewerClearVisAttributesModifiers&);
    G4UIcmdWithoutParameter* fpCommand;
};
...
class G4VisCommandViewerClone : public G4VVisCommand
{
  ...
  private:
    ...
    G4VisCommandViewerClone& operator=(const G4VisCommandViewerClone&);
    G4UIcommand* fpCommand;
};
...
class G4VisCommandViewerCopyViewFrom : public G4VVisCommand
{
  ...
  private:
    ...
    G4VisCommandViewerCopyViewFrom& operator=(const G4VisCommandViewerCopyViewFrom&);
    G4UIcmdWithAString* fpCommand;
};
...
class G4VisCommandViewerResetCameraParameters : public G4VVisCommand
{
  ...
  private:
    ...
    G4VisCommandViewerResetCameraParameters&
    operator=(const G4VisCommandViewerResetCameraParameters&);
    G4UIcmdWithAString* fpCommand;
};
