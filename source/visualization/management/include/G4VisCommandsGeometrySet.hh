...
class G4VisCommandGeometrySetColourFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetColourFunction() {}
    G4VisCommandGeometrySetColourFunction(const G4Colour& colour) : fColour(colour) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetColour(fColour); }
...
class G4VisCommandGeometrySetDaughtersInvisibleFunction : public G4VVisCommandGeometrySetFunction
{
  public:
...
class G4VisCommandGeometrySetForceAuxEdgeVisibleFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetForceAuxEdgeVisibleFunction() {}
    G4VisCommandGeometrySetForceAuxEdgeVisibleFunction(G4bool force) : fForce(force) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetForceAuxEdgeVisible(fForce); }
...
class G4VisCommandGeometrySetForceSolidFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetForceSolidFunction() {}
    G4VisCommandGeometrySetForceSolidFunction(G4bool force) : fForce(force) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetForceSolid(fForce); }
...
class G4VisCommandGeometrySetForceWireframeFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetForceWireframeFunction() {}
    G4VisCommandGeometrySetForceWireframeFunction(G4bool force) : fForce(force) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetForceWireframe(fForce); }
...
class G4VisCommandGeometrySetLineStyleFunction : public G4VVisCommandGeometrySetFunction
{
  public:
    ...
    {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetLineStyle(fLineStyle); }
...
class G4VisCommandGeometrySetLineWidthFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetLineWidthFunction() {}
    G4VisCommandGeometrySetLineWidthFunction(G4double lineWidth) : fLineWidth(lineWidth) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetLineWidth(fLineWidth); }
...
class G4VisCommandGeometrySetVisibilityFunction : public G4VVisCommandGeometrySetFunction
{
  public:

    virtual ~G4VisCommandGeometrySetVisibilityFunction() {}
    G4VisCommandGeometrySetVisibilityFunction(G4bool visibility) : fVisibility(visibility) {}
    void operator()(G4VisAttributes* visAtts) const { visAtts->SetVisibility(fVisibility); }
...
class G4VVisCommandGeometrySet : public G4VVisCommandGeometry
{
  protected:
    ...
    void SetLVVisAtts(G4LogicalVolume*, const G4VVisCommandGeometrySetFunction&, G4int depth,
                      G4int requestedDepth);
};
...
class G4VisCommandGeometrySetDaughtersInvisible : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetDaughtersInvisible&
    operator=(const G4VisCommandGeometrySetDaughtersInvisible&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetForceAuxEdgeVisible : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetForceAuxEdgeVisible&
    operator=(const G4VisCommandGeometrySetForceAuxEdgeVisible&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetForceCloud : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetForceCloud& operator=(const G4VisCommandGeometrySetForceCloud&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetForceSolid : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetForceSolid& operator=(const G4VisCommandGeometrySetForceSolid&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetForceLineSegmentsPerCircle : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetForceLineSegmentsPerCircle&
    operator=(const G4VisCommandGeometrySetForceLineSegmentsPerCircle&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetForceWireframe : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetForceWireframe& operator=(const G4VisCommandGeometrySetForceWireframe&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetLineStyle : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetLineStyle& operator=(const G4VisCommandGeometrySetLineStyle&);
    G4UIcommand* fpCommand;
};

class G4VisCommandGeometrySetLineWidth : public G4VVisCommandGeometrySet
{
  public:
  ...
  private:
    ...
    G4VisCommandGeometrySetLineWidth& operator=(const G4VisCommandGeometrySetLineWidth&);
    G4UIcommand* fpCommand;
};
