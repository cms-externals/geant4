...
class G4VisCommandSceneActivateModel : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneActivateModel& operator=(const G4VisCommandSceneActivateModel&);
...
class G4VisCommandSceneEndOfEventAction : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneEndOfEventAction& operator=(const G4VisCommandSceneEndOfEventAction&);
    G4UIcommand* fpCommand;
};
...
class G4VisCommandSceneEndOfRunAction : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneEndOfRunAction& operator=(const G4VisCommandSceneEndOfRunAction&);
    G4UIcmdWithAString* fpCommand;
};
...
class G4VisCommandSceneNotifyHandlers : public G4VVisCommandScene
{
  ...
  private:
    ...
    G4VisCommandSceneNotifyHandlers& operator=(const G4VisCommandSceneNotifyHandlers&);
    G4UIcommand* fpCommand;
};
