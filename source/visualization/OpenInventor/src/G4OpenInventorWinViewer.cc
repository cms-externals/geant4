...
class Geant4_SoWinExaminerViewer : public SoWinExaminerViewer
{
  public:
    ...
    {}
    virtual void sizeChanged(const SbVec2s& size) { SoWinExaminerViewer::sizeChanged(size); }
};
...
G4OpenInventorWinViewer::G4OpenInventorWinViewer(G4OpenInventorSceneHandler& sceneHandler,
                                                 const G4String& name)
  : G4OpenInventorViewer(sceneHandler, name), fShell(0), fViewer(0)
{
...
void G4OpenInventorWinViewer::Initialise()
{
  ...
  if (!parent)
  {
...

    {
      ...
      ::AppendMenu(casc, MF_STRING, ID_ETC_SET_REDUCED_WIRE_FRAME, "Set (G4) reduced wire frame");
      ::AppendMenu(casc, MF_STRING, ID_ETC_SET_FULL_WIRE_FRAME, "Set (G4) full wire frame");
      ::AppendMenu(casc, MF_STRING, ID_ETC_SET_PREVIEW, "Visible mothers + invisible daughters");
    ...
    fShell = ::CreateWindow(className, shellName.c_str(),
                            ...
                            CW_USEDEFAULT, CW_USEDEFAULT, width, height, 0, menuBar,
                            ::GetModuleHandle(0), 0);
...
//////////////////////////////////////////////////////////////////////////////
LRESULT CALLBACK G4OpenInventorWinViewer::WindowProc(HWND aWindow, UINT aMessage, WPARAM aWParam,
                                                     LPARAM aLParam)
//////////////////////////////////////////////////////////////////////////////
