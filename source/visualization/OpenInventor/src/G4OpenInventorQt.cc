...
G4OpenInventorQt::G4OpenInventorQt()
  : G4OpenInventor("OpenInventorQt", "OIQt", G4VGraphicsSystem::threeD), fInited(false)
{}
...
G4VViewer* G4OpenInventorQt::CreateViewer(G4VSceneHandler& scene, const G4String& name)
{
  ...
  if (pView)
  {
    ...
    {
      G4warn << "G4OpenInventorQt::CreateViewer: ERROR flagged by negative"
  ...
  if (!pView)
  {
    G4warn << "G4OpenInventorQt::CreateViewer: ERROR: null pointer on new G4OpenInventorQtViewer."
           << G4endl;
  }
