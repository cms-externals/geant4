...
G4OpenInventorXtExtendedViewer::G4OpenInventorXtExtendedViewer(
  ...
  : G4OpenInventorViewer(sceneHandler, name), fShell(0), fViewer(0), fHelpForm(0), fHelpText(0)
{
...
void G4OpenInventorXtExtendedViewer::Initialise()
{
  ...
  if (!parent)
  {
    ...
    if (sgeometry.empty())
    {
      G4cout << "ERROR: Geometry string \"" << sgeometry << "\" is empty.  Using \"600x600\"."
             << G4endl;
      width = 600;
      height = 600;
    ...
    fShell = XtAppCreateShell(shellName.c_str(), "Inventor", topLevelShellWidgetClass,
                              SoXt::getDisplay(), args, 3);
  ...
  fSoSelection->removeSelectionCallback(G4OpenInventorViewer::SelectionCB, this);
...
void G4OpenInventorXtExtendedViewer::SetView()
{
  ...
  fViewer->setBackgroundColor(SbColor((float)b.GetRed(), (float)b.GetGreen(), (float)b.GetBlue()));
}
...
Widget G4OpenInventorXtExtendedViewer::AddMenu(Widget aMenuBar, const G4String& aName,
                                               const G4String& aLabel)
{
  ...
  // Cascade button :
  Arg args[2];
  XmString cps = XmStringLtoRCreate((char*)aLabel.c_str(), (char*)XmSTRING_DEFAULT_CHARSET);
...
void G4OpenInventorXtExtendedViewer::AddButton(Widget aMenu, const G4String& aLabel,
...
void G4OpenInventorXtExtendedViewer::HelpCancelCbk(Widget, XtPointer aData, XtPointer)
{
...
void G4OpenInventorXtExtendedViewer::EscapeCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->Escape();
}
...
void G4OpenInventorXtExtendedViewer::PostScriptCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  // FWJ Workaround: avoids empty 2nd page in file
  SbBool superimpState = This->fViewer->getSuperimpositionEnabled(This->fViewer->superimposition);
  This->fViewer->setSuperimpositionEnabled(This->fViewer->superimposition, FALSE);
  This->WritePostScript();
  if (superimpState) This->fViewer->setSuperimpositionEnabled(This->fViewer->superimposition, TRUE);
}
void G4OpenInventorXtExtendedViewer::PDFCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  // FWJ Workaround: avoids empty 2nd page in file
  SbBool superimpState = This->fViewer->getSuperimpositionEnabled(This->fViewer->superimposition);
...
void G4OpenInventorXtExtendedViewer::PixmapPostScriptCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->WritePixmapPostScript();
}

void G4OpenInventorXtExtendedViewer::SceneGraphStatisticsCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SceneGraphStatistics();
}

void G4OpenInventorXtExtendedViewer::WriteInventorCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->WriteInventor();
}

void G4OpenInventorXtExtendedViewer::EraseDetectorCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->EraseDetector();
}

void G4OpenInventorXtExtendedViewer::EraseEventCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->EraseEvent();
}

void G4OpenInventorXtExtendedViewer::SetSolidCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetSolid();
}

void G4OpenInventorXtExtendedViewer::SetWireFrameCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetWireFrame();
}

void G4OpenInventorXtExtendedViewer::SetReducedWireFrameCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetReducedWireFrame(true);
}

void G4OpenInventorXtExtendedViewer::SetFullWireFrameCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetReducedWireFrame(false);
}

void G4OpenInventorXtExtendedViewer::UpdateSceneCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->UpdateScene();
}

void G4OpenInventorXtExtendedViewer::SetPreviewCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetPreview();
}

void G4OpenInventorXtExtendedViewer::SetPreviewAndFullCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
  This->SetPreviewAndFull();
}

void G4OpenInventorXtExtendedViewer::HelpCbk(Widget, XtPointer aData, XtPointer)
{
  G4OpenInventorXtExtendedViewer* This = (G4OpenInventorXtExtendedViewer*)aData;
