...
// Static initializer
G4OpenInventorXtExaminerViewerMessenger* G4OpenInventorXtExaminerViewerMessenger::fpInstance = 0;

G4OpenInventorXtExaminerViewerMessenger* G4OpenInventorXtExaminerViewerMessenger::GetInstance()
{
...
// Constructor
G4OpenInventorXtExaminerViewerMessenger::G4OpenInventorXtExaminerViewerMessenger()
{
  G4bool omitable;
...
void G4OpenInventorXtExaminerViewerMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  ...
  if (!pVViewer)
  {
    G4cout << "G4OpenInventorXtExaminerViewerMessenger::SetNewValue: "
              "No current viewer."
           << G4endl << "Use /vis/open, or similar, to get one." << G4endl;
    return;
  }

  G4OpenInventorXtExaminerViewer* pViewer = dynamic_cast<G4OpenInventorXtExaminerViewer*>(pVViewer);

  if (!pViewer)
  {
    G4cout << "G4OpenInventorXtExaminerViewerMessenger::SetNewValue:" << G4endl
  ...
  {
    G4int lookahead = fpCommandPathLookahead->GetNewIntValue(newValue);
