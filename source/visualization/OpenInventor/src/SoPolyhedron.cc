...
//////////////////////////////////////////////////////////////////////////////
Geant4_SoPolyhedron::Geant4_SoPolyhedron() : fPolyhedron(0)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
...
//////////////////////////////////////////////////////////////////////////////
Geant4_SoPolyhedron::Geant4_SoPolyhedron(const G4Polyhedron& aPolyhedron) : fPolyhedron(0)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  SO_NODE_CONSTRUCTOR(Geant4_SoPolyhedron);
...
//////////////////////////////////////////////////////////////////////////////
Geant4_SoPolyhedron::Geant4_SoPolyhedron(G4Polyhedron* aPolyhedron) : fPolyhedron(aPolyhedron)
//////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  SO_NODE_CONSTRUCTOR(Geant4_SoPolyhedron);
  ...
  shapeVertex(&pv);
    ...
    do
    {
      ...
      do
      {
        ...
        GEN_VERTEX(pv, vertex[0], vertex[1], vertex[2], 0.0, 0.0, unitNormal[0], unitNormal[1],
                   unitNormal[2]);
      } while (notLastEdge);
      endShape();
    } while (notLastFace);
    ...
    do
    {
      ...
      do
      {
        ...
        else
        {
          ...
          {
            if (edgeFlag > 0)
            {  // Pass to a visible edge :
              pvb.setNormal(normal);
              point.setValue(vertex[0], vertex[1], vertex[2]);
              pvb.setPoint(point);
            }
            else
            {  // Pass to an invisible edge :
