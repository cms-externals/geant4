...
// Public constructor
G4OpenInventorXtExaminerViewer::G4OpenInventorXtExaminerViewer(Widget parent, const char* name,
                                                               SbBool embed,
...
void G4OpenInventorXtExaminerViewer::constructor(const SbBool build)
{
  ...
  animateSensor = new SoTimerSensor(G4OpenInventorXtExaminerViewer::animateSensorCB, this);
  animateSensorRotation =
    new SoTimerSensor(G4OpenInventorXtExaminerViewer::animateSensorRotationCB, this);
  ...
  this->sscale = (SoScale*)this->getSuperimpositionNode(this->superimposition, "soxt->scale");
  this->stranslation =
    (SoTranslation*)this->getSuperimpositionNode(this->superimposition, "soxt->translation");
  this->sgeometry =
    (SoCoordinate3*)this->getSuperimpositionNode(this->superimposition, "soxt->geometry");
  this->axisSwitch =
    (SoSwitch*)this->getSuperimpositionNode(this->superimposition, "soxt->axisSwitch");
  this->animSpeedOutlineSwitch =
    (SoSwitch*)this->getSuperimpositionNode(this->superimposition, "soxt->animSpeedOutlineSwitch");
  this->animSpeedSwitch =
    (SoSwitch*)this->getSuperimpositionNode(this->superimposition, "soxt->animSpeedSwitch");
  this->curInfoSwitch =
    (SoSwitch*)this->getSuperimpositionNode(this->superimposition, "soxt->curInfoSwitch");
  this->curInfoTrans =
    (SoTranslation*)this->getSuperimpositionNode(this->superimposition, "soxt->curInfoTrans");
  this->curInfoFont =
    (SoFont*)this->getSuperimpositionNode(this->superimposition, "soxt->curInfoFont");
  this->curInfoText =
    (SoText2*)this->getSuperimpositionNode(this->superimposition, "soxt->curInfoText");
  this->mouseOverTransLogName = (SoTranslation*)this->getSuperimpositionNode(
    this->superimposition, "soxt->mouseOverTransLogName");
  this->mouseOverFontLogName =
    (SoFont*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverFontLogName");
  this->mouseOverTextLogName =
    (SoText2*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverTextLogName");
  this->mouseOverTransSolid = (SoTranslation*)this->getSuperimpositionNode(
    this->superimposition, "soxt->mouseOverTransSolid");
  this->mouseOverFontSolid =
    (SoFont*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverFontSolid");
  this->mouseOverTextSolid =
    (SoText2*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverTextSolid");
  this->mouseOverTransMaterial = (SoTranslation*)this->getSuperimpositionNode(
    this->superimposition, "soxt->mouseOverTransMaterial");
  this->mouseOverFontMaterial =
    (SoFont*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverFontMaterial");
  this->mouseOverTextMaterial =
    (SoText2*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverTextMaterial");
  this->mouseOverTransZPos =
    (SoTranslation*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverTransZPos");
  this->mouseOverFontZPos =
    (SoFont*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverFontZPos");
  this->mouseOverTextZPos =
    (SoText2*)this->getSuperimpositionNode(this->superimposition, "soxt->mouseOverTextZPos");

  SoCallback* cb =
    (SoCallback*)this->getSuperimpositionNode(this->superimposition, "soxt->callback");
...
SoNode* G4OpenInventorXtExaminerViewer::getSuperimpositionNode(SoNode* root, const char* name)
{
  if (!this->searcher) this->searcher = new SoSearchAction;
  searcher->reset();
...
void G4OpenInventorXtExaminerViewer::superimpositionCB(void* closure, SoAction* action)
{
  if (closure) ((G4OpenInventorXtExaminerViewer*)closure)->superimpositionEvent(action);
}
...
void G4OpenInventorXtExaminerViewer::superimpositionEvent(SoAction* action)
{
  ...
  SbViewportRegion vpRegion = ((SoGLRenderAction*)action)->getViewportRegion();
  ...
  float xInfo, yInfo, xMouseLogName, yMouseLogName, xMouseSolid, yMouseSolid, xMouseMaterial,
    yMouseMaterial, xMouseZPos, yMouseZPos;
  xInfo = -.45;
  yInfo = .45;
  xMouseLogName = 0.0;
  yMouseLogName = -.75;
  ...
  if (aspect > 1.0f)
  {
    ...
    this->mouseOverTransLogName->translation.setValue(SbVec3f(xMouseLogName, yMouseLogName, 0.0));
    this->mouseOverTransSolid->translation.setValue(SbVec3f(xMouseSolid, yMouseSolid, 0.0));
    this->mouseOverTransMaterial->translation.setValue(
      SbVec3f(xMouseMaterial, yMouseMaterial, 0.0));
    this->mouseOverTransZPos->translation.setValue(SbVec3f(xMouseZPos, yMouseZPos, 0.0));
  }
  else
  {
    yInfo /= aspect;
  ...
  else if (currentState == GENERAL)
  {  // Displaying longitudinal distance
...
Widget G4OpenInventorXtExaminerViewer::buildWidget(Widget parent)
{
  ...
  shell = XtParent(form);
  WM_DELETE_WINDOW = XInternAtom(XtDisplay(parent), "WM_DELETE_WINDOW", False);
  XmAddWMProtocolCallback(shell, WM_DELETE_WINDOW, (XtCallbackProc)closeMainWindowCB, this);
  ...
  XtManageChild(XmCreateSeparatorGadget(fileMenu, (char*)"Separator", NULL, 0));
...
void G4OpenInventorXtExaminerViewer::addButton(Widget menu, std::string name, XtCallbackProc cb)
{
...
void G4OpenInventorXtExaminerViewer::createViewerButtons(Widget parent, SbPList* buttonlist)
{
  int n;
  Arg args[6];
  ...
  Widget emptyButton = XtVaCreateManagedWidget("", xmPushButtonWidgetClass, parent, NULL);
  buttonlist->append(emptyButton);

  // Left arrow that goes back one view point on click
  n = 0;
  XtSetArg(args[n], XmNtopPosition, 1);
  n++;
  XtSetArg(args[n], XmNbottomPosition, 2);
  n++;
  ...
  n++;
  prevViewPtButton = XmCreateArrowButtonGadget(parent, (char*)"ArrowL", args, n);
  XtManageChild(prevViewPtButton);
  XtAddCallback(prevViewPtButton, XmNactivateCallback, G4OpenInventorXtExaminerViewer::prevViewPtCB,
                this);
  ...
  XtSetArg(args[n], XmNsensitive, False);
  n++;
  nextViewPtButton = XmCreateArrowButtonGadget(parent, (char*)"ArrowR", args, n);
  XtManageChild(nextViewPtButton);
  XtAddCallback(nextViewPtButton, XmNactivateCallback, G4OpenInventorXtExaminerViewer::nextViewPtCB,
                this);
  buttonlist->append(nextViewPtButton);

  // Save button for storing current camera parameters
  saveViewPtButton = XtVaCreateManagedWidget("Save", xmPushButtonWidgetClass, parent, NULL);
  XtAddCallback(saveViewPtButton, XmNactivateCallback, G4OpenInventorXtExaminerViewer::saveViewPtCB,
                this);
  Pixmap saveVP, saveVP_ins;
  saveVP = SoXtInternal::createPixmapFromXpm(saveViewPtButton, saveViewPt_xpm);
  saveVP_ins = SoXtInternal::createPixmapFromXpm(saveViewPtButton, saveViewPt_xpm, TRUE);
  XtVaSetValues(saveViewPtButton, XmNlabelType, XmPIXMAP, XmNlabelPixmap, saveVP, XmNselectPixmap,
                saveVP, XmNlabelInsensitivePixmap, saveVP_ins, XmNselectInsensitivePixmap,
                saveVP_ins, NULL);
  buttonlist->append(saveViewPtButton);

  // Toggle button to get abbreviated output
  abbrOutputButton =
    XtVaCreateManagedWidget("Abbr", xmToggleButtonWidgetClass, parent, XmNindicatorOn, False, NULL);
  ...
  pickextxpm = SoXtInternal::createPixmapFromXpm(abbrOutputButton, pickext_xpm);
  pickextxpm_ins = SoXtInternal::createPixmapFromXpm(abbrOutputButton, pickext_xpm, TRUE);
  XtVaSetValues(abbrOutputButton, XmNlabelType, XmPIXMAP, XmNlabelPixmap, pickextxpm,
                XmNselectPixmap, pickextxpm, XmNlabelInsensitivePixmap, pickextxpm_ins,
                XmNselectInsensitivePixmap, pickextxpm_ins, NULL);
  ...
  pickRefPathButton = XtVaCreateManagedWidget("Refpath", xmPushButtonWidgetClass, parent, NULL);
  ...
  pickrefxpm = SoXtInternal::createPixmapFromXpm(pickRefPathButton, pickref_xpm);
  pickrefxpm_ins = SoXtInternal::createPixmapFromXpm(pickRefPathButton, pickref_xpm, TRUE);
  XtVaSetValues(pickRefPathButton, XmNlabelType, XmPIXMAP, XmNlabelPixmap, pickrefxpm,
                XmNselectPixmap, pickrefxpm, XmNlabelInsensitivePixmap, pickrefxpm_ins,
                XmNselectInsensitivePixmap, pickrefxpm_ins, NULL);

  buttonlist->append(pickRefPathButton);

  // Toggle button for switching in and out of wireframe mode
  switchWireFrameButton = XtVaCreateManagedWidget("Wireframe", xmToggleButtonWidgetClass, parent,
                                                  XmNindicatorOn, False, NULL);
  ...
  wireframe = SoXtInternal::createPixmapFromXpm(switchWireFrameButton, wireframe_xpm);
  wireframe_ins = SoXtInternal::createPixmapFromXpm(switchWireFrameButton, wireframe_xpm, TRUE);
  XtVaSetValues(switchWireFrameButton, XmNlabelType, XmPIXMAP, XmNlabelPixmap, wireframe,
                XmNselectPixmap, wireframe, XmNlabelInsensitivePixmap, wireframe_ins,
                XmNselectInsensitivePixmap, wireframe_ins, NULL);
...
void G4OpenInventorXtExaminerViewer::afterRealizeHook()
{
  ...
  if (cam)
  {
    ...
    {
      defaultHeightAngle = ((SoPerspectiveCamera*)cam)->heightAngle.getValue();
      toggleCameraType();
      defaultHeight = ((SoOrthographicCamera*)cam)->height.getValue();
      toggleCameraType();
    }
    else
    {
  ...
  moCB->addEventCallback(SoLocation2Event::getClassTypeId(), mouseoverCB, static_cast<void*>(this));
  root->addChild(moCB);
  ...
  pickCB->addEventCallback(SoMouseButtonEvent::getClassTypeId(), pickingCB,
...
void G4OpenInventorXtExaminerViewer::pickingCB(void* aThis, SoEventCallback* eventCB)
{
    ...
    if (node->getTypeId() == SoLineSet::getClassTypeId())
    {
      ...
      else if (This->abbrOutputFlag)
      {
        ...
        if (attHolder && attHolder->GetAttDefs().size())
        {
          ...
          {
            G4cout << G4AttCheck(attHolder->GetAttValues()[i], attHolder->GetAttDefs()[i]);
            oss << G4AttCheck(attHolder->GetAttValues()[i], attHolder->GetAttDefs()[i]);
            if (oss.str().find(strTrajPoint) != std::string::npos)
            {
              ...
              {
                G4cout << G4AttCheck(attHolder->GetAttValues()[attHolder->GetAttDefs().size() - 1],
        ...
        else
        {
          ...
          G4cout << "SoNode : " << node << " SoType : " << cls << " name : " << name << G4endl;
...
void G4OpenInventorXtExaminerViewer::mouseoverCB(void* aThis, SoEventCallback* eventCB)
{
  ...
  if (pp != NULL)
  {
    ...
    if (node->getTypeId() == Geant4_SoPolyhedron::getClassTypeId())
    {
      ...
      if (attHolder && attHolder->GetAttDefs().size())
      {
        std::vector<const std::map<G4String, G4AttDef>*> vecDefs = attHolder->GetAttDefs();
        std::vector<const std::vector<G4AttValue>*> vecVals = attHolder->GetAttValues();
...
SbBool G4OpenInventorXtExaminerViewer::processSoEvent(const SoEvent* const ev)
{
      ...
      switch (me->getButton())
      {
        case SoMouseButtonEvent::BUTTON4:  // Scroll wheel up
          if (me->getState() == SoButtonEvent::DOWN)
          {
            if (cam->isOfType(SoPerspectiveCamera::getClassTypeId()))
            {
              float hAngle = ((SoPerspectiveCamera*)cam)->heightAngle.getValue();
              ((SoPerspectiveCamera*)cam)->heightAngle = hAngle + 0.01f;
              return TRUE;
            }
            else if (cam->isOfType(SoOrthographicCamera::getClassTypeId()))
            {
              float height = ((SoOrthographicCamera*)cam)->height.getValue();
        ...
        case SoMouseButtonEvent::BUTTON5:  // Scroll wheel down
          if (me->getState() == SoButtonEvent::DOWN)
          {
            ...
            {
              float hAngle = ((SoPerspectiveCamera*)cam)->heightAngle.getValue();
              if (hAngle > 0.01) ((SoPerspectiveCamera*)cam)->heightAngle = hAngle - 0.01f;
              return TRUE;
            }
            else if (cam->isOfType(SoOrthographicCamera::getClassTypeId()))
            {
              float height = ((SoOrthographicCamera*)cam)->height.getValue();
              if (height > 5) ((SoOrthographicCamera*)cam)->height = height - 5;
              return TRUE;
            }
          }
          break;
    ...
    if (SoKeyboardEvent::isKeyPressEvent(ev, ke->getKey()))
    {
      switch (ke->getKey())
      {
          ...
          else if (currentState == PAUSED_ANIMATION)
          {
            if (maxSpeed)
            {
              if ((beforePausing == ANIMATION
                   && refParticleIdx < (int)refParticleTrajectory.size() - 1)
                  || (beforePausing == REVERSED_ANIMATION && refParticleIdx > 0))
              {
        ...
        case SoKeyboardEvent::DELETE:
          if (viewPtList.size()
              && (currentState != ANIMATION && currentState != REVERSED_ANIMATION
                  && currentState != PAUSED_ANIMATION))
          {
        ...
        case SoKeyboardEvent::LEFT_ARROW:
          switch (currentState)
          {
            case BEAMLINE:
              ...
              {
                if (SoXtExaminerViewer::isAnimating()) stopAnimating();
            ...
            case VIEWPOINT:
              if ((!this->lshiftdown) && (!this->rshiftdown))
              {
                ...
                this->bottomWheelMotion(this->getBottomWheelValue() + 0.1f);
        ...
        case SoKeyboardEvent::PAGE_UP:
          switch (currentState)
          {
            ...
            case ANIMATION:
              ...
              if (maxSpeed > 0.8) maxSpeed = MAX_SPEED_INDICATOR;
              scheduleRedraw();
            ...
            case PAUSED_ANIMATION:
              ...
              {
                decSpeed();
                if (animateBtwPtsPeriod >= MIN_SPEED) beforePausing = ANIMATION;
              }
        ...
        case SoKeyboardEvent::PAGE_DOWN:
          switch (currentState)
          {
            ...
            case PAUSED_ANIMATION:
              ...
              {
                decSpeed();
                if (animateBtwPtsPeriod >= MIN_SPEED) beforePausing = REVERSED_ANIMATION;
              }
              scheduleRedraw();
              return TRUE;
            default:
  ...
  if (currentState == ANIMATION || currentState == REVERSED_ANIMATION || currentState == ROTATING)
    return FALSE;
  else
...
void G4OpenInventorXtExaminerViewer::incSpeed()
{
  ...
  if (currentState != PAUSED_ANIMATION)
  {
    ...
    if (refParticleIdx < lastIdx && !animateSensor->isScheduled()) animateRefParticle();
  }
}
...
void G4OpenInventorXtExaminerViewer::decSpeed()
{
  ...
  {
    if (std::floor(animateBtwPtsPeriod * 100) == 12)
    {  // Errors in double representation
      speedStep = 0.08;
    }
...
void G4OpenInventorXtExaminerViewer::updateSpeedIndicator(void)
{
  ...
  if (points[10][0] == 0.0f) this->animSpeedOutlineSwitch->whichChild.setValue(SO_SWITCH_ALL);
  if (points[14][0] == 0.0f) this->animSpeedSwitch->whichChild.setValue(SO_SWITCH_ALL);
...
void G4OpenInventorXtExaminerViewer::setReferencePath(SoLineSet* lineset, SoCoordinate3* coords,
                                                      bool append)
{
  ...
  if (!append) this->refParticleTrajectory.clear();
...
void G4OpenInventorXtExaminerViewer::setReferencePathZPos()
{
  ...
  {
    dist = (refParticleTrajectory[i] - refParticleTrajectory[i + 1]).length();
...
void G4OpenInventorXtExaminerViewer::findAndSetRefPath()
{
  ...
  if (pathList.getLength() != 0)
  {
    ...
    for (int i = 0; i < pathList.getLength(); ++i)
    {
      ...
      if (refPathFound) break;
    }

    if (coordvec.empty()) return;  // No track with a Coordinate3 node found
...
void G4OpenInventorXtExaminerViewer::distanceToTrajectory(const SbVec3f& q, float& dist,
                                                          SbVec3f& closestPoint, int& index)
{
...
{
  if (this->refParticleTrajectory.empty()) return;
  ...
  for (itEl = this->sceneElements.begin(), elementIndex = 0; itEl != this->sceneElements.end();
       ++itEl, ++elementIndex)
  {
...
{
  if (this->myElementList != NULL) XtUnmanageChild(this->myElementList);
  ...
  {
    ss << it->name;
    if (zcoordSetFlag) ss << " [" << it->closestPointZCoord << "]";
  ...
  labelRight = XmCreateLabelGadget(formTopRight, (char*)"Element [S mm]", args, n);
  ...
  n++;
  XtSetArg(args[n], XmNitemCount, size);
  n++;
  XtSetArg(args[n], XmNitems, elements);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, labelRight);
  n++;
...
void G4OpenInventorXtExaminerViewer::constructListsDialog(Widget w, XtPointer client_data,
                                                          XtPointer)
{
  ...
  {
    if (This->animateSensor->isScheduled()) This->animateSensor->unschedule();
  ...
  XmAddWMProtocolCallback(This->myShellDialog, WM_DELETE_WINDOW, (XtCallbackProc)closeListsDialogCB,
                          This);

  // Main Pane(listsDialog)
  n = 0;
  XtSetArg(args[n], XmNsashWidth, 1);
  n++;
  ...
  n++;
  // FWJ
  This->listsDialog = XmCreatePanedWindow(This->myShellDialog, (char*)"MainPane", args, n);
  ...
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
  n++;
  Widget formTopRight = XmCreateForm(formTop, (char*)"FormTopRight", args, n);
  ...
  n++;
  XtSetArg(args[n], XmNrightWidget, formTopRight);
  n++;
  ...
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  n++;
  Widget labelLeft = XmCreateLabelGadget(formTopLeft, (char*)"ViewPoints", args, n);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, labelLeft);
  n++;
  XtSetArg(args[n], XmNrightAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNrightWidget, This->myElementList);
  n++;
  XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM);
  n++;
  XtSetArg(args[n], XmNbottomAttachment, XmATTACH_FORM);
  ...
  This->myViewPtList = XmCreateScrolledList(formTopLeft, (char*)"ListLeft", args, n);
  if (This->viewPtList.size()) This->addViewPoints();
  XtAddCallback(This->myViewPtList, XmNbrowseSelectionCallback, (XtCallbackProc)loadBookmarkCB,
                This);
  ...
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, This->myViewPtList);
  n++;
  Widget label = XmCreateLabelGadget(formMiddle, (char*)"Selection", args, n);
  XtManageChild(label);
  ...
  n++;
  XtSetArg(args[n], XmNmaxLength, This->MAX_VP_NAME);
  n++;
  ...
  // Action Area Form
  n = 0;
  XtSetArg(args[n], XmNfractionBase, 4);
  n++;
  XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
  n++;
  XtSetArg(args[n], XmNtopWidget, This->viewPtSelection);
  n++;
  // FWJ fails compile
  ...
  XtVaSetValues(button, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, separator,
                XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION,
                XmNleftPosition, 0, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 1,
                XmNdefaultButtonShadowThickness, 2, XmNwidth, 40, XmNheight, 30, NULL);

  XtAddCallback(button, XmNactivateCallback, (XtCallbackProc)deleteBookmarkCB, This);
  XtManageChild(button);

  button = XmCreatePushButton(formAction, (char*)"Rename", NULL, 0);
  XtVaSetValues(button, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, separator,
                XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION,
                XmNleftPosition, 1, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 2,
                XmNdefaultButtonShadowThickness, 2, XmNwidth, 40, XmNheight, 30, NULL);

  XtAddCallback(button, XmNactivateCallback, (XtCallbackProc)renameBookmarkCB, This);
  XtManageChild(button);

  button = XmCreatePushButton(formAction, (char*)"Sort", NULL, 0);
  XtVaSetValues(button, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, separator,
                XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION,
                XmNleftPosition, 2, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 3,
                XmNdefaultButtonShadowThickness, 2, XmNwidth, 40, XmNheight, 30, NULL);
  ...
  XtVaSetValues(button, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, separator,
                XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_POSITION,
                XmNleftPosition, 3, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 4,
                XmNdefaultButtonShadowThickness, 2, XmNwidth, 40, XmNheight, 30, NULL);
...
void G4OpenInventorXtExaminerViewer::lookAtSceneElementCB(Widget, XtPointer client_data,
                                                          XtPointer call_data)
{
  char* value;
  ...
  if (This->SoXtExaminerViewer::isAnimating()) This->stopAnimating();

  XmListCallbackStruct* cbs = (XmListCallbackStruct*)call_data;

  value = (char*)XmStringUnparse(cbs->item, XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT, XmCHARSET_TEXT,
                                 NULL, 0, XmOUTPUT_ALL);
  ...
  if (error)
  {  // No counter is present => element name was not modified
  ...
  if ((idx > 0) && (path))
  {
    if (!This->refParticleTrajectory.empty())
    {
      ...
      if (This->currentState != BEAMLINE)
      {  // Set up default zoom
        SbVec3f p1, pN;
        This->currentState = BEAMLINE;
        This->prevParticleDir =
          SbVec3f(0, 0, 0);  // so that moveCamera() knows sets default parameters
...
void G4OpenInventorXtExaminerViewer::closeListsDialogCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::prevViewPtCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::nextViewPtCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::setViewPt()
{
  ...
  if (camera->isOfType(SoPerspectiveCamera::getClassTypeId()))
  {
    if (viewPtList[viewPtIdx].camType == ORTHOGRAPHIC)
    {
      toggleCameraType();
      camera = getCamera();
      ((SoOrthographicCamera*)camera)->height.setValue(viewPtList[viewPtIdx].height);
    }
    else
      ((SoPerspectiveCamera*)camera)->heightAngle.setValue(viewPtList[viewPtIdx].height);
  }
...
void G4OpenInventorXtExaminerViewer::saveViewPtCB(Widget w, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (This->fileName.empty())
  {
    ...
    return;  // Need to return and call this fn again from newViewPtFileCB since flow of control
             // does not stall here but keeps going
  }
  ...
  XtSetArg(args[n], XmNselectionLabelString, label);
  n++;
  // Prevent the dialog from closing automatically, in case the name is wrong
  XtSetArg(args[n], XmNautoUnmanage, False);
  n++;
  // FWJ
  XtSetArg(args[n], XmNtitle, "Save Bookmark");
  n++;
  nameViewPtDialog = XmCreatePromptDialog(parent, String("Save Bookmark"), args, n);

  XmStringFree(label);
  XtAddCallback(nameViewPtDialog, XmNokCallback, getViewPtNameCB, This);
  XtAddCallback(nameViewPtDialog, XmNcancelCallback, getViewPtNameCancelCB, This);
  ...
  std::string autoName = "";
  if (!This->warningFlag)
  {  // leave the TextField as it is if coming back from warning dialog
...
std::string G4OpenInventorXtExaminerViewer::viewPtAutoName()
{
  ...
  for (unsigned int i = 0; i < this->viewPtList.size(); ++i)
  {
    ...
    if (viewPt.find("viewpoint_") != std::string::npos)
    {
      ...
      if (tmp == 0)
      {
        ...
        if (!viewPt.compare("viewpoint_0")) existingViewPts.push_back(0);
      }
      else
  ...
  if (existingViewPts.size() > 0)
  {
    ...
    while (true)
    {
      if (std::find(existingViewPts.begin(), existingViewPts.end(), vpNum) == existingViewPts.end())
      {
...
void G4OpenInventorXtExaminerViewer::abbrOutputCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::pickRefPathCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;

  // Save viewing state and go to picking mode
  This->viewingBeforePickRef = This->isViewing();
  if (This->isViewing()) This->setViewing(false);
  This->setComponentCursor(SoXtCursor(SoXtCursor::CROSSHAIR));
  This->pickRefPathFlag = true;
}

void G4OpenInventorXtExaminerViewer::switchWireFrameCB(Widget w, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  else
  {
    ...
    This->setDrawStyle(SoXtViewer::INTERACTIVE, SoXtViewer::VIEW_SAME_AS_STILL);
  }
}

// Examines new viewpoint name and if OK calls saveViewPt.

void G4OpenInventorXtExaminerViewer::getViewPtNameCB(Widget w, XtPointer client_data,
                                                     XtPointer call_data)
{
  char* name = NULL;
  std::string strName;
  ...
  if (!nameExists)
  {
    ...
    if (This->viewPtIdx == -1) This->viewPtIdx = 0;
...
void G4OpenInventorXtExaminerViewer::getViewPtNameCancelCB(Widget w, XtPointer, XtPointer)
{
  XtUnmanageChild(w);
}
...
void G4OpenInventorXtExaminerViewer::deleteViewPtCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->deleteViewPt();
}
...
void G4OpenInventorXtExaminerViewer::deleteViewPt(char* vpName)
{
  ...
  if (!vpName) vpName = viewPtList[viewPtIdx].viewPtName;
  ...
  if (istat == -1)
  {
    ...
    warningMsgDialog("Error removing bookmarks file", dialogName, NULL);
  }
  istat = rename("temporaryFile.txt", fileName.c_str());
  if (istat == -1)
  {
    char dialogName[] = "Warning";
    warningMsgDialog("Error renaming bookmarks file", dialogName, NULL);
  }
  fileOut.open(fileName.c_str(), std::ios::in);
  fileOut.seekp(0, std::ios::end);
  ...
  {
    if (viewPtIdx >= (int)viewPtList.size()) viewPtIdx--;
    writeViewPtIdx();
    setViewPt();
  }
}
...
void G4OpenInventorXtExaminerViewer::sortViewPts(std::vector<std::string> sortedViewPts)
{
  ...
  while (sortIdx < size)
  {
    while (strcmp(sortedViewPts[sortIdx].c_str(), viewPtList[unsortIdx].viewPtName))
      unsortIdx++;
    ...
    fileOut << viewPtList[unsortIdx].camType << " " << viewPtList[unsortIdx].height << std::endl;
...
template<class T>
void G4OpenInventorXtExaminerViewer::parseString(T& t, const std::string& s, bool& error)
{
  std::istringstream str(s);
  if ((str >> t).fail()) error = true;
}

// Generic fileSelectionDialog creation.

void G4OpenInventorXtExaminerViewer::popUpFileSelDialog(Widget& dialog, std::string dialogName,
                                                        ...
                                                        XtCallbackProc cbOK)
{
  ...
  if (dialog == NULL)
  {
    ...
    n = 0;
    XtSetArg(args[n], XmNokLabelString, str);
    n++;
    XtSetArg(args[n], XmNresizePolicy, XmRESIZE_NONE);
    n++;

    dialog = XmCreateFileSelectionDialog(parent, (char*)dialogName.c_str(), args, n);
    ...
    if (scrollWidget) xmAddMouseEventHandler(scrollWidget);
...
void G4OpenInventorXtExaminerViewer::cancelFileSelDialogCB(Widget w, XtPointer, XtPointer)
{
  XtUnmanageChild(w);
}
...
void G4OpenInventorXtExaminerViewer::openViewPtFileCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->popUpFileSelDialog(This->openFileDialog, "Open File", "Load", viewPtFileSelectedCB);
}

void G4OpenInventorXtExaminerViewer::viewPtFileSelectedCB(Widget w, XtPointer client_data,
                                                          XtPointer call_data)
{
  char* file = NULL;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (cbs)
  {
    if (!(file = (char*)XmStringUnparse(cbs->value, XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT,
    ...
    if (!This->fileIn.fail())
    {
      ...
      else
      {
        ...
        std::string newDialogName = This->fileName.substr(This->fileName.rfind('/') + 1);
        XtVaSetValues(This->myShellDialog, XmNtitle, (char*)newDialogName.c_str(), NULL);
...
void G4OpenInventorXtExaminerViewer::warningMsgDialog(std::string msg, String dialogName,
                                                      XtCallbackProc cb)
{
  Arg args[5];
  unsigned int n;
  ...
  n = 0;
  XtSetArg(args[n], XmNmessageString, warningMsg);
  n++;
  Widget warningDialog = XmCreateWarningDialog(getParentWidget(), dialogName, args, n);
  if (cb) XtAddCallback(warningDialog, XmNokCallback, cb, this);
...
void G4OpenInventorXtExaminerViewer::newViewPtFileCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->popUpFileSelDialog(This->newFileDialog, "New File", "Save", createNewVPFileCB);
}

void G4OpenInventorXtExaminerViewer::createNewVPFileCB(Widget w, XtPointer client_data,
                                                       XtPointer call_data)
{
  char* file;
  std::string fName;
  ...
  if (cbs)
  {
    ...
    This->fileName = file;
    fName =
      This->fileName.substr(This->fileName.rfind('/') + 1);  // Extracts just the name of the file
    This->fileIn.open(file);
    if (This->fileIn.fail())
    {  // Filename does not exist
      ...
      XtSetSensitive(This->nextViewPtButton, False);
      XtSetSensitive(This->prevViewPtButton, False);
      if (This->listsDialog) closeListsDialogCB(w, This, NULL);
...
void G4OpenInventorXtExaminerViewer::overwriteFileCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->cleanUpAfterPrevFile();
  XtSetSensitive(This->nextViewPtButton, False);
...
void G4OpenInventorXtExaminerViewer::loadRefCoordsDialogCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->popUpFileSelDialog(This->loadRefCoordsDialog, "Load Ref Coords", "Load", loadRefCoordsCB);
}

void G4OpenInventorXtExaminerViewer::loadRefCoordsCB(Widget w, XtPointer client_data,
                                                     XtPointer call_data)
{
  char* file = NULL;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (cbs)
  {
    file = (char*)XmStringUnparse(cbs->value, XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT,
                                  XmCHARSET_TEXT, NULL, 0, XmOUTPUT_ALL);
...
void G4OpenInventorXtExaminerViewer::saveRefCoordsDialogCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (This->saveRefCoordsDialog == NULL)
  {
    ...
    This->saveRefCoordsDialog =
      XmCreateFileSelectionDialog(parent, (char*)"Save Ref Coords", args, n);
...
void G4OpenInventorXtExaminerViewer::saveRefCoordsCB(Widget w, XtPointer client_data,
                                                     XtPointer call_data)
{
  char* file;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (cbs)
  {
    ...
    if (ifile)
    {
      ...
      XtAddCallback(confirmOverwriteDialog, XmNcancelCallback, saveRefCoordsOverWriteCB,
                    client_data);
...
void G4OpenInventorXtExaminerViewer::saveRefCoordsOverWriteCB(Widget w, XtPointer client_data,
                                                              XtPointer call_data)
{
...
void G4OpenInventorXtExaminerViewer::loadSceneGraphDialogCB(Widget, XtPointer client_data,
                                                            XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->popUpFileSelDialog(This->loadSceneGraphDialog, "Load Scene Graph", "Load",
                           loadSceneGraphCB);
  return;
}

void G4OpenInventorXtExaminerViewer::loadSceneGraphCB(Widget w, XtPointer client_data,
                                                      XtPointer call_data)
{
  char* file = NULL;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::saveSceneGraphDialogCB(Widget, XtPointer client_data,
                                                            XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (This->saveSceneGraphDialog == NULL)
  {
    ...
    This->saveSceneGraphDialog =
      XmCreateFileSelectionDialog(parent, (char*)"Save Scene Graph", args, n);
...
void G4OpenInventorXtExaminerViewer::saveSceneGraphCB(Widget w, XtPointer client_data,
                                                      XtPointer call_data)
{
  char* file;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (cbs)
  {
    ...
    if (ifile)
    {
      ...
      XtAddCallback(confirmOverwriteDialog, XmNcancelCallback, saveSceneGraphOverWriteCB,
                    client_data);
...
void G4OpenInventorXtExaminerViewer::saveSceneGraphOverWriteCB(Widget w, XtPointer client_data,
                                                               XtPointer call_data)
{
  XmAnyCallbackStruct* cbs = (XmAnyCallbackStruct*)call_data;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::loadBookmarkCB(Widget, XtPointer client_data,
                                                    XtPointer call_data)
{
  char* vpName;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  vpName = (char*)XmStringUnparse(cbs->item, XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT, XmCHARSET_TEXT,
                                  NULL, 0, XmOUTPUT_ALL);
...
void G4OpenInventorXtExaminerViewer::deleteBookmarkCB(Widget, XtPointer client_data, XtPointer)
{
  char* vpName;
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
...
void G4OpenInventorXtExaminerViewer::renameBookmarkCB(Widget, XtPointer client_data, XtPointer)
{
  ...
  if (This->currentState == VIEWPOINT) This->scheduleRedraw();

  XmStringFree(vpNameXmStr);
  delete[] vpName1;
}

void G4OpenInventorXtExaminerViewer::sortBookmarksCB(Widget, XtPointer client_data, XtPointer)
{
  int size;
  char* vpName;
  ...
  if (This->viewPtList.size() < 2) return;

  // Get current entries from the list
  XtVaGetValues(This->myViewPtList, XmNitemCount, &size, XmNitems, &strList, NULL);

  for (int i = 0; i < size; i++)
  {
    vpName = (char*)XmStringUnparse(strList[i], XmFONTLIST_DEFAULT_TAG, XmCHARSET_TEXT,
                                    XmCHARSET_TEXT, NULL, 0, XmOUTPUT_ALL);
  ...
  for (int i = 0; i < size; i++)
  {
    ...
    if (!strcmp(charList[i].c_str(), This->curViewPtName)) This->viewPtIdx = i;
...
void G4OpenInventorXtExaminerViewer::closeMainWindowCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;

  if (This->openFileDialog) XtUnmanageChild(This->openFileDialog);

  if (This->newFileDialog) XtUnmanageChild(This->newFileDialog);

  if (This->listsDialog) closeListsDialogCB(NULL, This, NULL);
}
...
void G4OpenInventorXtExaminerViewer::saveCurCamera()
{
  ...
  if (cam->isOfType(SoPerspectiveCamera::getClassTypeId()))
  {
    camB4Animation.height = ((SoPerspectiveCamera*)cam)->heightAngle.getValue();
    camB4Animation.camType = PERSPECTIVE;
  }
  else if (cam->isOfType(SoOrthographicCamera::getClassTypeId()))
  {
    camB4Animation.height = ((SoOrthographicCamera*)cam)->height.getValue();
...
void G4OpenInventorXtExaminerViewer::restoreCamera()
{
  ...
  if (cam->isOfType(SoPerspectiveCamera::getClassTypeId()))
  {
    if (camB4Animation.camType == ORTHOGRAPHIC)
    {
      toggleCameraType();
      cam = getCamera();
      ((SoOrthographicCamera*)cam)->height.setValue(camB4Animation.height);
    }
    else
      ((SoPerspectiveCamera*)cam)->heightAngle.setValue(camB4Animation.height);
  }
  else if (cam->isOfType(SoOrthographicCamera::getClassTypeId()))
  {
...
void G4OpenInventorXtExaminerViewer::animateSensorRotationCB(void* data, SoSensor* sensor)
{
  ...
  float t = float((curTime - s->getBaseTime()).getValue()) / This->animateBtwPtsPeriod;

  if ((t > 1.0f) || (t + s->getInterval().getValue() > 1.0f)) t = 1.0f;
  SbBool end = (t == 1.0f);
...
void G4OpenInventorXtExaminerViewer::animateSensorCB(void* data, SoSensor* sensor)
{
  SbTime curTime = SbTime::getTimeOfDay();
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)data;
  SoCamera* cam = This->getCamera();
...
{
  G4OpenInventorXtExaminerViewer::gotoRefPathStartCB(NULL, (void*)this, NULL);
}

void G4OpenInventorXtExaminerViewer::gotoRefPathStartCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (This->currentState == ROTATING) return;
  if (This->currentState == ANIMATION || This->currentState == REVERSED_ANIMATION
      || This->currentState == PAUSED_ANIMATION)
  {
    if (This->animateSensor->isScheduled()) This->animateSensor->unschedule();
...
void G4OpenInventorXtExaminerViewer::invertRefPathCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  This->invertRefPath();
}
...
{
  std::reverse(this->refParticleTrajectory.begin(), this->refParticleTrajectory.end());
  this->setReferencePathZPos();
  this->sortElements();
}

void G4OpenInventorXtExaminerViewer::animateRefParticleCB(Widget, XtPointer client_data, XtPointer)
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)client_data;
  ...
  if (!This->refParticleTrajectory.size()) return;
...
void G4OpenInventorXtExaminerViewer::animateRefParticle()
{
  ...
  if (currentState != BEAMLINE) setStartingPtForAnimation();
...
void G4OpenInventorXtExaminerViewer::addEscapeCallback(void (*callback)(void*), void* object)
{
...
{
  G4OpenInventorXtExaminerViewer* This = (G4OpenInventorXtExaminerViewer*)userData;
  if (This->newEvents)
  {
