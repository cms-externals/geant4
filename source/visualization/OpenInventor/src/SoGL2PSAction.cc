...
{
  fFormat = TOOLS_GL2PS_SVG;
}
void SoGL2PSAction::setExportImageFormat_PGF()
{
  fFormat = TOOLS_GL2PS_PGF;
}
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  if (!openFile())
  {
    SoDebugError::post("SoGL2PSAction::enableFileWriting", "openFile() failed for fil %s",
                       fFileName.c_str());
    return false;
  }
#ifdef __COIN__
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
  ...
  tools_GLint res =
    ::tools_gl2psBeginPage(fContext, fTitle.c_str(), fProducer.c_str(), vp, fFormat, sort, options,
                           TOOLS_GL_RGBA, 0, NULL, 0, 0, 0, bufferSize, fFile, fFileName.c_str());
...
//////////////////////////////////////////////////////////////////////////////
bool SoGL2PSAction::addBitmap(int aWidth, int aHeight, float aXorig, float aYorig, float aXmove,
                              float aYmove)
/////////////////////////////////////////////////////////////////////////////
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
{
