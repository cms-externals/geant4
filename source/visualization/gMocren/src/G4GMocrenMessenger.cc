    ...
    kDrawVolumeGrid(false)
{
  ...
  */
  ...
  kSetgMocrenScoringMeshNameCommand =
    new G4UIcmdWithAString("/vis/gMocren/setScoringMeshName", this);
  kSetgMocrenScoringMeshNameCommand->SetGuidance(
  ...
  kAddgMocrenHitScorerNameCommand->SetGuidance(
  ...
  kResetgMocrenHitScorerNameCommand =
    new G4UIcmdWithoutParameter("/vis/gMocren/resetHitScorerName", this);
