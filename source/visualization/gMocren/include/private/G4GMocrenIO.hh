...
class GMocrenTrack
{
  ...
  public:
    ...
    void addStep(float _startx, float _starty, float _startz, float _endx, float _endy,
                 float _endz);
    void getStep(float& _startx, float& _starty, float& _startz, float& _endx, float& _endy,
                 float& _endz, int _num);
...
class GMocrenDetector
{
  ...
  public:
    ...
    void addEdge(float _startx, float _starty, float _startz, float _endx, float _endy,
                 float _endz);
    void getEdge(float& _startx, float& _starty, float& _startz, float& _endx, float& _endy,
                 float& _endz, int _num);
...
class G4GMocrenIO
{
  ...
  public:
    ...
    void getDetector(int _num, std::vector<float*>& _edges, std::vector<unsigned char*>& _color,
