...
//_____________________________________________________________________________
G4bool G4H2ToolsManager::List(std::ostream& output, G4bool onlyIfAcive)
{
  return G4THnManager<tools::histo::h2d>::List(output, onlyIfAcive);
}
