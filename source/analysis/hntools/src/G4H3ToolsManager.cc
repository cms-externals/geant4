...
//_____________________________________________________________________________
G4bool G4H3ToolsManager::List(std::ostream& output, G4bool onlyIfAcive)
{
  return G4THnManager<tools::histo::h3d>::List(output, onlyIfAcive);
}
