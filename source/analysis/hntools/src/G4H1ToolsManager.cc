...
//_____________________________________________________________________________
G4bool G4H1ToolsManager::List(std::ostream& output, G4bool onlyIfAcive)
{
  return G4THnManager<tools::histo::h1d>::List(output, onlyIfAcive);
}
