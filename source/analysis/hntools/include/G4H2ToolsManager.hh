                         ...
                         public G4THnManager<tools::histo::h2d>
{
  public:
    ...
    ~G4H2ToolsManager() override = default;
  ...
  protected:
    ...
    G4bool ScaleH2(G4int id, G4double factor) final;

    // Method to fill histograms
    //
    G4bool FillH2(G4int id, G4double xvalue, G4double yvalue, G4double weight = 1.0) final;

    // Methods to manipulate histograms
    //

    // Access methods
    G4int GetH2Id(const G4String& name, G4bool warn = true) const final;

    // Access to H2 parameters
    G4int GetH2Nxbins(G4int id) const final;
    G4double GetH2Xmin(G4int id) const final;
    G4double GetH2Xmax(G4int id) const final;
    G4double GetH2XWidth(G4int id) const final;
    G4int GetH2Nybins(G4int id) const final;
    G4double GetH2Ymin(G4int id) const final;
    G4double GetH2Ymax(G4int id) const final;
    G4double GetH2YWidth(G4int id) const final;

    // Setters for attributes for plotting
    G4bool SetH2Title(G4int id, const G4String& title) final;
    G4bool SetH2XAxisTitle(G4int id, const G4String& title) final;
    G4bool SetH2YAxisTitle(G4int id, const G4String& title) final;
    G4bool SetH2ZAxisTitle(G4int id, const G4String& title) final;

    // Access attributes for plotting
    G4String GetH2Title(G4int id) const final;
    G4String GetH2XAxisTitle(G4int id) const final;
    G4String GetH2YAxisTitle(G4int id) const final;
    G4String GetH2ZAxisTitle(G4int id) const final;
