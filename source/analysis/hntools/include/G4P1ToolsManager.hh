                         ...
                         public G4THnManager<tools::histo::p1d>
{
  public:
    ...
    ~G4P1ToolsManager() override = default;
  ...
  protected:
    ...
    G4bool SetP1(G4int id,
                 ...
                 const G4String& yfcnName = "none") final;
    // clang-format on
    G4bool ScaleP1(G4int id, G4double factor) final;

    // Method to fill profiles
    //
    G4bool FillP1(G4int id, G4double xvalue, G4double yvalue, G4double weight = 1.0) final;

    // Access methods
    //
    G4int GetP1Id(const G4String& name, G4bool warn = true) const final;

    // Access to P1 parameters
    G4int GetP1Nbins(G4int id) const final;
    G4double GetP1Xmin(G4int id) const final;
    G4double GetP1Xmax(G4int id) const final;
    G4double GetP1XWidth(G4int id) const final;
    G4double GetP1Ymin(G4int id) const final;
    G4double GetP1Ymax(G4int id) const final;

    // Attributes for plotting
    //

    // Setters
    G4bool SetP1Title(G4int id, const G4String& title) final;
    G4bool SetP1XAxisTitle(G4int id, const G4String& title) final;
    G4bool SetP1YAxisTitle(G4int id, const G4String& title) final;

    // Accessors
    G4String GetP1Title(G4int id) const final;
    G4String GetP1XAxisTitle(G4int id) const final;
    G4String GetP1YAxisTitle(G4int id) const final;
