...
#ifndef G4TOOLSANALYSISREADER_HH
#define G4TOOLSANALYSISREADER_HH
...
class G4ToolsAnalysisReader : public G4VAnalysisReader
{
  ...
  protected:
    ...
    G4int ReadTImpl(const G4String& htName, const G4String& fileName, const G4String& dirName,
                    G4bool isUserFileName, G4THnManager<HT>* htManager);
