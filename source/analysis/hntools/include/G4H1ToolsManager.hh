                         ...
                         public G4THnManager<tools::histo::h1d>
{
  public:
    ...
    ~G4H1ToolsManager() override = default;
  ...
  protected:
    ...
    G4bool SetH1(G4int id,
                 ...
                 const G4String& fcnName = "none") final;
    // clang-format on
    G4bool ScaleH1(G4int id, G4double factor) final;

    // Method to fill histograms
    //
    G4bool FillH1(G4int id, G4double value, G4double weight = 1.0) final;

    // Access methods
    //
    G4int GetH1Id(const G4String& name, G4bool warn = true) const final;

    // Access to H1 parameters
    G4int GetH1Nbins(G4int id) const final;
    G4double GetH1Xmin(G4int id) const final;
    G4double GetH1Xmax(G4int id) const final;
    G4double GetH1Width(G4int id) const final;

    // Attributes for plotting
    //

    // Setters
    G4bool SetH1Title(G4int id, const G4String& title) final;
    G4bool SetH1XAxisTitle(G4int id, const G4String& title) final;
    G4bool SetH1YAxisTitle(G4int id, const G4String& title) final;

    // Accessors
    G4String GetH1Title(G4int id) const final;
    G4String GetH1XAxisTitle(G4int id) const final;
    G4String GetH1YAxisTitle(G4int id) const final;
