                         ...
                         public G4THnManager<tools::histo::p2d>
{
  public:
    ...
    ~G4P2ToolsManager() override = default;
  ...
  protected:
    ...
    G4bool ScaleP2(G4int id, G4double factor) final;
    ...
    // Access methods
    G4int GetP2Id(const G4String& name, G4bool warn = true) const final;

    // Access to P2 parameters
    G4int GetP2Nxbins(G4int id) const final;
    G4double GetP2Xmin(G4int id) const final;
    G4double GetP2Xmax(G4int id) const final;
    G4double GetP2XWidth(G4int id) const final;
    G4int GetP2Nybins(G4int id) const final;
    G4double GetP2Ymin(G4int id) const final;
    G4double GetP2Ymax(G4int id) const final;
    G4double GetP2YWidth(G4int id) const final;
    G4double GetP2Zmin(G4int id) const final;
    G4double GetP2Zmax(G4int id) const final;

    // Setters for attributes for plotting
    G4bool SetP2Title(G4int id, const G4String& title) final;
    G4bool SetP2XAxisTitle(G4int id, const G4String& title) final;
    G4bool SetP2YAxisTitle(G4int id, const G4String& title) final;
    G4bool SetP2ZAxisTitle(G4int id, const G4String& title) final;

    // Access attributes for plotting
    G4String GetP2Title(G4int id) const final;
    G4String GetP2XAxisTitle(G4int id) const final;
    G4String GetP2YAxisTitle(G4int id) const final;
    G4String GetP2ZAxisTitle(G4int id) const final;
