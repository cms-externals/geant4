...
{
  G4Analysis::Warn("Ntuple merging is not available with " + outputType + " output.\n"
                     + "Setting is ignored.",
...
void G4VAnalysisManager::SetDefaultFileTypeImpl(const G4String& value)
{
  if ((!GetType().empty()) && (GetFileType() != value))
  {
    ...
    Warn("Cannot set default file type " + value + " different than the analysis manager type "
           + GetType(),
         fkClass, "SetDefault");
    return;
  }
...
G4bool G4VAnalysisManager::WriteAscii(const G4String& fileName)
{
  ...
  if (!output)
  {
    Warn("Cannot open file. File name is not defined.", fkClass, "WriteAscii");
    return false;
  }
...
std::shared_ptr<G4VFileManager> G4VAnalysisManager::GetFileManager(const G4String& fileName)
{
  ...
  {
    Warn("The file extension differs from " + GetFileType() + " output type.\n" + GetFileType()
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateH1(const G4String& name, const G4String& title, G4int nbins,
                                   G4double xmin, G4double xmax, const G4String& unitName,
                                   const G4String& fcnName, const G4String& binSchemeName)
{
  std::array<G4HnDimension, kDim1> bins = {{G4HnDimension(nbins, xmin, xmax)}};
...
G4int G4VAnalysisManager::CreateH1(const G4String& name, const G4String& title,
                                   const std::vector<G4double>& edges, const G4String& unitName,
                                   const G4String& fcnName)
{
  std::array<G4HnDimension, kDim1> bins = {{G4HnDimension(edges)}};
  std::array<G4HnDimensionInformation, kDim1> info = {
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateH2(const G4String& name, const G4String& title, G4int nxbins,
                                   G4double xmin, G4double xmax, G4int nybins, G4double ymin,
                                   G4double ymax, const G4String& xunitName,
                                   const G4String& yunitName, const G4String& xfcnName,
                                   const G4String& yfcnName, const G4String& xbinSchemeName,
                                   const G4String& ybinSchemeName)

{
  std::array<G4HnDimension, kDim2> bins = {
    {G4HnDimension(nxbins, xmin, xmax), G4HnDimension(nybins, ymin, ymax)}};
...
G4int G4VAnalysisManager::CreateH2(const G4String& name, const G4String& title,
                                   ...
                                   const std::vector<G4double>& yedges, const G4String& xunitName,
                                   const G4String& yunitName, const G4String& xfcnName,
                                   const G4String& yfcnName)

{
  std::array<G4HnDimension, kDim2> bins = {{G4HnDimension(xedges), G4HnDimension(yedges)}};
  std::array<G4HnDimensionInformation, kDim2> info = {
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateH3(const G4String& name, const G4String& title, G4int nxbins,
                                   G4double xmin, G4double xmax, G4int nybins, G4double ymin,
                                   G4double ymax, G4int nzbins, G4double zmin, G4double zmax,
                                   const G4String& xunitName, const G4String& yunitName,
                                   const G4String& zunitName, const G4String& xfcnName,
                                   const G4String& yfcnName, const G4String& zfcnName,
                                   const G4String& xbinSchemeName, const G4String& ybinSchemeName,
                                   const G4String& zbinSchemeName)

{
  std::array<G4HnDimension, kDim3> bins = {{G4HnDimension(nxbins, xmin, xmax),
...
G4int G4VAnalysisManager::CreateH3(const G4String& name, const G4String& title,
                                   ...
                                   const std::vector<G4double>& zedges, const G4String& xunitName,
                                   const G4String& yunitName, const G4String& zunitName,
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH1(G4int id, G4int nbins, G4double xmin, G4double xmax,
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH1(G4int id, const std::vector<G4double>& edges,
                                 const G4String& unitName, const G4String& fcnName)
{
  std::array<G4HnDimension, kDim1> bins = {{G4HnDimension(edges)}};
  std::array<G4HnDimensionInformation, kDim1> info = {
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH2(G4int id, G4int nxbins, G4double xmin, G4double xmax, G4int nybins,
                                 G4double ymin, G4double ymax, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& xfcnName,
                                 const G4String& yfcnName, const G4String& xbinSchemeName,
                                 const G4String& ybinSchemeName)
{
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH2(G4int id, const std::vector<G4double>& xedges,
                                 const std::vector<G4double>& yedges, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& xfcnName,
                                 const G4String& yfcnName)
{
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH3(G4int id, G4int nxbins, G4double xmin, G4double xmax, G4int nybins,
                                 G4double ymin, G4double ymax, G4int nzbins, G4double zmin,
                                 G4double zmax, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& zunitName,
                                 const G4String& xfcnName, const G4String& yfcnName,
                                 const G4String& zfcnName, const G4String& xbinSchemeName,
                                 const G4String& ybinSchemeName, const G4String& zbinSchemeName)
{
  std::array<G4HnDimension, kDim3> bins = {{G4HnDimension(nxbins, xmin, xmax),
                                            G4HnDimension(nybins, ymin, ymax),
                                            G4HnDimension(nzbins, zmin, zmax)}};
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetH3(G4int id, const std::vector<G4double>& xedges,
                                 const std::vector<G4double>& yedges,
                                 const std::vector<G4double>& zedges, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& zunitName,
                                 const G4String& xfcnName, const G4String& yfcnName,
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateP1(const G4String& name, const G4String& title, G4int nbins,
...
{
  std::array<G4HnDimension, kDim2> bins = {
    {G4HnDimension(nbins, xmin, xmax), G4HnDimension(0, ymin, ymax)}};
  std::array<G4HnDimensionInformation, kDim2> info = {
    {G4HnDimensionInformation(xunitName, xfcnName, xbinSchemeName),
...
G4int G4VAnalysisManager::CreateP1(const G4String& name, const G4String& title,
                                   const std::vector<G4double>& edges, G4double ymin, G4double ymax,
                                   const G4String& xunitName, const G4String& yunitName,
                                   const G4String& xfcnName, const G4String& yfcnName)
{
  std::array<G4HnDimension, kDim2> bins = {{G4HnDimension(edges), G4HnDimension(0, ymin, ymax)}};
  std::array<G4HnDimensionInformation, kDim2> info = {
    {G4HnDimensionInformation(xunitName, xfcnName), G4HnDimensionInformation(yunitName, yfcnName)}};

  return fVP1Manager->Create(name, title, bins, info);
}

//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateP2(const G4String& name, const G4String& title, G4int nxbins,
                                   G4double xmin, G4double xmax, G4int nybins, G4double ymin,
...
G4int G4VAnalysisManager::CreateP2(const G4String& name, const G4String& title,
                                   const std::vector<G4double>& xedges,
                                   const std::vector<G4double>& yedges, G4double zmin,
                                   G4double zmax, const G4String& xunitName,
                                   const G4String& yunitName, const G4String& zunitName,
                                   const G4String& xfcnName, const G4String& yfcnName,
                                   const G4String& zfcnName)
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetP1(G4int id, G4int nbins, G4double xmin, G4double xmax, G4double ymin,
                                 G4double ymax, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& xfcnName,
                                 const G4String& yfcnName, const G4String& xbinSchemeName)
{
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetP1(G4int id, const std::vector<G4double>& edges, G4double ymin,
                                 G4double ymax, const G4String& xunitName,
                                 const G4String& yunitName, const G4String& xfcnName,
                                 const G4String& yfcnName)
{
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetP2(G4int id, G4int nxbins, G4double xmin, G4double xmax, G4int nybins,
                                 G4double ymin, G4double ymax, G4double zmin, G4double zmax,
                                 const G4String& xunitName, const G4String& yunitName,
                                 const G4String& zunitName, const G4String& xfcnName,
                                 const G4String& yfcnName, const G4String& zfcnName,
                                 const G4String& xbinSchemeName, const G4String& ybinSchemeName)
...
//_____________________________________________________________________________
G4bool G4VAnalysisManager::SetP2(G4int id, const std::vector<G4double>& xedges,
                                 const std::vector<G4double>& yedges, G4double zmin, G4double zmax,
                                 const G4String& xunitName, const G4String& yunitName,
                                 const G4String& zunitName, const G4String& xfcnName,
                                 const G4String& yfcnName, const G4String& zfcnName)
{
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtuple(const G4String& name, const G4String& title)
{
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtupleIColumn(const G4String& name, std::vector<int>& vector)
{
  return fNtupleBookingManager->CreateNtupleIColumn(name, &vector);
}

//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtupleFColumn(const G4String& name, std::vector<float>& vector)
{
  return fNtupleBookingManager->CreateNtupleFColumn(name, &vector);
}

//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtupleDColumn(const G4String& name, std::vector<double>& vector)
{
...
//_____________________________________________________________________________
void G4VAnalysisManager::SetNtupleMerging(G4bool /*mergeNtuples*/, G4int /*nofReducedNtupleFiles*/)
{
...
//_____________________________________________________________________________
void G4VAnalysisManager::SetNtupleRowWise(G4bool /*rowWise*/, G4bool /*rowMode*/)
{
  // The function is overridden in the managers which supports ntuple merging
  // Here we give just a warning that the feature is not available.
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtupleIColumn(G4int ntupleId, const G4String& name)
{
...
//_____________________________________________________________________________
G4int G4VAnalysisManager::CreateNtupleSColumn(G4int ntupleId, const G4String& name)
{
...
G4bool G4VAnalysisManager::IsActive() const
{
  ...
  return fState.GetIsActivation()
         && (fH1HnManager->IsActive() || fH2HnManager->IsActive() || fH3HnManager->IsActive()
             || fP1HnManager->IsActive() || fP2HnManager->IsActive());
}
...
G4bool G4VAnalysisManager::IsAscii() const
{
  ...
  return (fH1HnManager->IsAscii() || fH2HnManager->IsAscii() || fH3HnManager->IsAscii()
          || fP1HnManager->IsAscii() || fP2HnManager->IsAscii());
}
...
G4bool G4VAnalysisManager::IsPlotting() const
{
  ...
  return (fH1HnManager->IsPlotting() || fH2HnManager->IsPlotting() || fH3HnManager->IsPlotting()
          || fP1HnManager->IsPlotting() || fP2HnManager->IsPlotting());
}
