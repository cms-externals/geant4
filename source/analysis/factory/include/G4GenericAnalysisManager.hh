...
class G4GenericAnalysisManager : public  G4ToolsAnalysisManager
{
  ...
  public:
    ...
    G4bool WriteH1(const G4String& fileName, G4int id = -1);
    // G4bool WriteH2(const G4String fileName, G4int id = -1);
    // G4bool WriteH3(const G4String fileName, G4int id = -1);
    // G4bool WriteP1(const G4String fileName, G4int id = -1);
    // G4bool WriteP2(const G4String fileName, G4int id = -1);
