...
class G4RootFileManager : public G4VTFileManager<G4RootFile>
{
  public:
    ...
    virtual G4String GetType() const final { return "Root"; }
    ...
    std::shared_ptr<G4RootFile> GetNtupleFile(G4int index) const;
  ...
  private:
    ...
    G4bool WriteNtupleFile(std::shared_ptr<tools::wroot::file> rfile, 
                           const G4String& fileName);
    G4bool CloseNtupleFile(std::shared_ptr<tools::wroot::file> rfile, 
                           const G4String& fileName);
...
//_____________________________________________________________________________
inline std::shared_ptr<G4RootFile> G4RootFileManager::GetFile() const
{ return fFile; }
