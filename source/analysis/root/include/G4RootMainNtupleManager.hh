...
#ifndef G4ROOTMAINNTUPLEMANAGER_HH
#define G4ROOTMAINNTUPLEMANAGER_HH
...
class G4RootMainNtupleManager : public G4BaseAnalysisManager
{
  ...
  public:
    ...
    G4RootMainNtupleManager(G4RootNtupleManager* ntupleBuilder,
                            std::shared_ptr<G4NtupleBookingManager> bookingManager, G4bool rowWise,
                            G4int fileNumber, const G4AnalysisManagerState& state);
  ...
  protected:
    ...
    // Access functions
    const std::vector<tools::wroot::ntuple*>& GetNtupleVector() { return fNtupleVector; }
...
inline void G4RootMainNtupleManager::SetFileManager(std::shared_ptr<G4RootFileManager> fileManager)
{
