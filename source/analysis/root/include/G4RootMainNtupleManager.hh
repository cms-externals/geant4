...
class G4RootMainNtupleManager : public G4BaseAnalysisManager
{
  ...
  protected:
    ...
    // Set/get methods
    void SetNtupleFile(std::shared_ptr<G4RootFile> rfile);
    void SetRowWise(G4bool rowWise);
    std::shared_ptr<G4RootFile> GetNtupleFile() const;

    // Access functions
    const std::vector<NtupleDescriptionType*>& GetNtupleDescriptionVector() 
      { return fNtupleBuilder->GetNtupleDescriptionVector(); }
    const std::vector<G4NtupleBooking*>& GetNtupleBookingVector() 
      { return fBookingManager->GetNtupleBookingVector(); }
...
inline void G4RootMainNtupleManager::SetNtupleFile(std::shared_ptr<G4RootFile> rfile) 
{ fNtupleFile = rfile; }

inline void G4RootMainNtupleManager::SetRowWise(G4bool rowWise)
{ fRowWise = rowWise; }

inline std::shared_ptr<G4RootFile> G4RootMainNtupleManager::GetNtupleFile() const 
{ return fNtupleFile; }
