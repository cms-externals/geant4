...
G4RootFileManager::CreateDirectory(tools::wroot::file* rfile, const G4String& directoryName,
                                   [[maybe_unused]] const G4String& objectType) const
{
...
G4String G4RootFileManager::GetNtupleFileName(RootNtupleDescription* ntupleDescription,
                                              G4bool perThread, G4int mainNumber) const
{
  ...
  {
    // update filename per mainNumber
    ntupleFileName = G4Analysis::GetNtupleFileName(ntupleFileName, GetFileType(), mainNumber);
  }
...
G4RootFileManager::CreateNtupleFile(RootNtupleDescription* ntupleDescription, G4int mainNumber)
{
...
//_____________________________________________________________________________
std::shared_ptr<G4RootFile>
G4RootFileManager::GetNtupleFile(RootNtupleDescription* ntupleDescription, G4bool perThread,
