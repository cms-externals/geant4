...
void G4gspos(G4String vname, G4int num, G4String vmoth, G4double x, G4double y, G4double z,
             G4int irot, G4String vonly)
{
  // find VTEs
  ...
  else
  {
    ...
    else
    {
      ...
      G4CreateCloneVTE(vte, mvte, vte->GetRpar(), vte->GetNpar(), num, x, y, z, irot, vonly);
    }
  }
}
