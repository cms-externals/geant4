...
void G4gsdvt2(G4String vname, G4String vmoth, G4double step, G4int iaxis, G4double c0, G4int numed,
              G4int ndvmx)
{
  // find mother VTE
  ...
  else
  {
    ...
    G4CreateCloneVTEWithDivision(vname, mvte, kDvt2, ndvmx, iaxis, numed, c0, step);
  }
}
