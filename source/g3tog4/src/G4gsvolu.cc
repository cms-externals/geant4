                             ...
                             G4int npar)
{
  ...
  G4bool deferred;
  G4bool okAxis[3];
  G4VSolid* solid = G3toG4MakeSolid(vname, shape, rpar, npar, hasNegPars, deferred, okAxis);
  ...
  // create VTE
  G3VolTableEntry* vte = new G3VolTableEntry(vname, shape, rpar, npar, nmed, solid, hasNegPars);
  G3Vol.PutVTE(vte);
