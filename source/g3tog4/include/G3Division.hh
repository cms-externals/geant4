...
class G3Division
{
  public:  // with description
    ...
    G3Division(G3DivType type, G3VolTableEntry* vte, G3VolTableEntry* mvte, G4int nofDivision,
  ...
  private:
    ...
    G3VolTableEntry* CreateEnvelope(G4String shape, G4double hi, G4double lo, G4double par[],
                                    G4int npar);
    G3VolTableEntry* Dvn();
