...
{
  // p, n, pi+, pi-
  static const std::vector<G4int> sLightHadrons = {2212, 2112, 211, -211};
...
const std::vector<G4int>& G4HadParticles::GetHyperons()
{
  ...
  static const std::vector<G4int> sHyperons = {3122, 3222, 3112, 3322, 3312, 3334};
  return sHyperons;
}
...
const std::vector<G4int>& G4HadParticles::GetAntiHyperons()
{
  ...
  static const std::vector<G4int> sAntiHyperons = {-3122, -3222, -3112, -3322, -3312, -3334};
...
{
  // K+, K-, KS, KL
  static const std::vector<G4int> sKaons = {321, -321, 310, 130};
  return sKaons;
}
...
const std::vector<G4int>& G4HadParticles::GetBCHadrons()
{
  ...
  static const std::vector<G4int> sBCHadrons = {// D+, D0, D-, D0bar, Ds+, Ds-
                                                ...
                                                -4122, -4232, -4132, -4332, -5122, -5232, -5132,
                                                -5332};
  return sBCHadrons;
}
...
{
  // d, t, He3, alpha
  static const std::vector<G4int> sLightIons = {1000010020, 1000010030, 1000020030, 1000020040};
  return sLightIons;
}
...
const std::vector<G4int>& G4HadParticles::GetLightAntiIons()
{
  ...
  static const std::vector<G4int> sLightAntiIons = {-2212,       -2112,       -1000010020,
...
const std::vector<G4int>& G4HadParticles::GetHyperNuclei()
{
  ...
  static const std::vector<G4int> sHyperNuclei = {1010010030, 1010010040, 1010020040,
                                                  1010020050, 1020000040, 1020010040};
  return sHyperNuclei;
}
...
{
  // anti-hyper-nuclei
  static const std::vector<G4int> sHyperAntiNuclei = {-1010010030, -1010010040, -1010020040,
                                                      -1010020050, -1020000040, -1020010040};
...
{
  static const std::vector<G4int> sBCChargedHadrons = {// D+, D-, Ds+, Ds-
                                                       411, -411, 431, -431,
                                                       // B+, B-, Bc+, Bc-,
                                                       521, -521, 541, -541,
