...
void G4EmExtraPhysics::SetNuOscDistanceBias(G4double bf)
{
...
void G4EmExtraPhysics::SetNuOscDistanceName(const G4String& dn)
{
...
void G4EmExtraPhysics::ConstructProcess()
{
  ...
  if( fNuActivated )
  {
    ...
    G4NuVacOscProcess* theNuVacOscProcess = new
      G4NuVacOscProcess(fNuOscDistanceName);

    if(fNuOscDistanceBias != 1.)
    {
      theNuVacOscProcess->SetBiasingFactor(fNuOscDistanceBias);
    }

    ph->RegisterProcess(theNuVacOscProcess, anuelectron);
    ph->RegisterProcess(theNuVacOscProcess, nuelectron);
    ph->RegisterProcess(theNuVacOscProcess, anumuon);
    ph->RegisterProcess(theNuVacOscProcess, numuon);
    ph->RegisterProcess(theNuVacOscProcess, anutau);
    ph->RegisterProcess(theNuVacOscProcess, nutau);
