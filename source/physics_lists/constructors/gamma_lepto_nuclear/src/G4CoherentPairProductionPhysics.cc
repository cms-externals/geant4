...
void G4CoherentPairProductionPhysics::ConstructProcess()
{
  ...
  else
  {
    ...
    G4ChannelingFastSimModel* Channeling = static_cast<G4ChannelingFastSimModel*>(
      RegionCh->GetFastSimulationManager()->GetFastSimulationModel(fNameChannelingModel, 0,
                                                                   someflag));
  ...
  {
    gammaProcess->ActivateIncoherentScattering();
  }
