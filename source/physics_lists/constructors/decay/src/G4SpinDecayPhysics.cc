...
G4SpinDecayPhysics::G4SpinDecayPhysics(G4int verb) : G4SpinDecayPhysics("SpinDecay", verb) {}

G4SpinDecayPhysics::G4SpinDecayPhysics(const G4String& name, G4int) : G4VPhysicsConstructor(name)
{
