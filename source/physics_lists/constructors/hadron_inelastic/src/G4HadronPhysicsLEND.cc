...
void G4HadronPhysicsLEND::ConstructProcess()
{
  ...
  auto* neutron_inelastic =
    (G4HadronInelasticProcess*)G4PhysListUtil::FindInelasticProcess(G4Neutron::Neutron());
  auto* neutron_capture =
    (G4NeutronCaptureProcess*)G4PhysListUtil::FindCaptureProcess(G4Neutron::Neutron());
  auto* neutron_fission =
    (G4NeutronFissionProcess*)G4PhysListUtil::FindFissionProcess(G4Neutron::Neutron());
  ...
  auto* gamma_inelastic =
    (G4HadronInelasticProcess*)G4PhysListUtil::FindInelasticProcess(G4Gamma::Gamma());
  ...
  if (gamma_inelastic == nullptr)
  {
    ...
    if (gproc != nullptr)
    {
      ...
      if (gnuc != nullptr) gamma_inelastic = (G4HadronInelasticProcess*)gnuc;
    }
  }
  ...
  auto* theGammaReactionLowE =
    new G4LENDCombinedModel(G4Gamma::Gamma());  // use combined LEND models
