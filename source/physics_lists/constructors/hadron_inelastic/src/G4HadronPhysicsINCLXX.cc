...
G4HadronPhysicsINCLXX::G4HadronPhysicsINCLXX(const G4String& name, const G4bool quasiElastic,
                                             const G4bool neutronHP, const G4bool ftfp)
  : G4HadronPhysicsFTFP_BERT(name, quasiElastic), withNeutronHP(neutronHP), withFTFP(ftfp)
{
