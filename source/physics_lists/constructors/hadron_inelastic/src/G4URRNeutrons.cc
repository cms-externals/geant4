...
void G4URRNeutrons::ConstructProcess()
{
  ...
  for (G4int index = 0; index < niElastic; ++index)
  {
    ...
    else if ((elasticProcess->GetHadronicInteractionList())[index]->GetModelName()
  ...
  if (indexHPelastic >= 0)
  {
    ...
    G4cout << G4endl << " G4URRNeutrons::ConstructProcess() : found NeutronHPElastic => Disabled !"
           << G4endl;
  }
  else
  {
  ...
  for (G4int index = 0; index < niCapture; ++index)
  {
    ...
    G4String nameNeutronCaptureModel =
      (captureProcess->GetHadronicInteractionList())[index]->GetModelName();
    if (nameNeutronCaptureModel == "NeutronHPCapture" || nameNeutronCaptureModel == "nRadCaptureHP"
  ...
  else
  {
    G4cout << "### " << GetPhysicsName()
           << " WARNING: NOT found any expected neutron capture model => G4URRNeutrons returns "
  ...
  for (G4int index = 0; index < niFission; ++index)
  {
    ...
    G4String nameNeutronFissionModel =
      (fissionProcess->GetHadronicInteractionList())[index]->GetModelName();
  ...
  if (indexHPfission >= 0)
  {
    ...
    G4cout
      << G4endl << " G4URRNeutrons::ConstructProcess() : found "
  ...
  {
    G4cout << "### " << GetPhysicsName()
           << " WARNING: NOT found any expected neutron fission model => G4URRNeutrons returns "
              "without doing anything !"
           << G4endl;
    return;
  }
  ...
  {
    if ((inelasticProcess->GetHadronicInteractionList())[index]->GetModelName()
        == "NeutronHPInelastic")
    {
  ...
  {
    (inelasticProcess->GetHadronicInteractionList())[indexHPinelastic]->SetMaxEnergy(
      0.0);  // Disabled
    G4cout << G4endl
