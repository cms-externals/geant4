...
//----------------------------------------------------------------------------
//
#ifndef G4HADRONPHYSICSSHIELDING_HH
#define G4HADRONPHYSICSSHIELDING_HH
...
class G4HadronPhysicsShielding : public G4HadronPhysicsFTFP_BERT
{
  public:
    ...
    explicit G4HadronPhysicsShielding(const G4String& name, G4int verbose, G4double minFTFPEnergy,
