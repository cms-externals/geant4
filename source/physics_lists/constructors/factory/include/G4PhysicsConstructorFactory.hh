...
// ********************************************************************
//
#ifndef G4PHYSICSCONSTRUCTORFACTORY_HH
#define G4PHYSICSCONSTRUCTORFACTORY_HH
...
template<typename T>
class G4PhysicsConstructorFactory : public G4VBasePhysConstrFactory
{
  public:
    ...
    virtual G4VPhysicsConstructor* Instantiate() { return new T(); }
};

#define G4_DECLARE_PHYSCONSTR_FACTORY(physics_constructor)                               \
  const G4PhysicsConstructorFactory<physics_constructor>& physics_constructor##Factory = \
    G4PhysicsConstructorFactory<physics_constructor>(#physics_constructor)
...
#define G4_DECLARE_PHYSCONSTR_FACTORY_NS(physics_constructor, nsname, pcbase) \
  namespace nsname                                                            \
  {                                                                           \
  const G4PhysicsConstructorFactory<physics_constructor>& pcbase##Factory =   \
    G4PhysicsConstructorFactory<physics_constructor>(#physics_constructor);   \
  }                                                                           \
...
#define G4_REFERENCE_PHYSCONSTR_FACTORY(physics_constructor)                                   \
  ...
  const G4PhysicsConstructorFactory<physics_constructor>&                                      \
    physics_constructor##FactoryRef##REGREF = physics_constructor##Factory
...
#define G4_REFERENCE_PHYSCONSTR_FACTORY_NS(physics_constructor, nsname, pcbase)        \
  ...
  const G4PhysicsConstructorFactory<physics_constructor>& pcbase##FactoryRef##REGREF = \
    pcbase##Factory;                                                                   \
  }                                                                                    \
  typedef int xyzzy__LINE__
// eat trailing semicolon using silly typedef
