...
G4IonPhysicsPHP::G4IonPhysicsPHP(G4int ver) : G4IonPhysicsPHP("ionInelasticFTFP_BIC_PHP", ver) {}
...
void G4IonPhysicsPHP::ConstructProcess()
{
  ...
  AddProcess("dInelastic", G4Deuteron::Deuteron(), theDeuteronHPInelasticData, modelDeuteronPHP,
             theIonBC2, theFTFP, theNuclNuclData);
  AddProcess("tInelastic", G4Triton::Triton(), theTritonHPInelasticData, modelTritonPHP, theIonBC2,
             theFTFP, theNuclNuclData);
  AddProcess("He3Inelastic", G4He3::He3(), theHe3HPInelasticData, modelHe3PHP, theIonBC2, theFTFP,
             theNuclNuclData);
  AddProcess("alphaInelastic", G4Alpha::Alpha(), theAlphaHPInelasticData, modelAlphaPHP, theIonBC2,
             theFTFP, theNuclNuclData);
  AddProcess("ionInelastic", G4GenericIon::GenericIon(), nullptr, nullptr, theIonBC1, theFTFP,
             theNuclNuclData);
...
void G4IonPhysicsPHP::AddProcess(const G4String& name, G4ParticleDefinition* part,
                                 ...
                                 G4HadronicInteraction* aBIC, G4HadronicInteraction* aFTFP,
