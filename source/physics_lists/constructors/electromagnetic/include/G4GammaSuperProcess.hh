...
// ********************************************************************
//
// $Id: G4GammaSuperProcess.hh 109146 2018-03-30 20:06:18Z vnivanch $
//
// -------------------------------------------------------------------
//
...
#ifndef G4GammaSuperProcess_h
#define G4GammaSuperProcess_h 1
...
class G4GammaSuperProcess : public G4VEmProcess
{
public:

  explicit G4GammaSuperProcess();

  virtual ~G4GammaSuperProcess();
...
public:
  ...
  // implementation of virtual method, specific for G4GammaSuperProcess
...
private:
  ...
  inline G4double ComputeSuperLambda(size_t idxe, size_t idxt, 
  ...
  G4GammaSuperProcess(G4GammaSuperProcess &) = delete;
  G4GammaSuperProcess & operator=(const G4GammaSuperProcess &right) = delete;
...
inline G4double
G4GammaSuperProcess::ComputeSuperLambda(size_t idxe, size_t idxt, 
				        size_t& idx, G4double e)
{
  idxEnergy = idxe;
...
inline G4double G4GammaSuperProcess::GetProbability(size_t idxt, size_t& idx)
{
...
G4GammaSuperProcess::SampleSecondaries(const G4Track& track, const G4Step& step,
				       G4VEmProcess* proc)
{
