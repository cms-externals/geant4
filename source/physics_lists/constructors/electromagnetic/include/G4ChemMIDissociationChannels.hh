...
#ifndef G4CHEMIDISSOCIATIONCHANNELS_HH
#define G4CHEMIDISSOCIATIONCHANNELS_HH

class G4ChemMIDissociationChannels
{
  public:

    G4ChemMIDissociationChannels() = default;
    ~G4ChemMIDissociationChannels() = default;
    static void ConstructDissociationChannels();
};

#endif  // G4CHEMIDISSOCIATIONCHANNELS_HH
