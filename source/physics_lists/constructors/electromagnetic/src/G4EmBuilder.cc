...
{
  if(G4EmParameters::Instance()->TransportationWithMsc()) {
    ...
    if(removed->GetProcessName() != "Transportation") {
      G4Exception("G4EmBuilder::ConstructElectronMscProcess", "em0050",
                  FatalException, "replaced process is not G4Transportation!");
    }
