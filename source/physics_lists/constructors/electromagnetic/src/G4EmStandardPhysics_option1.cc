...
// ********************************************************************
//
// $Id: G4EmStandardPhysics_option1.cc 111451 2018-08-10 07:58:19Z gcosmo $
//
//---------------------------------------------------------------------------
//
  ...
  : G4VPhysicsConstructor("G4EmStandard_opt1"), verbose(ver)
{
  ...
  param->SetSuperProcessActive(true);
...
void G4EmStandardPhysics_option1::ConstructProcess()
{
  ...
  for(const auto& particleName : partList.PartNames()) {
    ...
    if (particleName == "gamma") {
      ...
      if(G4EmParameters::Instance()->SuperProcessActive()) {
        G4GammaSuperProcess* sp = new G4GammaSuperProcess();
        sp->AddEmProcess(pee);
        sp->AddEmProcess(new G4ComptonScattering());
        sp->AddEmProcess(new G4GammaConversion());
        man->SetGammaSuperProcess(sp);
