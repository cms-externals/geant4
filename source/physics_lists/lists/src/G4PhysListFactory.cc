  ...
  : defName("FTFP_BERT"), verbose(ver), theMessenger(nullptr)
{
  ...
  nlists_em = 12;
  G4String s1[12] = {"",     "_EMV", "_EMX", "_EMY", "_EMZ", "_LIV",
                     "_PEN", "__GS", "__SS", "_EM0", "_WVI", "__LE"};
...
G4VModularPhysicsList* G4PhysListFactory::GetReferencePhysList(const G4String& name)
{
  ...
  if (0 < verbose)
  {
    G4cout << "G4PhysListFactory::GetReferencePhysList <" << had_name << em_name << ">" << G4endl;
  }
  ...
  else if (had_name == "LBE")
  {
    p = new LBE();
  }
  else if (had_name == "QBBC")
  {
    p = new QBBC(verbose);
  }
  else if (had_name == "QGSP_BERT")
  {
    p = new QGSP_BERT(verbose);
  }
  else if (had_name == "QGSP_BERT_HP")
  {
    p = new QGSP_BERT_HP(verbose);
  }
  else if (had_name == "QGSP_BIC")
  {
    p = new QGSP_BIC(verbose);
  }
  else if (had_name == "QGSP_BIC_HP")
  {
    p = new QGSP_BIC_HP(verbose);
  }
  else if (had_name == "QGSP_BIC_AllHP")
  {
    p = new QGSP_BIC_AllHP(verbose);
  }
  else if (had_name == "QGSP_FTFP_BERT")
  {
    p = new QGSP_FTFP_BERT(verbose);
  }
  else if (had_name == "QGSP_INCLXX")
  {
    p = new QGSP_INCLXX(verbose);
  }
  else if (had_name == "QGSP_INCLXX_HP")
  {
    p = new QGSP_INCLXX_HP(verbose);
  }
  else if (had_name == "QGS_BIC")
  {
    p = new QGS_BIC(verbose);
  }
  else if (had_name == "Shielding")
  {
    p = new Shielding(verbose);
  }
  else if (had_name == "ShieldingLEND")
  {
    p = new ShieldingLEND(verbose);
  }
  else if (had_name == "ShieldingLIQMD")
  {
    p = new Shielding(verbose, "HP", "", true);
  }
  else if (had_name == "ShieldingM")
  {
    p = new Shielding(verbose, "HP", "M");
  }
  else if (had_name == "NuBeam")
  {
    p = new NuBeam(verbose);
  }
  else if (had_name == "Shielding_HP")
  {
    p = new Shielding(verbose);
  }
  else if (had_name == "ShieldingLIQMD_HP")
  {
    p = new Shielding(verbose, "HP", "", true);
  }
  else if (had_name == "ShieldingM_HP")
  {
    p = new Shielding(verbose, "HP", "M");
  }
  else if (had_name == "FTFP_BERT_HPT")
  {
    p = new FTFP_BERT_HP(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "FTFP_INCLXX_HPT")
  {
    p = new FTFP_INCLXX_HP(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "QGSP_BERT_HPT")
  {
    p = new QGSP_BERT_HP(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "QGSP_BIC_HPT")
  {
    p = new QGSP_BIC_HPT(verbose);
  }
  else if (had_name == "QGSP_BIC_AllHPT")
  {
    p = new QGSP_BIC_AllHP(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "QGSP_INCLXX_HPT")
  {
    p = new QGSP_INCLXX_HP(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "Shielding_HPT")
  {
    p = new Shielding(verbose);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "ShieldingLIQMD_HPT")
  {
    p = new Shielding(verbose, "HP", "", true);
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
  else if (had_name == "ShieldingM_HPT")
  {
    p = new Shielding(verbose, "HP", "M");
    p->RegisterPhysics(new G4ThermalNeutrons);
  }
