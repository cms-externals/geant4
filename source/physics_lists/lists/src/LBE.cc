...
void LBE::AddTransportation()
{
  ...
  while ((*(myParticleIterator))())
  {
    ...
    if (particleName == "neutron") pmanager->AddDiscreteProcess(new G4MaxTimeCuts());
  ...
  while ((*(myParticleIterator))())
  {
    ...
    else if (particleName == "alpha" || particleName == "He3")
    {
      ...
      pmanager->AddProcess(new G4NuclearStopping(), -1, 3, -1);
             ...
             || particleName == "pi+" || particleName == "pi-" || particleName == "kaon+"
             || particleName == "kaon-")
    {
...
void LBE::ConstructHad()
{
  ...
  while ((*(myParticleIterator))())
  {
    ...
    else if (particleName == "kaon0L")
    {
      ...
      pmanager->AddDiscreteProcess(theElasticProcess);
      // Inelastic scattering
      // G4KaonZeroLInelasticProcess* theInelasticProcess = new
      // G4KaonZeroLInelasticProcess("inelastic");
      G4HadronInelasticProcess* theInelasticProcess =
...
void LBE::SetCuts()
{
  if (verboseLevel > 1) G4cout << "LBE::SetCuts:";
