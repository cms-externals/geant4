...
class G4PhysListRegistry
{
  public:
    ...
    G4bool DeconstructPhysListName(const G4String& name, G4String& plBase,
                                   std::vector<G4String>& physExt, std::vector<G4int>& replace,
                                   G4int verbose = 0) const;

    G4bool FindLongestMatch(const G4String& workName, const G4String& searchName,
                            const std::vector<G4String>& validNames, G4String& bestMatch,
                            G4int verbose = 0) const;
